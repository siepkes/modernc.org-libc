...
//go:build windows || darwin || (linux && arm) || (linux && s390x) || (linux && 386) || (linux && arm) || (linux && arm64)
// +build windows darwin linux,arm linux,s390x linux,386 linux,arm linux,arm64
