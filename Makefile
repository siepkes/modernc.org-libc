...
build_all_targets:
	...
	#TODO GOOS=freebsd GOARCH=amd64 go build -v ./...
	#TODO GOOS=freebsd GOARCH=amd64 go test -c -o /dev/null
	GOOS=linux GOARCH=386 go build -v ./...
	...
	#TODO GOOS=netbsd GOARCH=amd64 go build -v ./...
	#TODO GOOS=netbsd GOARCH=amd64 go test -c -o /dev/null
	GOOS=windows GOARCH=386 go build -v ./...
