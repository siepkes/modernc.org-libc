...
// # POSIX pthreads
//
// POSIX threads (pthreads) are modeled as Go goroutines. A TLS instance
// represents a main thread or a thread created by Xpthread_create. A TLS
// instance is not safe for concurrent use by multiple goroutines.
//
...
//
// The Go libc synchronizes the libc environ with the current Go environ only
// once, when the first TLS instance is created.
//
