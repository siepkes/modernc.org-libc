// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/common/runtest.exe.go src/common/runtest.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
func start(tls *libc.TLS, wrap uintptr, argv uintptr) (r int32) {
	...
	if pid == 0 {
		...
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func usage(tls *libc.TLS, argv uintptr) {
	...
	t_printf(tls, __ccgo_ts+45, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(argv))))
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for {
		v1 = libc.Xgetopt(tls, argc, argv, __ccgo_ts+124)
		opt = v1
		if !(v1 != -int32(1)) {
			break
		}
	...
	if pid == -int32(1) {
		...
		t_printf(tls, __ccgo_ts+129, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:73:3:
		t_printf(tls, __ccgo_ts+174, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
	...
	*(*timespec)(unsafe.Pointer(bp)) = timespec{
	...
	if libc.Xsigtimedwait(tls, bp+20, uintptr(0), bp) == -int32(1) {
		...
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EAGAIN) {
			...
			t_printf(tls, __ccgo_ts+194, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		...
		if libc.Xkill(tls, pid, int32(SIGKILL)) == -int32(1) {
			...
			t_printf(tls, __ccgo_ts+247, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
	}
	...
	if libc.Xwaitpid(tls, pid, bp+16, 0) != pid {
		...
		t_printf(tls, __ccgo_ts+292, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if !(*(*int32)(unsafe.Pointer(bp + 16))&libc.Int32FromInt32(0x7f) != 0) {
		...
		t_printf(tls, __ccgo_ts+340, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), *(*int32)(unsafe.Pointer(bp + 16))&int32(0xff00)>>int32(8)))
	} else {
		...
		if timeout != 0 {
			...
			t_printf(tls, __ccgo_ts+361, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
		} else {
			...
			if uint32(*(*int32)(unsafe.Pointer(bp + 16))&libc.Int32FromInt32(0xffff))-uint32(1) < uint32(0xff) {
				...
				t_printf(tls, __ccgo_ts+382, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrsignal(tls, *(*int32)(unsafe.Pointer(bp + 16))&int32(0x7f))))
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:98:3:
				t_printf(tls, __ccgo_ts+403, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
	}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+422, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+432, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+523, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+528, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+535, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+553, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+561, libc.VaList(bp+8, p))
	}
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+658) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+666) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+678) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+690) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+702) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+711) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+123) != 0
