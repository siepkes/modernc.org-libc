// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/frexpl.exe.go src/math/frexpl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:5:20:
var t = [21]l_li{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fy:    libc.Float64FromFloat64(0.5431549811672881),
		Fdy:   float32(0),
		Fi:    int64(3),
		Fe:    int32(0),
	},
	...
	4: {
		...
		Fy:    libc.Float64FromFloat64(0.5791910604357866),
		Fdy:   float32(0),
		Fi:    int64(4),
		Fe:    int32(0),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:18:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:23:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:26:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(924)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:27:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:29:3:
		if (*l_li)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:30:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:31:3:
		libc.Xfesetround(tls, (*l_li)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:32:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:33:3:
		y = libc.Xfrexpl(tls, (*l_li)(unsafe.Pointer(p)).Fx, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:34:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:36:3:
		if !(checkexceptall(tls, e, (*l_li)(unsafe.Pointer(p)).Fe, (*l_li)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+50, libc.VaList(bp+24, (*l_li)(unsafe.Pointer(p)).Ffile, (*l_li)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_li)(unsafe.Pointer(p)).Fr), (*l_li)(unsafe.Pointer(p)).Fx, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fi, estr(tls, (*l_li)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+108, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:40:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:42:3:
		d = ulperrl(tls, y, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:43:3:
		if v4 = !(checkcr(tls, y, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fr) != 0); !v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		...
		if v4 || libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) < libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0 && int64(*(*int32)(unsafe.Pointer(bp + 8))) != (*l_li)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:44:4:
			libc.Xprintf(tls, __ccgo_ts+117, libc.VaList(bp+24, (*l_li)(unsafe.Pointer(p)).Ffile, (*l_li)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_li)(unsafe.Pointer(p)).Fr), (*l_li)(unsafe.Pointer(p)).Fx, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 8)), float64(d), float64(d-(*l_li)(unsafe.Pointer(p)).Fdy), float64((*l_li)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:46:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpl.c:49:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+423) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+467) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+476) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+49) != 0
