// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lgammaf_r.exe.go src/math/lgammaf_r.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:8:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:8:20:
var t = [19]f_fi{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(8.035280227661133)),
		Fdy:   float32(-libc.Float64FromFloat64(0.4956488311290741)),
		Fi:    int64(-int32(1)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		...
		Fy:    float32(2.241811752319336),
		Fdy:   float32(-libc.Float64FromFloat64(0.006223057862371206)),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		...
		Fy:    float32(-libc.Float64FromFloat64(10.21376895904541)),
		Fdy:   float32(0.3787650763988495),
		Fi:    int64(-int32(1)),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		...
		Fy:    float32(-libc.Float64FromFloat64(6.446407318115234)),
		Fdy:   float32(0.2853533923625946),
		Fi:    int64(-int32(1)),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		...
		Fy:    float32(11.180424690246582),
		Fdy:   float32(0.26607054471969604),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		...
		Fy:    float32(0.30935433506965637),
		Fdy:   float32(-libc.Float64FromFloat64(0.44173941016197205)),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		...
		Fy:    float32(1.308403491973877),
		Fdy:   float32(0.07768253982067108),
		Fi:    int64(-int32(1)),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		...
		Fy:    float32(0.45990341901779175),
		Fdy:   float32(-libc.Float64FromFloat64(0.4957732558250427)),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		...
		Fy:    float32(0.17778414487838745),
		Fdy:   float32(0.37652814388275146),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		...
		Fy:    float32(1.4115465879440308),
		Fdy:   float32(0.20543527603149414),
		Fi:    int64(-int32(1)),
		Fe:    int32(FE_INEXACT),
	},
	10: {
	...
	18: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+57),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+57),
		Fdy:   float32(0),
		Fi:    int64(1),
		Fe:    int32(0),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:14:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:15:1:
	var bad, e, err, i int32
	var d float32
	var p uintptr
	var y float64
	var v2 uint32
	...
	_, _, _, _, _, _, _, _ = bad, d, e, err, i, p, y, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:20:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:23:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(684)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:24:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:26:3:
		if (*f_fi)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:27:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:28:3:
		libc.Xfesetround(tls, (*f_fi)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:29:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:30:3:
		y = float64(lgammaf_r(tls, (*f_fi)(unsafe.Pointer(p)).Fx, bp+4))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:31:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:33:3:
		if !(checkexcept(tls, e, (*f_fi)(unsafe.Pointer(p)).Fe, (*f_fi)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+58, libc.VaList(bp+16, (*f_fi)(unsafe.Pointer(p)).Ffile, (*f_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_fi)(unsafe.Pointer(p)).Fr), float64((*f_fi)(unsafe.Pointer(p)).Fx), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fi, estr(tls, (*f_fi)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+117, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:37:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:39:3:
		d = ulperrf(tls, float32(y), (*f_fi)(unsafe.Pointer(p)).Fy, (*f_fi)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:40:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:58:2:
		*(*float32)(unsafe.Pointer(bp)) = (*f_fi)(unsafe.Pointer(p)).Fx
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:59:2:
		v2 = *(*uint32)(unsafe.Pointer(bp))
		goto _3
	_3:
		bad = libc.BoolInt32(!(libc.BoolInt32(v2&libc.Uint32FromInt32(0x7fffffff) > libc.Uint32FromInt32(0x7f800000)) != 0) && (*f_fi)(unsafe.Pointer(p)).Fx != -libc.X__builtin_inff(tls) && !((*f_fi)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_DIVBYZERO) != 0) && int64(*(*int32)(unsafe.Pointer(bp + 4))) != (*f_fi)(unsafe.Pointer(p)).Fi)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:41:3:
		if bad != 0 || !(checkulp(tls, d, (*f_fi)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:42:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(2) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:43:5:
				libc.Xprintf(tls, __ccgo_ts+126, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:45:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:46:4:
			libc.Xprintf(tls, __ccgo_ts+129, libc.VaList(bp+16, (*f_fi)(unsafe.Pointer(p)).Ffile, (*f_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_fi)(unsafe.Pointer(p)).Fr), float64((*f_fi)(unsafe.Pointer(p)).Fx), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 4)), float64(d), float64(d-(*f_fi)(unsafe.Pointer(p)).Fdy), float64((*f_fi)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf_r.c:50:2:
