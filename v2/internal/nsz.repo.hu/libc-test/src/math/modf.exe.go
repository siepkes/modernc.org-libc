// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/modf.exe.go src/math/modf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:5:20:
var t = [23]d_dd{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fy:    float64(0.34523984933830487),
		Fdy:   float32(0),
		Fy2:   float64(4),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	4: {
		...
		Fy:    float64(0.26705696697258574),
		Fdy:   float32(0),
		Fy2:   float64(9),
		Fdy2:  float32(0),
		Fe:    int32(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:10:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:11:1:
	var d, di float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:15:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:18:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1104)/libc.Uint32FromInt64(48)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:19:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*48
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:21:3:
		if (*d_dd)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:22:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:23:3:
		libc.Xfesetround(tls, (*d_dd)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:24:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:25:3:
		y = libc.Xmodf(tls, (*d_dd)(unsafe.Pointer(p)).Fx, bp)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:26:3:
		...
		/* TODO: fix inexact */
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:29:3:
		if !(checkexceptall(tls, e|int32(FE_INEXACT), (*d_dd)(unsafe.Pointer(p)).Fe|int32(FE_INEXACT), (*d_dd)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+48, libc.VaList(bp+16, (*d_dd)(unsafe.Pointer(p)).Ffile, (*d_dd)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_dd)(unsafe.Pointer(p)).Fr), (*d_dd)(unsafe.Pointer(p)).Fx, (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fy2, estr(tls, (*d_dd)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:35:3:
		d = ulperr(tls, y, (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:36:3:
		di = ulperr(tls, *(*float64)(unsafe.Pointer(bp)), (*d_dd)(unsafe.Pointer(p)).Fy2, (*d_dd)(unsafe.Pointer(p)).Fdy2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:37:3:
		if !(checkcr(tls, float64(y), (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fr) != 0) || !(checkcr(tls, *(*float64)(unsafe.Pointer(bp)), (*d_dd)(unsafe.Pointer(p)).Fy2, (*d_dd)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+16, (*d_dd)(unsafe.Pointer(p)).Ffile, (*d_dd)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_dd)(unsafe.Pointer(p)).Fr), (*d_dd)(unsafe.Pointer(p)).Fx, (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fy2, y, *(*float64)(unsafe.Pointer(bp)), float64(d), float64(d-(*d_dd)(unsafe.Pointer(p)).Fdy), float64((*d_dd)(unsafe.Pointer(p)).Fdy), float64(di), float64(di-(*d_dd)(unsafe.Pointer(p)).Fdy2), float64((*d_dd)(unsafe.Pointer(p)).Fdy2)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modf.c:43:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+425) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+433) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+445) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+469) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+478) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+47) != 0
