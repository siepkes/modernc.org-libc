// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/ynf.exe.go src/math/ynf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:7:20:
var t = [34]fi_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fi:    int64(-int32(1)),
		Fy:    float32(-libc.Float64FromFloat64(0.33858218789100647)),
		Fdy:   float32(-libc.Float64FromFloat64(0.17655716836452484)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	4: {
		...
		Fi:    int64(2),
		Fy:    float32(-libc.Float64FromFloat64(0.1789238154888153)),
		Fdy:   float32(-libc.Float64FromFloat64(0.2155245542526245)),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(3),
		Fy:    float32(-libc.Float64FromFloat64(18.575639724731445)),
		Fdy:   float32(0.08003348112106323),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
	...
	7: {
		...
		Fi:    int64(5),
		Fy:    float32(-libc.Float64FromFloat64(4457.10107421875)),
		Fdy:   float32(-libc.Float64FromFloat64(0.22706131637096405)),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(6),
		Fy:    float32(-libc.Float64FromFloat64(11703.513671875)),
		Fdy:   float32(0.11464684456586838),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:13:1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:17:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1224)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:23:3:
		if (*fi_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:25:3:
		libc.Xfesetround(tls, (*fi_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:27:3:
		y = float64(libc.Xynf(tls, int32((*fi_f)(unsafe.Pointer(p)).Fi), (*fi_f)(unsafe.Pointer(p)).Fx))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:30:3:
		if !(checkexcept(tls, e, (*fi_f)(unsafe.Pointer(p)).Fe, (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+46, libc.VaList(bp+16, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fx), float64((*fi_f)(unsafe.Pointer(p)).Fy), estr(tls, (*fi_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:36:3:
		d = ulperrf(tls, float32(y), (*fi_f)(unsafe.Pointer(p)).Fy, (*fi_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:37:3:
		if v4 = (*fi_f)(unsafe.Pointer(p)).Fx < libc.Float32FromInt32(0); v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:38:3:
		if bad != 0 || !((*fi_f)(unsafe.Pointer(p)).Fx < libc.Float32FromInt32(0)) && !(checkulp(tls, d, (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:39:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(2.5) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:40:5:
				libc.Xprintf(tls, __ccgo_ts+109, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:42:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+16, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fx), float64((*fi_f)(unsafe.Pointer(p)).Fy), y, float64(d), float64(d-(*fi_f)(unsafe.Pointer(p)).Fdy), float64((*fi_f)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ynf.c:47:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+411) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+419) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+464) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+22) != 0
