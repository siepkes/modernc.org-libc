// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/sincosl.exe.go src/math/sincosl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:6:20:
var t = [15]l_ll{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	3: {
		...
		Fy2:   libc.Float64FromFloat64(0.9692853212503283),
	...
	4: {
		...
		Fy:    libc.Float64FromFloat64(0.15706789772028007),
	...
	5: {
		...
		Fy:    libc.Float64FromFloat64(0.6146844860113447),
		Fdy:   float32(-libc.Float64FromFloat64(0.09976737946271896)),
		Fy2:   libc.Float64FromFloat64(0.7887730869248576),
	...
	6: {
		...
		Fy2:   libc.Float64FromFloat64(0.9184692397007294),
	...
	7: {
		...
		Fy:    libc.Float64FromFloat64(0.5326763286672376),
		Fdy:   float32(-libc.Float64FromFloat64(0.3550407588481903)),
		Fy2:   libc.Float64FromFloat64(0.8463190467415896),
	...
	8: {
		...
		Fy:    libc.Float64FromFloat64(0.6991102068649779),
		Fdy:   float32(-libc.Float64FromFloat64(0.427672415971756)),
		Fy2:   libc.Float64FromFloat64(0.7150139289952383),
	...
	9: {
		...
		Fy2:   libc.Float64FromFloat64(0.7783494994757447),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:16:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(144)
	defer tls.Free(144)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:17:1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:21:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:24:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(720)/libc.Uint32FromInt64(48)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:25:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*48
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:27:3:
		if (*l_ll)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:28:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:29:3:
		libc.Xfesetround(tls, (*l_ll)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:30:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:31:3:
		libc.Xsincosl(tls, (*l_ll)(unsafe.Pointer(p)).Fx, bp, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:32:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:34:3:
		if !(checkexcept(tls, e, (*l_ll)(unsafe.Pointer(p)).Fe, (*l_ll)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+24, (*l_ll)(unsafe.Pointer(p)).Ffile, (*l_ll)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_ll)(unsafe.Pointer(p)).Fr), (*l_ll)(unsafe.Pointer(p)).Fx, (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fy2, estr(tls, (*l_ll)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+110, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:38:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:40:3:
		dsin = ulperr(tls, *(*float64)(unsafe.Pointer(bp)), (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:41:3:
		dcos = ulperr(tls, *(*float64)(unsafe.Pointer(bp + 8)), (*l_ll)(unsafe.Pointer(p)).Fy2, (*l_ll)(unsafe.Pointer(p)).Fdy2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:42:3:
		if !(checkulp(tls, dsin, (*l_ll)(unsafe.Pointer(p)).Fr) != 0) || !(checkulp(tls, dcos, (*l_ll)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+119, libc.VaList(bp+24, (*l_ll)(unsafe.Pointer(p)).Ffile, (*l_ll)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_ll)(unsafe.Pointer(p)).Fr), (*l_ll)(unsafe.Pointer(p)).Fx, (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fy2, *(*float64)(unsafe.Pointer(bp)), *(*float64)(unsafe.Pointer(bp + 8)), float64(dsin), float64(dsin-(*l_ll)(unsafe.Pointer(p)).Fdy), float64((*l_ll)(unsafe.Pointer(p)).Fdy), float64(dcos), float64(dcos-(*l_ll)(unsafe.Pointer(p)).Fdy2), float64((*l_ll)(unsafe.Pointer(p)).Fdy2)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:46:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosl.c:49:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+451) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+463) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+475) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+487) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+496) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+51) != 0
