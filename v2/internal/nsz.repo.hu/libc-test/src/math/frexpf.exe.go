// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/frexpf.exe.go src/math/frexpf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:5:20:
var t = [21]f_fi{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(0.5041780471801758)),
		Fdy:   float32(0),
		Fi:    int64(4),
		Fe:    int32(0),
	},
	...
	2: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.5238395929336548)),
		Fdy:   float32(0),
		Fi:    int64(4),
		Fe:    int32(0),
	},
	3: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.8164591789245605)),
		Fdy:   float32(0),
		Fi:    int64(3),
		Fe:    int32(0),
	},
	...
	6: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.8132078647613525)),
		Fdy:   float32(0),
		Fi:    int64(-int32(1)),
		Fe:    int32(0),
	},
	...
	20: {
		...
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+51),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+51),
		Fdy:   float32(0),
		Fi:    int64(0),
		Fe:    int32(0),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	_, _, _, _, _, _, _, _ = d, e, err, i, p, y, v2, v4
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(756)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:23:3:
		if (*f_fi)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:25:3:
		libc.Xfesetround(tls, (*f_fi)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:27:3:
		y = float64(libc.Xfrexpf(tls, (*f_fi)(unsafe.Pointer(p)).Fx, bp+4))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:30:3:
		if !(checkexceptall(tls, e, (*f_fi)(unsafe.Pointer(p)).Fe, (*f_fi)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+16, (*f_fi)(unsafe.Pointer(p)).Ffile, (*f_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_fi)(unsafe.Pointer(p)).Fr), float64((*f_fi)(unsafe.Pointer(p)).Fx), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fi, estr(tls, (*f_fi)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+108, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:36:3:
		d = ulperrf(tls, float32(y), (*f_fi)(unsafe.Pointer(p)).Fy, (*f_fi)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:37:3:
		if v4 = !(checkcr(tls, float64(y), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fr) != 0); !v4 {
		...
		if v4 || libc.BoolInt32(v2&uint32(0x7fffffff) < uint32(0x7f800000)) != 0 && int64(*(*int32)(unsafe.Pointer(bp + 4))) != (*f_fi)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+117, libc.VaList(bp+16, (*f_fi)(unsafe.Pointer(p)).Ffile, (*f_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_fi)(unsafe.Pointer(p)).Fr), float64((*f_fi)(unsafe.Pointer(p)).Fx), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 4)), float64(d), float64(d-(*f_fi)(unsafe.Pointer(p)).Fdy), float64((*f_fi)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexpf.c:43:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+184, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+194, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+420) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+428) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+440) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+452) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+464) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+473) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+51) != 0
