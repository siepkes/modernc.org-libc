// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/jnf.exe.go src/math/jnf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:7:20:
var t = [30]fi_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fi:    int64(-int32(2)),
		Fy:    float32(-libc.Float64FromFloat64(0.09526743739843369)),
		Fdy:   float32(-libc.Float64FromFloat64(0.009049452841281891)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(-int32(1)),
		Fy:    float32(0.1861736923456192),
		Fdy:   float32(-libc.Float64FromFloat64(0.02815016731619835)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(0),
		Fy:    float32(0.07417816668748856),
		Fdy:   float32(0.1667075753211975),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(1),
		Fy:    float32(0.14480164647102356),
		Fdy:   float32(0.3374083340167999),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(2),
		Fy:    float32(0.19546274840831757),
		Fdy:   float32(0.24616770446300507),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(3),
		Fy:    float32(0.0058799986727535725),
		Fdy:   float32(0.12139527499675751),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(4),
		Fy:    float32(7.059315248625353e-05),
		Fdy:   float32(0.10884815454483032),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(5),
		Fy:    float32(1.4378250853042118e-05),
		Fdy:   float32(-libc.Float64FromFloat64(0.462659627199173)),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(6),
		Fy:    float32(4.57233227280085e-06),
		Fdy:   float32(-libc.Float64FromFloat64(0.3658711910247803)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(7),
		Fy:    float32(-libc.Float64FromFloat64(1.0142194639684021e-07)),
		Fdy:   float32(-libc.Float64FromFloat64(0.37866640090942383)),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 22,
	...
	14: {
		...
		Fline: int32(5),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+45),
		Fi:    int64(0),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+45),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	15: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:13:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1080)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:23:3:
		if (*fi_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:25:3:
		libc.Xfesetround(tls, (*fi_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:27:3:
		y = float64(libc.Xjnf(tls, int32((*fi_f)(unsafe.Pointer(p)).Fi), (*fi_f)(unsafe.Pointer(p)).Fx))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:30:3:
		if !(checkexcept(tls, e, (*fi_f)(unsafe.Pointer(p)).Fe, (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+46, libc.VaList(bp+8, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fx), float64((*fi_f)(unsafe.Pointer(p)).Fy), estr(tls, (*fi_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:36:3:
		d = ulperrf(tls, float32(y), (*fi_f)(unsafe.Pointer(p)).Fy, (*fi_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:37:3:
		if !(checkulp(tls, d, (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:38:4:
			if libc.Xfabsf(tls, d) < libc.Float32FromFloat32(3) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:39:5:
				libc.Xprintf(tls, __ccgo_ts+109, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:41:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:42:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+8, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fx), float64((*fi_f)(unsafe.Pointer(p)).Fy), y, float64(d), float64(d-(*fi_f)(unsafe.Pointer(p)).Fdy), float64((*fi_f)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jnf.c:46:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+411) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+419) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+464) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+45) != 0
