// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/frexp.exe.go src/math/frexp.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:5:20:
var t = [21]d_di{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    -libc.Float64FromFloat64(0.50417802441123),
		Fdy:   float32(0),
		Fi:    int64(4),
		Fe:    int32(0),
	},
	...
	2: {
		...
		Fy:    -libc.Float64FromFloat64(0.5238395892222031),
		Fdy:   float32(0),
		Fi:    int64(4),
		Fe:    int32(0),
	},
	3: {
		...
		Fy:    -libc.Float64FromFloat64(0.8164591977391855),
		Fdy:   float32(0),
		Fi:    int64(3),
		Fe:    int32(0),
	},
	...
	6: {
		...
		Fy:    -libc.Float64FromFloat64(0.8132078447707106),
		Fdy:   float32(0),
		Fi:    int64(-int32(1)),
		Fe:    int32(0),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(924)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:23:3:
		if (*d_di)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:25:3:
		libc.Xfesetround(tls, (*d_di)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:27:3:
		y = libc.Xfrexp(tls, (*d_di)(unsafe.Pointer(p)).Fx, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:30:3:
		if !(checkexceptall(tls, e, (*d_di)(unsafe.Pointer(p)).Fe, (*d_di)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+50, libc.VaList(bp+24, (*d_di)(unsafe.Pointer(p)).Ffile, (*d_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_di)(unsafe.Pointer(p)).Fr), (*d_di)(unsafe.Pointer(p)).Fx, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fi, estr(tls, (*d_di)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+105, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:36:3:
		d = ulperr(tls, y, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:37:3:
		if v4 = !(checkcr(tls, float64(y), (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fr) != 0); !v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		...
		if v4 || libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) < libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0 && int64(*(*int32)(unsafe.Pointer(bp + 8))) != (*d_di)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+114, libc.VaList(bp+24, (*d_di)(unsafe.Pointer(p)).Ffile, (*d_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_di)(unsafe.Pointer(p)).Fr), (*d_di)(unsafe.Pointer(p)).Fx, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 8)), float64(d), float64(d-(*d_di)(unsafe.Pointer(p)).Fdy), float64((*d_di)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/frexp.c:43:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+180, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+190, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+281, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+286, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+293, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+311, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+319, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+324, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+367, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+416) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+424) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+436) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+448) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+460) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+469) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+49) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+469) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+475, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
