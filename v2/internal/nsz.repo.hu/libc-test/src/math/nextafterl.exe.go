// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/nextafterl.exe.go src/math/nextafterl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:5:20:
var t = [43]ll_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	18: {
		...
		Fx2:   libc.Float64FromFloat64(1.0000000000000002),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:18:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:22:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:25:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1892)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:26:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:28:3:
		if (*ll_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:29:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:30:3:
		libc.Xfesetround(tls, (*ll_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:31:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:32:3:
		y = libc.Xnextafterl(tls, (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:33:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:35:3:
		if !(checkexceptall(tls, e, (*ll_l)(unsafe.Pointer(p)).Fe, (*ll_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+58, libc.VaList(bp+8, (*ll_l)(unsafe.Pointer(p)).Ffile, (*ll_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_l)(unsafe.Pointer(p)).Fr), (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2, (*ll_l)(unsafe.Pointer(p)).Fy, estr(tls, (*ll_l)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+119, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:39:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:41:3:
		d = ulperrl(tls, y, (*ll_l)(unsafe.Pointer(p)).Fy, (*ll_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:42:3:
		if !(checkcr(tls, y, (*ll_l)(unsafe.Pointer(p)).Fy, (*ll_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+128, libc.VaList(bp+8, (*ll_l)(unsafe.Pointer(p)).Ffile, (*ll_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_l)(unsafe.Pointer(p)).Fr), (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2, (*ll_l)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*ll_l)(unsafe.Pointer(p)).Fdy), float64((*ll_l)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:45:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterl.c:48:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+434) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+442) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+454) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+466) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+478) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+487) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+57) != 0
