// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/atan2f.exe.go src/math/atan2f.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:5:20:
var t = [170]ff_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	2: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   float32(1.4693679385278594e-39),
		Fy:    float32(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	12: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   float32(-libc.Float64FromFloat64(1.4693679385278594e-39)),
		Fy:    float32(3.1415927410125732),
		Fdy:   float32(0.3666777014732361),
		Fe:    int32(FE_INEXACT),
	},
	...
	15: {
		...
		Fx:    float32(-libc.Float64FromFloat64(0)),
		Fx2:   -libc.X__builtin_inff(nil),
		Fy:    float32(-libc.Float64FromFloat64(3.1415927410125732)),
	...
	40: {
		...
		Fx:    float32(3.4028234663852886e+38),
		Fx2:   float32(1.1754943508222875e-38),
		Fy:    float32(1.570796251296997),
		Fdy:   float32(-libc.Float64FromFloat64(0.6333222985267639)),
		Fe:    int32(FE_INEXACT),
	},
	41: {
		Ffile: __ccgo_ts,
	...
	42: {
		...
		Fx:    float32(-libc.Float64FromFloat64(3.4028234663852886e+38)),
		Fx2:   float32(1.1754943508222875e-38),
		Fy:    float32(-libc.Float64FromFloat64(1.570796251296997)),
		Fdy:   float32(0.6333222985267639),
		Fe:    int32(FE_INEXACT),
	},
	43: {
		Ffile: __ccgo_ts,
	...
	52: {
		...
		Fx2:   float32(3.4028234663852886e+38),
		Fy:    float32(0),
		Fdy:   float32(-libc.Float64FromFloat64(2.4651906226892496e-32)),
	...
	53: {
		...
		Fx2:   float32(3.4028234663852886e+38),
		Fy:    float32(-libc.Float64FromFloat64(0)),
		Fdy:   float32(2.4651906226892496e-32),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	54: {
		Ffile: __ccgo_ts,
	...
	59: {
		...
		Fx:    float32(-libc.Float64FromFloat64(1.1754943508222875e-38)),
		Fx2:   float32(-libc.Float64FromFloat64(3.4028234663852886e+38)),
		Fy:    float32(-libc.Float64FromFloat64(3.141592502593994)),
		Fdy:   float32(0.6333222985267639),
		Fe:    int32(FE_INEXACT),
	},
	60: {
	...
	72: {
		...
		Fx:    float32(1.1754943508222875e-38),
		Fx2:   float32(-libc.Float64FromFloat64(1.1754943508222875e-38)),
		Fy:    float32(2.356194496154785),
		Fdy:   float32(0.02500828728079796),
		Fe:    int32(FE_INEXACT),
	},
	73: {
		Ffile: __ccgo_ts,
		...
		Fx:    float32(-libc.Float64FromFloat64(1.1754943508222875e-38)),
		Fx2:   float32(-libc.Float64FromFloat64(1.1754943508222875e-38)),
		Fy:    float32(-libc.Float64FromFloat64(2.356194496154785)),
		Fdy:   float32(-libc.Float64FromFloat64(0.02500828728079796)),
		Fe:    int32(FE_INEXACT),
	},
	74: {
		Ffile: __ccgo_ts,
	...
	78: {
		...
		Fx2:   float32(1.4244518280029297),
		Fy:    float32(-libc.Float64FromFloat64(0.36076784133911133)),
		Fdy:   float32(0.19534504413604736),
		Fe:    int32(FE_INEXACT),
	},
	79: {
		Ffile: __ccgo_ts,
		...
		Fx2:   float32(-libc.Float64FromFloat64(1.3357105255126953)),
		Fy:    float32(2.2197396755218506),
		Fdy:   float32(0.2761240303516388),
		Fe:    int32(FE_INEXACT),
	},
	80: {
		Ffile: __ccgo_ts,
		...
		Fx2:   float32(-libc.Float64FromFloat64(0.07858390361070633)),
		Fy:    float32(-libc.Float64FromFloat64(1.7148325443267822)),
		Fdy:   float32(-libc.Float64FromFloat64(0.07392401993274689)),
		Fe:    int32(FE_INEXACT),
	},
	81: {
		Ffile: __ccgo_ts,
		...
		Fx2:   float32(1.7101776599884033),
		Fy:    float32(0.5946701765060425),
		Fdy:   float32(0.1366693526506424),
		Fe:    int32(FE_INEXACT),
	},
	82: {
		Ffile: __ccgo_ts,
		...
		Fx2:   float32(-libc.Float64FromFloat64(1.916048288345337)),
		Fy:    float32(-libc.Float64FromFloat64(2.9679269790649414)),
		Fdy:   float32(0.23670583963394165),
		Fe:    int32(FE_INEXACT),
	},
	83: {
		Ffile: __ccgo_ts,
		Fline: int32(128),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.8337516784667969)),
		Fx2:   float32(0.09243548661470413),
		Fy:    float32(-libc.Float64FromFloat64(1.4603803157806396)),
		Fdy:   float32(0.020033713430166245),
		Fe:    int32(FE_INEXACT),
	},
	84: {
		Ffile: __ccgo_ts,
		Fline: int32(129),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(1.516845703125)),
		Fx2:   float32(1.4243642091751099),
		Fy:    float32(-libc.Float64FromFloat64(0.8168311715126038)),
		Fdy:   float32(-libc.Float64FromFloat64(0.23591256141662598)),
		Fe:    int32(FE_INEXACT),
	},
	85: {
		Ffile: __ccgo_ts,
		Fline: int32(130),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(1.9923361539840698)),
		Fx2:   float32(-libc.Float64FromFloat64(1.9977492094039917)),
		Fy:    float32(-libc.Float64FromFloat64(2.357551097869873)),
		Fdy:   float32(0.07532889395952225),
		Fe:    int32(FE_INEXACT),
	},
	86: {
		Ffile: __ccgo_ts,
		Fline: int32(131),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.9107399582862854)),
		Fx2:   float32(1.1629410982131958),
		Fy:    float32(-libc.Float64FromFloat64(0.6643725037574768)),
		Fdy:   float32(0.2371213734149933),
		Fe:    int32(FE_INEXACT),
	},
	87: {
		Ffile: __ccgo_ts,
		Fline: int32(132),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.5740546584129333),
		Fx2:   float32(0.9874694347381592),
		Fy:    float32(0.5265852808952332),
		Fdy:   float32(-libc.Float64FromFloat64(0.009734263643622398)),
		Fe:    int32(FE_INEXACT),
	},
	88: {
		Ffile: __ccgo_ts,
	...
	132: {
		...
		Fy:    float32(-libc.Float64FromFloat64(1.0585895776748657)),
		Fdy:   float32(-libc.Float64FromFloat64(0.22352588176727295)),
		Fe:    int32(FE_INEXACT),
	},
	133: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(2.686873435974121),
		Fdy:   float32(0.09464472532272339),
		Fe:    int32(FE_INEXACT),
	},
	134: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(1.8893001079559326)),
		Fdy:   float32(-libc.Float64FromFloat64(0.21941901743412018)),
		Fe:    int32(FE_INEXACT),
	},
	135: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.9605468511581421)),
		Fdy:   float32(0.46015575528144836),
		Fe:    int32(FE_INEXACT),
	},
	136: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(1.0919123888015747),
		Fdy:   float32(-libc.Float64FromFloat64(0.05708503723144531)),
		Fe:    int32(FE_INEXACT),
	},
	137: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(1.4685084819793701)),
		Fdy:   float32(0.19611206650733948),
		Fe:    int32(FE_INEXACT),
	},
	138: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(1.5641601085662842),
		Fdy:   float32(0.48143187165260315),
		Fe:    int32(FE_INEXACT),
	},
	139: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.10281659662723541)),
		Fdy:   float32(-libc.Float64FromFloat64(0.4216274917125702)),
		Fe:    int32(FE_INEXACT),
	},
	140: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(0.29697975516319275),
		Fdy:   float32(0.2322007566690445),
		Fe:    int32(FE_INEXACT),
	},
	141: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(1.5131611824035645)),
		Fdy:   float32(0.16620726883411407),
		Fe:    int32(FE_INEXACT),
	},
	142: {
		Ffile: __ccgo_ts + 48,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:13:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(5440)/libc.Uint32FromInt64(32)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*32
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:23:3:
		if (*ff_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:25:3:
		libc.Xfesetround(tls, (*ff_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:27:3:
		y = libc.Xatan2f(tls, (*ff_f)(unsafe.Pointer(p)).Fx, (*ff_f)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:30:3:
		if !(checkexcept(tls, e, (*ff_f)(unsafe.Pointer(p)).Fe, (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+128, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:36:3:
		d = ulperrf(tls, y, (*ff_f)(unsafe.Pointer(p)).Fy, (*ff_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:37:3:
		if !(checkulp(tls, d, (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:38:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atan2f.c:43:2:
