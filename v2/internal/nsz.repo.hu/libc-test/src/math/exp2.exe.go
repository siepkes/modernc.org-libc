// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/exp2.exe.go src/math/exp2.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:5:19:
var t = [35]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float64(0.003729380227666592),
		Fdy:   float32(0.1281578093767166),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(20.32579462123892),
		Fdy:   float32(0.03073759749531746),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.0029987283924334954),
		Fdy:   float32(-libc.Float64FromFloat64(0.31000515818595886)),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.010808622025681005),
		Fdy:   float32(-libc.Float64FromFloat64(0.28607869148254395)),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(616.1154770730207),
		Fdy:   float32(-libc.Float64FromFloat64(0.08883064985275269)),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(1.5822591361986904),
		Fdy:   float32(-libc.Float64FromFloat64(0.1258980929851532)),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.7543971221632684),
		Fdy:   float32(-libc.Float64FromFloat64(0.24229088425636292)),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(1.4760685736993149),
		Fdy:   float32(0.27173060178756714),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(1.710184880131433),
		Fdy:   float32(-libc.Float64FromFloat64(0.0205493476241827)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.6247003734030933),
		Fdy:   float32(-libc.Float64FromFloat64(0.31195688247680664)),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 23,
	...
	16: {
		...
		Fline: int32(7),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+47)),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+47)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	17: {
		...
		Fline: int32(8),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.998046875),
		Fy:    float64(3.9945884515638808),
		Fdy:   float32(0.1476455181837082),
		Fe:    int32(FE_INEXACT),
	},
	18: {
		Ffile: __ccgo_ts + 23,
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1021.9),
		Fy:    float64(2.384775113731291e-308),
		Fdy:   float32(-libc.Float64FromFloat64(0.2217157781124115)),
		Fe:    int32(FE_INEXACT),
	},
	19: {
		Ffile: __ccgo_ts + 23,
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1022),
	...
	20: {
		...
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1022.1),
		Fy:    float64(2.0760673185932884e-308),
		Fdy:   float32(0.198451966047287),
	...
	21: {
		...
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1023),
	...
	22: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1023.9),
		Fy:    float64(1.6773070034857416e+308),
		Fdy:   float32(0.396903932094574),
		Fe:    int32(FE_INEXACT),
	},
	23: {
		Ffile: __ccgo_ts + 23,
	...
	25: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(3.14),
		Fy:    float64(8.815240927012887),
		Fdy:   float32(0.39309585094451904),
		Fe:    int32(FE_INEXACT),
	},
	26: {
		Ffile: __ccgo_ts + 23,
		Fline: int32(17),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1022.5),
		Fy:    float64(1.5733648139913585e-308),
		Fdy:   float32(-libc.Float64FromFloat64(0.28231191635131836)),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	27: {
		Ffile: __ccgo_ts + 23,
	...
	28: {
		...
		Fline: int32(19),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1023.5),
		Fy:    float64(7.866824069956793e-309),
		Fdy:   float32(-libc.Float64FromFloat64(0.14115595817565918)),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	29: {
		Ffile: __ccgo_ts + 23,
	...
	30: {
		...
		Fline: int32(21),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1025),
		Fy:    float64(2.781342323134e-309),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	31: {
		...
		Fline: int32(22),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1074),
		Fy:    float64(5e-324),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	32: {
		...
		Fline: int32(23),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1074.5),
		Fy:    float64(5e-324),
		Fdy:   float32(0.2928932309150696),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	33: {
		Ffile: __ccgo_ts + 23,
		Fline: int32(24),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(1075),
		Fy:    float64(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1260)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:22:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:24:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:26:3:
		y = libc.Xexp2(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:29:3:
		if !(checkexcept(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:30:4:
			if libc.Xfabs(tls, y) < float64(2.2250738585072014e-308) && e|int32(FE_INEXACT) == libc.Int32FromInt32(FE_INEXACT)|libc.Int32FromInt32(FE_UNDERFLOW) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:31:5:
				libc.Xprintf(tls, __ccgo_ts+48, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:33:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+51, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, estr(tls, (*d_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+8, estr(tls, e)))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:38:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:39:3:
		if !(checkulp(tls, d, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:40:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*d_d)(unsafe.Pointer(p)).Fdy), float64((*d_d)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:42:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/exp2.c:45:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+166, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+176, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+267, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+272, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+279, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+297, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+305, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+310, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+353, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+402) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+410) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+422) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+434) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+446) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+47) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+455) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+461, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
