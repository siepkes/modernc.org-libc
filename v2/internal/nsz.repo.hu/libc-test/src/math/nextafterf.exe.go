// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/nextafterf.exe.go src/math/nextafterf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:5:20:
var t = [43]ff_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(8.066847801208496)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	1: {
	...
	2: {
		...
		Fy:    float32(-libc.Float64FromFloat64(8.38143253326416)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	3: {
		...
		Fy:    float32(-libc.Float64FromFloat64(6.531672954559326)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	4: {
	...
	5: {
		...
		Fy:    float32(-libc.Float64FromFloat64(6.450045108795166)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	6: {
	...
	7: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.7920544743537903)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	8: {
	...
	9: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.5587586164474487)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	10: {
	...
	19: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(1),
		Fx2:   float32(0.9999847412109375),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:12:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1376)/libc.Uint32FromInt64(32)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*32
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:22:3:
		if (*ff_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:24:3:
		libc.Xfesetround(tls, (*ff_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:26:3:
		y = libc.Xnextafterf(tls, (*ff_f)(unsafe.Pointer(p)).Fx, (*ff_f)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:29:3:
		if !(checkexceptall(tls, e, (*ff_f)(unsafe.Pointer(p)).Fe, (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:30:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+118, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:35:3:
		d = ulperrf(tls, y, (*ff_f)(unsafe.Pointer(p)).Fy, (*ff_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:36:3:
		if !(checkcr(tls, float64(y), float64((*ff_f)(unsafe.Pointer(p)).Fy), (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:37:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nextafterf.c:42:2:
