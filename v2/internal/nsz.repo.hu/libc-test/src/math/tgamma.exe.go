// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/tgamma.exe.go src/math/tgamma.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:5:19:
var t = [168]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	34: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(32),
		Fy:    float64(8.222838654177922e+33),
	...
	35: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(64),
		Fy:    float64(1.98260831540444e+87),
	...
	36: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(128),
		Fy:    float64(3.0126600184576594e+213),
	...
	37: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(138),
		Fy:    float64(5.012888748274992e+234),
	...
	38: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(139),
		Fy:    float64(6.917786472619489e+236),
	...
	39: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(140),
		Fy:    float64(9.615723196941089e+238),
	...
	40: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(141),
		Fy:    float64(1.3462012475717526e+241),
	...
	41: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(142),
		Fy:    float64(1.898143759076171e+243),
	...
	42: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(143),
		Fy:    float64(2.695364137888163e+245),
	...
	43: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(144),
		Fy:    float64(3.854370717180073e+247),
	...
	44: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(145),
		Fy:    float64(5.5502938327393044e+249),
	...
	45: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(169),
		Fy:    float64(2.5260757449731984e+302),
	...
	46: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(170),
		Fy:    float64(4.269068009004705e+304),
	...
	47: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(171),
		Fy:    float64(7.257415615307999e+306),
	...
	50: {
		...
		Fy:    float64(1.1258999068426234e+15),
	...
	51: {
		...
		Fy:    float64(2.2517998136852475e+15),
	...
	52: {
		...
		Fy:    float64(4.5035996273704955e+15),
	...
	53: {
		...
		Fy:    float64(9.007199254740991e+15),
	...
	55: {
		...
		Fy:    float64(1.7976931348623095e+308),
	...
	68: {
		...
		Fy:    float64(1.501199875790165e+15),
	...
	69: {
		...
		Fy:    float64(1.1258999068426236e+15),
	...
	70: {
		...
		Fy:    float64(5.629499534213125e+14),
		Fdy:   float32(0.3088626563549042),
		Fe:    int32(FE_INEXACT),
	},
	71: {
		...
		Fy:    float64(7.505999378950831e+14),
	...
	72: {
		...
		Fy:    float64(1.1258999068426245e+15),
		Fdy:   float32(0.1544313281774521),
		Fe:    int32(FE_INEXACT),
	},
	73: {
		...
		Fy:    float64(2.2517998136852485e+15),
	...
	89: {
		...
		Fy:    float64(9.527899106168822e-301),
	...
	90: {
		...
		Fy:    float64(5.4758040840066757e-303),
	...
	93: {
		...
		Fy:    float64(3.1290309051457535e-305),
	...
	94: {
		...
		Fy:    float64(1.7778584688333368e-307),
	...
	97: {
		...
		Fy:    float64(1.004439812899894e-309),
	...
	128: {
		...
		Fy:    float64(0.010912654781909862),
	...
	130: {
		...
		Fy:    float64(0.00022384932885968948),
	...
	132: {
		...
		Fy:    float64(2.772127911575102e-06),
	...
	134: {
		...
		Fy:    float64(2.2957581048241013e-08),
	...
	136: {
		...
		Fy:    float64(1.360449247303171e-10),
	...
	138: {
		...
		Fy:    float64(6.053166840058603e-13),
	...
	143: {
		...
		Fy:    float64(1.6131742461908134e-301),
	...
	145: {
		...
		Fy:    float64(5.6482208842233253e-306),
	...
	147: {
		...
		Fy:    float64(1.9316265431712e-310),
	...
	156: {
		...
		Fy:    float64(4.177797167776188e-88),
	...
	157: {
		...
		Fy:    float64(1.183111089623681e-214),
	...
	158: {
		...
		Fy:    float64(4.295078426216706e+241),
	...
	159: {
		...
		Fy:    float64(7.70661090545803e-244),
	...
	160: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(171.5),
		Fy:    float64(9.4833675668248e+307),
	...
	161: {
		...
		Fy:    float64(1.797693134861967e+308),
	...
	162: {
		...
		Fy:    float64(1.7976931348622299e+308),
	...
	164: {
		...
		Fy:    float64(8.88682451236381e+203),
	...
	165: {
		...
		Fy:    float64(2.8900298331601873e-206),
	...
	166: {
		...
		Fy:    float64(9.334616806332964e+07),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(6048)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:22:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:24:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:26:3:
		y = libc.Xtgamma(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:29:3:
		if !(checkexcept(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, estr(tls, (*d_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:35:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:36:3:
		if !(checkulp(tls, d, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:37:4:
			if libc.Xfabsf(tls, d) < libc.Float32FromFloat32(5.5) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:38:5:
				libc.Xprintf(tls, __ccgo_ts+112, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:40:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:41:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*d_d)(unsafe.Pointer(p)).Fdy), float64((*d_d)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgamma.c:45:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+410) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+418) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+430) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+442) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+454) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+463) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+51) != 0
