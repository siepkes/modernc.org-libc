// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/nexttowardf.exe.go src/math/nexttowardf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:6:20:
var t = [45]ll_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(8.066848754882812),
		Fx2:   libc.Float64FromFloat64(4.53566256067686864039689709215963375754654407501220703125),
		Fy:    -libc.Float64FromFloat64(8.066847801208496),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	1: {
		...
		Fline: int32(2),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(4.345239639282227),
		Fx2:   -libc.Float64FromFloat64(8.88799136300345123638810829191925222403369843959808349609375),
		Fy:    libc.Float64FromFloat64(4.345239162445068),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	2: {
		...
		Fline: int32(3),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(8.381433486938477),
		Fx2:   -libc.Float64FromFloat64(2.76360733737958805494687453130353560482035391032695770263671875),
		Fy:    -libc.Float64FromFloat64(8.38143253326416),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	3: {
		...
		Fline: int32(4),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(6.531673431396484),
		Fx2:   libc.Float64FromFloat64(4.567535276842743484360109817998818471096456050872802734375),
		Fy:    -libc.Float64FromFloat64(6.531672954559326),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	4: {
		...
		Fline: int32(5),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(9.267057418823242),
		Fx2:   libc.Float64FromFloat64(4.8113920843597958974802164533457471407018601894378662109375),
		Fy:    libc.Float64FromFloat64(9.267056465148926),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	5: {
		...
		Fline: int32(6),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(6.450045585632324),
		Fx2:   libc.Float64FromFloat64(0.6620717923376738959563049535805845380309619940817356109619140625),
		Fy:    -libc.Float64FromFloat64(6.450045108795166),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	6: {
		...
		Fline: int32(7),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(7.858890056610107),
		Fx2:   libc.Float64FromFloat64(0.05215452675006224789972333368004431264353115693666040897369384765625),
		Fy:    libc.Float64FromFloat64(7.858889579772949),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	7: {
		...
		Fline: int32(8),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(0.7920545339584351),
		Fx2:   libc.Float64FromFloat64(7.6764026851175400285344496698058947004028595983982086181640625),
		Fy:    -libc.Float64FromFloat64(0.7920544743537903),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	8: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0.6157026886940002),
		Fx2:   libc.Float64FromFloat64(2.01190257903248027383270868373443818200030364096164703369140625),
		Fy:    libc.Float64FromFloat64(0.615702748298645),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	9: {
		...
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(0.5587586760520935),
		Fx2:   libc.Float64FromFloat64(0.0322398306026380385667928774040547068580053746700286865234375),
		Fy:    -libc.Float64FromFloat64(0.5587586164474487),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	10: {
		...
		Fline: int32(1),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(3.4028234663852886e+38),
	...
	11: {
		...
		Fy:    libc.Float64FromFloat64(3.4028232635611926e+38),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	12: {
		...
		Fline: int32(3),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.401298464324817e-45),
		Fx2:   float64(-libc.X__builtin_inff(nil)),
	...
	13: {
		...
		Fx:    libc.Float64FromFloat64(1.401298464324817e-45),
		Fx2:   float64(libc.X__builtin_inff(nil)),
		Fy:    libc.Float64FromFloat64(2.802596928649634e-45),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	14: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.401298464324817e-45),
		Fx2:   libc.Float64FromFloat64(1.40129846432481691534834763676137345267866059737340975700076406586061275515795e-45),
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	15: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.401298464324817e-45),
		Fx2:   libc.Float64FromFloat64(1.4012984643248173820744934763470014884834646308827278012696767199481477377417e-45),
		Fy:    libc.Float64FromFloat64(2.802596928649634e-45),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	16: {
		...
		Fx2:   libc.Float64FromFloat64(1.0000000000000002220446049250313080847263336181640625),
		Fy:    libc.Float64FromFloat64(1.0000001192092896),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	17: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1),
		Fx2:   libc.Float64FromFloat64(0.99999999999999988897769753748434595763683319091796875),
		Fy:    libc.Float64FromFloat64(0.9999999403953552),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	18: {
		...
		Fline: int32(15),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1754940705625946e-38),
		Fx2:   libc.Float64FromFloat64(1),
		Fy:    libc.Float64FromFloat64(1.1754942106924411e-38),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	19: {
		...
		Fline: int32(16),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1754942106924411e-38),
		Fx2:   libc.Float64FromFloat64(1),
		Fy:    libc.Float64FromFloat64(1.1754943508222875e-38),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	20: {
		...
		Fline: int32(17),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.175494490952134e-38),
		Fx2:   libc.Float64FromFloat64(0),
		Fy:    libc.Float64FromFloat64(1.1754943508222875e-38),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	26: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1),
		Fx2:   float64(libc.X__builtin_nanf(nil, __ccgo_ts+61)),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+61)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	27: {
		...
		Fline: int32(24),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+61)),
		Fx2:   libc.Float64FromFloat64(1),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+61)),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	30: {
		...
		Fx:    libc.Float64FromFloat64(0),
		Fx2:   float64(libc.X__builtin_inff(nil)),
		Fy:    libc.Float64FromFloat64(1.401298464324817e-45),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	31: {
	...
	40: {
		...
		Fx:    float64(libc.X__builtin_inff(nil)),
		Fx2:   float64(-libc.X__builtin_inff(nil)),
		Fy:    libc.Float64FromFloat64(3.4028234663852886e+38),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	41: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:19:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:23:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:26:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1980)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:27:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:29:3:
		if (*ll_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:30:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:31:3:
		libc.Xfesetround(tls, (*ll_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:32:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:33:3:
		y = libc.Xnexttowardf(tls, float32((*ll_l)(unsafe.Pointer(p)).Fx), (*ll_l)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:34:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:36:3:
		if !(checkexceptall(tls, e, (*ll_l)(unsafe.Pointer(p)).Fe, (*ll_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+62, libc.VaList(bp+8, (*ll_l)(unsafe.Pointer(p)).Ffile, (*ll_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_l)(unsafe.Pointer(p)).Fr), (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2, (*ll_l)(unsafe.Pointer(p)).Fy, estr(tls, (*ll_l)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:40:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:42:3:
		d = ulperrf(tls, y, float32((*ll_l)(unsafe.Pointer(p)).Fy), (*ll_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:43:3:
		if !(checkcr(tls, float64(y), (*ll_l)(unsafe.Pointer(p)).Fy, (*ll_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:44:4:
			libc.Xprintf(tls, __ccgo_ts+133, libc.VaList(bp+8, (*ll_l)(unsafe.Pointer(p)).Ffile, (*ll_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_l)(unsafe.Pointer(p)).Fr), (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2, (*ll_l)(unsafe.Pointer(p)).Fy, float64(y), float64(d), float64(d-(*ll_l)(unsafe.Pointer(p)).Fdy), float64((*ll_l)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:46:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/nexttowardf.c:49:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+439) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+447) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+459) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+471) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+483) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+492) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+61) != 0
