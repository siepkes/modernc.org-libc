// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/acoshl.exe.go src/math/acoshl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:5:19:
var t = [34]l_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fy:    libc.Float64FromFloat64(2.1487163980597503),
		Fdy:   float32(-libc.Float64FromFloat64(0.291634738445282)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	4: {
		...
		Fy:    libc.Float64FromFloat64(2.91668914109908),
		Fdy:   float32(-libc.Float64FromFloat64(0.24191908538341522)),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
	...
	17: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.000474714396831),
		Fy:    libc.Float64FromFloat64(0.030811583621269234),
		Fdy:   float32(-libc.Float64FromFloat64(0.14720220863819122)),
		Fe:    int32(FE_INEXACT),
	},
	18: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0018394073032046),
		Fy:    libc.Float64FromFloat64(0.06064393912727107),
		Fdy:   float32(-libc.Float64FromFloat64(0.27641335129737854)),
		Fe:    int32(FE_INEXACT),
	},
	19: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0018841158083673),
		Fy:    libc.Float64FromFloat64(0.06137628950531526),
		Fdy:   float32(0.14453989267349243),
		Fe:    int32(FE_INEXACT),
	},
	20: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.007102192192419),
		Fy:    libc.Float64FromFloat64(0.11911172253310362),
		Fdy:   float32(-libc.Float64FromFloat64(0.07012676447629929)),
		Fe:    int32(FE_INEXACT),
	},
	21: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(13),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0072165761523613),
		Fy:    libc.Float64FromFloat64(0.1200659234653388),
		Fdy:   float32(0.34816744923591614),
		Fe:    int32(FE_INEXACT),
	},
	22: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(14),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0075588903624033),
		Fy:    libc.Float64FromFloat64(0.12287706626647071),
		Fdy:   float32(0.2380778044462204),
		Fe:    int32(FE_INEXACT),
	},
	23: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(15),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0254239847486402),
		Fy:    libc.Float64FromFloat64(0.22501990747093337),
		Fdy:   float32(-libc.Float64FromFloat64(0.326139897108078)),
		Fe:    int32(FE_INEXACT),
	},
	24: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(16),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0256625220747686),
		Fy:    libc.Float64FromFloat64(0.22606860120643968),
		Fdy:   float32(-libc.Float64FromFloat64(0.03866777941584587)),
		Fe:    int32(FE_INEXACT),
	},
	25: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(17),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0258391651139116),
		Fy:    libc.Float64FromFloat64(0.22684200879243638),
		Fdy:   float32(-libc.Float64FromFloat64(0.21494144201278687)),
		Fe:    int32(FE_INEXACT),
	},
	26: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(18),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0277926416782197),
		Fy:    libc.Float64FromFloat64(0.23522265570367998),
		Fdy:   float32(-libc.Float64FromFloat64(0.18194638192653656)),
		Fe:    int32(FE_INEXACT),
	},
	27: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(19),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0279579384525759),
		Fy:    libc.Float64FromFloat64(0.23591789536785635),
		Fdy:   float32(-libc.Float64FromFloat64(0.21022343635559082)),
		Fe:    int32(FE_INEXACT),
	},
	28: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(20),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0302303051591817),
		Fy:    libc.Float64FromFloat64(0.24527213177511742),
		Fdy:   float32(-libc.Float64FromFloat64(0.2814681828022003)),
		Fe:    int32(FE_INEXACT),
	},
	29: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(21),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1042249363786338),
		Fy:    libc.Float64FromFloat64(0.45268787679702205),
		Fdy:   float32(0.2765592634677887),
		Fe:    int32(FE_INEXACT),
	},
	30: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(22),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1060831199926429),
		Fy:    libc.Float64FromFloat64(0.4566373404384803),
		Fdy:   float32(-libc.Float64FromFloat64(0.29381608963012695)),
		Fe:    int32(FE_INEXACT),
	},
	31: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(23),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1066965028066487),
		Fy:    libc.Float64FromFloat64(0.45793306496297603),
		Fdy:   float32(-libc.Float64FromFloat64(0.2617563307285309)),
		Fe:    int32(FE_INEXACT),
	},
	32: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(24),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1089809557628658),
		Fy:    libc.Float64FromFloat64(0.4627246859959428),
		Fdy:   float32(-libc.Float64FromFloat64(0.3990095555782318)),
		Fe:    int32(FE_INEXACT),
	},
	33: {
		Ffile: __ccgo_ts + 25,
		Fline: int32(25),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.1169429159875521),
		Fy:    libc.Float64FromFloat64(0.47902433134075284),
		Fdy:   float32(-libc.Float64FromFloat64(0.321674108505249)),
		Fe:    int32(FE_INEXACT),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:18:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:22:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:25:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1224)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:26:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:28:3:
		if (*l_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:29:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:30:3:
		libc.Xfesetround(tls, (*l_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:31:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:32:3:
		y = libc.Xacoshl(tls, (*l_l)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:33:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:35:3:
		if !(checkexcept(tls, e, (*l_l)(unsafe.Pointer(p)).Fe, (*l_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:36:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:39:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:41:3:
		d = ulperrl(tls, y, (*l_l)(unsafe.Pointer(p)).Fy, (*l_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:42:3:
		if !(checkulp(tls, d, (*l_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:43:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:45:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acoshl.c:48:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+410) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+418) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+430) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+442) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+454) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+463) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+24) != 0
