// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/tanhl.exe.go src/math/tanhl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:5:19:
var t = [259]l_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	15: {
		...
		Fline: int32(54),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(6.410030298071676),
		Fy:    libc.Float64FromFloat64(0.9999945881313685),
	...
	16: {
		...
		Fline: int32(55),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(7.924049524500565),
		Fy:    libc.Float64FromFloat64(0.9999997380080344),
	...
	20: {
		...
		Fline: int32(59),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(5.204982064916739),
		Fy:    libc.Float64FromFloat64(0.9999397403046324),
	...
	21: {
		...
		Fline: int32(60),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(7.695798073994006),
		Fy:    libc.Float64FromFloat64(0.999999586434187),
	...
	30: {
		...
		Fr:    int32(FE_TOWARDZERO),
		Fx:    libc.Float64FromFloat64(5.204982064916739),
		Fy:    libc.Float64FromFloat64(0.9999397403046323),
	...
	31: {
		...
		Fr:    int32(FE_TOWARDZERO),
		Fx:    libc.Float64FromFloat64(7.695798073994006),
		Fy:    libc.Float64FromFloat64(0.9999995864341868),
	...
	35: {
		...
		Fr:    int32(FE_UPWARD),
		Fx:    libc.Float64FromFloat64(6.410030298071676),
		Fy:    libc.Float64FromFloat64(0.9999945881313687),
	...
	36: {
		...
		Fr:    int32(FE_UPWARD),
		Fx:    libc.Float64FromFloat64(7.924049524500565),
		Fy:    libc.Float64FromFloat64(0.9999997380080345),
	...
	245: {
		...
		Fy:    libc.Float64FromFloat64(0.9996636978961307),
	...
	248: {
		...
		Fy:    libc.Float64FromFloat64(0.9999999821447234),
	...
	249: {
		...
		Fy:    libc.Float64FromFloat64(0.5796835018635275),
	...
	251: {
		...
		Fy:    libc.Float64FromFloat64(0.5092819248700439),
	...
	252: {
		...
		Fy:    libc.Float64FromFloat64(0.6493374550318555),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:19:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:23:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:26:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(9324)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:27:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:29:3:
		if (*l_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:30:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:31:3:
		libc.Xfesetround(tls, (*l_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:32:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:33:3:
		y = libc.Xtanhl(tls, (*l_l)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:34:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:36:3:
		if !(checkexcept(tls, e, (*l_l)(unsafe.Pointer(p)).Fe, (*l_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:37:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+120, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:40:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:42:3:
		d = ulperrl(tls, y, (*l_l)(unsafe.Pointer(p)).Fy, (*l_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:43:3:
		if !(checkulp(tls, d, (*l_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:44:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:46:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanhl.c:49:2:
