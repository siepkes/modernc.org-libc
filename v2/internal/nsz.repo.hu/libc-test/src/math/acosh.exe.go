// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/acosh.exe.go src/math/acosh.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:5:19:
var t = [34]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	17: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.000474714396831),
		Fy:    float64(0.030811583621269234),
	...
	18: {
		...
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0018394073032046),
		Fy:    float64(0.06064393912727107),
	...
	19: {
		...
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0018841158083673),
		Fy:    float64(0.06137628950531526),
	...
	20: {
		...
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.007102192192419),
		Fy:    float64(0.11911172253310362),
	...
	21: {
		...
		Fline: int32(13),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0072165761523613),
		Fy:    float64(0.1200659234653388),
	...
	22: {
		...
		Fline: int32(14),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0075588903624033),
		Fy:    float64(0.12287706626647071),
	...
	23: {
		...
		Fline: int32(15),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0254239847486402),
		Fy:    float64(0.22501990747093337),
	...
	24: {
		...
		Fline: int32(16),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0256625220747686),
		Fy:    float64(0.22606860120643968),
	...
	25: {
		...
		Fline: int32(17),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0258391651139116),
		Fy:    float64(0.22684200879243638),
	...
	26: {
		...
		Fline: int32(18),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0277926416782197),
		Fy:    float64(0.23522265570367998),
	...
	27: {
		...
		Fline: int32(19),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0279579384525759),
		Fy:    float64(0.23591789536785635),
	...
	28: {
		...
		Fline: int32(20),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0302303051591817),
		Fy:    float64(0.24527213177511742),
	...
	29: {
		...
		Fline: int32(21),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.1042249363786338),
		Fy:    float64(0.45268787679702205),
	...
	30: {
		...
		Fline: int32(22),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.1060831199926429),
		Fy:    float64(0.4566373404384803),
	...
	31: {
		...
		Fline: int32(23),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.1066965028066487),
		Fy:    float64(0.45793306496297603),
	...
	32: {
		...
		Fline: int32(24),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.1089809557628658),
		Fy:    float64(0.4627246859959428),
	...
	33: {
		...
		Fline: int32(25),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.1169429159875521),
		Fy:    float64(0.47902433134075284),
		Fdy:   float32(-libc.Float64FromFloat64(0.321674108505249)),
		Fe:    int32(FE_INEXACT),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1224)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:22:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:24:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:26:3:
		y = libc.Xacosh(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:29:3:
		if !(checkexcept(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:30:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:35:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:36:3:
		if !(checkulp(tls, d, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:37:4:
			if libc.Xfabsf(tls, d) < libc.Float32FromFloat32(2) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:38:5:
				libc.Xprintf(tls, __ccgo_ts+109, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:40:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:41:4:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/acosh.c:45:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+406) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+414) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+426) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+438) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+450) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+459) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+24) != 0
