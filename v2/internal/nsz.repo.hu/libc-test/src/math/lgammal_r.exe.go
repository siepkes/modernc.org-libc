// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lgammal_r.exe.go src/math/lgammal_r.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:6:20:
var t = [19]l_li{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:19:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:24:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:27:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(836)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:28:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:30:3:
		if (*l_li)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:31:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:32:3:
		libc.Xfesetround(tls, (*l_li)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:33:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:34:3:
		y = lgammal_r(tls, (*l_li)(unsafe.Pointer(p)).Fx, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:35:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:37:3:
		if !(checkexcept(tls, e, (*l_li)(unsafe.Pointer(p)).Fe, (*l_li)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+56, libc.VaList(bp+24, (*l_li)(unsafe.Pointer(p)).Ffile, (*l_li)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_li)(unsafe.Pointer(p)).Fr), (*l_li)(unsafe.Pointer(p)).Fx, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fi, estr(tls, (*l_li)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:40:4:
			libc.Xprintf(tls, __ccgo_ts+117, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:41:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:43:3:
		d = ulperrl(tls, y, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fdy)
		// TODO: 2 ulp errors allowed
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:45:3:
		...
		if v4 || !(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && (*l_li)(unsafe.Pointer(p)).Fx != float64(-libc.X__builtin_inff(tls)) && !((*l_li)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_DIVBYZERO) != 0) && int64(*(*int32)(unsafe.Pointer(bp + 8))) != (*l_li)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:46:4:
			libc.Xprintf(tls, __ccgo_ts+126, libc.VaList(bp+24, (*l_li)(unsafe.Pointer(p)).Ffile, (*l_li)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_li)(unsafe.Pointer(p)).Fr), (*l_li)(unsafe.Pointer(p)).Fx, (*l_li)(unsafe.Pointer(p)).Fy, (*l_li)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 8)), float64(d), float64(d-(*l_li)(unsafe.Pointer(p)).Fdy), float64((*l_li)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:48:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammal_r.c:51:2:
