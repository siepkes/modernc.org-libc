// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lgamma_r.exe.go src/math/lgamma_r.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:8:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:8:20:
var t = [19]d_di{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	18: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+55)),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+55)),
		Fdy:   float32(0),
		Fi:    int64(1),
		Fe:    int32(0),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:14:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:15:1:
	...
	var _ /* yi at bp+8 */ int32
	_, _, _, _, _, _, _, _ = bad, d, e, err, i, p, y, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:20:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:23:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(836)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:24:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:26:3:
		if (*d_di)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:27:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:28:3:
		libc.Xfesetround(tls, (*d_di)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:29:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:30:3:
		y = lgamma_r(tls, (*d_di)(unsafe.Pointer(p)).Fx, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:31:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:33:3:
		if !(checkexcept(tls, e, (*d_di)(unsafe.Pointer(p)).Fe, (*d_di)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+56, libc.VaList(bp+24, (*d_di)(unsafe.Pointer(p)).Ffile, (*d_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_di)(unsafe.Pointer(p)).Fr), (*d_di)(unsafe.Pointer(p)).Fx, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fi, estr(tls, (*d_di)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+114, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:37:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:39:3:
		d = ulperr(tls, y, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:40:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		*(*float64)(unsafe.Pointer(bp)) = (*d_di)(unsafe.Pointer(p)).Fx
		...
		goto _3
	_3:
		bad = libc.BoolInt32(!(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && (*d_di)(unsafe.Pointer(p)).Fx != float64(-libc.X__builtin_inff(tls)) && !((*d_di)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_DIVBYZERO) != 0) && int64(*(*int32)(unsafe.Pointer(bp + 8))) != (*d_di)(unsafe.Pointer(p)).Fi)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:41:3:
		if bad != 0 || !(checkulp(tls, d, (*d_di)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:42:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(11) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:43:5:
				libc.Xprintf(tls, __ccgo_ts+123, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:45:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:46:4:
			libc.Xprintf(tls, __ccgo_ts+126, libc.VaList(bp+24, (*d_di)(unsafe.Pointer(p)).Ffile, (*d_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_di)(unsafe.Pointer(p)).Fr), (*d_di)(unsafe.Pointer(p)).Fx, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 8)), float64(d), float64(d-(*d_di)(unsafe.Pointer(p)).Fdy), float64((*d_di)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma_r.c:50:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+439) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+451) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+463) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+475) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+484) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+55) != 0
