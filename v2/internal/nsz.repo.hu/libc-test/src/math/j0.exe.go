// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/j0.exe.go src/math/j0.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:6:19:
var t = [24]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float64(0.15566022095976176),
		Fdy:   float32(-libc.Float64FromFloat64(0.4184402525424957)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.3529097224248869),
		Fdy:   float32(0.2766090929508209),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.07417818148209926),
		Fdy:   float32(-libc.Float64FromFloat64(0.18622657656669617)),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.26482442087797264),
		Fdy:   float32(0.37029188871383667),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.1509567817439821),
		Fdy:   float32(0.11027076095342636),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.8934080375231922),
		Fdy:   float32(-libc.Float64FromFloat64(0.06779281049966812)),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.959093433416707),
		Fdy:   float32(-libc.Float64FromFloat64(0.2064921110868454)),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.9226489699209159),
		Fdy:   float32(0.0010350439697504044),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.8556916005579677),
		Fdy:   float32(0.04361286386847496),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.8880944283471938),
		Fdy:   float32(-libc.Float64FromFloat64(0.31097421050071716)),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 21,
	...
	14: {
		...
		Fline: int32(5),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+43)),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+43)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	15: {
		...
		Fline: int32(7),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(2.404821752113386),
		Fy:    float64(1.9756601350909454e-06),
		Fdy:   float32(-libc.Float64FromFloat64(0.29564547538757324)),
		Fe:    int32(FE_INEXACT),
	},
	16: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(8),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(2.40482551965038),
		Fy:    float64(1.9751170684698528e-08),
		Fdy:   float32(0.013748393394052982),
		Fe:    int32(FE_INEXACT),
	},
	17: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.404825557695773),
		Fy:    -libc.Float64FromFloat64(6.10876525973673e-17),
		Fdy:   float32(0.060168176889419556),
		Fe:    int32(FE_INEXACT),
	},
	18: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.520078110286311),
		Fy:    -libc.Float64FromFloat64(2.7522649432621832e-17),
		Fdy:   float32(-libc.Float64FromFloat64(0.27615606784820557)),
		Fe:    int32(FE_INEXACT),
	},
	19: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(8.653727912911013),
		Fy:    -libc.Float64FromFloat64(7.948465570525162e-17),
		Fdy:   float32(-libc.Float64FromFloat64(0.34733301401138306)),
		Fe:    int32(FE_INEXACT),
	},
	20: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.5745408694701114e+308),
		Fy:    -libc.Float64FromFloat64(7.455736819252105e-159),
		Fdy:   float32(0.018635692074894905),
		Fe:    int32(FE_INEXACT),
	},
	21: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(13),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.96565312682827),
		Fy:    float64(0.24373479345378662),
		Fdy:   float32(-libc.Float64FromFloat64(0.053189679980278015)),
		Fe:    int32(FE_INEXACT),
	},
	22: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(14),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0.00012037607270885618),
		Fy:    float64(0.9999999963774003),
		Fdy:   float32(0.4704771041870117),
		Fe:    int32(FE_INEXACT),
	},
	23: {
		Ffile: __ccgo_ts + 21,
		Fline: int32(15),
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(0.00012138870687530847),
		Fy:    float64(0.9999999963161955),
		Fdy:   float32(0.46966999769210815),
		Fe:    int32(FE_INEXACT),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:13:1:
	var bad, e, err, i int32
	var d float32
	var p uintptr
	var y float64
	_, _, _, _, _, _, _ = bad, d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:17:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(864)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:23:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:25:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:27:3:
		y = libc.Xj0(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:30:3:
		if !(checkexcept(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+44, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, estr(tls, (*d_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+91, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:36:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:37:3:
		if !(checkulp(tls, d, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:38:4:
			if libc.Xfabsf(tls, d) < libc.Float32FromFloat32(4.503599627370496e+15) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:39:5:
				libc.Xprintf(tls, __ccgo_ts+100, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:41:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:42:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*d_d)(unsafe.Pointer(p)).Fdy), float64((*d_d)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/j0.c:46:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+158, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+168, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+259, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+264, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+271, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+289, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+297, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+302, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+345, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+394) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+402) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+414) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+426) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+438) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+447) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+43) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+447) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+453, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
