// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/scalblnl.exe.go src/math/scalblnl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:5:20:
var t = [27]li_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fi:    int64(-int32(2)),
		Fy:    -libc.Float64FromFloat64(2.01671209764492),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	1: {
		...
		Fi:    int64(-int32(1)),
		Fy:    libc.Float64FromFloat64(2.1726199246691524),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	2: {
		...
		Fi:    int64(0),
		Fy:    -libc.Float64FromFloat64(8.38143342755525),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	3: {
		...
		Fi:    int64(1),
		Fy:    -libc.Float64FromFloat64(13.063347163826968),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	4: {
		...
		Fi:    int64(2),
		Fy:    libc.Float64FromFloat64(37.06822786789034),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	5: {
		...
		Fi:    int64(3),
		Fy:    libc.Float64FromFloat64(5.295887184796036),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	6: {
		...
		Fi:    int64(4),
		Fy:    -libc.Float64FromFloat64(6.505662758165685),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	7: {
		...
		Fi:    int64(5),
		Fy:    libc.Float64FromFloat64(17.97631187906317),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	8: {
		...
		Fi:    int64(6),
		Fy:    libc.Float64FromFloat64(49.545746981843436),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	9: {
		...
		Fi:    int64(7),
		Fy:    -libc.Float64FromFloat64(86.88175393784351),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	10: {
	...
	13: {
		...
		Fline: int32(4),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+53)),
		Fi:    int64(0),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+53)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	14: {
	...
	26: {
		...
		Fline: int32(17),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.000244140625),
		Fi:    int64(-int32(1074)),
		Fy:    libc.Float64FromFloat64(5e-324),
		Fdy:   float32(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:18:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:22:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:25:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1188)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:26:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:28:3:
		if (*li_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:29:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:30:3:
		libc.Xfesetround(tls, (*li_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:31:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:32:3:
		y = libc.Xscalblnl(tls, (*li_l)(unsafe.Pointer(p)).Fx, int32((*li_l)(unsafe.Pointer(p)).Fi))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:33:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:35:3:
		if !(checkexceptall(tls, e, (*li_l)(unsafe.Pointer(p)).Fe, (*li_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+54, libc.VaList(bp+8, (*li_l)(unsafe.Pointer(p)).Ffile, (*li_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*li_l)(unsafe.Pointer(p)).Fr), (*li_l)(unsafe.Pointer(p)).Fx, (*li_l)(unsafe.Pointer(p)).Fi, (*li_l)(unsafe.Pointer(p)).Fy, estr(tls, (*li_l)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:39:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:41:3:
		d = ulperrl(tls, y, (*li_l)(unsafe.Pointer(p)).Fy, (*li_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:42:3:
		if !(checkcr(tls, y, (*li_l)(unsafe.Pointer(p)).Fy, (*li_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+8, (*li_l)(unsafe.Pointer(p)).Ffile, (*li_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*li_l)(unsafe.Pointer(p)).Fr), (*li_l)(unsafe.Pointer(p)).Fx, (*li_l)(unsafe.Pointer(p)).Fi, (*li_l)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*li_l)(unsafe.Pointer(p)).Fdy), float64((*li_l)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:45:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnl.c:48:2:
