// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/remquol.exe.go src/math/remquol.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:5:21:
var t = [76]ll_li{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    libc.Float64FromFloat64(1.0044767307740567),
		Fdy:   float32(0),
		Fi:    int64(-int32(2)),
		Fe:    int32(0),
	},
	...
	4: {
		...
		Fy:    -libc.Float64FromFloat64(0.35572720174700656),
		Fdy:   float32(0),
		Fi:    int64(2),
		Fe:    int32(0),
	},
	5: {
		...
		Fy:    libc.Float64FromFloat64(0.17067236731650248),
		Fdy:   float32(0),
		Fi:    int64(-int32(10)),
		Fe:    int32(0),
	},
	6: {
		...
		Fy:    -libc.Float64FromFloat64(0.016443286217702822),
		Fdy:   float32(0),
		Fi:    int64(151),
		Fe:    int32(0),
	},
	...
	40: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0),
		Fx2:   float64(libc.X__builtin_nanf(nil, __ccgo_ts+51)),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+51)),
		Fdy:   float32(0),
		Fi:    int64(0),
		Fe:    int32(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:18:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:23:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:26:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(3952)/libc.Uint32FromInt64(52)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:27:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*52
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:29:3:
		if (*ll_li)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:30:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:31:3:
		libc.Xfesetround(tls, (*ll_li)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:32:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:33:3:
		y = libc.Xremquol(tls, (*ll_li)(unsafe.Pointer(p)).Fx, (*ll_li)(unsafe.Pointer(p)).Fx2, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:34:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:36:3:
		if !(checkexcept(tls, e, (*ll_li)(unsafe.Pointer(p)).Fe, (*ll_li)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+24, (*ll_li)(unsafe.Pointer(p)).Ffile, (*ll_li)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_li)(unsafe.Pointer(p)).Fr), (*ll_li)(unsafe.Pointer(p)).Fx, (*ll_li)(unsafe.Pointer(p)).Fx2, (*ll_li)(unsafe.Pointer(p)).Fy, (*ll_li)(unsafe.Pointer(p)).Fi, estr(tls, (*ll_li)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:40:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:42:3:
		d = ulperr(tls, float64(y), (*ll_li)(unsafe.Pointer(p)).Fy, (*ll_li)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:43:3:
		if v4 = !(checkcr(tls, y, (*ll_li)(unsafe.Pointer(p)).Fy, (*ll_li)(unsafe.Pointer(p)).Fr) != 0); !v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
			*(*float64)(unsafe.Pointer(bp)) = (*ll_li)(unsafe.Pointer(p)).Fy
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:65:2:
			v2 = *(*uint64)(unsafe.Pointer(bp))
			goto _3
		_3:
		}
		if v7 = v4 || !(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && int64(*(*int32)(unsafe.Pointer(bp + 8))&libc.Int32FromInt32(7)) != (*ll_li)(unsafe.Pointer(p)).Fi&int64(7); !v7 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
			*(*float64)(unsafe.Pointer(bp)) = (*ll_li)(unsafe.Pointer(p)).Fy
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:65:2:
			v5 = *(*uint64)(unsafe.Pointer(bp))
		...
		if v7 || !(libc.BoolInt32(v5&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && libc.BoolInt32(*(*int32)(unsafe.Pointer(bp + 8)) < 0) != libc.BoolInt32((*ll_li)(unsafe.Pointer(p)).Fi < 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:46:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+24, (*ll_li)(unsafe.Pointer(p)).Ffile, (*ll_li)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_li)(unsafe.Pointer(p)).Fr), (*ll_li)(unsafe.Pointer(p)).Fx, (*ll_li)(unsafe.Pointer(p)).Fx2, (*ll_li)(unsafe.Pointer(p)).Fy, (*ll_li)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 8)), float64(d), float64(d-(*ll_li)(unsafe.Pointer(p)).Fdy), float64((*ll_li)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:48:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquol.c:51:2:
