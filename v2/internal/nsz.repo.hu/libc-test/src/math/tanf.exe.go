// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/tanf.exe.go src/math/tanf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:5:19:
var t = [171]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(39),
	...
	156: {
		...
		Fy:    float32(4.626595497131348),
		Fdy:   float32(0.2455666959285736),
		Fe:    int32(FE_INEXACT),
	},
	157: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(2.6001901626586914),
		Fdy:   float32(0.3652407228946686),
		Fe:    int32(FE_INEXACT),
	},
	158: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(1.716740608215332),
		Fdy:   float32(0.08169349282979965),
		Fe:    int32(FE_INEXACT),
	},
	159: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.2537320852279663)),
		Fdy:   float32(0.23186513781547546),
		Fe:    int32(FE_INEXACT),
	},
	160: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.15904149413108826)),
		Fdy:   float32(-libc.Float64FromFloat64(0.009332014247775078)),
		Fe:    int32(FE_INEXACT),
	},
	161: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(0.7792918682098389),
		Fdy:   float32(-libc.Float64FromFloat64(0.06759700924158096)),
		Fe:    int32(FE_INEXACT),
	},
	162: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.43059954047203064)),
		Fdy:   float32(0.005771996453404427),
		Fe:    int32(FE_INEXACT),
	},
	163: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(0.6294037103652954),
		Fdy:   float32(-libc.Float64FromFloat64(0.16838163137435913)),
		Fe:    int32(FE_INEXACT),
	},
	164: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(0.977757453918457),
		Fdy:   float32(0.38969388604164124),
		Fe:    int32(FE_INEXACT),
	},
	165: {
		Ffile: __ccgo_ts + 21,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.8066186308860779)),
		Fdy:   float32(0.12294059991836548),
		Fe:    int32(FE_INEXACT),
	},
	166: {
		Ffile: __ccgo_ts + 44,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:13:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(4788)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:23:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:25:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:27:3:
		y = libc.Xtanf(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:30:3:
		if !(checkexcept(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+117, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:36:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:37:3:
		if !(checkulp(tls, d, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:38:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tanf.c:43:2:
