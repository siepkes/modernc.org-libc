// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/floorl.exe.go src/math/floorl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:5:19:
var t = [401]l_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	4: {
		...
		Fline: int32(42),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(9.007199254740991e+15),
	...
	32: {
		...
		Fline: int32(71),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(2.1767398198957398e+15),
		Fy:    libc.Float64FromFloat64(2.176739819895739e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	33: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(2.1767398198957398e+15),
		Fy:    -libc.Float64FromFloat64(2.17673981989574e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	34: {
	...
	56: {
		...
		Fline: int32(96),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(2.1767398198957392e+15),
		Fy:    libc.Float64FromFloat64(2.176739819895739e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	80: {
		...
		Fline: int32(121),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0.49999999999999994),
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	82: {
		...
		Fline: int32(123),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0.5000000000000001),
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	86: {
		...
		Fline: int32(127),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.4999999999999998),
		Fy:    libc.Float64FromFloat64(1),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	88: {
		...
		Fline: int32(129),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.5000000000000002),
		Fy:    libc.Float64FromFloat64(1),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	92: {
		...
		Fline: int32(133),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(2.4999999999999996),
		Fy:    libc.Float64FromFloat64(2),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	94: {
		...
		Fline: int32(135),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(2.5000000000000004),
		Fy:    libc.Float64FromFloat64(2),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	98: {
		...
		Fline: int32(139),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(5.4418495497393444e+14),
		Fy:    libc.Float64FromFloat64(5.44184954973934e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	99: {
		...
		Fline: int32(140),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(5.441849549739345e+14),
		Fy:    libc.Float64FromFloat64(5.44184954973934e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	100: {
		...
		Fline: int32(141),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(5.4418495497393456e+14),
		Fy:    libc.Float64FromFloat64(5.44184954973934e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	101: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    -libc.Float64FromFloat64(5.4418495497393444e+14),
		Fy:    -libc.Float64FromFloat64(5.44184954973935e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	102: {
	...
	177: {
		...
		Fline: int32(219),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(35.611297072073405),
		Fy:    libc.Float64FromFloat64(35),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	178: {
		...
		Fline: int32(220),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(44.022492631551394),
		Fy:    libc.Float64FromFloat64(44),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	179: {
	...
	182: {
		...
		Fline: int32(224),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(28.916562170799768),
		Fy:    libc.Float64FromFloat64(28),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	183: {
		...
		Fline: int32(225),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(42.7544339083583),
		Fy:    libc.Float64FromFloat64(42),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	184: {
	...
	206: {
		...
		Fline: int32(249),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(4608),
		Fy:    libc.Float64FromFloat64(4608),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	207: {
		...
		Fline: int32(250),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.388608e+06),
		Fy:    libc.Float64FromFloat64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	208: {
		...
		Fline: int32(251),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(4.503599627370495e+15),
		Fy:    libc.Float64FromFloat64(4.503599627370495e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	209: {
		...
		Fline: int32(252),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(4.503599627370496e+15),
	...
	211: {
		...
		Fline: int32(254),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(3.5111194040279537e+305),
		Fy:    libc.Float64FromFloat64(3.5111194040279537e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	212: {
		...
		Fline: int32(255),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(3.5111194040279572e+305),
		Fy:    libc.Float64FromFloat64(3.5111194040279572e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	213: {
		...
		Fline: int32(256),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(3.5111194040279604e+305),
		Fy:    libc.Float64FromFloat64(3.5111194040279604e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	214: {
		...
		Fy:    libc.Float64FromFloat64(3.511119404027961e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	215: {
	...
	225: {
		...
		Fline: int32(268),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(0.9375),
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	227: {
		...
		Fline: int32(270),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(7.999999999999999),
	...
	228: {
		...
		Fline: int32(271),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.000000000000002),
	...
	229: {
		...
		Fline: int32(272),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(512.0000000000009),
		Fy:    libc.Float64FromFloat64(512),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	230: {
		...
		Fline: int32(273),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(262144.00000000006),
		Fy:    libc.Float64FromFloat64(262144),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	231: {
		...
		Fline: int32(274),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.388608000000002e+06),
		Fy:    libc.Float64FromFloat64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	232: {
		...
		Fy:    libc.Float64FromFloat64(4.503599627370494e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	233: {
	...
	238: {
		...
		Fline: int32(281),
		Fr:    int32(FE_DOWNWARD),
		Fx:    -libc.Float64FromFloat64(511.99999999999955),
		Fy:    -libc.Float64FromFloat64(512),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	239: {
		...
		Fline: int32(282),
		Fr:    int32(FE_DOWNWARD),
		Fx:    -libc.Float64FromFloat64(262143.99999999997),
		Fy:    -libc.Float64FromFloat64(262144),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	240: {
		...
		Fline: int32(283),
		Fr:    int32(FE_DOWNWARD),
		Fx:    -libc.Float64FromFloat64(8.388607999999997e+06),
		Fy:    -libc.Float64FromFloat64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	241: {
		...
		Fline: int32(284),
		Fr:    int32(FE_DOWNWARD),
		Fx:    -libc.Float64FromFloat64(8.388607999999998e+06),
		Fy:    -libc.Float64FromFloat64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	242: {
		...
		Fline: int32(285),
		Fr:    int32(FE_DOWNWARD),
		Fx:    -libc.Float64FromFloat64(8.388607999999999e+06),
		Fy:    -libc.Float64FromFloat64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	267: {
		...
		Fline: int32(310),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(4.500000000000001),
		Fy:    libc.Float64FromFloat64(4),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	365: {
		...
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.0000152587890625),
		Fy:    libc.Float64FromFloat64(1),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	367: {
		...
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0.9999923706054688),
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:19:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:23:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:26:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(14436)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:27:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:29:3:
		if (*l_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:30:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:31:3:
		libc.Xfesetround(tls, (*l_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:32:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:33:3:
		y = libc.Xfloorl(tls, (*l_l)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:34:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:36:3:
		if !(checkexceptall(tls, e, (*l_l)(unsafe.Pointer(p)).Fe, (*l_l)(unsafe.Pointer(p)).Fr) != 0) && e|int32(FE_INEXACT) != (*l_l)(unsafe.Pointer(p)).Fe {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:37:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:40:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:42:3:
		d = ulperrl(tls, y, (*l_l)(unsafe.Pointer(p)).Fy, (*l_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:43:3:
		if !(checkcr(tls, y, (*l_l)(unsafe.Pointer(p)).Fy, (*l_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:44:4:
			libc.Xprintf(tls, __ccgo_ts+133, libc.VaList(bp+8, (*l_l)(unsafe.Pointer(p)).Ffile, (*l_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_l)(unsafe.Pointer(p)).Fr), (*l_l)(unsafe.Pointer(p)).Fx, (*l_l)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*l_l)(unsafe.Pointer(p)).Fdy), float64((*l_l)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:46:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorl.c:49:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+195, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+205, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+296, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+301, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+308, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+326, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+334, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+339, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+382, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+439) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+451) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+463) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+475) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+484) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+21) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+484) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+490, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
