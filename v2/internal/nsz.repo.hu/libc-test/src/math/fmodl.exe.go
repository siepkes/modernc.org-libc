// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/fmodl.exe.go src/math/fmodl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:5:20:
var t = [1051]ll_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	48: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.7976931348623157e+308),
		Fx2:   libc.Float64FromFloat64(8.988465674311579e+307),
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	70: {
		...
		Fx2:   libc.Float64FromFloat64(71.22259414414681),
	...
	71: {
		...
		Fline: int32(123),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(88.04498526310279),
		Fx2:   -libc.Float64FromFloat64(66.78552142661842),
		Fy:    libc.Float64FromFloat64(21.25946383648437),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	72: {
	...
	73: {
		...
		Fline: int32(125),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(57.833124341599536),
		Fx2:   libc.Float64FromFloat64(85.5088678167166),
		Fy:    libc.Float64FromFloat64(57.833124341599536),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	74: {
	...
	75: {
		...
		Fx2:   libc.Float64FromFloat64(4.621773070236693),
	...
	76: {
		...
		Fx2:   libc.Float64FromFloat64(71.21820707478629),
	...
	78: {
		...
		Fx2:   libc.Float64FromFloat64(58.14706899562555),
	...
	79: {
		...
		Fline: int32(131),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(28.70274214255075),
		Fx2:   libc.Float64FromFloat64(49.3734605429732),
		Fy:    libc.Float64FromFloat64(28.70274214255075),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	80: {
	...
	82: {
		...
		Fline: int32(135),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(1.7976931348623153e+308),
		Fx2:   libc.Float64FromFloat64(1.5e-323),
	...
	86: {
		...
		Fline: int32(140),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(2.225073858507204e-308),
		Fx2:   libc.Float64FromFloat64(2.2250738585072043e-308),
		Fy:    libc.Float64FromFloat64(2.225073858507204e-308),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	87: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(2.225073858507204e-308),
		Fx2:   libc.Float64FromFloat64(2.2250738585072034e-308),
		Fy:    libc.Float64FromFloat64(5e-324),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	130: {
		...
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(2.225073858507201e-308),
		Fx2:   libc.Float64FromFloat64(4.4501477170144023e-308),
	...
	141: {
		...
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(2.225073858507203e-308),
		Fx2:   libc.Float64FromFloat64(2.225073858507204e-308),
	...
	143: {
		...
		Fline: int32(201),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(2.2250738585072034e-308),
		Fx2:   libc.Float64FromFloat64(2.225073858507204e-308),
		Fy:    libc.Float64FromFloat64(2.2250738585072034e-308),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	144: {
		...
		Fline: int32(202),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(2.2250738585072043e-308),
		Fx2:   libc.Float64FromFloat64(2.225073858507204e-308),
		Fy:    libc.Float64FromFloat64(5e-324),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	145: {
		...
		Fline: int32(203),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(4.4501477170144023e-308),
		Fx2:   libc.Float64FromFloat64(4.450147717014403e-308),
	...
	146: {
		...
		Fline: int32(204),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(1.139237815555687e-305),
		Fx2:   libc.Float64FromFloat64(5.696189077778436e-306),
		Fy:    libc.Float64FromFloat64(5.696189077778434e-306),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	147: {
		...
		Fline: int32(205),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(0.125),
		Fx2:   libc.Float64FromFloat64(0.5),
		Fy:    libc.Float64FromFloat64(0.125),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	148: {
	...
	149: {
		...
		Fline: int32(207),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(0.25000000000000006),
		Fx2:   libc.Float64FromFloat64(0.5),
		Fy:    libc.Float64FromFloat64(0.25000000000000006),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	150: {
		...
		Fline: int32(208),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(0.375),
		Fx2:   libc.Float64FromFloat64(0.5),
		Fy:    libc.Float64FromFloat64(0.375),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	151: {
		...
		Fline: int32(209),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(0.625),
		Fx2:   libc.Float64FromFloat64(0.5),
		Fy:    libc.Float64FromFloat64(0.125),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	153: {
		...
		Fx2:   libc.Float64FromFloat64(1.9999999999999998),
	...
	176: {
		...
		Fline: int32(234),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(2.0000000000000036),
		Fx2:   libc.Float64FromFloat64(4),
		Fy:    libc.Float64FromFloat64(2.0000000000000036),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	177: {
	...
	185: {
		...
		Fline: int32(243),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(5.999999999999993),
		Fx2:   libc.Float64FromFloat64(4),
		Fy:    libc.Float64FromFloat64(1.999999999999993),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	186: {
	...
	191: {
		...
		Fline: int32(249),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(1.99584030953472e+292),
		Fx2:   libc.Float64FromFloat64(7.98336123813888e+292),
		Fy:    libc.Float64FromFloat64(1.99584030953472e+292),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	192: {
		...
		Fx2:   libc.Float64FromFloat64(8.98846567431158e+307),
		Fy:    libc.Float64FromFloat64(4.49423283715579e+307),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	193: {
		...
		Fline: int32(251),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.988465674311576e+307),
		Fx2:   libc.Float64FromFloat64(8.988465674311578e+307),
		Fy:    libc.Float64FromFloat64(8.988465674311576e+307),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	194: {
	...
	203: {
		...
		Fline: int32(261),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.988465674311582e+307),
		Fx2:   libc.Float64FromFloat64(8.988465674311578e+307),
		Fy:    libc.Float64FromFloat64(3.99168061906944e+292),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	204: {
	...
	209: {
		...
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.988465674311586e+307),
		Fx2:   libc.Float64FromFloat64(8.98846567431159e+307),
		Fy:    libc.Float64FromFloat64(8.988465674311586e+307),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	210: {
	...
	211: {
		...
		Fline: int32(269),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.988465674311588e+307),
		Fx2:   libc.Float64FromFloat64(8.98846567431159e+307),
		Fy:    libc.Float64FromFloat64(8.988465674311588e+307),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	212: {
		...
		Fline: int32(270),
		Fr:    int32(FE_DOWNWARD),
		Fx:    libc.Float64FromFloat64(8.988465674311592e+307),
		Fx2:   libc.Float64FromFloat64(8.98846567431159e+307),
		Fy:    libc.Float64FromFloat64(1.99584030953472e+292),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	976: {
		...
		Fy:    libc.Float64FromFloat64(4.345239849338305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	977: {
	...
	979: {
		...
		Fy:    libc.Float64FromFloat64(4.45566488261279),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	980: {
	...
	981: {
		...
		Fy:    libc.Float64FromFloat64(0.035711240532359426),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	982: {
	...
	983: {
		...
		Fy:    libc.Float64FromFloat64(0.615702673197924),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	984: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:19:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:23:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:26:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(46244)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:27:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:29:3:
		if (*ll_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:30:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:31:3:
		libc.Xfesetround(tls, (*ll_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:32:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:33:3:
		y = libc.Xfmodl(tls, (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:34:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:36:3:
		if !(checkexcept(tls, e, (*ll_l)(unsafe.Pointer(p)).Fe, (*ll_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+68, libc.VaList(bp+8, (*ll_l)(unsafe.Pointer(p)).Ffile, (*ll_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_l)(unsafe.Pointer(p)).Fr), (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2, (*ll_l)(unsafe.Pointer(p)).Fy, estr(tls, (*ll_l)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:40:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:42:3:
		d = ulperrl(tls, y, (*ll_l)(unsafe.Pointer(p)).Fy, (*ll_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:43:3:
		if !(checkcr(tls, y, (*ll_l)(unsafe.Pointer(p)).Fy, (*ll_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:44:4:
			libc.Xprintf(tls, __ccgo_ts+133, libc.VaList(bp+8, (*ll_l)(unsafe.Pointer(p)).Ffile, (*ll_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*ll_l)(unsafe.Pointer(p)).Fr), (*ll_l)(unsafe.Pointer(p)).Fx, (*ll_l)(unsafe.Pointer(p)).Fx2, (*ll_l)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*ll_l)(unsafe.Pointer(p)).Fdy), float64((*ll_l)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:46:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmodl.c:49:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+434) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+442) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+454) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+466) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+478) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+487) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+20) != 0
