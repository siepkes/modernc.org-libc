// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lgamma.exe.go src/math/lgamma.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:6:20:
var t = [199]d_di{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	56: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(131072),
		Fy:    float64(1.413410210444138e+06),
	...
	57: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(262144),
		Fy:    float64(3.0085294216269394e+06),
	...
	58: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(524288),
		Fy:    float64(6.380472565067316e+06),
	...
	59: {
		...
		Fline: int32(51),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.048576e+06),
		Fy:    float64(1.348776794752331e+07),
	...
	60: {
		...
		Fline: int32(52),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.2676506002282294e+30),
		Fy:    float64(8.659919334810373e+31),
	...
	61: {
		...
		Fline: int32(53),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.6069380442589903e+60),
		Fy:    float64(2.2116197689826736e+62),
		Fdy:   float32(0.11806158721446991),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	62: {
		...
		Fline: int32(54),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.037035976334486e+90),
		Fy:    float64(4.2155268713229285e+92),
	...
	63: {
		...
		Fline: int32(55),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.5822498780869086e+120),
		Fy:    float64(7.133694391207944e+122),
		Fdy:   float32(0.11806158721446991),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	64: {
		...
		Fline: int32(56),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(3.273390607896142e+150),
		Fy:    float64(1.131197344759412e+153),
	...
	65: {
		...
		Fline: int32(57),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(4.149515568880993e+180),
		Fy:    float64(1.7215854947867936e+183),
		Fdy:   float32(-libc.Float64FromFloat64(0.32290762662887573)),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	66: {
		...
		Fline: int32(58),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.260135901548374e+210),
		Fy:    float64(2.5469737227627324e+213),
	...
	67: {
		...
		Fline: int32(59),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.668014432879854e+240),
		Fy:    float64(3.690864308834075e+243),
		Fdy:   float32(0.11806158721446991),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	68: {
		...
		Fline: int32(60),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(8.452712498170644e+270),
		Fy:    float64(5.264623740073543e+273),
	...
	69: {
		...
		Fline: int32(61),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0715086071862673e+301),
		Fy:    float64(7.416416614096889e+303),
		Fdy:   float32(0.3975769877433777),
		Fi:    int64(1),
		Fe:    int32(FE_INEXACT),
	},
	70: {
		...
		Fline: int32(62),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.0972248137587377e+304),
		Fy:    float64(7.670464441444942e+306),
	...
	71: {
		...
		Fline: int32(63),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.1944496275174755e+304),
		Fy:    float64(1.535613964861183e+307),
	...
	72: {
		...
		Fline: int32(64),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(4.388899255034951e+304),
		Fy:    float64(3.074270082866755e+307),
	...
	73: {
		...
		Fline: int32(65),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(8.777798510069902e+304),
		Fy:    float64(6.154624472022289e+307),
	...
	74: {
		...
		Fline: int32(66),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.7555597020139804e+305),
		Fy:    float64(1.2321417556622133e+308),
	...
	75: {
		...
		Fline: int32(67),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(3.511119404027961e+305),
		Fy:    float64(libc.X__builtin_inff(nil)),
		Fdy:   float32(0),
		Fi:    int64(1),
	...
	76: {
		...
		Fline: int32(69),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(8.881784197001252e-16),
		Fy:    float64(34.657359027997266),
	...
	77: {
		...
		Fline: int32(70),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(4.440892098500626e-16),
		Fy:    float64(35.35050620855721),
	...
	78: {
		...
		Fline: int32(71),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.220446049250313e-16),
		Fy:    float64(36.04365338911715),
	...
	79: {
		...
		Fline: int32(72),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.1102230246251565e-16),
		Fy:    float64(36.7368005696771),
	...
	81: {
		...
		Fline: int32(74),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.562684646268023e-309),
	...
	181: {
		...
		Fline: int32(176),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(141.23456789),
		Fy:    float64(556.380477226722),
	...
	184: {
		...
		Fline: int32(179),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(171.62437695630268),
		Fy:    float64(709.7827128933839),
	...
	187: {
		...
		Fline: int32(182),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(123.456789),
		Fy:    float64(469.60934366579744),
	...
	189: {
		...
		Fline: int32(184),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(12.3456789),
		Fy:    float64(18.351825377975345),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:13:1:
	var bad, e, err, i, yi int32
	var d float32
	var p uintptr
	var y float64
	var v2 uint64
	...
	_, _, _, _, _, _, _, _, _ = bad, d, e, err, i, p, y, yi, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:18:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:21:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(8756)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:22:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:24:3:
		if (*d_di)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:25:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:26:3:
		libc.Xfesetround(tls, (*d_di)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:27:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:28:3:
		y = libc.Xlgamma(tls, (*d_di)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:29:3:
		yi = gngam
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:30:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:32:3:
		if !(checkexcept(tls, e, (*d_di)(unsafe.Pointer(p)).Fe, (*d_di)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+16, (*d_di)(unsafe.Pointer(p)).Ffile, (*d_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_di)(unsafe.Pointer(p)).Fr), (*d_di)(unsafe.Pointer(p)).Fx, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fi, estr(tls, (*d_di)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+108, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:36:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:38:3:
		d = ulperr(tls, y, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:39:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		*(*float64)(unsafe.Pointer(bp)) = (*d_di)(unsafe.Pointer(p)).Fx
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:65:2:
		v2 = *(*uint64)(unsafe.Pointer(bp))
		goto _3
	_3:
		bad = libc.BoolInt32(!(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && (*d_di)(unsafe.Pointer(p)).Fx != float64(-libc.X__builtin_inff(tls)) && !((*d_di)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_DIVBYZERO) != 0) && int64(yi) != (*d_di)(unsafe.Pointer(p)).Fi)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:40:3:
		if bad != 0 || !(checkulp(tls, d, (*d_di)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:41:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(11) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:42:5:
				libc.Xprintf(tls, __ccgo_ts+117, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:44:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:45:4:
			libc.Xprintf(tls, __ccgo_ts+120, libc.VaList(bp+16, (*d_di)(unsafe.Pointer(p)).Ffile, (*d_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_di)(unsafe.Pointer(p)).Fr), (*d_di)(unsafe.Pointer(p)).Fx, (*d_di)(unsafe.Pointer(p)).Fy, (*d_di)(unsafe.Pointer(p)).Fi, y, yi, float64(d), float64(d-(*d_di)(unsafe.Pointer(p)).Fdy), float64((*d_di)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgamma.c:49:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+187, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+197, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+288, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+293, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+300, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+318, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+326, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+331, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+374, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+423) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+467) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+476) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+51) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+476) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+482, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
