// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/llroundf.exe.go src/math/llroundf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:5:19:
var t = [27]f_i{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	25: {
		...
		Fline: int32(18),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(1.2676506002282294e+30),
		Fi:    int64(0),
		Fe:    int32(FE_INVALID),
	},
	26: {
		...
		Fline: int32(19),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(1.2676506002282294e+30)),
		Fi:    int64(0),
		Fe:    int32(FE_INVALID),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:12:1:
	var e, err, i int32
	var p uintptr
	var yi int64
	_, _, _, _, _ = e, err, i, p, yi
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:15:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:18:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(756)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:19:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:21:3:
		if (*f_i)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:22:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:23:3:
		libc.Xfesetround(tls, (*f_i)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:24:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:25:3:
		yi = libc.Xllroundf(tls, (*f_i)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:26:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:28:3:
		if !(checkexcept(tls, e, (*f_i)(unsafe.Pointer(p)).Fe, (*f_i)(unsafe.Pointer(p)).Fr) != 0) && e|int32(FE_INEXACT) != (*f_i)(unsafe.Pointer(p)).Fe {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:29:4:
			libc.Xprintf(tls, __ccgo_ts+56, libc.VaList(bp+8, (*f_i)(unsafe.Pointer(p)).Ffile, (*f_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_i)(unsafe.Pointer(p)).Fr), float64((*f_i)(unsafe.Pointer(p)).Fx), (*f_i)(unsafe.Pointer(p)).Fi, estr(tls, (*f_i)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+111, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:32:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:34:3:
		if !((*f_i)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_INVALID) != 0) && yi != (*f_i)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+120, libc.VaList(bp+8, (*f_i)(unsafe.Pointer(p)).Ffile, (*f_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_i)(unsafe.Pointer(p)).Fr), float64((*f_i)(unsafe.Pointer(p)).Fx), (*f_i)(unsafe.Pointer(p)).Fi, yi))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:37:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundf.c:40:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+399) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+407) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+419) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+452) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+55) != 0
