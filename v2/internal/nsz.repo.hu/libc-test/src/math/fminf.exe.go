// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/fminf.exe.go src/math/fminf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:5:20:
var t = [68]ff_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(8.066848754882812)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	1: {
		...
		Fy:    float32(-libc.Float64FromFloat64(8.887990951538086)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	2: {
		...
		Fy:    float32(-libc.Float64FromFloat64(8.381433486938477)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	3: {
		...
		Fy:    float32(-libc.Float64FromFloat64(6.531673431396484)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	4: {
	...
	5: {
		...
		Fy:    float32(-libc.Float64FromFloat64(6.450045585632324)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	6: {
		...
		Fy:    float32(0.052154526114463806),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	7: {
	...
	9: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.5587586760520935)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	10: {
	...
	18: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+49),
		Fx2:   float32(1),
		Fy:    float32(1),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	32: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   libc.X__builtin_nanf(nil, __ccgo_ts+49),
		Fy:    float32(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	53: {
		...
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+49),
		Fx2:   libc.X__builtin_nanf(nil, __ccgo_ts+49),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+49),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	54: {
	...
	65: {
		...
		Fx2:   float32(0.5),
		Fy:    float32(-libc.Float64FromFloat64(1.75)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	66: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:12:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(2176)/libc.Uint32FromInt64(32)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*32
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:22:3:
		if (*ff_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:24:3:
		libc.Xfesetround(tls, (*ff_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:26:3:
		y = libc.Xfminf(tls, (*ff_f)(unsafe.Pointer(p)).Fx, (*ff_f)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:29:3:
		if !(checkexceptall(tls, e, (*ff_f)(unsafe.Pointer(p)).Fe, (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+50, libc.VaList(bp+8, (*ff_f)(unsafe.Pointer(p)).Ffile, (*ff_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*ff_f)(unsafe.Pointer(p)).Fr), float64((*ff_f)(unsafe.Pointer(p)).Fx), float64((*ff_f)(unsafe.Pointer(p)).Fx2), float64((*ff_f)(unsafe.Pointer(p)).Fy), estr(tls, (*ff_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:35:3:
		d = ulperrf(tls, y, (*ff_f)(unsafe.Pointer(p)).Fy, (*ff_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:36:3:
		if !(checkcr(tls, float64(y), float64((*ff_f)(unsafe.Pointer(p)).Fy), (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+8, (*ff_f)(unsafe.Pointer(p)).Ffile, (*ff_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*ff_f)(unsafe.Pointer(p)).Fr), float64((*ff_f)(unsafe.Pointer(p)).Fx), float64((*ff_f)(unsafe.Pointer(p)).Fx2), float64((*ff_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*ff_f)(unsafe.Pointer(p)).Fdy), float64((*ff_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fminf.c:42:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+173, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+183, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+274, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+279, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+286, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+304, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+312, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+317, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+360, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+409) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+417) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+429) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+441) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+453) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+462) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+49) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+462) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+468, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
