// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/sincosf.exe.go src/math/sincosf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:6:20:
var t = [15]f_ff{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(0.977429211139679)),
		Fdy:   float32(0.0801057294011116),
		Fy2:   float32(-libc.Float64FromFloat64(0.21126316487789154)),
		Fdy2:  float32(0.48328569531440735),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.933354377746582)),
		Fdy:   float32(0.34475627541542053),
		Fy2:   float32(-libc.Float64FromFloat64(0.3589562177658081)),
		Fdy2:  float32(0.042505208402872086),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.8640924692153931)),
		Fdy:   float32(-libc.Float64FromFloat64(0.468659907579422)),
		Fy2:   float32(-libc.Float64FromFloat64(0.5033331513404846)),
		Fdy2:  float32(-libc.Float64FromFloat64(0.1386195719242096)),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.24593880772590637)),
		Fdy:   float32(-libc.Float64FromFloat64(0.3955177664756775)),
		Fy2:   float32(0.9692853689193726),
		Fdy2:  float32(0.1786951720714569),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(0.1570674479007721),
		Fdy:   float32(-libc.Float64FromFloat64(0.24006809294223785)),
		Fy2:   float32(-libc.Float64FromFloat64(0.9875878691673279)),
		Fdy2:  float32(0.1389600932598114),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(0.6146844625473022),
		Fdy:   float32(-libc.Float64FromFloat64(0.07707194238901138)),
		Fy2:   float32(0.7887731194496155),
		Fdy2:  float32(0.2989593744277954),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.39549243450164795)),
		Fdy:   float32(-libc.Float64FromFloat64(0.11720617115497589)),
		Fy2:   float32(0.918469250202179),
		Fdy2:  float32(0.24250665307044983),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(0.5326763391494751),
		Fdy:   float32(-libc.Float64FromFloat64(0.16059114038944244)),
		Fy2:   float32(0.8463190197944641),
		Fdy2:  float32(-libc.Float64FromFloat64(0.24033240973949432)),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(0.699110209941864),
		Fdy:   float32(0.26384368538856506),
		Fy2:   float32(0.7150139212608337),
		Fdy2:  float32(-libc.Float64FromFloat64(0.3372635245323181)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.627831220626831)),
		Fdy:   float32(0.005127954296767712),
		Fy2:   float32(0.7783495187759399),
		Fdy2:  float32(0.16550153493881226),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 26,
	...
	12: {
		...
		Fdy:   float32(0),
		Fy2:   libc.X__builtin_nanf(nil, __ccgo_ts+53),
		Fdy2:  float32(0),
		Fe:    int32(FE_INVALID),
	},
	13: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:12:1:
	var dcos, dsin float32
	var e, err, i int32
	var p uintptr
	var _ /* ycos at bp+4 */ float32
	var _ /* ysin at bp+0 */ float32
	_, _, _, _, _, _ = dcos, dsin, e, err, i, p
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(540)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:22:3:
		if (*f_ff)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:24:3:
		libc.Xfesetround(tls, (*f_ff)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:26:3:
		libc.Xsincosf(tls, (*f_ff)(unsafe.Pointer(p)).Fx, bp, bp+4)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:29:3:
		if !(checkexcept(tls, e, (*f_ff)(unsafe.Pointer(p)).Fe, (*f_ff)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+54, libc.VaList(bp+16, (*f_ff)(unsafe.Pointer(p)).Ffile, (*f_ff)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_ff)(unsafe.Pointer(p)).Fr), float64((*f_ff)(unsafe.Pointer(p)).Fx), float64((*f_ff)(unsafe.Pointer(p)).Fy), float64((*f_ff)(unsafe.Pointer(p)).Fy2), estr(tls, (*f_ff)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:35:3:
		dsin = ulperrf(tls, *(*float32)(unsafe.Pointer(bp)), (*f_ff)(unsafe.Pointer(p)).Fy, (*f_ff)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:36:3:
		dcos = ulperrf(tls, *(*float32)(unsafe.Pointer(bp + 4)), (*f_ff)(unsafe.Pointer(p)).Fy2, (*f_ff)(unsafe.Pointer(p)).Fdy2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:37:3:
		if !(checkulp(tls, dsin, (*f_ff)(unsafe.Pointer(p)).Fr) != 0) || !(checkulp(tls, dcos, (*f_ff)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+118, libc.VaList(bp+16, (*f_ff)(unsafe.Pointer(p)).Ffile, (*f_ff)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_ff)(unsafe.Pointer(p)).Fr), float64((*f_ff)(unsafe.Pointer(p)).Fx), float64((*f_ff)(unsafe.Pointer(p)).Fy), float64((*f_ff)(unsafe.Pointer(p)).Fy2), float64(*(*float32)(unsafe.Pointer(bp))), float64(*(*float32)(unsafe.Pointer(bp + 4))), float64(dsin), float64(dsin-(*f_ff)(unsafe.Pointer(p)).Fdy), float64((*f_ff)(unsafe.Pointer(p)).Fdy), float64(dcos), float64(dcos-(*f_ff)(unsafe.Pointer(p)).Fdy2), float64((*f_ff)(unsafe.Pointer(p)).Fdy2)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:41:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincosf.c:44:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+437) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+445) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+469) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+481) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+490) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0
