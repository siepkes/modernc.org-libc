// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/tgammaf.exe.go src/math/tgammaf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:5:19:
var t = [19]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(0.00032383392681367695)),
		Fdy:   float32(-libc.Float64FromFloat64(0.10936804115772247)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(9.410365104675293),
		Fdy:   float32(-libc.Float64FromFloat64(0.012943606823682785)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(3.666201519081369e-05)),
		Fdy:   float32(0.27265480160713196),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.001586210448294878)),
		Fdy:   float32(0.2610263228416443),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(71712.796875),
		Fdy:   float32(0.4791005253791809),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.362545132637024),
		Fdy:   float32(0.2702399790287018),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(3.700261354446411)),
		Fdy:   float32(0.45351019501686096),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.5839210748672485),
		Fdy:   float32(0.42365485429763794),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.1945674419403076),
		Fdy:   float32(0.07331132143735886),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(4.102294921875)),
		Fdy:   float32(0.07997164875268936),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 26,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:12:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(532)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:22:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:24:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:26:3:
		y = libc.Xtgammaf(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:29:3:
		if !(checkexcept(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+54, libc.VaList(bp+8, (*f_f)(unsafe.Pointer(p)).Ffile, (*f_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_f)(unsafe.Pointer(p)).Fr), float64((*f_f)(unsafe.Pointer(p)).Fx), float64((*f_f)(unsafe.Pointer(p)).Fy), estr(tls, (*f_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+106, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:35:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:36:3:
		if !(checkulp(tls, d, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+8, (*f_f)(unsafe.Pointer(p)).Ffile, (*f_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_f)(unsafe.Pointer(p)).Fr), float64((*f_f)(unsafe.Pointer(p)).Fx), float64((*f_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*f_f)(unsafe.Pointer(p)).Fdy), float64((*f_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/tgammaf.c:42:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+411) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+419) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+464) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0
