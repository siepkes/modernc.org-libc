// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/sincos.exe.go src/math/sincos.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:6:20:
var t = [15]d_dd{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    -libc.Float64FromFloat64(0.9774292928781227),
		Fdy:   float32(-libc.Float64FromFloat64(0.14564912021160126)),
		Fy2:   -libc.Float64FromFloat64(0.21126281599887137),
		Fdy2:  float32(-libc.Float64FromFloat64(0.10962469130754471)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.9333544736965718),
		Fdy:   float32(-libc.Float64FromFloat64(0.08813747018575668)),
		Fy2:   -libc.Float64FromFloat64(0.35895602297578955),
		Fdy2:  float32(-libc.Float64FromFloat64(0.10759828239679337)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.8640924711706304),
		Fdy:   float32(-libc.Float64FromFloat64(0.11743883043527603)),
		Fy2:   -libc.Float64FromFloat64(0.503333091765516),
		Fdy2:  float32(-libc.Float64FromFloat64(0.021430473774671555)),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.24593894772615374),
		Fdy:   float32(-libc.Float64FromFloat64(0.12697851657867432)),
		Fy2:   float64(0.9692853212503283),
		Fdy2:  float32(-libc.Float64FromFloat64(0.4787876307964325)),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.15706789772028007),
		Fdy:   float32(-libc.Float64FromFloat64(0.029550159350037575)),
		Fy2:   -libc.Float64FromFloat64(0.9875878064788627),
		Fdy2:  float32(0.4880668818950653),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.6146844860113447),
		Fdy:   float32(-libc.Float64FromFloat64(0.09976737946271896)),
		Fy2:   float64(0.7887730869248576),
		Fdy2:  float32(0.12708666920661926),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.39549242182823696),
		Fdy:   float32(-libc.Float64FromFloat64(0.3668774962425232)),
		Fy2:   float64(0.9184692397007294),
		Fdy2:  float32(-libc.Float64FromFloat64(0.26120713353157043)),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.5326763286672376),
		Fdy:   float32(-libc.Float64FromFloat64(0.3550407588481903)),
		Fy2:   float64(0.8463190467415896),
		Fdy2:  float32(-libc.Float64FromFloat64(0.302586168050766)),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.6991102068649779),
		Fdy:   float32(-libc.Float64FromFloat64(0.427672415971756)),
		Fy2:   float64(0.7150139289952383),
		Fdy2:  float32(-libc.Float64FromFloat64(0.08537746220827103)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.6278312326301215),
		Fdy:   float32(-libc.Float64FromFloat64(0.3828115463256836)),
		Fy2:   float64(0.7783494994757447),
		Fdy2:  float32(0.30890750885009766),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 25,
	...
	12: {
		...
		Fdy:   float32(0),
		Fy2:   float64(libc.X__builtin_nanf(nil, __ccgo_ts+51)),
		Fdy2:  float32(0),
		Fe:    int32(FE_INVALID),
	},
	13: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(144)
	defer tls.Free(144)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:12:1:
	var dcos, dsin float32
	var e, err, i int32
	var p uintptr
	var _ /* ycos at bp+8 */ float64
	var _ /* ysin at bp+0 */ float64
	_, _, _, _, _, _ = dcos, dsin, e, err, i, p
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(720)/libc.Uint32FromInt64(48)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*48
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:22:3:
		if (*d_dd)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:24:3:
		libc.Xfesetround(tls, (*d_dd)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:26:3:
		libc.Xsincos(tls, (*d_dd)(unsafe.Pointer(p)).Fx, bp, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:29:3:
		if !(checkexcept(tls, e, (*d_dd)(unsafe.Pointer(p)).Fe, (*d_dd)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+24, (*d_dd)(unsafe.Pointer(p)).Ffile, (*d_dd)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_dd)(unsafe.Pointer(p)).Fr), (*d_dd)(unsafe.Pointer(p)).Fx, (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fy2, estr(tls, (*d_dd)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+106, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:35:3:
		dsin = ulperr(tls, *(*float64)(unsafe.Pointer(bp)), (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:36:3:
		dcos = ulperr(tls, *(*float64)(unsafe.Pointer(bp + 8)), (*d_dd)(unsafe.Pointer(p)).Fy2, (*d_dd)(unsafe.Pointer(p)).Fdy2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:37:3:
		if !(checkulp(tls, dsin, (*d_dd)(unsafe.Pointer(p)).Fr) != 0) || !(checkulp(tls, dcos, (*d_dd)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+24, (*d_dd)(unsafe.Pointer(p)).Ffile, (*d_dd)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_dd)(unsafe.Pointer(p)).Fr), (*d_dd)(unsafe.Pointer(p)).Fx, (*d_dd)(unsafe.Pointer(p)).Fy, (*d_dd)(unsafe.Pointer(p)).Fy2, *(*float64)(unsafe.Pointer(bp)), *(*float64)(unsafe.Pointer(bp + 8)), float64(dsin), float64(dsin-(*d_dd)(unsafe.Pointer(p)).Fdy), float64((*d_dd)(unsafe.Pointer(p)).Fdy), float64(dcos), float64(dcos-(*d_dd)(unsafe.Pointer(p)).Fdy2), float64((*d_dd)(unsafe.Pointer(p)).Fdy2)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:41:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/sincos.c:44:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+197, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+207, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+298, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+303, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+310, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+328, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+336, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+341, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+384, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+433) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+441) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+453) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+465) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+477) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+486) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+51) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+486) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+492, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
