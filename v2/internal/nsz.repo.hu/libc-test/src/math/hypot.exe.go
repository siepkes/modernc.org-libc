// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/hypot.exe.go src/math/hypot.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:5:20:
var t = [281]dd_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.258385194403621e+308),
		Fx2:   float64(1.0786158809173895e+308),
		Fy:    float64(1.6573911777433338e+308),
	...
	2: {
		...
		Fx:    float64(1.258385194403621e+308),
		Fx2:   float64(1.0786158809173895e+308),
		Fy:    float64(1.657391177743334e+308),
	...
	12: {
		...
		Fline: int32(52),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669424005565e+15),
		Fx2:   float64(3.151334375278812e+15),
		Fy:    float64(7.046598485305413e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	13: {
		...
		Fline: int32(53),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669269714493e+15),
		Fx2:   float64(3.151335028866276e+15),
		Fy:    float64(7.046598639596485e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	14: {
		...
		Fline: int32(54),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669115423389e+15),
		Fx2:   float64(3.15133568245374e+15),
		Fy:    float64(7.046598793887589e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	15: {
		...
		Fline: int32(55),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302668961132253e+15),
		Fx2:   float64(3.151336336041204e+15),
		Fy:    float64(7.046598948178725e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	16: {
		...
		Fline: int32(56),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302668806841085e+15),
		Fx2:   float64(3.151336989628668e+15),
		Fy:    float64(7.046599102469893e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	17: {
		...
		Fline: int32(57),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669548829667e+15),
		Fx2:   float64(3.151334577248444e+15),
		Fy:    float64(7.046598687275045e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	18: {
		...
		Fline: int32(58),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669394538587e+15),
		Fx2:   float64(3.151335230835916e+15),
		Fy:    float64(7.046598841566125e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	19: {
		...
		Fline: int32(59),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669240247475e+15),
		Fx2:   float64(3.151335884423388e+15),
		Fy:    float64(7.046598995857237e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	20: {
		...
		Fline: int32(60),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669085956331e+15),
		Fx2:   float64(3.15133653801086e+15),
		Fy:    float64(7.046599150148381e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	21: {
		...
		Fline: int32(61),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302668931665155e+15),
		Fx2:   float64(3.151337191598332e+15),
		Fy:    float64(7.046599304439557e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	22: {
		...
		Fline: int32(62),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669750799301e+15),
		Fx2:   float64(3.15133445242434e+15),
		Fy:    float64(7.046598812099149e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	23: {
		...
		Fline: int32(63),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669596508229e+15),
		Fx2:   float64(3.15133510601182e+15),
		Fy:    float64(7.046598966390221e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	24: {
		...
		Fline: int32(64),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669442217125e+15),
		Fx2:   float64(3.1513357595993e+15),
		Fy:    float64(7.046599120681325e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	25: {
		...
		Fline: int32(65),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669287925989e+15),
		Fx2:   float64(3.15133641318678e+15),
		Fy:    float64(7.046599274972461e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	26: {
		...
		Fline: int32(66),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669133634821e+15),
		Fx2:   float64(3.15133706677426e+15),
		Fy:    float64(7.046599429263629e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	27: {
		...
		Fline: int32(67),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669875623407e+15),
		Fx2:   float64(3.151334654393976e+15),
		Fy:    float64(7.046599014068785e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	28: {
		...
		Fline: int32(68),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669721332327e+15),
		Fx2:   float64(3.151335307981464e+15),
		Fy:    float64(7.046599168359865e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	29: {
		...
		Fline: int32(69),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669567041215e+15),
		Fx2:   float64(3.151335961568952e+15),
		Fy:    float64(7.046599322650977e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	30: {
		...
		Fline: int32(70),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669412750071e+15),
		Fx2:   float64(3.15133661515644e+15),
		Fy:    float64(7.046599476942121e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	31: {
		...
		Fline: int32(71),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(6.302669258458895e+15),
		Fx2:   float64(3.151337268743928e+15),
		Fy:    float64(7.046599631233297e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	32: {
		...
		Fx2:   float64(7.122257165747457),
		Fy:    float64(7.612290425838322),
	...
	33: {
		...
		Fline: int32(74),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(8.804497059255036),
		Fx2:   -libc.Float64FromFloat64(6.678554470267167),
		Fy:    float64(11.050894003597906),
	...
	35: {
		...
		Fline: int32(76),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.783313058569083),
		Fx2:   float64(8.55088264701145),
		Fy:    float64(10.322998787967439),
	...
	37: {
		...
		Fx2:   float64(0.46217753403762046),
		Fy:    float64(4.194300048758669),
	...
	38: {
		...
		Fx2:   float64(7.121822756627268),
		Fy:    float64(10.403887661264678),
	...
	40: {
		...
		Fx2:   float64(5.814709308046944),
		Fy:    float64(7.385595855280984),
	...
	41: {
		...
		Fline: int32(82),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.8702734166225548),
		Fx2:   float64(4.937345714844306),
		Fy:    float64(5.7110289960795635),
	...
	49: {
		...
		Fx2:   float64(1.7377692303071453e+308),
		Fy:    float64(libc.X__builtin_inff(nil)),
		Fdy:   float32(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:13:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(12364)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:23:3:
		if (*dd_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:25:3:
		libc.Xfesetround(tls, (*dd_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:27:3:
		y = libc.Xhypot(tls, (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:30:3:
		if !(checkexcept(tls, e, (*dd_d)(unsafe.Pointer(p)).Fe, (*dd_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:36:3:
		d = ulperr(tls, y, (*dd_d)(unsafe.Pointer(p)).Fy, (*dd_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:37:3:
		if !(checkulp(tls, d, (*dd_d)(unsafe.Pointer(p)).Fr) != 0) || (*dd_d)(unsafe.Pointer(p)).Fr == FE_TONEAREST && libc.Xfabs(tls, float64(d)) >= float64(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:38:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/hypot.c:43:2:
