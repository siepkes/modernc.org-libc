// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/floor.exe.go src/math/floor.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:5:19:
var t = [401]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	4: {
		...
		Fline: int32(42),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(9.007199254740991e+15),
	...
	32: {
		...
		Fline: int32(71),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.1767398198957398e+15),
		Fy:    float64(2.176739819895739e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	33: {
	...
	56: {
		...
		Fline: int32(96),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(2.1767398198957392e+15),
		Fy:    float64(2.176739819895739e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	80: {
		...
		Fline: int32(121),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0.49999999999999994),
		Fy:    float64(0),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	98: {
		...
		Fline: int32(139),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.4418495497393444e+14),
		Fy:    float64(5.44184954973934e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	99: {
		...
		Fline: int32(140),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.441849549739345e+14),
		Fy:    float64(5.44184954973934e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	100: {
		...
		Fline: int32(141),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(5.4418495497393456e+14),
		Fy:    float64(5.44184954973934e+14),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	207: {
		...
		Fline: int32(250),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(8.388608e+06),
		Fy:    float64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	208: {
		...
		Fline: int32(251),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(4.503599627370495e+15),
		Fy:    float64(4.503599627370495e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	209: {
		...
		Fline: int32(252),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(4.503599627370496e+15),
		Fy:    float64(4.503599627370496e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	210: {
		...
		Fline: int32(253),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(4.503599627370497e+15),
		Fy:    float64(4.503599627370497e+15),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	211: {
		...
		Fline: int32(254),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(3.5111194040279537e+305),
		Fy:    float64(3.5111194040279537e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	212: {
		...
		Fline: int32(255),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(3.5111194040279572e+305),
		Fy:    float64(3.5111194040279572e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	213: {
		...
		Fline: int32(256),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(3.5111194040279604e+305),
		Fy:    float64(3.5111194040279604e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	214: {
		...
		Fy:    float64(3.511119404027961e+305),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	215: {
	...
	231: {
		...
		Fline: int32(274),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(8.388608000000002e+06),
		Fy:    float64(8.388608e+06),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	232: {
		...
		Fline: int32(275),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(4.5035996273704945e+15),
		Fy:    float64(4.503599627370494e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	233: {
		...
		Fline: int32(276),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float64(4.5035996273704955e+15),
		Fy:    float64(4.503599627370495e+15),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	369: {
		...
		Fline: int32(14),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(7.888609052210118e-31),
		Fy:    float64(0),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:13:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(14436)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:23:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:25:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:27:3:
		y = libc.Xfloor(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:30:3:
		if !(checkexceptall(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) && e|int32(FE_INEXACT) != (*d_d)(unsafe.Pointer(p)).Fe {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+121, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:36:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:37:3:
		if !(checkcr(tls, float64(y), (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+130, libc.VaList(bp+8, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*d_d)(unsafe.Pointer(p)).Fdy), float64((*d_d)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floor.c:43:2:
