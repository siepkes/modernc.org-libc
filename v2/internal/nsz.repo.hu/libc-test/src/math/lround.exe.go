// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lround.exe.go src/math/lround.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:5:19:
var t = [27]d_i{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:12:1:
	var e, err, i int32
	var p uintptr
	var yi int64
	_, _, _, _, _ = e, err, i, p, yi
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:15:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:18:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(864)/libc.Uint32FromInt64(32)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:19:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*32
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:21:3:
		if (*d_i)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:22:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:23:3:
		libc.Xfesetround(tls, (*d_i)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:24:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:25:3:
		yi = int64(libc.Xlround(tls, (*d_i)(unsafe.Pointer(p)).Fx))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:26:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:28:3:
		if !(checkexcept(tls, e, (*d_i)(unsafe.Pointer(p)).Fe, (*d_i)(unsafe.Pointer(p)).Fr) != 0) && e|int32(FE_INEXACT) != (*d_i)(unsafe.Pointer(p)).Fe {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:29:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*d_i)(unsafe.Pointer(p)).Ffile, (*d_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_i)(unsafe.Pointer(p)).Fr), (*d_i)(unsafe.Pointer(p)).Fx, (*d_i)(unsafe.Pointer(p)).Fi, estr(tls, (*d_i)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+105, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:32:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:34:3:
		if !((*d_i)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_INVALID) != 0) && yi != (*d_i)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+114, libc.VaList(bp+8, (*d_i)(unsafe.Pointer(p)).Ffile, (*d_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_i)(unsafe.Pointer(p)).Fr), (*d_i)(unsafe.Pointer(p)).Fx, (*d_i)(unsafe.Pointer(p)).Fi, yi))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:37:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lround.c:40:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+391) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+399) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+411) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+423) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+435) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+444) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+51) != 0
