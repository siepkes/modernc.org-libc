// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/scalb.exe.go src/math/scalb.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:7:20:
var t = [44]dd_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	11: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0),
		Fx2:   float64(1.2676506002282294e+30),
		Fy:    float64(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	12: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0),
		Fx2:   -libc.Float64FromFloat64(1.2676506002282294e+30),
		Fy:    float64(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	15: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0),
		Fx2:   float64(libc.X__builtin_nanf(nil, __ccgo_ts+24)),
		Fy:    float64(libc.X__builtin_nanf(nil, __ccgo_ts+24)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:13:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:14:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:18:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:21:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1936)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:22:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:24:3:
		if (*dd_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:25:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:26:3:
		libc.Xfesetround(tls, (*dd_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:27:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:28:3:
		y = libc.Xscalb(tls, (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:29:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:31:3:
		if !(checkexceptall(tls, e, (*dd_d)(unsafe.Pointer(p)).Fe, (*dd_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+50, libc.VaList(bp+8, (*dd_d)(unsafe.Pointer(p)).Ffile, (*dd_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*dd_d)(unsafe.Pointer(p)).Fr), (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2, (*dd_d)(unsafe.Pointer(p)).Fy, estr(tls, (*dd_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:35:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:37:3:
		d = ulperr(tls, y, (*dd_d)(unsafe.Pointer(p)).Fy, (*dd_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:38:3:
		if !(checkcr(tls, float64(y), (*dd_d)(unsafe.Pointer(p)).Fy, (*dd_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+8, (*dd_d)(unsafe.Pointer(p)).Ffile, (*dd_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*dd_d)(unsafe.Pointer(p)).Fr), (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2, (*dd_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*dd_d)(unsafe.Pointer(p)).Fdy), float64((*dd_d)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:41:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalb.c:44:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+409) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+417) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+429) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+441) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+453) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+462) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+24) != 0
