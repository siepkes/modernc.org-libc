// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/coshf.exe.go src/math/coshf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:5:19:
var t = [220]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	10: {
		...
		Fy:    float32(1),
		Fdy:   float32(-libc.Float64FromFloat64(1.4551915228366852e-11)),
		Fe:    int32(FE_INEXACT),
	},
	11: {
		Ffile: __ccgo_ts,
	...
	18: {
		...
		Fy:    float32(341900.71875),
		Fdy:   float32(-libc.Float64FromFloat64(0.42595914006233215)),
		Fe:    int32(FE_INEXACT),
	},
	19: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.461369467568128e+15),
		Fdy:   float32(-libc.Float64FromFloat64(0.4832671880722046)),
		Fe:    int32(FE_INEXACT),
	},
	20: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(6.571962968391549e+18),
		Fdy:   float32(-libc.Float64FromFloat64(0.4210434556007385)),
		Fe:    int32(FE_INEXACT),
	},
	21: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.58950515277824e+14),
		Fdy:   float32(-libc.Float64FromFloat64(0.04612268507480621)),
		Fe:    int32(FE_INEXACT),
	},
	22: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(381555),
		Fdy:   float32(0.42827439308166504),
		Fe:    int32(FE_INEXACT),
	},
	23: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(3.6361312866210938),
		Fdy:   float32(-libc.Float64FromFloat64(0.03595497086644173)),
		Fe:    int32(FE_INEXACT),
	},
	24: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.808313614336e+12),
		Fdy:   float32(-libc.Float64FromFloat64(0.43299558758735657)),
		Fe:    int32(FE_INEXACT),
	},
	25: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.849201261669253e+18),
		Fdy:   float32(-libc.Float64FromFloat64(0.3815724551677704)),
		Fe:    int32(FE_INEXACT),
	},
	26: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(2231.203125),
		Fdy:   float32(0.28110450506210327),
		Fe:    int32(FE_INEXACT),
	},
	27: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(3.17838482661301e+20),
		Fdy:   float32(-libc.Float64FromFloat64(0.3339102566242218)),
		Fe:    int32(FE_INEXACT),
	},
	28: {
		Ffile: __ccgo_ts,
	...
	46: {
		...
		Fy:    float32(1),
		Fdy:   float32(-libc.Float64FromFloat64(2.3283064365386963e-10)),
		Fe:    int32(FE_INEXACT),
	},
	47: {
		Ffile: __ccgo_ts,
	...
	48: {
		...
		Fline: int32(89),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(0.00048828125),
		Fy:    float32(1.0000001192092896),
		Fdy:   float32(-libc.Float64FromFloat64(1.9868215517249155e-08)),
		Fe:    int32(FE_INEXACT),
	},
	49: {
		Ffile: __ccgo_ts,
	...
	62: {
		...
		Fline: int32(103),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(-libc.Float64FromFloat64(0.00048828125)),
		Fy:    float32(1.0000001192092896),
		Fdy:   float32(-libc.Float64FromFloat64(1.9868215517249155e-08)),
		Fe:    int32(FE_INEXACT),
	},
	...
	205: {
		...
		Fy:    float32(1593.5216064453125),
		Fdy:   float32(0.26242581009864807),
		Fe:    int32(FE_INEXACT),
	},
	206: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(38.56174087524414),
		Fdy:   float32(-libc.Float64FromFloat64(0.08168885856866837)),
		Fe:    int32(FE_INEXACT),
	},
	207: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(2182.631103515625),
		Fdy:   float32(-libc.Float64FromFloat64(0.02331414446234703)),
		Fe:    int32(FE_INEXACT),
	},
	208: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(343.2738037109375),
		Fdy:   float32(0.20081493258476257),
		Fe:    int32(FE_INEXACT),
	},
	209: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(5291.78173828125),
		Fdy:   float32(0.36286723613739014),
		Fe:    int32(FE_INEXACT),
	},
	210: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(1.2272322177886963),
		Fdy:   float32(0.32777416706085205),
		Fe:    int32(FE_INEXACT),
	},
	211: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(1.0838085412979126),
		Fdy:   float32(-libc.Float64FromFloat64(0.039848703891038895)),
		Fe:    int32(FE_INEXACT),
	},
	212: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(1.161980390548706),
		Fdy:   float32(0.15274477005004883),
		Fe:    int32(FE_INEXACT),
	},
	213: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(1.314923644065857),
		Fdy:   float32(-libc.Float64FromFloat64(0.2387111485004425)),
		Fe:    int32(FE_INEXACT),
	},
	214: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(1.2393412590026855),
		Fdy:   float32(-libc.Float64FromFloat64(0.45791932940483093)),
		Fe:    int32(FE_INEXACT),
	},
	215: {
		Ffile: __ccgo_ts + 46,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:13:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(6160)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:23:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:25:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:27:3:
		y = libc.Xcoshf(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:30:3:
		if !(checkexcept(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+121, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:36:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:37:3:
		if !(checkulp(tls, d, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:38:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/coshf.c:43:2:
