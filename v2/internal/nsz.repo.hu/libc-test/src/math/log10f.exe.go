// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/log10f.exe.go src/math/log10f.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:5:19:
var t = [238]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
		...
		Fy:    float32(38.53184127807617),
		Fdy:   float32(0.4873184859752655),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fx:    float32(3.4028234663852886e+38),
		Fy:    float32(38.531837463378906),
		Fdy:   float32(-libc.Float64FromFloat64(0.5126814842224121)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	14: {
		...
		Fy:    float32(1.656698827900982e-06),
		Fdy:   float32(0.13377825915813446),
		Fe:    int32(FE_INEXACT),
	},
	15: {
		Ffile: __ccgo_ts,
	...
	16: {
		...
		Fy:    float32(-libc.Float64FromFloat64(1.6567050806770567e-06)),
		Fdy:   float32(0.4559154212474823),
		Fe:    int32(FE_INEXACT),
	},
	17: {
		Ffile: __ccgo_ts,
		...
		Fr:    int32(FE_TOWARDZERO),
		Fx:    float32(1.0000038146972656),
		Fy:    float32(1.6566987142141443e-06),
		Fdy:   float32(-libc.Float64FromFloat64(0.8662217259407043)),
		Fe:    int32(FE_INEXACT),
	},
	18: {
		Ffile: __ccgo_ts,
	...
	25: {
		...
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(0.9999961853027344),
		Fy:    float32(-libc.Float64FromFloat64(1.6567051943638944e-06)),
		Fdy:   float32(-libc.Float64FromFloat64(0.5440845489501953)),
		Fe:    int32(FE_INEXACT),
	},
	26: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(37.929779052734375)),
		Fdy:   float32(0.10510067641735077),
		Fe:    int32(FE_INEXACT),
	},
	27: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(44.85346984863281)),
		Fdy:   float32(-libc.Float64FromFloat64(0.1296825408935547)),
		Fe:    int32(FE_INEXACT),
	},
	28: {
		Ffile: __ccgo_ts,
	...
	29: {
		...
		Fr:    int32(FE_TOWARDZERO),
		Fx:    float32(1.401298464324817e-45),
		Fy:    float32(-libc.Float64FromFloat64(44.85346603393555)),
		Fdy:   float32(0.8703174591064453),
		Fe:    int32(FE_INEXACT),
	},
	30: {
		Ffile: __ccgo_ts,
	...
	32: {
		...
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(1.1754943508222875e-38),
		Fy:    float32(-libc.Float64FromFloat64(37.92978286743164)),
		Fdy:   float32(-libc.Float64FromFloat64(0.894899308681488)),
		Fe:    int32(FE_INEXACT),
	},
	33: {
		Ffile: __ccgo_ts,
	...
	34: {
		...
		Fy:    float32(1.5630607604980469),
		Fdy:   float32(-libc.Float64FromFloat64(0.3652569353580475)),
		Fe:    int32(FE_INEXACT),
	},
	35: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.9325312376022339),
		Fdy:   float32(0.026039432734251022),
		Fe:    int32(FE_INEXACT),
	},
	36: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.9732316732406616),
		Fdy:   float32(0.49530890583992004),
		Fe:    int32(FE_INEXACT),
	},
	37: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.2202978134155273),
		Fdy:   float32(-libc.Float64FromFloat64(0.1289096623659134)),
		Fe:    int32(FE_INEXACT),
	},
	38: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.5617554187774658),
		Fdy:   float32(-libc.Float64FromFloat64(0.20245754718780518)),
		Fe:    int32(FE_INEXACT),
	},
	39: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.6815614700317383),
		Fdy:   float32(0.1720048189163208),
		Fe:    int32(FE_INEXACT),
	},
	40: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.8971681594848633),
		Fdy:   float32(0.2376539558172226),
		Fe:    int32(FE_INEXACT),
	},
	41: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.967334508895874),
		Fdy:   float32(-libc.Float64FromFloat64(0.48142820596694946)),
		Fe:    int32(FE_INEXACT),
	},
	42: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(1.619057059288025),
		Fdy:   float32(-libc.Float64FromFloat64(0.4476802945137024)),
		Fe:    int32(FE_INEXACT),
	},
	43: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(0.3219669461250305),
		Fdy:   float32(-libc.Float64FromFloat64(0.1003313958644867)),
		Fe:    int32(FE_INEXACT),
	},
	44: {
		Ffile: __ccgo_ts,
	...
	221: {
		...
		Fy:    float32(0.6380137205123901),
		Fdy:   float32(-libc.Float64FromFloat64(0.20476758480072021)),
		Fe:    int32(FE_INEXACT),
	},
	222: {
		Ffile: __ccgo_ts + 23,
	...
	224: {
		...
		Fy:    float32(0.9669418334960938),
		Fdy:   float32(-libc.Float64FromFloat64(0.34273025393486023)),
		Fe:    int32(FE_INEXACT),
	},
	225: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.1791512817144394)),
		Fdy:   float32(-libc.Float64FromFloat64(0.27078554034233093)),
		Fe:    int32(FE_INEXACT),
	},
	226: {
		Ffile: __ccgo_ts + 23,
	...
	227: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.25044935941696167)),
		Fdy:   float32(0.2126826047897339),
		Fe:    int32(FE_INEXACT),
	},
	228: {
		Ffile: __ccgo_ts + 23,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.1111735999584198)),
		Fdy:   float32(0.46515095233917236),
		Fe:    int32(FE_INEXACT),
	},
	229: {
		Ffile: __ccgo_ts + 23,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:13:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(6664)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:23:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:25:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:27:3:
		y = libc.Xlog10f(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:30:3:
		if !(checkexcept(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+74, libc.VaList(bp+8, (*f_f)(unsafe.Pointer(p)).Ffile, (*f_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_f)(unsafe.Pointer(p)).Fr), float64((*f_f)(unsafe.Pointer(p)).Fx), float64((*f_f)(unsafe.Pointer(p)).Fy), estr(tls, (*f_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+125, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:36:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:37:3:
		if !(checkulp(tls, d, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+134, libc.VaList(bp+8, (*f_f)(unsafe.Pointer(p)).Ffile, (*f_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_f)(unsafe.Pointer(p)).Fr), float64((*f_f)(unsafe.Pointer(p)).Fx), float64((*f_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*f_f)(unsafe.Pointer(p)).Fdy), float64((*f_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/log10f.c:43:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+429) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+437) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+449) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+461) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+473) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+482) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+22) != 0
