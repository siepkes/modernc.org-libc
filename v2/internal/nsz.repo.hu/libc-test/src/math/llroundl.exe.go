// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/llroundl.exe.go src/math/llroundl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:5:19:
var t = [27]l_i{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:18:1:
	var e, err, i int32
	var p uintptr
	var yi int64
	_, _, _, _, _ = e, err, i, p, yi
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:21:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:24:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(864)/libc.Uint32FromInt64(32)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:25:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*32
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:27:3:
		if (*l_i)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:28:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:29:3:
		libc.Xfesetround(tls, (*l_i)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:30:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:31:3:
		yi = libc.Xllroundl(tls, (*l_i)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:32:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:34:3:
		if !(checkexcept(tls, e, (*l_i)(unsafe.Pointer(p)).Fe, (*l_i)(unsafe.Pointer(p)).Fr) != 0) && e|int32(FE_INEXACT) != (*l_i)(unsafe.Pointer(p)).Fe {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+54, libc.VaList(bp+8, (*l_i)(unsafe.Pointer(p)).Ffile, (*l_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_i)(unsafe.Pointer(p)).Fr), (*l_i)(unsafe.Pointer(p)).Fx, (*l_i)(unsafe.Pointer(p)).Fi, estr(tls, (*l_i)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+110, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:38:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:40:3:
		if !((*l_i)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_INVALID) != 0) && yi != (*l_i)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:41:4:
			libc.Xprintf(tls, __ccgo_ts+119, libc.VaList(bp+8, (*l_i)(unsafe.Pointer(p)).Ffile, (*l_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_i)(unsafe.Pointer(p)).Fr), (*l_i)(unsafe.Pointer(p)).Fx, (*l_i)(unsafe.Pointer(p)).Fi, yi))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:43:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/llroundl.c:46:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+399) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+407) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+419) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+452) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0
