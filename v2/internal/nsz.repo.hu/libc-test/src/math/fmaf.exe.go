// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/fmaf.exe.go src/math/fmaf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:5:21:
var t = [71]fff_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fx3:   float32(0.6620717644691467),
		Fy:    float32(-libc.Float64FromFloat64(35.92643356323242)),
		Fdy:   float32(-libc.Float64FromFloat64(0.18832778930664062)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fx3:   float32(0.052154526114463806),
		Fy:    float32(-libc.Float64FromFloat64(38.568294525146484)),
		Fdy:   float32(0.4049978256225586),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
		...
		Fx3:   float32(7.676402568817139),
		Fy:    float32(30.839393615722656),
		Fdy:   float32(0.30582499504089355),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fx3:   float32(-libc.Float64FromFloat64(0.7920545339584351)),
		Fy:    float32(-libc.Float64FromFloat64(30.625703811645508)),
		Fdy:   float32(0.18035888671875),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fx3:   float32(-libc.Float64FromFloat64(0.5587586760520935)),
		Fy:    float32(44.028690338134766),
		Fdy:   float32(0.062422990798950195),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts + 23,
	...
	6: {
		...
		Fx3:   float32(-libc.Float64FromFloat64(0)),
		Fy:    float32(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	13: {
		...
		Fx:    float32(0),
		Fx2:   float32(0),
		Fx3:   libc.X__builtin_nanf(nil, __ccgo_ts+47),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+47),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	14: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   libc.X__builtin_nanf(nil, __ccgo_ts+47),
		Fx3:   float32(0),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+47),
		Fdy:   float32(0),
		Fe:    int32(0),
	...
	15: {
		...
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+47),
		Fx2:   float32(0),
		Fx3:   float32(0),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+47),
		Fdy:   float32(0),
	...
	41: {
		...
		Fline: int32(38),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(7.52316384526264e-37),
		Fx2:   float32(7.52316384526264e-37),
		Fx3:   float32(1.401298464324817e-45),
		Fy:    float32(1.401298464324817e-45),
		Fdy:   float32(-libc.Float64FromFloat64(4.0389678347315804e-28)),
	...
	42: {
		...
		Fx:    float32(1),
		Fx2:   float32(1),
		Fx3:   float32(-libc.Float64FromFloat64(1)),
		Fy:    float32(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	51: {
		...
		Fx2:   float32(1.7767905202692447e-15),
		Fx3:   float32(1.1754943508222875e-38),
		Fy:    float32(1.1754942106924411e-38),
		Fdy:   float32(0.000244140625),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	52: {
		Ffile: __ccgo_ts + 23,
	...
	53: {
		...
		Fdy:   float32(-libc.Float64FromFloat64(0.999755859375)),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
	54: {
		Ffile: __ccgo_ts + 23,
	...
	55: {
		...
		Fline: int32(52),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(6.382080252417363e-17)),
		Fx2:   float32(-libc.Float64FromFloat64(3675.7626953125)),
		Fx3:   float32(3.3837570523331806e-09),
		Fy:    float32(3.3839915314359814e-09),
	...
	56: {
		...
		Fx2:   float32(-libc.Float64FromFloat64(3675.7626953125)),
		Fx3:   float32(3.3837570523331806e-09),
		Fy:    float32(3.3839917534805863e-09),
		Fdy:   float32(0.5),
		Fe:    int32(FE_INEXACT),
	},
	57: {
	...
	59: {
		...
		Fx3:   float32(1.4210853868169056e-14),
		Fy:    float32(2),
		Fdy:   float32(-libc.Float64FromFloat64(0.5)),
		Fe:    int32(FE_INEXACT),
	},
	60: {
		...
		Fx:    float32(1.0000001192092896),
		Fx2:   float32(1.9999998807907104),
		Fx3:   float32(1.4210854715202004e-14),
		Fy:    float32(2),
		Fdy:   float32(-libc.Float64FromFloat64(0.5)),
		Fe:    int32(FE_INEXACT),
	},
	61: {
		...
		Fx:    float32(1.0000001192092896),
		Fx2:   float32(1.9999998807907104),
		Fx3:   float32(1.4210856409267898e-14),
	...
	62: {
		...
		Fx3:   float32(-libc.Float64FromFloat64(1.4210853868169056e-14)),
	...
	63: {
		...
		Fx:    float32(1.0000001192092896),
		Fx2:   float32(-libc.Float64FromFloat64(1.9999998807907104)),
		Fx3:   float32(-libc.Float64FromFloat64(1.4210854715202004e-14)),
		Fy:    float32(-libc.Float64FromFloat64(2)),
		Fdy:   float32(0.5),
		Fe:    int32(FE_INEXACT),
	},
	64: {
		...
		Fx:    float32(1.0000001192092896),
		Fx2:   float32(-libc.Float64FromFloat64(1.9999998807907104)),
		Fx3:   float32(-libc.Float64FromFloat64(1.4210856409267898e-14)),
	...
	65: {
		...
		Fx2:   float32(1.9999998807907104),
		Fx3:   float32(2.8421707736338113e-14),
		Fy:    float32(2.000000238418579),
		Fdy:   float32(-libc.Float64FromFloat64(0.5)),
		Fe:    int32(FE_INEXACT),
	},
	66: {
		...
		Fx:    float32(1.000000238418579),
		Fx2:   float32(1.9999998807907104),
		Fx3:   float32(2.842170943040401e-14),
		Fy:    float32(2.000000476837158),
		Fdy:   float32(0.5),
		Fe:    int32(FE_INEXACT),
	},
	67: {
		...
		Fx:    float32(1.000000238418579),
		Fx2:   float32(1.9999998807907104),
		Fx3:   float32(2.8421712818535796e-14),
		Fy:    float32(2.000000476837158),
		Fdy:   float32(0.5),
		Fe:    int32(FE_INEXACT),
	},
	68: {
		...
		Fx:    float32(1.000000238418579),
		Fx2:   float32(-libc.Float64FromFloat64(1.9999998807907104)),
		Fx3:   float32(-libc.Float64FromFloat64(2.8421707736338113e-14)),
		Fy:    float32(-libc.Float64FromFloat64(2.000000238418579)),
		Fdy:   float32(0.5),
		Fe:    int32(FE_INEXACT),
	},
	69: {
		...
		Fx:    float32(1.000000238418579),
		Fx2:   float32(-libc.Float64FromFloat64(1.9999998807907104)),
		Fx3:   float32(-libc.Float64FromFloat64(2.842170943040401e-14)),
		Fy:    float32(-libc.Float64FromFloat64(2.000000476837158)),
		Fdy:   float32(-libc.Float64FromFloat64(0.5)),
		Fe:    int32(FE_INEXACT),
	},
	70: {
		...
		Fx:    float32(1.000000238418579),
		Fx2:   float32(-libc.Float64FromFloat64(1.9999998807907104)),
		Fx3:   float32(-libc.Float64FromFloat64(2.8421712818535796e-14)),
		Fy:    float32(-libc.Float64FromFloat64(2.000000476837158)),
		Fdy:   float32(-libc.Float64FromFloat64(0.5)),
		Fe:    int32(FE_INEXACT),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:10:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:11:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:15:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:18:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(2556)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:19:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:21:3:
		if (*fff_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:22:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:23:3:
		libc.Xfesetround(tls, (*fff_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:24:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:25:3:
		y = libc.Xfmaf(tls, (*fff_f)(unsafe.Pointer(p)).Fx, (*fff_f)(unsafe.Pointer(p)).Fx2, (*fff_f)(unsafe.Pointer(p)).Fx3)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:26:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:32:3:
		if !(checkexceptall(tls, e|int32(FE_INEXACT), (*fff_f)(unsafe.Pointer(p)).Fe|int32(FE_INEXACT), (*fff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+48, libc.VaList(bp+8, (*fff_f)(unsafe.Pointer(p)).Ffile, (*fff_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fff_f)(unsafe.Pointer(p)).Fr), float64((*fff_f)(unsafe.Pointer(p)).Fx), float64((*fff_f)(unsafe.Pointer(p)).Fx2), float64((*fff_f)(unsafe.Pointer(p)).Fx3), float64((*fff_f)(unsafe.Pointer(p)).Fy), estr(tls, (*fff_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:37:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:39:3:
		d = ulperrf(tls, y, (*fff_f)(unsafe.Pointer(p)).Fy, (*fff_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:40:3:
		if !(checkcr(tls, float64(y), float64((*fff_f)(unsafe.Pointer(p)).Fy), (*fff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:41:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+8, (*fff_f)(unsafe.Pointer(p)).Ffile, (*fff_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fff_f)(unsafe.Pointer(p)).Fr), float64((*fff_f)(unsafe.Pointer(p)).Fx), float64((*fff_f)(unsafe.Pointer(p)).Fx2), float64((*fff_f)(unsafe.Pointer(p)).Fx3), float64((*fff_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*fff_f)(unsafe.Pointer(p)).Fdy), float64((*fff_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:43:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmaf.c:46:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+175, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+185, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+276, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+281, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+288, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+306, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+314, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+319, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+362, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+411) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+419) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+464) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+47) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+464) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+470, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
