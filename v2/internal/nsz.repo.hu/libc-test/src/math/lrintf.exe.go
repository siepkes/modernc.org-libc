// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lrintf.exe.go src/math/lrintf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:5:19:
var t = [27]f_i{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:12:1:
	var e, err, i int32
	var p uintptr
	var yi int64
	_, _, _, _, _ = e, err, i, p, yi
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:15:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:18:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(756)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:19:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:21:3:
		if (*f_i)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:22:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:23:3:
		libc.Xfesetround(tls, (*f_i)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:24:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:25:3:
		yi = int64(libc.Xlrintf(tls, (*f_i)(unsafe.Pointer(p)).Fx))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:26:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:28:3:
		if !(checkexcept(tls, e, (*f_i)(unsafe.Pointer(p)).Fe, (*f_i)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:29:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*f_i)(unsafe.Pointer(p)).Ffile, (*f_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_i)(unsafe.Pointer(p)).Fr), float64((*f_i)(unsafe.Pointer(p)).Fx), (*f_i)(unsafe.Pointer(p)).Fi, estr(tls, (*f_i)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+105, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:32:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:34:3:
		if !((*f_i)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_INVALID) != 0) && yi != (*f_i)(unsafe.Pointer(p)).Fi {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+114, libc.VaList(bp+8, (*f_i)(unsafe.Pointer(p)).Ffile, (*f_i)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_i)(unsafe.Pointer(p)).Fr), float64((*f_i)(unsafe.Pointer(p)).Fx), (*f_i)(unsafe.Pointer(p)).Fi, yi))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:37:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lrintf.c:40:2:
