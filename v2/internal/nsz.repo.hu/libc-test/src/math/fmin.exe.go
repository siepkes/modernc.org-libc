// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/fmin.exe.go src/math/fmin.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:5:20:
var t = [68]dd_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fy:    -libc.Float64FromFloat64(8.88799136300345),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	2: {
	...
	6: {
		...
		Fy:    float64(0.05215452675006225),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	7: {
	...
	32: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0),
		Fx2:   float64(libc.X__builtin_nanf(nil, __ccgo_ts+47)),
		Fy:    float64(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	65: {
		...
		Fx2:   float64(0.5),
		Fy:    -libc.Float64FromFloat64(1.75),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	66: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(2992)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:22:3:
		if (*dd_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:24:3:
		libc.Xfesetround(tls, (*dd_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:26:3:
		y = libc.Xfmin(tls, (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:29:3:
		if !(checkexceptall(tls, e, (*dd_d)(unsafe.Pointer(p)).Fe, (*dd_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+48, libc.VaList(bp+8, (*dd_d)(unsafe.Pointer(p)).Ffile, (*dd_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*dd_d)(unsafe.Pointer(p)).Fr), (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2, (*dd_d)(unsafe.Pointer(p)).Fy, estr(tls, (*dd_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:35:3:
		d = ulperr(tls, y, (*dd_d)(unsafe.Pointer(p)).Fy, (*dd_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:36:3:
		if !(checkcr(tls, float64(y), (*dd_d)(unsafe.Pointer(p)).Fy, (*dd_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+8, (*dd_d)(unsafe.Pointer(p)).Ffile, (*dd_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*dd_d)(unsafe.Pointer(p)).Fr), (*dd_d)(unsafe.Pointer(p)).Fx, (*dd_d)(unsafe.Pointer(p)).Fx2, (*dd_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*dd_d)(unsafe.Pointer(p)).Fdy), float64((*dd_d)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/fmin.c:42:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+169, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+179, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+270, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+275, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+282, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+300, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+308, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+313, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+356, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+405) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+413) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+425) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+437) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+449) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+458) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+47) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+458) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+464, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
