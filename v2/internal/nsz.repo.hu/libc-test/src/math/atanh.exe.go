// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/atanh.exe.go src/math/atanh.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:5:19:
var t = [24]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	5: {
		...
		Fy:    float64(0.7963404371347943),
		Fdy:   float32(0.21338365972042084),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.43153570730602897),
		Fdy:   float32(-libc.Float64FromFloat64(0.4325666129589081)),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(0.6354006111644578),
		Fdy:   float32(-libc.Float64FromFloat64(0.06527865678071976)),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float64(1.0306085575277995),
		Fdy:   float32(0.14632052183151245),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.8268179645205255),
		Fdy:   float32(0.1397128701210022),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 25,
	...
	19: {
		...
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(1.3552527156068805e-20),
		Fy:    float64(1.3552527156068805e-20),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	20: {
		...
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(9.332636185032189e-302),
		Fy:    float64(9.332636185032189e-302),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	21: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(864)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:22:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:24:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:26:3:
		y = libc.Xatanh(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:29:3:
		if !(checkexcept(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:30:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+100, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:35:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:36:3:
		if !(checkulp(tls, d, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:37:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/atanh.c:42:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+403) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+411) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+423) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+435) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+447) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+456) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+24) != 0
