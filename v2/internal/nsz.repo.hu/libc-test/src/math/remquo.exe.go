// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/remquo.exe.go src/math/remquo.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:5:21:
var t = [76]dd_di{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:10:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:11:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(3952)/libc.Uint32FromInt64(52)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*52
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:22:3:
		if (*dd_di)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:24:3:
		libc.Xfesetround(tls, (*dd_di)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:26:3:
		y = libc.Xremquo(tls, (*dd_di)(unsafe.Pointer(p)).Fx, (*dd_di)(unsafe.Pointer(p)).Fx2, bp+8)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:29:3:
		if !(checkexcept(tls, e, (*dd_di)(unsafe.Pointer(p)).Fe, (*dd_di)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+24, (*dd_di)(unsafe.Pointer(p)).Ffile, (*dd_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*dd_di)(unsafe.Pointer(p)).Fr), (*dd_di)(unsafe.Pointer(p)).Fx, (*dd_di)(unsafe.Pointer(p)).Fx2, (*dd_di)(unsafe.Pointer(p)).Fy, (*dd_di)(unsafe.Pointer(p)).Fi, estr(tls, (*dd_di)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+111, libc.VaList(bp+24, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:35:3:
		d = ulperr(tls, y, (*dd_di)(unsafe.Pointer(p)).Fy, (*dd_di)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:36:3:
		if v4 = !(checkcr(tls, float64(y), (*dd_di)(unsafe.Pointer(p)).Fy, (*dd_di)(unsafe.Pointer(p)).Fr) != 0); !v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
			*(*float64)(unsafe.Pointer(bp)) = (*dd_di)(unsafe.Pointer(p)).Fy
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:65:2:
			v2 = *(*uint64)(unsafe.Pointer(bp))
			goto _3
		_3:
		}
		if v7 = v4 || !(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && int64(*(*int32)(unsafe.Pointer(bp + 8))&libc.Int32FromInt32(7)) != (*dd_di)(unsafe.Pointer(p)).Fi&int64(7); !v7 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
			*(*float64)(unsafe.Pointer(bp)) = (*dd_di)(unsafe.Pointer(p)).Fy
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:65:2:
			v5 = *(*uint64)(unsafe.Pointer(bp))
		...
		if v7 || !(libc.BoolInt32(v5&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && libc.BoolInt32(*(*int32)(unsafe.Pointer(bp + 8)) < 0) != libc.BoolInt32((*dd_di)(unsafe.Pointer(p)).Fi < 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+120, libc.VaList(bp+24, (*dd_di)(unsafe.Pointer(p)).Ffile, (*dd_di)(unsafe.Pointer(p)).Fline, rstr(tls, (*dd_di)(unsafe.Pointer(p)).Fr), (*dd_di)(unsafe.Pointer(p)).Fx, (*dd_di)(unsafe.Pointer(p)).Fx2, (*dd_di)(unsafe.Pointer(p)).Fy, (*dd_di)(unsafe.Pointer(p)).Fi, y, *(*int32)(unsafe.Pointer(bp + 8)), float64(d), float64(d-(*dd_di)(unsafe.Pointer(p)).Fdy), float64((*dd_di)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:41:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquo.c:44:2:
