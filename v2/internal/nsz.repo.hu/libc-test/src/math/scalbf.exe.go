// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/scalbf.exe.go src/math/scalbf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:7:20:
var t = [44]ff_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+25),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_INVALID),
	},
	1: {
		Ffile: __ccgo_ts,
		Fline: int32(2),
	...
	11: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   float32(1.2676506002282294e+30),
		Fy:    float32(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	12: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   float32(-libc.Float64FromFloat64(1.2676506002282294e+30)),
		Fy:    float32(0),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	15: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   libc.X__builtin_nanf(nil, __ccgo_ts+25),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+25),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	...
	18: {
		...
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+25),
		Fx2:   float32(0),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+25),
		Fdy:   float32(0),
		Fe:    int32(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:13:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:14:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:18:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:21:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1408)/libc.Uint32FromInt64(32)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:22:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*32
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:24:3:
		if (*ff_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:25:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:26:3:
		libc.Xfesetround(tls, (*ff_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:27:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:28:3:
		y = libc.Xscalbf(tls, (*ff_f)(unsafe.Pointer(p)).Fx, (*ff_f)(unsafe.Pointer(p)).Fx2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:29:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:31:3:
		if !(checkexceptall(tls, e, (*ff_f)(unsafe.Pointer(p)).Fe, (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*ff_f)(unsafe.Pointer(p)).Ffile, (*ff_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*ff_f)(unsafe.Pointer(p)).Fr), float64((*ff_f)(unsafe.Pointer(p)).Fx), float64((*ff_f)(unsafe.Pointer(p)).Fx2), float64((*ff_f)(unsafe.Pointer(p)).Fy), estr(tls, (*ff_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+106, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:35:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:37:3:
		d = ulperrf(tls, y, (*ff_f)(unsafe.Pointer(p)).Fy, (*ff_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:38:3:
		if !(checkcr(tls, float64(y), float64((*ff_f)(unsafe.Pointer(p)).Fy), (*ff_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+8, (*ff_f)(unsafe.Pointer(p)).Ffile, (*ff_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*ff_f)(unsafe.Pointer(p)).Fr), float64((*ff_f)(unsafe.Pointer(p)).Fx), float64((*ff_f)(unsafe.Pointer(p)).Fx2), float64((*ff_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*ff_f)(unsafe.Pointer(p)).Fdy), float64((*ff_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:41:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbf.c:44:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+177, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+187, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+278, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+283, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+290, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+308, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+316, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+321, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+364, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+413) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+421) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+433) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+445) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+466) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+25) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+466) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+472, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
