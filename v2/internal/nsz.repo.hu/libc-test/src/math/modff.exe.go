// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/modff.exe.go src/math/modff.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:5:20:
var t = [23]f_ff{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    float32(-libc.Float64FromFloat64(0.0668487548828125)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(8)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	1: {
		...
		Fy:    float32(0.34523963928222656),
		Fdy:   float32(0),
		Fy2:   float32(4),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	2: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.38143348693847656)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(8)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	3: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.5316734313964844)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(6)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	4: {
	...
	6: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.40660393238067627)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(0)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	7: {
	...
	9: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.6787636876106262)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(0)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	15: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(1)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	16: {
	...
	19: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0)),
		Fdy:   float32(0),
		Fy2:   float32(-libc.Float64FromFloat64(2)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	20: {
	...
	22: {
		...
		Fdy:   float32(0),
		Fy2:   libc.X__builtin_nanf(nil, __ccgo_ts+49),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:10:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:11:1:
	var d, di, y float32
	var e, err, i int32
	var p uintptr
	var _ /* yi at bp+0 */ float32
	_, _, _, _, _, _, _ = d, di, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:15:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:18:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(828)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:19:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:21:3:
		if (*f_ff)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:22:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:23:3:
		libc.Xfesetround(tls, (*f_ff)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:24:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:25:3:
		y = libc.Xmodff(tls, (*f_ff)(unsafe.Pointer(p)).Fx, bp)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:26:3:
		...
		/* TODO: fix inexact */
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:29:3:
		if !(checkexceptall(tls, e|int32(FE_INEXACT), (*f_ff)(unsafe.Pointer(p)).Fe|int32(FE_INEXACT), (*f_ff)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+50, libc.VaList(bp+16, (*f_ff)(unsafe.Pointer(p)).Ffile, (*f_ff)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_ff)(unsafe.Pointer(p)).Fr), float64((*f_ff)(unsafe.Pointer(p)).Fx), float64((*f_ff)(unsafe.Pointer(p)).Fy), float64((*f_ff)(unsafe.Pointer(p)).Fy2), estr(tls, (*f_ff)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:35:3:
		d = ulperr(tls, float64(y), float64((*f_ff)(unsafe.Pointer(p)).Fy), (*f_ff)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:36:3:
		di = ulperr(tls, float64(*(*float32)(unsafe.Pointer(bp))), float64((*f_ff)(unsafe.Pointer(p)).Fy2), (*f_ff)(unsafe.Pointer(p)).Fdy2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:37:3:
		if !(checkcr(tls, float64(y), float64((*f_ff)(unsafe.Pointer(p)).Fy), (*f_ff)(unsafe.Pointer(p)).Fr) != 0) || !(checkcr(tls, float64(*(*float32)(unsafe.Pointer(bp))), float64((*f_ff)(unsafe.Pointer(p)).Fy2), (*f_ff)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+16, (*f_ff)(unsafe.Pointer(p)).Ffile, (*f_ff)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_ff)(unsafe.Pointer(p)).Fr), float64((*f_ff)(unsafe.Pointer(p)).Fx), float64((*f_ff)(unsafe.Pointer(p)).Fy), float64((*f_ff)(unsafe.Pointer(p)).Fy2), float64(y), float64(*(*float32)(unsafe.Pointer(bp))), float64(d), float64(d-(*f_ff)(unsafe.Pointer(p)).Fdy), float64((*f_ff)(unsafe.Pointer(p)).Fdy), float64(di), float64(di-(*f_ff)(unsafe.Pointer(p)).Fdy2), float64((*f_ff)(unsafe.Pointer(p)).Fdy2)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modff.c:43:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+429) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+437) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+449) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+461) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+473) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+482) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+49) != 0
