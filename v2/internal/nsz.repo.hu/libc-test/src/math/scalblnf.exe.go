// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/scalblnf.exe.go src/math/scalblnf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:5:20:
var t = [27]fi_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fi:    int64(-int32(2)),
		Fy:    float32(-libc.Float64FromFloat64(2.016712188720703)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	1: {
	...
	3: {
		...
		Fi:    int64(1),
		Fy:    float32(-libc.Float64FromFloat64(13.063346862792969)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	4: {
	...
	6: {
		...
		Fi:    int64(4),
		Fy:    float32(-libc.Float64FromFloat64(6.50566291809082)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	7: {
	...
	9: {
		...
		Fi:    int64(7),
		Fy:    float32(-libc.Float64FromFloat64(86.88175201416016)),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	10: {
	...
	13: {
		...
		Fline: int32(4),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+55),
		Fi:    int64(0),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+55),
		Fdy:   float32(0),
		Fe:    int32(0),
	},
	14: {
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(972)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:22:3:
		if (*fi_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:24:3:
		libc.Xfesetround(tls, (*fi_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:26:3:
		y = float64(libc.Xscalblnf(tls, (*fi_f)(unsafe.Pointer(p)).Fx, int32((*fi_f)(unsafe.Pointer(p)).Fi)))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:29:3:
		if !(checkexceptall(tls, e, (*fi_f)(unsafe.Pointer(p)).Fe, (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+56, libc.VaList(bp+8, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), float64((*fi_f)(unsafe.Pointer(p)).Fx), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fy), estr(tls, (*fi_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+115, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:35:3:
		d = ulperrf(tls, float32(y), (*fi_f)(unsafe.Pointer(p)).Fy, (*fi_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:36:3:
		if !(checkcr(tls, float64(y), float64((*fi_f)(unsafe.Pointer(p)).Fy), (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+124, libc.VaList(bp+8, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), float64((*fi_f)(unsafe.Pointer(p)).Fx), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fy), y, float64(d), float64(d-(*fi_f)(unsafe.Pointer(p)).Fdy), float64((*fi_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalblnf.c:42:2:
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+323, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+428) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+436) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+448) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+460) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+472) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+481) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+55) != 0
