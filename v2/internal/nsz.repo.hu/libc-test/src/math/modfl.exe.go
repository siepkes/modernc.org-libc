// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/modfl.exe.go src/math/modfl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:5:20:
var t = [23]l_ll{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fy:    -libc.Float64FromFloat64(0.06684839057968084),
		Fdy:   float32(0),
		Fy2:   -libc.Float64FromFloat64(8),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	1: {
		...
		Fy:    libc.Float64FromFloat64(0.34523984933830487),
		Fdy:   float32(0),
		Fy2:   libc.Float64FromFloat64(4),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	2: {
		...
		Fy:    -libc.Float64FromFloat64(0.38143342755524934),
		Fdy:   float32(0),
		Fy2:   -libc.Float64FromFloat64(8),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	3: {
		...
		Fy:    -libc.Float64FromFloat64(0.5316735819134841),
		Fdy:   float32(0),
		Fy2:   -libc.Float64FromFloat64(6),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	4: {
		...
		Fy:    libc.Float64FromFloat64(0.26705696697258574),
		Fdy:   float32(0),
		Fy2:   libc.Float64FromFloat64(9),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	5: {
		...
		Fy:    libc.Float64FromFloat64(0.6619858980995045),
		Fdy:   float32(0),
		Fy2:   libc.Float64FromFloat64(0),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	6: {
		...
		Fy:    -libc.Float64FromFloat64(0.4066039223853553),
		Fdy:   float32(0),
		Fy2:   -libc.Float64FromFloat64(0),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	7: {
		...
		Fy:    libc.Float64FromFloat64(0.5617597462207241),
		Fdy:   float32(0),
		Fy2:   libc.Float64FromFloat64(0),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	8: {
		...
		Fy:    libc.Float64FromFloat64(0.7741522965913037),
		Fdy:   float32(0),
		Fy2:   libc.Float64FromFloat64(0),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	9: {
		...
		Fy:    -libc.Float64FromFloat64(0.6787637026394024),
		Fdy:   float32(0),
		Fy2:   -libc.Float64FromFloat64(0),
		Fdy2:  float32(0),
		Fe:    int32(0),
	...
	20: {
		...
		Fy:    libc.Float64FromFloat64(0),
		Fdy:   float32(0),
		Fy2:   float64(libc.X__builtin_inff(nil)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
	21: {
	...
	22: {
		...
		Fdy:   float32(0),
		Fy2:   float64(libc.X__builtin_nanf(nil, __ccgo_ts+47)),
		Fdy2:  float32(0),
		Fe:    int32(0),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:15:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:16:1:
	var d, di float32
	var e, err, i int32
	var p uintptr
	var y float64
	var _ /* yi at bp+0 */ float64
	_, _, _, _, _, _, _ = d, di, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:20:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:23:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1104)/libc.Uint32FromInt64(48)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:24:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*48
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:26:3:
		if (*l_ll)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:27:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:28:3:
		libc.Xfesetround(tls, (*l_ll)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:29:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:30:3:
		y = libc.Xmodfl(tls, (*l_ll)(unsafe.Pointer(p)).Fx, bp)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:31:3:
		...
		/* TODO: fix inexact */
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:34:3:
		if !(checkexceptall(tls, e|int32(FE_INEXACT), (*l_ll)(unsafe.Pointer(p)).Fe|int32(FE_INEXACT), (*l_ll)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+48, libc.VaList(bp+16, (*l_ll)(unsafe.Pointer(p)).Ffile, (*l_ll)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_ll)(unsafe.Pointer(p)).Fr), (*l_ll)(unsafe.Pointer(p)).Fx, (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fy2, estr(tls, (*l_ll)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:38:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:40:3:
		d = ulperr(tls, float64(y), (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:41:3:
		di = ulperr(tls, *(*float64)(unsafe.Pointer(bp)), (*l_ll)(unsafe.Pointer(p)).Fy2, (*l_ll)(unsafe.Pointer(p)).Fdy2)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:42:3:
		if !(checkcr(tls, y, (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fr) != 0) || !(checkcr(tls, *(*float64)(unsafe.Pointer(bp)), (*l_ll)(unsafe.Pointer(p)).Fy2, (*l_ll)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+16, (*l_ll)(unsafe.Pointer(p)).Ffile, (*l_ll)(unsafe.Pointer(p)).Fline, rstr(tls, (*l_ll)(unsafe.Pointer(p)).Fr), (*l_ll)(unsafe.Pointer(p)).Fx, (*l_ll)(unsafe.Pointer(p)).Fy, (*l_ll)(unsafe.Pointer(p)).Fy2, y, *(*float64)(unsafe.Pointer(bp)), float64(d), float64(d-(*l_ll)(unsafe.Pointer(p)).Fdy), float64((*l_ll)(unsafe.Pointer(p)).Fdy), float64(di), float64(di-(*l_ll)(unsafe.Pointer(p)).Fdy2), float64((*l_ll)(unsafe.Pointer(p)).Fdy2)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:45:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/modfl.c:48:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+433) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+441) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+453) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+465) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+477) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+486) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+47) != 0
