// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/floorf.exe.go src/math/floorf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:5:19:
var t = [417]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	33: {
		...
		Fy:    float32(-libc.Float64FromFloat64(4.176828e+06)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	34: {
	...
	109: {
		...
		Fy:    float32(-libc.Float64FromFloat64(1.044207e+06)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	110: {
	...
	184: {
		...
		Fline: int32(226),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(13.435422897338867)),
		Fy:    float32(-libc.Float64FromFloat64(14)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	185: {
	...
	187: {
		...
		Fline: int32(229),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(33.39276123046875)),
		Fy:    float32(-libc.Float64FromFloat64(34)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	188: {
		...
		Fline: int32(230),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(13.545157432556152)),
		Fy:    float32(-libc.Float64FromFloat64(14)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	189: {
		...
		Fline: int32(231),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(1.9645987749099731)),
		Fy:    float32(-libc.Float64FromFloat64(2)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	...
	192: {
		...
		Fline: int32(234),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(8.403443336486816)),
		Fy:    float32(-libc.Float64FromFloat64(9)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	193: {
		...
		Fline: int32(235),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(47.901222229003906)),
		Fy:    float32(-libc.Float64FromFloat64(48)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	194: {
	...
	242: {
		...
		Fy:    float32(-libc.Float64FromFloat64(5)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
	243: {
	...
	245: {
		...
		Fline: int32(288),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(-libc.Float64FromFloat64(511.999755859375)),
	...
	246: {
		...
		Fline: int32(289),
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(-libc.Float64FromFloat64(262143.984375)),
	...
	285: {
		...
		Fline: int32(328),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(4.500000476837158)),
		Fy:    float32(-libc.Float64FromFloat64(5)),
		Fdy:   float32(0),
		Fe:    int32(FE_INEXACT),
	},
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:13:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(11676)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:23:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:25:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:27:3:
		y = libc.Xfloorf(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:30:3:
		if !(checkexceptall(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) && e|int32(FE_INEXACT) != (*f_f)(unsafe.Pointer(p)).Fe {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+125, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:36:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:37:3:
		if !(checkcr(tls, float64(y), float64((*f_f)(unsafe.Pointer(p)).Fy), (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:38:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/floorf.c:43:2:
