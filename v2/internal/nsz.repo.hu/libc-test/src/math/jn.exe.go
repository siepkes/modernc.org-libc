// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/jn.exe.go src/math/jn.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:6:20:
var t = [30]di_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
		...
		Fi:    int64(-int32(2)),
		Fy:    -libc.Float64FromFloat64(0.09526753467603093),
		Fdy:   float32(-libc.Float64FromFloat64(0.21236099302768707)),
		Fe:    int32(FE_INEXACT),
	},
	1: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(-int32(1)),
		Fy:    float64(0.18617375789597987),
		Fdy:   float32(-libc.Float64FromFloat64(0.4751335680484772)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	3: {
		...
		Fi:    int64(1),
		Fy:    float64(0.14480159824583846),
		Fdy:   float32(-libc.Float64FromFloat64(0.39379072189331055)),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(2),
		Fy:    float64(0.19546267062087974),
		Fdy:   float32(0.23219047486782074),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(3),
		Fy:    float64(0.005879999242011018),
		Fdy:   float32(0.15657448768615723),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(4),
		Fy:    float64(7.059314478159831e-05),
		Fdy:   float32(0.32217034697532654),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(5),
		Fy:    float64(1.4378248257334976e-05),
		Fdy:   float32(0.4959937334060669),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(6),
		Fy:    float64(4.572333061624648e-06),
		Fdy:   float32(-libc.Float64FromFloat64(0.022202493622899055)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(7),
		Fy:    -libc.Float64FromFloat64(1.0142195936085269e-07),
		Fdy:   float32(0.1487058401107788),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts + 21,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1320)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:22:3:
		if (*di_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:24:3:
		libc.Xfesetround(tls, (*di_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:26:3:
		y = libc.Xjn(tls, int32((*di_d)(unsafe.Pointer(p)).Fi), (*di_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:29:3:
		if !(checkexcept(tls, e, (*di_d)(unsafe.Pointer(p)).Fe, (*di_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+44, libc.VaList(bp+8, (*di_d)(unsafe.Pointer(p)).Ffile, (*di_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*di_d)(unsafe.Pointer(p)).Fr), (*di_d)(unsafe.Pointer(p)).Fi, (*di_d)(unsafe.Pointer(p)).Fx, (*di_d)(unsafe.Pointer(p)).Fy, estr(tls, (*di_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+97, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:35:3:
		d = ulperr(tls, y, (*di_d)(unsafe.Pointer(p)).Fy, (*di_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:36:3:
		if !(checkulp(tls, d, (*di_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:37:4:
			if libc.Xfabsf(tls, d) < libc.Float32FromFloat32(3) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:38:5:
				libc.Xprintf(tls, __ccgo_ts+106, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:40:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:41:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+8, (*di_d)(unsafe.Pointer(p)).Ffile, (*di_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*di_d)(unsafe.Pointer(p)).Fr), (*di_d)(unsafe.Pointer(p)).Fi, (*di_d)(unsafe.Pointer(p)).Fx, (*di_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*di_d)(unsafe.Pointer(p)).Fdy), float64((*di_d)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/jn.c:45:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+407) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+415) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+427) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+439) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+451) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+460) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+43) != 0
