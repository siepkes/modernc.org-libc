// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/asinf.exe.go src/math/asinf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:5:19:
var t = [252]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(38),
	...
	2: {
		...
		Fy:    float32(1.570451021194458),
		Fdy:   float32(-libc.Float64FromFloat64(0.3239321708679199)),
		Fe:    int32(FE_INEXACT),
	},
	3: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(1.570451021194458)),
		Fdy:   float32(0.3239321708679199),
		Fe:    int32(FE_INEXACT),
	},
	4: {
		Ffile: __ccgo_ts,
	...
	6: {
		...
		Fr:    int32(FE_UPWARD),
		Fx:    float32(0.9999999403953552),
		Fy:    float32(1.5704511404037476),
		Fdy:   float32(0.6760678291320801),
		Fe:    int32(FE_INEXACT),
	},
	7: {
		Ffile: __ccgo_ts,
	...
	9: {
		...
		Fr:    int32(FE_DOWNWARD),
		Fx:    float32(-libc.Float64FromFloat64(0.9999999403953552)),
		Fy:    float32(-libc.Float64FromFloat64(1.5704511404037476)),
		Fdy:   float32(-libc.Float64FromFloat64(0.6760678291320801)),
		Fe:    int32(FE_INEXACT),
	},
	10: {
		Ffile: __ccgo_ts,
		Fline: int32(50),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(3.0495901228277944e-05),
		Fy:    float32(3.0495901228277944e-05),
		Fdy:   float32(-libc.Float64FromFloat64(0.002598621416836977)),
		Fe:    int32(FE_INEXACT),
	},
	11: {
		Ffile: __ccgo_ts,
		Fline: int32(51),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(3.0495901228277944e-05)),
		Fy:    float32(-libc.Float64FromFloat64(3.0495901228277944e-05)),
		Fdy:   float32(0.002598621416836977),
		Fe:    int32(FE_INEXACT),
	},
	12: {
		Ffile: __ccgo_ts,
	...
	22: {
		...
		Fline: int32(64),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.26870840787887573)),
		Fy:    float32(-libc.Float64FromFloat64(0.2720518708229065)),
		Fdy:   float32(0.02397100068628788),
		Fe:    int32(FE_INEXACT),
	},
	23: {
		Ffile: __ccgo_ts,
		Fline: int32(65),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.7122259140014648),
		Fy:    float32(0.7926641702651978),
		Fdy:   float32(-libc.Float64FromFloat64(0.024217037484049797)),
		Fe:    int32(FE_INEXACT),
	},
	24: {
		Ffile: __ccgo_ts,
		Fline: int32(66),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.8804502487182617),
		Fy:    float32(1.0768109560012817),
		Fdy:   float32(-libc.Float64FromFloat64(0.1933617889881134)),
		Fe:    int32(FE_INEXACT),
	},
	25: {
		Ffile: __ccgo_ts,
		Fline: int32(67),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.6678552627563477)),
		Fy:    float32(-libc.Float64FromFloat64(0.7313234806060791)),
		Fdy:   float32(-libc.Float64FromFloat64(0.2656354606151581)),
		Fe:    int32(FE_INEXACT),
	},
	26: {
		Ffile: __ccgo_ts,
		Fline: int32(68),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.270903080701828)),
		Fy:    float32(-libc.Float64FromFloat64(0.27433106303215027)),
		Fdy:   float32(0.21774470806121826),
		Fe:    int32(FE_INEXACT),
	},
	27: {
		Ffile: __ccgo_ts,
		Fline: int32(69),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.039291951805353165)),
		Fy:    float32(-libc.Float64FromFloat64(0.03930206969380379)),
		Fdy:   float32(-libc.Float64FromFloat64(0.17783285677433014)),
		Fe:    int32(FE_INEXACT),
	},
	28: {
		Ffile: __ccgo_ts,
		Fline: int32(70),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.5783314108848572),
		Fy:    float32(0.6166818737983704),
		Fdy:   float32(0.09442579746246338),
		Fe:    int32(FE_INEXACT),
	},
	29: {
		Ffile: __ccgo_ts,
		Fline: int32(71),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.8550888299942017),
		Fy:    float32(1.0257221460342407),
		Fdy:   float32(0.028884407132864),
		Fe:    int32(FE_INEXACT),
	},
	30: {
		Ffile: __ccgo_ts,
		Fline: int32(72),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.16806890070438385)),
		Fy:    float32(-libc.Float64FromFloat64(0.16887037456035614)),
		Fdy:   float32(0.06597352027893066),
		Fe:    int32(FE_INEXACT),
	},
	31: {
		Ffile: __ccgo_ts,
		Fline: int32(73),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(-libc.Float64FromFloat64(0.9580241441726685)),
		Fy:    float32(-libc.Float64FromFloat64(1.2800289392471313)),
		Fdy:   float32(-libc.Float64FromFloat64(0.38148918747901917)),
		Fe:    int32(FE_INEXACT),
	},
	32: {
		Ffile: __ccgo_ts,
	...
	87: {
		...
		Fdy:   float32(-libc.Float64FromFloat64(2.6193447411060333e-10)),
		Fe:    int32(FE_INEXACT),
	},
	88: {
		Ffile: __ccgo_ts,
	...
	90: {
		...
		Fdy:   float32(-libc.Float64FromFloat64(0.2812500298023224)),
		Fe:    int32(FE_INEXACT),
	},
	91: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(1.1175871783564162e-08)),
		Fdy:   float32(-libc.Float64FromFloat64(1)),
		Fe:    int32(FE_INEXACT),
	},
	92: {
	...
	93: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.00024414065410383046)),
		Fdy:   float32(-libc.Float64FromFloat64(0.9166666865348816)),
		Fe:    int32(FE_INEXACT),
	},
	94: {
		Ffile: __ccgo_ts,
	...
	107: {
		...
		Fdy:   float32(2.6193447411060333e-10),
		Fe:    int32(FE_INEXACT),
	},
	108: {
		Ffile: __ccgo_ts,
	...
	110: {
		...
		Fdy:   float32(0.2812500298023224),
		Fe:    int32(FE_INEXACT),
	},
	111: {
		Ffile: __ccgo_ts,
	...
	177: {
		...
		Fr:    int32(FE_UPWARD),
		Fx:    float32(1.1175870895385742e-08),
		Fy:    float32(1.1175871783564162e-08),
		Fdy:   float32(1),
		Fe:    int32(FE_INEXACT),
	},
	178: {
	...
	179: {
		...
		Fr:    int32(FE_UPWARD),
		Fx:    float32(0.000244140625),
		Fy:    float32(0.00024414065410383046),
		Fdy:   float32(0.9166666865348816),
		Fe:    int32(FE_INEXACT),
	},
	180: {
		Ffile: __ccgo_ts,
	...
	237: {
		...
		Fy:    float32(0.7234652042388916),
		Fdy:   float32(-libc.Float64FromFloat64(0.1307632476091385)),
		Fe:    int32(FE_INEXACT),
	},
	238: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.41873374581336975)),
		Fdy:   float32(0.3161141574382782),
		Fe:    int32(FE_INEXACT),
	},
	239: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(0.5965113639831543),
		Fdy:   float32(-libc.Float64FromFloat64(0.4510819613933563)),
		Fe:    int32(FE_INEXACT),
	},
	240: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(0.8853747844696045),
		Fdy:   float32(0.02493886835873127),
		Fe:    int32(FE_INEXACT),
	},
	241: {
		Ffile: __ccgo_ts + 22,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.7460777759552002)),
		Fdy:   float32(0.2515012323856354),
		Fe:    int32(FE_INEXACT),
	},
	242: {
		Ffile: __ccgo_ts + 46,
	...
	251: {
		...
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.5004770159721375),
		Fy:    float32(0.5241496562957764),
		Fdy:   float32(-libc.Float64FromFloat64(0.29427099227905273)),
		Fe:    int32(FE_INEXACT),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:13:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:17:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(7056)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:23:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:25:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:27:3:
		y = libc.Xasinf(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:30:3:
		if !(checkexcept(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:31:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+121, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:36:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:37:3:
		if !(checkulp(tls, d, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:38:4:
			...
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:40:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/asinf.c:43:2:
