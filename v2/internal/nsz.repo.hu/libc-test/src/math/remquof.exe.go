// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/remquof.exe.go src/math/remquof.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:5:21:
var t = [76]ff_fi{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	4: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.3557271957397461)),
		Fdy:   float32(0),
		Fi:    int64(2),
		Fe:    int32(0),
	},
	5: {
		...
		Fy:    float32(0.17067205905914307),
		Fdy:   float32(0),
		Fi:    int64(-int32(10)),
		Fe:    int32(0),
	},
	6: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.016443386673927307)),
		Fdy:   float32(0),
		Fi:    int64(151),
		Fe:    int32(0),
	},
	...
	20: {
		...
		Fx2:   float32(1),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+53),
		Fdy:   float32(0),
		Fi:    int64(-int32(2)),
		Fe:    int32(FE_INVALID),
	},
	...
	22: {
		...
		Fline: int32(13),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.X__builtin_nanf(nil, __ccgo_ts+53),
		Fx2:   float32(1),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+53),
		Fdy:   float32(0),
		Fi:    int64(-int32(2)),
	...
	40: {
		...
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0),
		Fx2:   libc.X__builtin_nanf(nil, __ccgo_ts+53),
		Fy:    libc.X__builtin_nanf(nil, __ccgo_ts+53),
		Fdy:   float32(0),
		Fi:    int64(0),
		Fe:    int32(0),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:10:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:11:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	var v2, v5 uint32
	...
	var _ /* yi at bp+4 */ int32
	_, _, _, _, _, _, _, _, _, _ = d, e, err, i, p, y, v2, v4, v5, v7
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(3040)/libc.Uint32FromInt64(40)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*40
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:22:3:
		if (*ff_fi)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:24:3:
		libc.Xfesetround(tls, (*ff_fi)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:26:3:
		y = libc.Xremquof(tls, (*ff_fi)(unsafe.Pointer(p)).Fx, (*ff_fi)(unsafe.Pointer(p)).Fx2, bp+4)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:29:3:
		if !(checkexcept(tls, e, (*ff_fi)(unsafe.Pointer(p)).Fe, (*ff_fi)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+54, libc.VaList(bp+16, (*ff_fi)(unsafe.Pointer(p)).Ffile, (*ff_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*ff_fi)(unsafe.Pointer(p)).Fr), float64((*ff_fi)(unsafe.Pointer(p)).Fx), float64((*ff_fi)(unsafe.Pointer(p)).Fx2), float64((*ff_fi)(unsafe.Pointer(p)).Fy), (*ff_fi)(unsafe.Pointer(p)).Fi, estr(tls, (*ff_fi)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+114, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:35:3:
		d = ulperr(tls, float64(y), float64((*ff_fi)(unsafe.Pointer(p)).Fy), (*ff_fi)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:36:3:
		if v4 = !(checkcr(tls, float64(y), float64((*ff_fi)(unsafe.Pointer(p)).Fy), (*ff_fi)(unsafe.Pointer(p)).Fr) != 0); !v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:58:2:
			*(*float32)(unsafe.Pointer(bp)) = (*ff_fi)(unsafe.Pointer(p)).Fy
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:59:2:
			v2 = *(*uint32)(unsafe.Pointer(bp))
			goto _3
		_3:
		}
		if v7 = v4 || !(libc.BoolInt32(v2&libc.Uint32FromInt32(0x7fffffff) > libc.Uint32FromInt32(0x7f800000)) != 0) && int64(*(*int32)(unsafe.Pointer(bp + 4))&libc.Int32FromInt32(7)) != (*ff_fi)(unsafe.Pointer(p)).Fi&int64(7); !v7 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:58:2:
			*(*float32)(unsafe.Pointer(bp)) = (*ff_fi)(unsafe.Pointer(p)).Fy
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:59:2:
		...
		if v7 || !(libc.BoolInt32(v5&libc.Uint32FromInt32(0x7fffffff) > libc.Uint32FromInt32(0x7f800000)) != 0) && libc.BoolInt32(*(*int32)(unsafe.Pointer(bp + 4)) < 0) != libc.BoolInt32((*ff_fi)(unsafe.Pointer(p)).Fi < 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:39:4:
			libc.Xprintf(tls, __ccgo_ts+123, libc.VaList(bp+16, (*ff_fi)(unsafe.Pointer(p)).Ffile, (*ff_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*ff_fi)(unsafe.Pointer(p)).Fr), float64((*ff_fi)(unsafe.Pointer(p)).Fx), float64((*ff_fi)(unsafe.Pointer(p)).Fx2), float64((*ff_fi)(unsafe.Pointer(p)).Fy), (*ff_fi)(unsafe.Pointer(p)).Fi, float64(y), *(*int32)(unsafe.Pointer(bp + 4)), float64(d), float64(d-(*ff_fi)(unsafe.Pointer(p)).Fdy), float64((*ff_fi)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:41:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/remquof.c:44:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+430) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+438) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+450) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+462) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+474) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+483) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0
