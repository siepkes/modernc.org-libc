// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/yn.exe.go src/math/yn.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:6:20:
var t = [34]di_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fi:    int64(-int32(1)),
		Fy:    -libc.Float64FromFloat64(0.3385821357745925),
		Fdy:   float32(-libc.Float64FromFloat64(0.3217972218990326)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	4: {
		...
		Fi:    int64(2),
		Fy:    -libc.Float64FromFloat64(0.17892390323638072),
		Fdy:   float32(-libc.Float64FromFloat64(0.22975105047225952)),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(3),
		Fy:    -libc.Float64FromFloat64(18.575637941602285),
		Fdy:   float32(0.3629147410392761),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
	...
	7: {
		...
		Fi:    int64(5),
		Fy:    -libc.Float64FromFloat64(4457.101895916727),
		Fdy:   float32(0.02819478139281273),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fi:    int64(6),
		Fy:    -libc.Float64FromFloat64(11703.51219527324),
		Fdy:   float32(-libc.Float64FromFloat64(0.2194088250398636)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	...
	_, _, _, _, _, _, _, _, _ = d, e, err, i, p, y, v2, v4, v5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1496)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:22:3:
		if (*di_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:24:3:
		libc.Xfesetround(tls, (*di_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:26:3:
		y = libc.Xyn(tls, int32((*di_d)(unsafe.Pointer(p)).Fi), (*di_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:29:3:
		if !(checkexcept(tls, e, (*di_d)(unsafe.Pointer(p)).Fe, (*di_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+44, libc.VaList(bp+16, (*di_d)(unsafe.Pointer(p)).Ffile, (*di_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*di_d)(unsafe.Pointer(p)).Fr), (*di_d)(unsafe.Pointer(p)).Fi, (*di_d)(unsafe.Pointer(p)).Fx, (*di_d)(unsafe.Pointer(p)).Fy, estr(tls, (*di_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+97, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:35:3:
		d = ulperr(tls, y, (*di_d)(unsafe.Pointer(p)).Fy, (*di_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:36:3:
		if v5 = !((*di_d)(unsafe.Pointer(p)).Fx < libc.Float64FromInt32(0)) && !(checkulp(tls, d, (*di_d)(unsafe.Pointer(p)).Fr) != 0); !v5 {
			if v4 = (*di_d)(unsafe.Pointer(p)).Fx < libc.Float64FromInt32(0); v4 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		...
		if v5 || v4 && !(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && y != float64(-libc.X__builtin_inff(tls)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+106, libc.VaList(bp+16, (*di_d)(unsafe.Pointer(p)).Ffile, (*di_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*di_d)(unsafe.Pointer(p)).Fr), (*di_d)(unsafe.Pointer(p)).Fi, (*di_d)(unsafe.Pointer(p)).Fx, (*di_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*di_d)(unsafe.Pointer(p)).Fdy), float64((*di_d)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/yn.c:42:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+168, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+178, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+269, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+274, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+281, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+299, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+307, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+312, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+355, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+404) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+412) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+424) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+436) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+448) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+21) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+457) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+463, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
