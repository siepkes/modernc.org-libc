// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/ldexpf.exe.go src/math/ldexpf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:5:20:
var t = [24]fi_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:12:1:
	var d, y float32
	var e, err, i int32
	var p uintptr
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(864)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:22:3:
		if (*fi_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:24:3:
		libc.Xfesetround(tls, (*fi_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:26:3:
		y = libc.Xldexpf(tls, (*fi_f)(unsafe.Pointer(p)).Fx, int32((*fi_f)(unsafe.Pointer(p)).Fi))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:29:3:
		if !(checkexceptall(tls, e, (*fi_f)(unsafe.Pointer(p)).Fe, (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), float64((*fi_f)(unsafe.Pointer(p)).Fx), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fy), estr(tls, (*fi_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:35:3:
		d = ulperrf(tls, y, (*fi_f)(unsafe.Pointer(p)).Fy, (*fi_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:36:3:
		if !(checkcr(tls, float64(y), float64((*fi_f)(unsafe.Pointer(p)).Fy), (*fi_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+118, libc.VaList(bp+8, (*fi_f)(unsafe.Pointer(p)).Ffile, (*fi_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*fi_f)(unsafe.Pointer(p)).Fr), float64((*fi_f)(unsafe.Pointer(p)).Fx), (*fi_f)(unsafe.Pointer(p)).Fi, float64((*fi_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*fi_f)(unsafe.Pointer(p)).Fdy), float64((*fi_f)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/ldexpf.c:42:2:
