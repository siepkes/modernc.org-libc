// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/scalbn.exe.go src/math/scalbn.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:5:20:
var t = [29]di_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	28: {
		...
		Fline: int32(19),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0.5000000000000012),
		Fi:    int64(-int32(1024)),
		Fy:    float64(2.781342323134007e-309),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:12:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:16:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:19:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1276)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:20:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:22:3:
		if (*di_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:23:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:24:3:
		libc.Xfesetround(tls, (*di_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:25:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:26:3:
		y = libc.Xscalbn(tls, (*di_d)(unsafe.Pointer(p)).Fx, int32((*di_d)(unsafe.Pointer(p)).Fi))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:27:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:29:3:
		if !(checkexceptall(tls, e, (*di_d)(unsafe.Pointer(p)).Fe, (*di_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:30:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*di_d)(unsafe.Pointer(p)).Ffile, (*di_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*di_d)(unsafe.Pointer(p)).Fr), (*di_d)(unsafe.Pointer(p)).Fx, (*di_d)(unsafe.Pointer(p)).Fi, (*di_d)(unsafe.Pointer(p)).Fy, estr(tls, (*di_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+109, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:33:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:35:3:
		d = ulperr(tls, y, (*di_d)(unsafe.Pointer(p)).Fy, (*di_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:36:3:
		if !(checkcr(tls, float64(y), (*di_d)(unsafe.Pointer(p)).Fy, (*di_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+118, libc.VaList(bp+8, (*di_d)(unsafe.Pointer(p)).Ffile, (*di_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*di_d)(unsafe.Pointer(p)).Fr), (*di_d)(unsafe.Pointer(p)).Fx, (*di_d)(unsafe.Pointer(p)).Fi, (*di_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*di_d)(unsafe.Pointer(p)).Fdy), float64((*di_d)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:39:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbn.c:42:2:
