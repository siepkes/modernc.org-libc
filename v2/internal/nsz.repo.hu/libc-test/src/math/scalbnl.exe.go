// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/scalbnl.exe.go src/math/scalbnl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:5:20:
var t = [29]li_l{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	27: {
		...
		Fline: int32(18),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0.7499999999999999),
		Fi:    int64(-int32(1073)),
		Fy:    libc.Float64FromFloat64(5e-324),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	...
	28: {
		...
		Fline: int32(19),
		Fr:    int32(FE_TONEAREST),
		Fx:    libc.Float64FromFloat64(0.5000000000000012),
		Fi:    int64(-int32(1024)),
		Fy:    libc.Float64FromFloat64(2.781342323134007e-309),
		Fdy:   float32(0),
		Fe:    libc.Int32FromInt32(FE_INEXACT) | libc.Int32FromInt32(FE_UNDERFLOW),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:18:1:
	var d float32
	var e, err, i int32
	var p uintptr
	var y float64
	_, _, _, _, _, _ = d, e, err, i, p, y
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:22:12:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:25:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(1276)/libc.Uint32FromInt64(44)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:26:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*44
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:28:3:
		if (*li_l)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:29:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:30:3:
		libc.Xfesetround(tls, (*li_l)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:31:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:32:3:
		y = libc.Xscalbnl(tls, (*li_l)(unsafe.Pointer(p)).Fx, int32((*li_l)(unsafe.Pointer(p)).Fi))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:33:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:35:3:
		if !(checkexceptall(tls, e, (*li_l)(unsafe.Pointer(p)).Fe, (*li_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:36:4:
			libc.Xprintf(tls, __ccgo_ts+52, libc.VaList(bp+8, (*li_l)(unsafe.Pointer(p)).Ffile, (*li_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*li_l)(unsafe.Pointer(p)).Fr), (*li_l)(unsafe.Pointer(p)).Fx, (*li_l)(unsafe.Pointer(p)).Fi, (*li_l)(unsafe.Pointer(p)).Fy, estr(tls, (*li_l)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:38:4:
			libc.Xprintf(tls, __ccgo_ts+112, libc.VaList(bp+8, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:39:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:41:3:
		d = ulperrl(tls, y, (*li_l)(unsafe.Pointer(p)).Fy, (*li_l)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:42:3:
		if !(checkcr(tls, y, (*li_l)(unsafe.Pointer(p)).Fy, (*li_l)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+121, libc.VaList(bp+8, (*li_l)(unsafe.Pointer(p)).Ffile, (*li_l)(unsafe.Pointer(p)).Fline, rstr(tls, (*li_l)(unsafe.Pointer(p)).Fr), (*li_l)(unsafe.Pointer(p)).Fx, (*li_l)(unsafe.Pointer(p)).Fi, (*li_l)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*li_l)(unsafe.Pointer(p)).Fdy), float64((*li_l)(unsafe.Pointer(p)).Fdy)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:45:4:
			err++
		}
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/scalbnl.c:48:2:
