// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/lgammaf.exe.go src/math/lgammaf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:8:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:8:20:
var t = [19]f_fi{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:14:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:15:1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:20:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:23:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(684)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:24:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:26:3:
		if (*f_fi)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:27:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:28:3:
		libc.Xfesetround(tls, (*f_fi)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:29:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:30:3:
		y = float64(libc.Xlgammaf(tls, (*f_fi)(unsafe.Pointer(p)).Fx))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:31:3:
		yi = gngam
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:32:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:34:3:
		if !(checkexcept(tls, e, (*f_fi)(unsafe.Pointer(p)).Fe, (*f_fi)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:35:4:
			libc.Xprintf(tls, __ccgo_ts+54, libc.VaList(bp+16, (*f_fi)(unsafe.Pointer(p)).Ffile, (*f_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_fi)(unsafe.Pointer(p)).Fr), float64((*f_fi)(unsafe.Pointer(p)).Fx), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fi, estr(tls, (*f_fi)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:37:4:
			libc.Xprintf(tls, __ccgo_ts+111, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:38:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:40:3:
		d = ulperrf(tls, float32(y), (*f_fi)(unsafe.Pointer(p)).Fy, (*f_fi)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:41:3:
		...
		*(*float32)(unsafe.Pointer(bp)) = (*f_fi)(unsafe.Pointer(p)).Fx
		...
		goto _3
	_3:
		bad = libc.BoolInt32(!(libc.BoolInt32(v2&libc.Uint32FromInt32(0x7fffffff) > libc.Uint32FromInt32(0x7f800000)) != 0) && (*f_fi)(unsafe.Pointer(p)).Fx != -libc.X__builtin_inff(tls) && !((*f_fi)(unsafe.Pointer(p)).Fe&libc.Int32FromInt32(FE_DIVBYZERO) != 0) && int64(yi) != (*f_fi)(unsafe.Pointer(p)).Fi)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:42:3:
		if bad != 0 || !(checkulp(tls, d, (*f_fi)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:43:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(2) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:44:5:
				libc.Xprintf(tls, __ccgo_ts+120, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:46:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:47:4:
			libc.Xprintf(tls, __ccgo_ts+123, libc.VaList(bp+16, (*f_fi)(unsafe.Pointer(p)).Ffile, (*f_fi)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_fi)(unsafe.Pointer(p)).Fr), float64((*f_fi)(unsafe.Pointer(p)).Fx), float64((*f_fi)(unsafe.Pointer(p)).Fy), (*f_fi)(unsafe.Pointer(p)).Fi, y, yi, float64(d), float64(d-(*f_fi)(unsafe.Pointer(p)).Fdy), float64((*f_fi)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/lgammaf.c:51:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+427) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+435) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+447) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+459) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+471) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+480) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0
