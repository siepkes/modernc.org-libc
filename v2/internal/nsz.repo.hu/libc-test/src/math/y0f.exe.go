// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/y0f.exe.go src/math/y0f.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:7:19:
var t = [19]f_f{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.14513729512691498)),
		Fdy:   float32(0.08984018117189407),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	4: {
		...
		Fy:    float32(0.21403495967388153),
		Fdy:   float32(-libc.Float64FromFloat64(0.44856297969818115)),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.2336350381374359)),
		Fdy:   float32(-libc.Float64FromFloat64(0.46357598900794983)),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
	...
	7: {
		...
		Fy:    float32(-libc.Float64FromFloat64(0.3580692708492279)),
		Fdy:   float32(-libc.Float64FromFloat64(0.11120672523975372)),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    float32(-libc.Float64FromFloat64(0.1124703586101532)),
		Fdy:   float32(-libc.Float64FromFloat64(0.26528534293174744)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
	...
	16: {
		...
		Fline: int32(7),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(1.048007607460022),
		Fy:    float32(0.1247745081782341),
		Fdy:   float32(-libc.Float64FromFloat64(0.18034429848194122)),
		Fe:    int32(FE_INEXACT),
	},
	17: {
		Ffile: __ccgo_ts + 23,
		Fline: int32(8),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(0.7712846994400024),
		Fy:    float32(-libc.Float64FromFloat64(0.11536631733179092)),
		Fdy:   float32(-libc.Float64FromFloat64(0.08139047771692276)),
		Fe:    int32(FE_INEXACT),
	},
	18: {
		Ffile: __ccgo_ts + 23,
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    float32(3.9576785564422607),
		Fy:    float32(-libc.Float64FromFloat64(5.5199631532332205e-08)),
		Fdy:   float32(-libc.Float64FromFloat64(0.3834332823753357)),
		Fe:    int32(FE_INEXACT),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:13:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:14:1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:18:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:21:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(532)/libc.Uint32FromInt64(28)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:22:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*28
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:24:3:
		if (*f_f)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:25:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:26:3:
		libc.Xfesetround(tls, (*f_f)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:27:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:28:3:
		y = libc.Xy0f(tls, (*f_f)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:29:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:31:3:
		if !(checkexcept(tls, e, (*f_f)(unsafe.Pointer(p)).Fe, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:32:4:
			libc.Xprintf(tls, __ccgo_ts+46, libc.VaList(bp+16, (*f_f)(unsafe.Pointer(p)).Ffile, (*f_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_f)(unsafe.Pointer(p)).Fr), float64((*f_f)(unsafe.Pointer(p)).Fx), float64((*f_f)(unsafe.Pointer(p)).Fy), estr(tls, (*f_f)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:34:4:
			libc.Xprintf(tls, __ccgo_ts+94, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:35:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:37:3:
		d = ulperrf(tls, y, (*f_f)(unsafe.Pointer(p)).Fy, (*f_f)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:38:3:
		if v4 = (*f_f)(unsafe.Pointer(p)).Fx < libc.Float32FromInt32(0); v4 {
		...
		bad = libc.BoolInt32(v4 && !(libc.BoolInt32(v2&libc.Uint32FromInt32(0x7fffffff) > libc.Uint32FromInt32(0x7f800000)) != 0) && y != -libc.X__builtin_inff(tls))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:39:3:
		if bad != 0 || !((*f_f)(unsafe.Pointer(p)).Fx < libc.Float32FromInt32(0)) && !(checkulp(tls, d, (*f_f)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:40:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(8.388608e+06) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:41:5:
				libc.Xprintf(tls, __ccgo_ts+103, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:43:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:44:4:
			libc.Xprintf(tls, __ccgo_ts+106, libc.VaList(bp+16, (*f_f)(unsafe.Pointer(p)).Ffile, (*f_f)(unsafe.Pointer(p)).Fline, rstr(tls, (*f_f)(unsafe.Pointer(p)).Fr), float64((*f_f)(unsafe.Pointer(p)).Fx), float64((*f_f)(unsafe.Pointer(p)).Fy), float64(y), float64(d), float64(d-(*f_f)(unsafe.Pointer(p)).Fdy), float64((*f_f)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0f.c:48:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+162, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+172, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+398) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+406) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+418) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+430) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+442) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+451) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+22) != 0
