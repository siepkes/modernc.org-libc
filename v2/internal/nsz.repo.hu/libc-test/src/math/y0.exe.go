// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/math/y0.exe.go src/math/y0.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:6:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:6:19:
var t = [22]d_d{
	0: {
		Ffile: __ccgo_ts,
		Fline: int32(1),
	...
	1: {
		...
		Fy:    -libc.Float64FromFloat64(0.14513736758687854),
		Fdy:   float32(-libc.Float64FromFloat64(0.3836148977279663)),
		Fe:    int32(FE_INEXACT),
	},
	2: {
		Ffile: __ccgo_ts,
	...
	4: {
		...
		Fy:    float64(0.21403503986889466),
		Fdy:   float32(-libc.Float64FromFloat64(0.3251359164714813)),
		Fe:    int32(FE_INEXACT),
	},
	5: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.23363500351853095),
		Fdy:   float32(0.3694811165332794),
		Fe:    int32(FE_INEXACT),
	},
	6: {
		Ffile: __ccgo_ts,
	...
	7: {
		...
		Fy:    -libc.Float64FromFloat64(0.35806929912223595),
		Fdy:   float32(0.34507444500923157),
		Fe:    int32(FE_INEXACT),
	},
	8: {
		Ffile: __ccgo_ts,
		...
		Fy:    -libc.Float64FromFloat64(0.11247033879761033),
		Fdy:   float32(-libc.Float64FromFloat64(0.2973099648952484)),
		Fe:    int32(FE_INEXACT),
	},
	9: {
		Ffile: __ccgo_ts,
	...
	16: {
		...
		Fline: int32(8),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0.8935769662791675),
		Fy:    -libc.Float64FromFloat64(2.3389279284062102e-17),
		Fdy:   float32(0.2670368552207947),
		Fe:    int32(FE_INEXACT),
	},
	17: {
		Ffile: __ccgo_ts + 22,
		Fline: int32(9),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(0.8935769662791676),
		Fy:    float64(7.42460430426097e-17),
		Fdy:   float32(0.4648538827896118),
		Fe:    int32(FE_INEXACT),
	},
	18: {
		Ffile: __ccgo_ts + 22,
		Fline: int32(10),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(3.9576784193148575),
		Fy:    float64(1.3543379239656842e-16),
		Fdy:   float32(0.02104984223842621),
		Fe:    int32(FE_INEXACT),
	},
	19: {
		Ffile: __ccgo_ts + 22,
		Fline: int32(11),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(3.957678419314858),
		Fy:    -libc.Float64FromFloat64(4.3331064642935194e-17),
		Fdy:   float32(0.3328237235546112),
		Fe:    int32(FE_INEXACT),
	},
	20: {
		Ffile: __ccgo_ts + 22,
		Fline: int32(12),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(7.086051060301772),
		Fy:    -libc.Float64FromFloat64(2.400257436414576e-16),
		Fdy:   float32(-libc.Float64FromFloat64(0.271716833114624)),
		Fe:    int32(FE_INEXACT),
	},
	21: {
		Ffile: __ccgo_ts + 22,
		Fline: int32(13),
		Fr:    int32(FE_TONEAREST),
		Fx:    float64(7.086051060301773),
		Fy:    float64(2.651448172550504e-17),
		Fdy:   float32(-libc.Float64FromFloat64(0.4825265109539032)),
		Fe:    int32(FE_INEXACT),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:13:1:
	...
	_, _, _, _, _, _, _, _, _ = bad, d, e, err, i, p, y, v2, v4
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:17:17:
	err = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:20:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(792)/libc.Uint32FromInt64(36)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:21:3:
		p = uintptr(unsafe.Pointer(&t)) + uintptr(i)*36
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:23:3:
		if (*d_d)(unsafe.Pointer(p)).Fr < 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:24:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:25:3:
		libc.Xfesetround(tls, (*d_d)(unsafe.Pointer(p)).Fr)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:26:3:
		feclearexcept(tls, int32(FE_ALL_EXCEPT))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:27:3:
		y = libc.Xy0(tls, (*d_d)(unsafe.Pointer(p)).Fx)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:28:3:
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:30:3:
		if !(checkexcept(tls, e, (*d_d)(unsafe.Pointer(p)).Fe, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:31:4:
			libc.Xprintf(tls, __ccgo_ts+44, libc.VaList(bp+16, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, estr(tls, (*d_d)(unsafe.Pointer(p)).Fe)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:33:4:
			libc.Xprintf(tls, __ccgo_ts+91, libc.VaList(bp+16, estr(tls, e)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:34:4:
			err++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:36:3:
		d = ulperr(tls, y, (*d_d)(unsafe.Pointer(p)).Fy, (*d_d)(unsafe.Pointer(p)).Fdy)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:37:3:
		if v4 = (*d_d)(unsafe.Pointer(p)).Fx < libc.Float64FromInt32(0); v4 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/math.h:64:2:
		...
		bad = libc.BoolInt32(v4 && !(libc.BoolInt32(v2&(-libc.Uint64FromUint64(1)>>libc.Int32FromInt32(1)) > libc.Uint64FromUint64(0x7ff)<<libc.Int32FromInt32(52)) != 0) && y != float64(-libc.X__builtin_inff(tls)))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:38:3:
		if bad != 0 || !((*d_d)(unsafe.Pointer(p)).Fx < libc.Float64FromInt32(0)) && !(checkulp(tls, d, (*d_d)(unsafe.Pointer(p)).Fr) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:39:4:
			if !(bad != 0) && libc.Xfabsf(tls, d) < libc.Float32FromFloat32(4.503599627370496e+15) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:40:5:
				libc.Xprintf(tls, __ccgo_ts+100, 0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:42:5:
				err++
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:43:4:
			libc.Xprintf(tls, __ccgo_ts+103, libc.VaList(bp+16, (*d_d)(unsafe.Pointer(p)).Ffile, (*d_d)(unsafe.Pointer(p)).Fline, rstr(tls, (*d_d)(unsafe.Pointer(p)).Fr), (*d_d)(unsafe.Pointer(p)).Fx, (*d_d)(unsafe.Pointer(p)).Fy, y, float64(d), float64(d-(*d_d)(unsafe.Pointer(p)).Fdy), float64((*d_d)(unsafe.Pointer(p)).Fdy)))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/math/y0.c:47:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+394) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+402) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+414) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+426) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+438) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+447) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+21) != 0
