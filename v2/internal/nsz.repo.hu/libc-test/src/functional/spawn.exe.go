// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/spawn.exe.go src/functional/spawn.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/spawn.h:27:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/spawn.h:34:3:
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/spawn.h:36:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/spawn.h:40:3:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:21:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(160)
	defer tls.Free(160)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:22:1:
	var r, v1, v2, v3, v4, v5, v6, v7, v8 int32
	var _ /* fa at bp+40 */ posix_spawn_file_actions_t
	var _ /* foo at bp+12 */ [10]int8
	var _ /* p at bp+24 */ [2]int32
	var _ /* pid at bp+32 */ pid_t
	var _ /* status at bp+36 */ int32
	_, _, _, _, _, _, _, _, _ = r, v1, v2, v3, v4, v5, v6, v7, v8
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:30:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	_ = !(libc.Xpipe(tls, bp+24) != 0) || t_printf(tls, __ccgo_ts, libc.VaList(bp+128, __ccgo_ts+56, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:31:2:
	v1 = libc.Xposix_spawn_file_actions_init(tls, bp+40)
	r = v1
	_ = v1 == 0 || t_printf(tls, __ccgo_ts+65, libc.VaList(bp+128, __ccgo_ts+119, r, 0)) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:32:2:
	v2 = libc.Xposix_spawn_file_actions_addclose(tls, bp+40, (*(*[2]int32)(unsafe.Pointer(bp + 24)))[0])
	r = v2
	_ = v2 == 0 || t_printf(tls, __ccgo_ts+154, libc.VaList(bp+128, __ccgo_ts+208, r, 0)) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:33:2:
	v3 = libc.Xposix_spawn_file_actions_adddup2(tls, bp+40, (*(*[2]int32)(unsafe.Pointer(bp + 24)))[int32(1)], int32(1))
	r = v3
	_ = v3 == 0 || t_printf(tls, __ccgo_ts+253, libc.VaList(bp+128, __ccgo_ts+307, r, 0)) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:34:2:
	v4 = libc.Xposix_spawn_file_actions_addclose(tls, bp+40, (*(*[2]int32)(unsafe.Pointer(bp + 24)))[int32(1)])
	r = v4
	_ = v4 == 0 || t_printf(tls, __ccgo_ts+354, libc.VaList(bp+128, __ccgo_ts+408, r, 0)) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:35:2:
	*(*[3]uintptr)(unsafe.Pointer(bp)) = [3]uintptr{
		0: __ccgo_ts + 453,
		1: __ccgo_ts + 458,
		2: uintptr(0),
	}
	v5 = libc.Xposix_spawnp(tls, bp+32, __ccgo_ts+453, bp+40, uintptr(0), bp, uintptr(0))
	r = v5
	_ = v5 == 0 || t_printf(tls, __ccgo_ts+464, libc.VaList(bp+128, __ccgo_ts+518, r, 0)) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:36:2:
	libc.Xclose(tls, (*(*[2]int32)(unsafe.Pointer(bp + 24)))[int32(1)])
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:37:2:
	v6 = libc.Xwaitpid(tls, *(*pid_t)(unsafe.Pointer(bp + 32)), bp+36, 0)
	r = v6
	_ = v6 == *(*pid_t)(unsafe.Pointer(bp + 32)) || t_printf(tls, __ccgo_ts+586, libc.VaList(bp+128, __ccgo_ts+640, r, *(*pid_t)(unsafe.Pointer(bp + 32)))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:38:2:
	v7 = libc.Xread(tls, (*(*[2]int32)(unsafe.Pointer(bp + 24)))[0], bp+12, uint32(10))
	r = v7
	_ = v7 == int32(6) || t_printf(tls, __ccgo_ts+665, libc.VaList(bp+128, __ccgo_ts+719, r, int32(6))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:39:2:
	libc.Xclose(tls, (*(*[2]int32)(unsafe.Pointer(bp + 24)))[0])
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:40:2:
	v8 = libc.Xposix_spawn_file_actions_destroy(tls, bp+40)
	r = v8
	_ = v8 == 0 || t_printf(tls, __ccgo_ts+747, libc.VaList(bp+128, __ccgo_ts+801, r, 0)) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/spawn.c:41:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+839, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+849, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+941, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+946, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+953, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+971, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+979, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+984, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1027, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1076) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1084) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1096) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1108) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1120) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1129) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+940) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1129) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1135, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/spawn.c:30: %s failed (errno = %d \"%s\")\n\x00!pipe(p)\x00src/functional/spawn.c:31: %s failed, got %d want %d\n\x00posix_spawn_file_actions_init(&fa)\x00src/functional/spawn.c:32: %s failed, got %d want %d\n\x00posix_spawn_file_actions_addclose(&fa, p[0])\x00src/functional/spawn.c:33: %s failed, got %d want %d\n\x00posix_spawn_file_actions_adddup2(&fa, p[1], 1)\x00src/functional/spawn.c:34: %s failed, got %d want %d\n\x00posix_spawn_file_actions_addclose(&fa, p[1])\x00echo\x00hello\x00src/functional/spawn.c:35: %s failed, got %d want %d\n\x00posix_spawnp(&pid, \"echo\", &fa, 0, (char *[]){\"echo\",\"hello\",0}, 0)\x00src/functional/spawn.c:37: %s failed, got %d want %d\n\x00waitpid(pid, &status, 0)\x00src/functional/spawn.c:38: %s failed, got %d want %d\n\x00read(p[0], foo, sizeof foo)\x00src/functional/spawn.c:40: %s failed, got %d want %d\n\x00posix_spawn_file_actions_destroy(&fa)\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
