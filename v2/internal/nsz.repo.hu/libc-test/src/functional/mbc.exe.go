// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/mbc.exe.go src/functional/mbc.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:23:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(208)
	defer tls.Free(208)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:24:1:
	var i, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v3, v30, v31, v32, v33, v34, v4, v5, v6, v7, v8, v9 int32
	var _ /* cs at bp+0 */ uintptr
	var _ /* st at bp+8 */ mbstate_t
	var _ /* st2 at bp+16 */ mbstate_t
	var _ /* wc at bp+24 */ wchar_t
	var _ /* wcs at bp+28 */ [32]wchar_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = i, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v3, v30, v31, v32, v33, v34, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:30:2:
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+12) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+24) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+33) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+45) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+59) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:39:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	*(*uintptr)(unsafe.Pointer(bp)) = __ccgo_ts + 60
	v1 = int32(libc.Xmbsrtowcs(tls, bp+28, bp, uint32(3), bp+8))
	i = v1
	_ = v1 == int32(3) || t_printf(tls, __ccgo_ts+67, libc.VaList(bp+168, __ccgo_ts+123, __ccgo_ts+165, i, int32(3))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:40:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	*(*uintptr)(unsafe.Pointer(bp)) = __ccgo_ts + 60
	v2 = int32(libc.Xmbsrtowcs(tls, bp+28, bp, uint32(8), bp+8))
	i = v2
	_ = v2 == int32(6) || t_printf(tls, __ccgo_ts+197, libc.VaList(bp+168, __ccgo_ts+253, __ccgo_ts+165, i, int32(6))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:41:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	*(*uintptr)(unsafe.Pointer(bp)) = __ccgo_ts + 60
	v3 = int32(libc.Xmbsrtowcs(tls, libc.UintptrFromInt32(0), bp, uint32(2), bp+8))
	i = v3
	_ = v3 == int32(6) || t_printf(tls, __ccgo_ts+295, libc.VaList(bp+168, __ccgo_ts+351, __ccgo_ts+394, i, int32(6))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:43:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+53) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:44:3:
		return t_printf(tls, __ccgo_ts+423, libc.VaList(bp+168, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:46:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v4 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+495, uint32(1), bp+8))
	i = v4
	_ = v4 == -int32(1) || t_printf(tls, __ccgo_ts+497, libc.VaList(bp+168, __ccgo_ts+553, __ccgo_ts+582, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:47:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v5 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+604, uint32(1), bp+8))
	i = v5
	_ = v5 == -int32(1) || t_printf(tls, __ccgo_ts+606, libc.VaList(bp+168, __ccgo_ts+662, __ccgo_ts+691, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:49:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v6 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+723, uint32(2), bp+8))
	i = v6
	_ = v6 == -int32(1) || t_printf(tls, __ccgo_ts+726, libc.VaList(bp+168, __ccgo_ts+782, __ccgo_ts+815, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:50:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v7 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+828, uint32(2), bp+8))
	i = v7
	_ = v7 == -int32(1) || t_printf(tls, __ccgo_ts+831, libc.VaList(bp+168, __ccgo_ts+887, __ccgo_ts+920, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:51:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v8 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+935, uint32(3), bp+8))
	i = v8
	_ = v8 == -int32(1) || t_printf(tls, __ccgo_ts+939, libc.VaList(bp+168, __ccgo_ts+995, __ccgo_ts+920, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:52:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v9 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1032, uint32(4), bp+8))
	i = v9
	_ = v9 == -int32(1) || t_printf(tls, __ccgo_ts+1037, libc.VaList(bp+168, __ccgo_ts+1093, __ccgo_ts+920, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:53:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v10 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1134, uint32(5), bp+8))
	i = v10
	_ = v10 == -int32(1) || t_printf(tls, __ccgo_ts+1140, libc.VaList(bp+168, __ccgo_ts+1196, __ccgo_ts+920, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:54:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v11 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1241, uint32(6), bp+8))
	i = v11
	_ = v11 == -int32(1) || t_printf(tls, __ccgo_ts+1248, libc.VaList(bp+168, __ccgo_ts+1304, __ccgo_ts+920, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:55:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v12 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1353, uint32(3), bp+8))
	i = v12
	_ = v12 == -int32(1) || t_printf(tls, __ccgo_ts+1357, libc.VaList(bp+168, __ccgo_ts+1413, __ccgo_ts+1450, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:56:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v13 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1466, uint32(3), bp+8))
	i = v13
	_ = v13 == -int32(1) || t_printf(tls, __ccgo_ts+1470, libc.VaList(bp+168, __ccgo_ts+1526, __ccgo_ts+1563, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:57:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v14 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1579, uint32(4), bp+8))
	i = v14
	_ = v14 == -int32(1) || t_printf(tls, __ccgo_ts+1584, libc.VaList(bp+168, __ccgo_ts+1640, __ccgo_ts+1681, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:58:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v15 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1697, uint32(4), bp+8))
	i = v15
	_ = v15 == -int32(1) || t_printf(tls, __ccgo_ts+1702, libc.VaList(bp+168, __ccgo_ts+1758, __ccgo_ts+1799, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:60:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v16 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1815, uint32(3), bp+8))
	i = v16
	_ = v16 == -int32(1) || t_printf(tls, __ccgo_ts+1819, libc.VaList(bp+168, __ccgo_ts+1875, __ccgo_ts+1912, i, -int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:61:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v17 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+1938, uint32(3), bp+8))
	i = v17
	_ = v17 == int32(3) || t_printf(tls, __ccgo_ts+1942, libc.VaList(bp+168, __ccgo_ts+1998, __ccgo_ts+2035, i, int32(3))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:62:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v18 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2059, uint32(3), bp+8))
	i = v18
	_ = v18 == int32(3) || t_printf(tls, __ccgo_ts+2063, libc.VaList(bp+168, __ccgo_ts+2119, __ccgo_ts+2156, i, int32(3))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:63:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v19 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2180, uint32(4), bp+8))
	i = v19
	_ = v19 == int32(4) || t_printf(tls, __ccgo_ts+2185, libc.VaList(bp+168, __ccgo_ts+2241, __ccgo_ts+2282, i, int32(4))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:64:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v20 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2308, uint32(4), bp+8))
	i = v20
	_ = v20 == int32(4) || t_printf(tls, __ccgo_ts+2313, libc.VaList(bp+168, __ccgo_ts+2369, __ccgo_ts+2410, i, int32(4))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:66:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v21 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2436, uint32(2), bp+8))
	i = v21
	_ = v21 == int32(2) || t_printf(tls, __ccgo_ts+2439, libc.VaList(bp+168, __ccgo_ts+2495, __ccgo_ts+2528, i, int32(2))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:67:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2436, uint32(2), bp+8)
	v22 = *(*wchar_t)(unsafe.Pointer(bp + 24))
	i = v22
	_ = v22 == int32(0x80) || t_printf(tls, __ccgo_ts+2541, libc.VaList(bp+168, __ccgo_ts+2605, __ccgo_ts+2643, i, int32(0x80))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:68:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v23 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2654, uint32(3), bp+8))
	i = v23
	_ = v23 == int32(3) || t_printf(tls, __ccgo_ts+2658, libc.VaList(bp+168, __ccgo_ts+2714, __ccgo_ts+2528, i, int32(3))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:69:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2654, uint32(3), bp+8)
	v24 = *(*wchar_t)(unsafe.Pointer(bp + 24))
	i = v24
	_ = v24 == int32(0x800) || t_printf(tls, __ccgo_ts+2751, libc.VaList(bp+168, __ccgo_ts+2815, __ccgo_ts+2643, i, int32(0x800))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:70:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v25 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2857, uint32(4), bp+8))
	i = v25
	_ = v25 == int32(4) || t_printf(tls, __ccgo_ts+2862, libc.VaList(bp+168, __ccgo_ts+2918, __ccgo_ts+2528, i, int32(4))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:71:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	libc.Xmbrtowc(tls, bp+24, __ccgo_ts+2857, uint32(4), bp+8)
	v26 = *(*wchar_t)(unsafe.Pointer(bp + 24))
	i = v26
	_ = v26 == int32(0x10000) || t_printf(tls, __ccgo_ts+2959, libc.VaList(bp+168, __ccgo_ts+3023, __ccgo_ts+2643, i, int32(0x10000))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:73:2:
	libc.Xmemset(tls, bp+16, 0, uint32(8))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:74:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v27 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+3069, uint32(1), bp+16))
	i = v27
	_ = v27 == -int32(2) || t_printf(tls, __ccgo_ts+3071, libc.VaList(bp+168, __ccgo_ts+3127, __ccgo_ts+3157, i, -int32(2))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:75:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v28 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+495, uint32(1), bp+16))
	i = v28
	_ = v28 == int32(1) || t_printf(tls, __ccgo_ts+3187, libc.VaList(bp+168, __ccgo_ts+3243, __ccgo_ts+3273, i, int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:76:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v29 = *(*wchar_t)(unsafe.Pointer(bp + 24))
	i = v29
	_ = v29 == int32(0x80) || t_printf(tls, __ccgo_ts+3290, libc.VaList(bp+168, __ccgo_ts+3354, __ccgo_ts+2643, i, int32(0x80))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:78:2:
	libc.Xmemset(tls, bp+16, 0, uint32(8))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:79:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v30 = int32(libc.Xmbrtowc(tls, bp+24, __ccgo_ts+3069, uint32(1), bp+16))
	i = v30
	_ = v30 == -int32(2) || t_printf(tls, __ccgo_ts+3357, libc.VaList(bp+168, __ccgo_ts+3127, __ccgo_ts+3157, i, -int32(2))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:80:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	*(*uintptr)(unsafe.Pointer(bp)) = __ccgo_ts + 3413
	v31 = int32(libc.Xmbsrtowcs(tls, bp+28, bp, uint32(32), bp+16))
	i = v31
	_ = v31 == int32(4) || t_printf(tls, __ccgo_ts+3418, libc.VaList(bp+168, __ccgo_ts+3474, __ccgo_ts+3273, i, int32(4))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:81:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v32 = (*(*[32]wchar_t)(unsafe.Pointer(bp + 28)))[0]
	i = v32
	_ = v32 == int32(0xa0) || t_printf(tls, __ccgo_ts+3521, libc.VaList(bp+168, __ccgo_ts+3585, __ccgo_ts+2643, i, int32(0xa0))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:82:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v33 = (*(*[32]wchar_t)(unsafe.Pointer(bp + 28)))[int32(1)]
	i = v33
	_ = v33 == int32('a') || t_printf(tls, __ccgo_ts+3592, libc.VaList(bp+168, __ccgo_ts+3656, __ccgo_ts+2643, i, int32('a'))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:83:2:
	libc.Xmemset(tls, bp+8, 0, uint32(8))
	v34 = libc.BoolInt32(!(*(*uintptr)(unsafe.Pointer(bp)) != 0))
	i = v34
	_ = v34 == int32(1) || t_printf(tls, __ccgo_ts+3663, libc.VaList(bp+168, __ccgo_ts+3719, __ccgo_ts+3723, i, int32(1))) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/mbc.c:84:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+3744, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+3754, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3845, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3850, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3857, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3875, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3883, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3888, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3931, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+45) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+33) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+12) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+24) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+53) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+59) != 0
	...
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+53) != 0 {
		...
		return t_printf(tls, __ccgo_ts+3980, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00POSIX.UTF-8\x00C.UTF-8\x00UTF-8\x00\x00abcdef\x00src/functional/mbc.c:39: %s failed (%s) got %d want %d\n\x00mbsrtowcs(wcs, (cs=\"abcdef\",&cs), 3, &st)\x00wrong semantics for wcs buf len\x00src/functional/mbc.c:40: %s failed (%s) got %d want %d\n\x00mbsrtowcs(wcs, (cs=\"abcdef\",&cs), 8, &st)\x00src/functional/mbc.c:41: %s failed (%s) got %d want %d\n\x00mbsrtowcs(NULL, (cs=\"abcdef\",&cs), 2, &st)\x00wrong semantics for NULL wcs\x00src/functional/mbc.c:44: cannot set UTF-8 locale for test (codeset=%s)\n\x00\x80\x00src/functional/mbc.c:46: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\x80\", 1, &st)\x00failed to catch error\x00\xc0\x00src/functional/mbc.c:47: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xc0\", 1, &st)\x00failed to catch illegal initial\x00\xc0\x80\x00src/functional/mbc.c:49: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xc0\\x80\", 2, &st)\x00aliasing nul\x00\xc0\xaf\x00src/functional/mbc.c:50: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xc0\\xaf\", 2, &st)\x00aliasing slash\x00\xe0\x80\xaf\x00src/functional/mbc.c:51: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xe0\\x80\\xaf\", 3, &st)\x00\xf0\x80\x80\xaf\x00src/functional/mbc.c:52: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf0\\x80\\x80\\xaf\", 4, &st)\x00\xf8\x80\x80\x80\xaf\x00src/functional/mbc.c:53: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf8\\x80\\x80\\x80\\xaf\", 5, &st)\x00\xfc\x80\x80\x80\x80\xaf\x00src/functional/mbc.c:54: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xfc\\x80\\x80\\x80\\x80\\xaf\", 6, &st)\x00\xe0\x82\x80\x00src/functional/mbc.c:55: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xe0\\x82\\x80\", 3, &st)\x00aliasing U+0080\x00\xe0\x9f\xbf\x00src/functional/mbc.c:56: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xe0\\x9f\\xbf\", 3, &st)\x00aliasing U+07FF\x00\xf0\x80\xa0\x80\x00src/functional/mbc.c:57: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf0\\x80\\xa0\\x80\", 4, &st)\x00aliasing U+0800\x00\xf0\x8f\xbf\xbd\x00src/functional/mbc.c:58: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf0\\x8f\\xbf\\xbd\", 4, &st)\x00aliasing U+FFFD\x00\xed\xa0\x80\x00src/functional/mbc.c:60: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xed\\xa0\\x80\", 3, &st)\x00failed to catch surrogate\x00\ufffe\x00src/functional/mbc.c:61: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xef\\xbf\\xbe\", 3, &st)\x00failed to accept U+FFFE\x00\uffff\x00src/functional/mbc.c:62: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xef\\xbf\\xbf\", 3, &st)\x00failed to accept U+FFFF\x00\U0010fffe\x00src/functional/mbc.c:63: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf4\\x8f\\xbf\\xbe\", 4, &st)\x00failed to accept U+10FFFE\x00\U0010ffff\x00src/functional/mbc.c:64: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf4\\x8f\\xbf\\xbf\", 4, &st)\x00failed to accept U+10FFFF\x00\u0080\x00src/functional/mbc.c:66: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xc2\\x80\", 2, &st)\x00wrong length\x00src/functional/mbc.c:67: %s failed (%s) got 0x%04x want 0x%04x\n\x00(mbrtowc(&wc, \"\\xc2\\x80\", 2, &st),wc)\x00wrong char\x00ࠀ\x00src/functional/mbc.c:68: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xe0\\xa0\\x80\", 3, &st)\x00src/functional/mbc.c:69: %s failed (%s) got 0x%04x want 0x%04x\n\x00(mbrtowc(&wc, \"\\xe0\\xa0\\x80\", 3, &st),wc)\x00𐀀\x00src/functional/mbc.c:70: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xf0\\x90\\x80\\x80\", 4, &st)\x00src/functional/mbc.c:71: %s failed (%s) got 0x%04x want 0x%04x\n\x00(mbrtowc(&wc, \"\\xf0\\x90\\x80\\x80\", 4, &st),wc)\x00\xc2\x00src/functional/mbc.c:74: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\xc2\", 1, &st2)\x00failed to accept initial byte\x00src/functional/mbc.c:75: %s failed (%s) got %d want %d\n\x00mbrtowc(&wc, \"\\x80\", 1, &st2)\x00failed to resume\x00src/functional/mbc.c:76: %s failed (%s) got 0x%04x want 0x%04x\n\x00wc\x00src/functional/mbc.c:79: %s failed (%s) got %d want %d\n\x00\xa0abc\x00src/functional/mbc.c:80: %s failed (%s) got %d want %d\n\x00mbsrtowcs(wcs, (cs=\"\\xa0\"\"abc\",&cs), 32, &st2)\x00src/functional/mbc.c:81: %s failed (%s) got 0x%04x want 0x%04x\n\x00wcs[0]\x00src/functional/mbc.c:82: %s failed (%s) got 0x%04x want 0x%04x\n\x00wcs[1]\x00src/functional/mbc.c:83: %s failed (%s) got %d want %d\n\x00!cs\x00wrong final position\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
