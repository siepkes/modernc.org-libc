// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/ungetc.exe.go src/functional/ungetc.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:16:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(144)
	defer tls.Free(144)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:17:1:
	var f, v2 uintptr
	var i, v1, v10, v12, v14, v16, v18, v20, v22, v24, v26, v28, v30, v33, v35, v37, v39, v4, v41, v6, v8 int32
	var v11, v13, v15, v17, v19, v21, v23, v25, v27, v29, v3, v31, v32, v34, v36, v38, v40, v42, v5, v7, v9 bool
	var _ /* a at bp+0 */ [100]int8
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = f, i, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v3, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v4, v40, v41, v42, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:22:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	...
	i = v1
	if v3 = v1 == 0; !v3 {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+112, __ccgo_ts+80, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:24:2:
	if !(f != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:24:10:
		return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:26:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v4 = libc.Xfprintf(tls, f, __ccgo_ts+97, 0)
	i = v4
	if v5 = v4 == int32(13); !v5 {
		t_printf(tls, __ccgo_ts+111, libc.VaList(bp+112, __ccgo_ts+166, i, int32(13), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v5 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:27:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v6 = libc.Xfseek(tls, f, 0, SEEK_SET)
	i = v6
	if v7 = v6 == 0; !v7 {
		t_printf(tls, __ccgo_ts+195, libc.VaList(bp+112, __ccgo_ts+250, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v7 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:29:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v8 = libc.Xfeof(tls, f)
	i = v8
	if v9 = v8 == 0; !v9 {
		t_printf(tls, __ccgo_ts+272, libc.VaList(bp+112, __ccgo_ts+322, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:30:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v10 = libc.Xfgetc(tls, f)
	i = v10
	if v11 = v10 == int32('h'); !v11 {
		t_printf(tls, __ccgo_ts+330, libc.VaList(bp+112, __ccgo_ts+384, i, int32('h'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:31:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v12 = libc.Xftell(tls, f)
	i = v12
	if v13 = v12 == int32(1); !v13 {
		t_printf(tls, __ccgo_ts+393, libc.VaList(bp+112, __ccgo_ts+443, i, int32(1), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:32:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v14 = libc.Xungetc(tls, int32('x'), f)
	i = v14
	if v15 = v14 == int32('x'); !v15 {
		t_printf(tls, __ccgo_ts+452, libc.VaList(bp+112, __ccgo_ts+502, i, int32('x'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v15 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:33:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v16 = libc.Xftell(tls, f)
	i = v16
	if v17 = v16 == 0; !v17 {
		t_printf(tls, __ccgo_ts+517, libc.VaList(bp+112, __ccgo_ts+443, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v17 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:34:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v18 = libc.Xfscanf(tls, f, __ccgo_ts+567, libc.VaList(bp+112, bp))
	i = v18
	if v19 = v18 == 0; !v19 {
		t_printf(tls, __ccgo_ts+572, libc.VaList(bp+112, __ccgo_ts+640, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v19 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:35:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v20 = libc.Xftell(tls, f)
	i = v20
	if v21 = v20 == 0; !v21 {
		t_printf(tls, __ccgo_ts+661, libc.VaList(bp+112, __ccgo_ts+443, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v21 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:36:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v22 = libc.Xfgetc(tls, f)
	i = v22
	if v23 = v22 == int32('x'); !v23 {
		t_printf(tls, __ccgo_ts+711, libc.VaList(bp+112, __ccgo_ts+384, i, int32('x'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v23 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:37:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v24 = libc.Xftell(tls, f)
	i = v24
	if v25 = v24 == int32(1); !v25 {
		t_printf(tls, __ccgo_ts+765, libc.VaList(bp+112, __ccgo_ts+443, i, int32(1), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v25 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:39:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v26 = libc.Xfseek(tls, f, 0, SEEK_SET)
	i = v26
	if v27 = v26 == 0; !v27 {
		t_printf(tls, __ccgo_ts+815, libc.VaList(bp+112, __ccgo_ts+250, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v27 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:40:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v28 = libc.Xungetc(tls, int32('x'), f)
	i = v28
	if v29 = v28 == int32('x'); !v29 {
		t_printf(tls, __ccgo_ts+865, libc.VaList(bp+112, __ccgo_ts+502, i, int32('x'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v29 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:41:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v30 = int32(libc.Xfread(tls, bp, uint32(1), uint32(100), f))
	i = v30
	if v31 = v30 == int32(14); !v31 {
		t_printf(tls, __ccgo_ts+915, libc.VaList(bp+112, __ccgo_ts+977, i, int32(14), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v31 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:42:2:
	(*(*[100]int8)(unsafe.Pointer(bp)))[int32(14)] = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:43:2:
	if v32 = !(libc.Xstrcmp(tls, bp, __ccgo_ts+1002) != 0); !v32 {
		t_printf(tls, __ccgo_ts+1017, libc.VaList(bp+112, bp, __ccgo_ts+1002, __ccgo_ts+1064))
	}
	_ = v32 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:45:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v33 = libc.Xfseek(tls, f, 0, SEEK_SET)
	i = v33
	if v34 = v33 == 0; !v34 {
		t_printf(tls, __ccgo_ts+1097, libc.VaList(bp+112, __ccgo_ts+250, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v34 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:46:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v35 = libc.Xfscanf(tls, f, __ccgo_ts+1147, libc.VaList(bp+112, bp))
	i = v35
	if v36 = v35 == 0; !v36 {
		t_printf(tls, __ccgo_ts+1152, libc.VaList(bp+112, __ccgo_ts+1220, i, 0, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v36 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:47:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v37 = libc.Xungetc(tls, int32('x'), f)
	i = v37
	if v38 = v37 == int32('x'); !v38 {
		t_printf(tls, __ccgo_ts+1241, libc.VaList(bp+112, __ccgo_ts+502, i, int32('x'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v38 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:48:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v39 = libc.Xfgetc(tls, f)
	i = v39
	if v40 = v39 == int32('x'); !v40 {
		t_printf(tls, __ccgo_ts+1318, libc.VaList(bp+112, __ccgo_ts+384, i, int32('x'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v40 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:49:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v41 = libc.Xfgetc(tls, f)
	i = v41
	if v42 = v41 == int32('h'); !v42 {
		t_printf(tls, __ccgo_ts+1372, libc.VaList(bp+112, __ccgo_ts+384, i, int32('h'), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v42 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:51:2:
	libc.Xfclose(tls, f)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ungetc.c:52:2:
	return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1426, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1436, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1528, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1533, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1540, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1558, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1566, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1571, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1614, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1663) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1671) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1683) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1695) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1707) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1716) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1527) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1716) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1722, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/ungetc.c:22: %s failed (failed to create temp file %d!=%d (%s))\n\x00!(f = tmpfile())\x00hello, world\n\x00src/functional/ungetc.c:26: %s failed (%d != %d (%m))\n\x00fprintf(f, \"hello, world\\n\")\x00src/functional/ungetc.c:27: %s failed (%d != %d (%m))\n\x00fseek(f, 0, SEEK_SET)\x00src/functional/ungetc.c:29: %s failed (%d != %d)\n\x00feof(f)\x00src/functional/ungetc.c:30: %s failed ('%c' != '%c')\n\x00fgetc(f)\x00src/functional/ungetc.c:31: %s failed (%d != %d)\n\x00ftell(f)\x00src/functional/ungetc.c:32: %s failed (%d != %d)\n\x00ungetc('x', f)\x00src/functional/ungetc.c:33: %s failed (%d != %d)\n\x00%[h]\x00src/functional/ungetc.c:34: %s failed (got %d fields, expected %d)\n\x00fscanf(f, \"%[h]\", a)\x00src/functional/ungetc.c:35: %s failed (%d != %d)\n\x00src/functional/ungetc.c:36: %s failed ('%c' != '%c')\n\x00src/functional/ungetc.c:37: %s failed (%d != %d)\n\x00src/functional/ungetc.c:39: %s failed (%d != %d)\n\x00src/functional/ungetc.c:40: %s failed (%d != %d)\n\x00src/functional/ungetc.c:41: %s failed (read %d, expected %d)\n\x00fread(a, 1, sizeof a, f)\x00xhello, world\n\x00src/functional/ungetc.c:43: [%s] != [%s] (%s)\n\x00mismatch reading ungot character\x00src/functional/ungetc.c:45: %s failed (%d != %d)\n\x00%[x]\x00src/functional/ungetc.c:46: %s failed (got %d fields, expected %d)\n\x00fscanf(f, \"%[x]\", a)\x00src/functional/ungetc.c:47: %s failed (unget failed after fscanf: %d != %d)\n\x00src/functional/ungetc.c:48: %s failed ('%c' != '%c')\n\x00src/functional/ungetc.c:49: %s failed ('%c' != '%c')\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
