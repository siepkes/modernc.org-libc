// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/pthread_cancel-points.exe.go src/functional/pthread_cancel-points.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:1:9:
const O_CREAT = 64

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/fcntl.h:46:9:
const O_RDWR = 2

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/pthread.h:65:9:
const PTHREAD_CANCEL_DISABLE = 1

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/pthread.h:64:9:
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:17:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:17:14:
var sem_seq sem_t

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:17:23:
var sem_test sem_t

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:19:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:19:12:
var seqno int32

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:21:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:21:19:
var cdescr = __ccgo_ts

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:23:13:
func prepare_sem(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:24:1:
	var r, v1 int32
	_, _ = r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:25:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:25:2:
	v1 = libc.Xsem_init(tls, uintptr(unsafe.Pointer(&sem_test)), 0, uint32(int32(arg)))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:25:2:
		t_printf(tls, __ccgo_ts+22, libc.VaList(bp+8, libc.Xstrerror(tls, r), cdescr))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:28:13:
func cleanup_sem(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:29:1:
	var r, v1 int32
	_, _ = r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:30:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:30:2:
	v1 = libc.Xsem_destroy(tls, uintptr(unsafe.Pointer(&sem_test)))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:30:2:
		t_printf(tls, __ccgo_ts+136, libc.VaList(bp+8, libc.Xstrerror(tls, r), cdescr))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:33:13:
func execute_sem_wait(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:34:1:
	var r, v1 int32
	_, _ = r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:35:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:35:2:
	v1 = libc.Xsem_wait(tls, uintptr(unsafe.Pointer(&sem_test)))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:35:2:
		t_printf(tls, __ccgo_ts+241, libc.VaList(bp+8, libc.Xstrerror(tls, r), cdescr))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:38:13:
func execute_sem_timedwait(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:39:1:
	var r, v1 int32
	var _ /* ts at bp+0 */ timespec
	_, _ = r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:41:2:
	libc.Xclock_gettime(tls, CLOCK_REALTIME, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:42:2:
	(*(*timespec)(unsafe.Pointer(bp))).Ftv_sec += int64(1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:43:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:43:2:
	v1 = libc.Xsem_timedwait(tls, uintptr(unsafe.Pointer(&sem_test)), bp)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:43:2:
		t_printf(tls, __ccgo_ts+366, libc.VaList(bp+24, libc.Xstrerror(tls, r), cdescr))
	}
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:46:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:46:18:
var td_test pthread_t

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:48:13:
func run_test(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:49:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:50:2:
	for libc.Xsem_wait(tls, uintptr(unsafe.Pointer(&sem_test))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:50:29:
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:51:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:54:13:
func prepare_thread(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:55:1:
	var r, v1 int32
	_, _ = r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:56:2:
	prepare_sem(tls, arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:57:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:57:2:
	v1 = pthread_create(tls, uintptr(unsafe.Pointer(&td_test)), uintptr(0), __ccgo_fp(run_test), uintptr(0))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:57:2:
		t_printf(tls, __ccgo_ts+507, libc.VaList(bp+8, libc.Xstrerror(tls, r), cdescr))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:60:13:
func cleanup_thread(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:61:1:
	var r, r1, v1, v2 int32
	var v3 bool
	var _ /* res at bp+0 */ uintptr
	_, _, _, _, _ = r, r1, v1, v2, v3
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:63:2:
	if td_test != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:64:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:64:3:
		v1 = libc.Xsem_post(tls, uintptr(unsafe.Pointer(&sem_test)))
		r = v1
		if v1 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:64:3:
			t_printf(tls, __ccgo_ts+635, libc.VaList(bp+16, libc.Xstrerror(tls, r), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:65:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:65:3:
		v2 = pthread_join(tls, td_test, bp)
		r1 = v2
		if v2 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:65:3:
			t_printf(tls, __ccgo_ts+734, libc.VaList(bp+16, libc.Xstrerror(tls, r1), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:66:3:
		if v3 = *(*uintptr)(unsafe.Pointer(bp)) == uintptr(0); !v3 {
			t_printf(tls, __ccgo_ts+848, libc.VaList(bp+16, cdescr))
		}
		_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:68:2:
	cleanup_sem(tls, arg)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:71:13:
func execute_thread_join(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:72:1:
	var r, v1 int32
	_, _ = r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:73:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:73:2:
	v1 = pthread_join(tls, td_test, uintptr(0))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:73:2:
		t_printf(tls, __ccgo_ts+943, libc.VaList(bp+8, libc.Xstrerror(tls, r), cdescr))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:74:2:
	td_test = uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:77:13:
func prepare_dummy(tls *libc.TLS, arg uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:78:1:
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:81:13:
func execute_shm_open(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:82:1:
	var fd uintptr
	var v1 int32
	_, _ = fd, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:83:6:
	fd = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:84:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:84:2:
	v1 = libc.Xshm_open(tls, __ccgo_ts+1060, libc.Int32FromInt32(O_RDWR)|libc.Int32FromInt32(O_CREAT), uint32(0666))
	*(*int32)(unsafe.Pointer(fd)) = v1
	if v1 == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:84:2:
		t_printf(tls, __ccgo_ts+1069, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))), cdescr))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:87:13:
func cleanup_shm(tls *libc.TLS, arg uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:88:1:
	var fd uintptr
	_ = fd
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:89:6:
	fd = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:90:2:
	if *(*int32)(unsafe.Pointer(fd)) > 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:91:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:91:3:
		if libc.Xclose(tls, *(*int32)(unsafe.Pointer(fd))) == -int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:91:3:
			t_printf(tls, __ccgo_ts+1180, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:92:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:92:3:
		if libc.Xshm_unlink(tls, __ccgo_ts+1060) == -int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:92:3:
			t_printf(tls, __ccgo_ts+1259, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))), cdescr))
		}
	}
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:96:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:103:3:
var scenarios = [8]struct {
	Fwant_cancel int32
	Fprepare     uintptr
	Fexecute     uintptr
	Fcleanup     uintptr
	...
	0: {
		Fwant_cancel: int32(1),
		Fprepare:     uintptr(0),
		Fexecute:     uintptr(0),
		Fcleanup:     uintptr(0),
		Farg:         uintptr(0),
		Fdescr:       __ccgo_ts + 1344,
	},
	1: {
		Fwant_cancel: int32(1),
		Fprepare:     uintptr(0),
		Fexecute:     uintptr(0),
		Fcleanup:     uintptr(0),
		Farg:         libc.UintptrFromInt32(1),
		Fdescr:       __ccgo_ts + 1362,
	},
	2: {
		Fwant_cancel: int32(1),
		Fprepare:     uintptr(0),
	...
	5: {
		...
		Fcleanup:     uintptr(0),
		Farg:         libc.UintptrFromInt32(1),
		Fdescr:       __ccgo_ts + 1456,
	},
	6: {
		Fwant_cancel: int32(0),
		Fprepare:     uintptr(0),
		Fexecute:     uintptr(0),
		Fcleanup:     uintptr(0),
		Farg:         uintptr(unsafe.Pointer(&int32(0))),
		Fdescr:       __ccgo_ts + 1482,
	},
	7: {},
}

func init() {
	p := unsafe.Pointer(&scenarios)
	*(*uintptr)(unsafe.Add(p, 4)) = __ccgo_fp(prepare_sem)
	*(*uintptr)(unsafe.Add(p, 8)) = __ccgo_fp(execute_sem_wait)
	*(*uintptr)(unsafe.Add(p, 12)) = __ccgo_fp(cleanup_sem)
	*(*uintptr)(unsafe.Add(p, 28)) = __ccgo_fp(prepare_sem)
	*(*uintptr)(unsafe.Add(p, 32)) = __ccgo_fp(execute_sem_wait)
	*(*uintptr)(unsafe.Add(p, 36)) = __ccgo_fp(cleanup_sem)
	*(*uintptr)(unsafe.Add(p, 52)) = __ccgo_fp(prepare_sem)
	*(*uintptr)(unsafe.Add(p, 56)) = __ccgo_fp(execute_sem_timedwait)
	*(*uintptr)(unsafe.Add(p, 60)) = __ccgo_fp(cleanup_sem)
	*(*uintptr)(unsafe.Add(p, 76)) = __ccgo_fp(prepare_sem)
	*(*uintptr)(unsafe.Add(p, 80)) = __ccgo_fp(execute_sem_timedwait)
	*(*uintptr)(unsafe.Add(p, 84)) = __ccgo_fp(cleanup_sem)
	*(*uintptr)(unsafe.Add(p, 100)) = __ccgo_fp(prepare_thread)
	*(*uintptr)(unsafe.Add(p, 104)) = __ccgo_fp(execute_thread_join)
	*(*uintptr)(unsafe.Add(p, 108)) = __ccgo_fp(cleanup_thread)
	*(*uintptr)(unsafe.Add(p, 124)) = __ccgo_fp(prepare_thread)
	*(*uintptr)(unsafe.Add(p, 128)) = __ccgo_fp(execute_thread_join)
	*(*uintptr)(unsafe.Add(p, 132)) = __ccgo_fp(cleanup_thread)
	*(*uintptr)(unsafe.Add(p, 148)) = __ccgo_fp(prepare_dummy)
	*(*uintptr)(unsafe.Add(p, 152)) = __ccgo_fp(execute_shm_open)
	*(*uintptr)(unsafe.Add(p, 156)) = __ccgo_fp(cleanup_shm)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:112:4:
var cur_sc = uintptr(unsafe.Pointer(&scenarios))

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:114:13:
func run_execute(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:115:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:116:2:
	pthread_setcancelstate(tls, int32(PTHREAD_CANCEL_DISABLE), uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:117:2:
	for libc.Xsem_wait(tls, uintptr(unsafe.Pointer(&sem_seq))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:117:28:
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:118:2:
	pthread_setcancelstate(tls, PTHREAD_CANCEL_ENABLE, uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:119:2:
	seqno = int32(1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:120:2:
	(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*struct {
		Fwant_cancel int32
		Fprepare     uintptr
		Fexecute     uintptr
		Fcleanup     uintptr
		Farg         uintptr
		Fdescr       uintptr
	})(unsafe.Pointer(cur_sc)).Fexecute})))(tls, (*struct {
		Fwant_cancel int32
		Fprepare     uintptr
		Fexecute     uintptr
		Fcleanup     uintptr
		Farg         uintptr
		Fdescr       uintptr
	})(unsafe.Pointer(cur_sc)).Farg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:121:2:
	seqno = int32(2)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:122:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:125:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r5 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:126:1:
	var r, r1, r2, r3, r4, v1, v3, v4, v5, v6 int32
	var v10, v11, v12, v7, v8, v9 bool
	var _ /* res at bp+4 */ uintptr
	var _ /* td at bp+0 */ pthread_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = r, r1, r2, r3, r4, v1, v10, v11, v12, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:127:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:127:2:
	v1 = libc.Xsem_init(tls, uintptr(unsafe.Pointer(&sem_seq)), 0, uint32(0))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:127:2:
		t_printf(tls, __ccgo_ts+1491, libc.VaList(bp+16, libc.Xstrerror(tls, r), cdescr))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:129:2:
	for {
		if !((*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			...
			Farg         uintptr
			Fdescr       uintptr
		})(unsafe.Pointer(cur_sc)).Fprepare != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:133:3:
		cdescr = (*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			Fexecute     uintptr
			...
			Farg         uintptr
			Fdescr       uintptr
		})(unsafe.Pointer(cur_sc)).Fdescr
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:134:3:
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			Fexecute     uintptr
			...
			Farg         uintptr
			Fdescr       uintptr
		})(unsafe.Pointer(cur_sc)).Fprepare})))(tls, (*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			Fexecute     uintptr
			Fcleanup     uintptr
		...
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:135:3:
		seqno = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:136:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:136:3:
		v3 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(run_execute), uintptr(0))
		r1 = v3
		if v3 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:136:3:
			t_printf(tls, __ccgo_ts+1597, libc.VaList(bp+16, libc.Xstrerror(tls, r1), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:137:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:137:3:
		v4 = pthread_cancel(tls, *(*pthread_t)(unsafe.Pointer(bp)))
		r2 = v4
		if v4 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:137:3:
			t_printf(tls, __ccgo_ts+1729, libc.VaList(bp+16, libc.Xstrerror(tls, r2), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:138:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:138:3:
		v5 = libc.Xsem_post(tls, uintptr(unsafe.Pointer(&sem_seq)))
		r3 = v5
		if v5 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:138:3:
			t_printf(tls, __ccgo_ts+1820, libc.VaList(bp+16, libc.Xstrerror(tls, r3), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:139:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:139:3:
		v6 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+4)
		r4 = v6
		if v6 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:139:3:
			t_printf(tls, __ccgo_ts+1928, libc.VaList(bp+16, libc.Xstrerror(tls, r4), cdescr))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:140:3:
		if (*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			Fexecute     uintptr
			...
			Farg         uintptr
			Fdescr       uintptr
		})(unsafe.Pointer(cur_sc)).Fwant_cancel != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:141:4:
			if v7 = *(*uintptr)(unsafe.Pointer(bp + 4)) == uintptr(-libc.Int32FromInt32(1)); !v7 {
				t_printf(tls, __ccgo_ts+2037, libc.VaList(bp+16, cdescr))
			}
			if v9 = v7 || libc.Bool(libc.Int32FromInt32(0) != 0); v9 {
				if v8 = seqno == int32(1); !v8 {
					t_printf(tls, __ccgo_ts+2147, libc.VaList(bp+16, cdescr))
				}
			}
			_ = v9 && (v8 || libc.Bool(libc.Int32FromInt32(0) != 0))
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:144:4:
			if v10 = *(*uintptr)(unsafe.Pointer(bp + 4)) != uintptr(-libc.Int32FromInt32(1)); !v10 {
				t_printf(tls, __ccgo_ts+2222, libc.VaList(bp+16, cdescr))
			}
			if v12 = v10 || libc.Bool(libc.Int32FromInt32(0) != 0); v12 {
				if v11 = seqno == int32(2); !v11 {
					t_printf(tls, __ccgo_ts+2332, libc.VaList(bp+16, cdescr))
				}
			}
			_ = v12 && (v11 || libc.Bool(libc.Int32FromInt32(0) != 0))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:147:3:
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			Fexecute     uintptr
			...
			Farg         uintptr
			Fdescr       uintptr
		})(unsafe.Pointer(cur_sc)).Fcleanup})))(tls, (*struct {
			Fwant_cancel int32
			Fprepare     uintptr
			Fexecute     uintptr
			Fcleanup     uintptr
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel-points.c:150:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+2407, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+2417, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2509, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2514, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2521, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2539, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2547, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2552, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2595, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2644) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2652) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2664) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2676) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2688) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2697) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2508) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2697) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2703, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "global initialization\x00src/functional/pthread_cancel-points.c:25: sem_init(&sem_test, 0, (long)arg) failed: %s (%s, creating semaphore)\n\x00src/functional/pthread_cancel-points.c:30: sem_destroy(&sem_test) failed: %s (%s, destroying semaphore)\n\x00src/functional/pthread_cancel-points.c:35: sem_wait(&sem_test) failed: %s (%s, waiting on semaphore in the canceled thread)\n\x00src/functional/pthread_cancel-points.c:43: sem_timedwait(&sem_test, &ts) failed: %s (%s, timed-waiting on semaphore in the canceled thread)\n\x00src/functional/pthread_cancel-points.c:57: pthread_create(&td_test, 0, run_test, 0) failed: %s (%s, creating auxiliary thread)\n\x00src/functional/pthread_cancel-points.c:64: sem_post(&sem_test) failed: %s (%s, posting semaphore)\n\x00src/functional/pthread_cancel-points.c:65: pthread_join(td_test, &res) failed: %s (%s, joining auxiliary thread)\n\x00src/functional/pthread_cancel-points.c:66: res == 0 failed (%s, auxiliary thread exit status)\n\x00src/functional/pthread_cancel-points.c:73: pthread_join(td_test, 0) failed: %s (%s, joining in the canceled thread)\n\x00/testshm\x00src/functional/pthread_cancel-points.c:84: *fd = shm_open(\"/testshm\", O_RDWR|O_CREAT, 0666) failed: %s (%s, )\n\x00src/functional/pthread_cancel-points.c:91: close(*fd) failed: %s (%s, shm fd)\n\x00src/functional/pthread_cancel-points.c:92: shm_unlink(\"/testshm\") failed: %s (%s, )\n\x00blocking sem_wait\x00non-blocking sem_wait\x00blocking sem_timedwait\x00non-blocking sem_timedwait\x00blocking pthread_join\x00non-blocking pthread_join\x00shm_open\x00src/functional/pthread_cancel-points.c:127: sem_init(&sem_seq, 0, 0) failed: %s (%s, creating semaphore)\n\x00src/functional/pthread_cancel-points.c:136: pthread_create(&td, 0, run_execute, 0) failed: %s (%s, creating thread to be canceled)\n\x00src/functional/pthread_cancel-points.c:137: pthread_cancel(td) failed: %s (%s, canceling)\n\x00src/functional/pthread_cancel-points.c:138: sem_post(&sem_seq) failed: %s (%s, unblocking canceled thread)\n\x00src/functional/pthread_cancel-points.c:139: pthread_join(td, &res) failed: %s (%s, joining canceled thread)\n\x00src/functional/pthread_cancel-points.c:141: res == PTHREAD_CANCELED failed (%s, canceled thread exit status)\n\x00src/functional/pthread_cancel-points.c:142: seqno == 1 failed (%s, seqno)\n\x00src/functional/pthread_cancel-points.c:144: res != PTHREAD_CANCELED failed (%s, canceled thread exit status)\n\x00src/functional/pthread_cancel-points.c:145: seqno == 2 failed (%s, seqno)\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
