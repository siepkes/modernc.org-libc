// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/pthread_mutex.exe.go src/functional/pthread_mutex.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:12:13:
func relock(tls *libc.TLS, arg uintptr) (r1 uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:13:1:
	var a uintptr
	var r, v1, v2, v3 int32
	_, _, _, _, _ = a, r, v1, v2, v3
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:14:7:
	a = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:17:2:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:18:2:
	if libc.Xsem_post(tls, *(*uintptr)(unsafe.Pointer(a + 1*4))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:18:2:
		t_printf(tls, __ccgo_ts+72, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:19:2:
	*(*int32)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(a + 2*4)))) = pthread_mutex_lock(tls, *(*uintptr)(unsafe.Pointer(a)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:20:2:
	if libc.Xsem_post(tls, *(*uintptr)(unsafe.Pointer(a + 1*4))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:20:2:
		t_printf(tls, __ccgo_ts+134, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:22:2:
	v2 = pthread_mutex_unlock(tls, *(*uintptr)(unsafe.Pointer(a)))
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:22:2:
		t_printf(tls, __ccgo_ts+196, libc.VaList(bp+8, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:23:2:
	if *(*int32)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(a + 2*4)))) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:24:3:
		v3 = pthread_mutex_unlock(tls, *(*uintptr)(unsafe.Pointer(a)))
		r = v3
		if v3 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:24:3:
			t_printf(tls, __ccgo_ts+270, libc.VaList(bp+8, libc.Xstrerror(tls, r)))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:25:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:28:12:
func test_relock(tls *libc.TLS, mtype int32) (r1 int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:29:1:
	var r, v1, v2, v3, v4, v5, v6, v7 int32
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:38:7:
	*(*[3]uintptr)(unsafe.Pointer(bp + 72)) = [3]uintptr{
		0: bp + 20,
		1: bp + 48,
		2: bp + 64,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:40:2:
	v1 = pthread_mutexattr_init(tls, bp+44)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:40:2:
		t_printf(tls, __ccgo_ts+344, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:41:2:
	v2 = pthread_mutexattr_settype(tls, bp+44, mtype)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:41:2:
		t_printf(tls, __ccgo_ts+419, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:42:2:
	v3 = pthread_mutex_init(tls, (*(*[3]uintptr)(unsafe.Pointer(bp + 72)))[0], bp+44)
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:42:2:
		t_printf(tls, __ccgo_ts+504, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:43:2:
	v4 = pthread_mutexattr_destroy(tls, bp+44)
	r = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:43:2:
		t_printf(tls, __ccgo_ts+581, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:44:2:
	if libc.Xsem_init(tls, (*(*[3]uintptr)(unsafe.Pointer(bp + 72)))[int32(1)], 0, uint32(0)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:44:2:
		t_printf(tls, __ccgo_ts+659, libc.VaList(bp+96, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:45:2:
	v5 = pthread_create(tls, bp+16, uintptr(0), __ccgo_fp(relock), bp+72)
	r = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:45:2:
		t_printf(tls, __ccgo_ts+727, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:46:2:
	if libc.Xsem_wait(tls, (*(*[3]uintptr)(unsafe.Pointer(bp + 72)))[int32(1)]) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:46:2:
		t_printf(tls, __ccgo_ts+807, libc.VaList(bp+96, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:47:2:
	if libc.Xclock_gettime(tls, CLOCK_REALTIME, bp) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:47:2:
		t_printf(tls, __ccgo_ts+869, libc.VaList(bp+96, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:48:2:
	(*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec += libc.Int32FromInt32(100) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:49:2:
	if (*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec >= libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:50:3:
		(*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec -= libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:51:3:
		(*(*timespec)(unsafe.Pointer(bp))).Ftv_sec += int64(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:53:2:
	r = libc.Xsem_timedwait(tls, (*(*[3]uintptr)(unsafe.Pointer(bp + 72)))[int32(1)], bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:54:2:
	if r == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:55:3:
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(ETIMEDOUT) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:56:4:
			t_printf(tls, __ccgo_ts+951, libc.VaList(bp+96, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		/* leave the deadlocked relock thread running */
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:58:3:
		return -int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:60:2:
	v6 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp + 16)), bp+68)
	r = v6
	if v6 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:60:2:
		t_printf(tls, __ccgo_ts+1034, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:61:2:
	v7 = pthread_mutex_destroy(tls, (*(*[3]uintptr)(unsafe.Pointer(bp + 72)))[0])
	r = v7
	if v7 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:61:2:
		t_printf(tls, __ccgo_ts+1101, libc.VaList(bp+96, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:62:2:
	if libc.Xsem_destroy(tls, (*(*[3]uintptr)(unsafe.Pointer(bp + 72)))[int32(1)]) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:62:2:
		t_printf(tls, __ccgo_ts+1176, libc.VaList(bp+96, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:63:2:
	return *(*int32)(unsafe.Pointer(bp + 64))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:66:13:
func unlock(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:67:1:
	var a uintptr
	_ = a
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:68:7:
	a = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:70:2:
	*(*int32)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(a + 1*4)))) = pthread_mutex_unlock(tls, *(*uintptr)(unsafe.Pointer(a)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:71:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:74:12:
func test_unlock(tls *libc.TLS, mtype int32) (r1 int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:75:1:
	var r, v1, v2, v3, v4, v5, v6, v7 int32
	...
	_, _, _, _, _, _, _, _ = r, v1, v2, v3, v4, v5, v6, v7
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:82:7:
	*(*[2]uintptr)(unsafe.Pointer(bp + 40)) = [2]uintptr{
		0: bp + 4,
		1: bp + 32,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:84:2:
	v1 = pthread_mutexattr_init(tls, bp+28)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:84:2:
		t_printf(tls, __ccgo_ts+1241, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:85:2:
	v2 = pthread_mutexattr_settype(tls, bp+28, mtype)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:85:2:
		t_printf(tls, __ccgo_ts+1316, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:86:2:
	v3 = pthread_mutex_init(tls, (*(*[2]uintptr)(unsafe.Pointer(bp + 40)))[0], bp+28)
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:86:2:
		t_printf(tls, __ccgo_ts+1401, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:87:2:
	v4 = pthread_mutexattr_destroy(tls, bp+28)
	r = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:87:2:
		t_printf(tls, __ccgo_ts+1478, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:88:2:
	v5 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(unlock), bp+40)
	r = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:88:2:
		t_printf(tls, __ccgo_ts+1556, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:89:2:
	v6 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+36)
	r = v6
	if v6 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:89:2:
		t_printf(tls, __ccgo_ts+1636, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:90:2:
	v7 = pthread_mutex_destroy(tls, (*(*[2]uintptr)(unsafe.Pointer(bp + 40)))[0])
	r = v7
	if v7 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:90:2:
		t_printf(tls, __ccgo_ts+1703, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:91:2:
	return *(*int32)(unsafe.Pointer(bp + 32))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:94:12:
func test_unlock_other(tls *libc.TLS, mtype int32) (r1 int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:95:1:
	var r, v1, v2, v3, v4, v5, v6, v7, v8, v9 int32
	var _ /* a at bp+40 */ [2]uintptr
	var _ /* i at bp+32 */ int32
	var _ /* m at bp+4 */ pthread_mutex_t
	var _ /* ma at bp+28 */ pthread_mutexattr_t
	var _ /* p at bp+36 */ uintptr
	var _ /* t at bp+0 */ pthread_t
	_, _, _, _, _, _, _, _, _, _ = r, v1, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:102:7:
	*(*[2]uintptr)(unsafe.Pointer(bp + 40)) = [2]uintptr{
		0: bp + 4,
		1: bp + 32,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:104:2:
	v1 = pthread_mutexattr_init(tls, bp+28)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:104:2:
		t_printf(tls, __ccgo_ts+1778, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:105:2:
	v2 = pthread_mutexattr_settype(tls, bp+28, mtype)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:105:2:
		t_printf(tls, __ccgo_ts+1854, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:106:2:
	v3 = pthread_mutex_init(tls, (*(*[2]uintptr)(unsafe.Pointer(bp + 40)))[0], bp+28)
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:106:2:
		t_printf(tls, __ccgo_ts+1940, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:107:2:
	v4 = pthread_mutexattr_destroy(tls, bp+28)
	r = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:107:2:
		t_printf(tls, __ccgo_ts+2018, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:108:2:
	v5 = pthread_mutex_lock(tls, (*(*[2]uintptr)(unsafe.Pointer(bp + 40)))[0])
	r = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:108:2:
		t_printf(tls, __ccgo_ts+2097, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:109:2:
	v6 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(unlock), bp+40)
	r = v6
	if v6 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:109:2:
		t_printf(tls, __ccgo_ts+2170, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:110:2:
	v7 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+36)
	r = v7
	if v7 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:110:2:
		t_printf(tls, __ccgo_ts+2251, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:111:2:
	v8 = pthread_mutex_unlock(tls, (*(*[2]uintptr)(unsafe.Pointer(bp + 40)))[0])
	r = v8
	if v8 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:111:2:
		t_printf(tls, __ccgo_ts+2319, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:112:2:
	v9 = pthread_mutex_destroy(tls, (*(*[2]uintptr)(unsafe.Pointer(bp + 40)))[0])
	r = v9
	if v9 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:112:2:
		t_printf(tls, __ccgo_ts+2394, libc.VaList(bp+56, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:113:2:
	return *(*int32)(unsafe.Pointer(bp + 32))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:116:13:
func test_mutexattr(tls *libc.TLS) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:117:1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:123:2:
	v1 = pthread_mutexattr_init(tls, bp)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:123:2:
		t_printf(tls, __ccgo_ts+2470, libc.VaList(bp+16, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:124:2:
	v2 = pthread_mutexattr_gettype(tls, bp, bp+4)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:124:2:
		t_printf(tls, __ccgo_ts+2545, libc.VaList(bp+16, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:125:2:
	if *(*int32)(unsafe.Pointer(bp + 4)) != PTHREAD_MUTEX_DEFAULT {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:126:3:
		t_printf(tls, __ccgo_ts+2627, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp + 4)), PTHREAD_MUTEX_DEFAULT))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:127:2:
	v3 = pthread_mutexattr_settype(tls, bp, int32(PTHREAD_MUTEX_ERRORCHECK))
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:127:2:
		t_printf(tls, __ccgo_ts+2724, libc.VaList(bp+16, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:128:2:
	v4 = pthread_mutexattr_gettype(tls, bp, bp+4)
	r = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:128:2:
		t_printf(tls, __ccgo_ts+2828, libc.VaList(bp+16, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:129:2:
	if *(*int32)(unsafe.Pointer(bp + 4)) != int32(PTHREAD_MUTEX_ERRORCHECK) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:130:3:
		t_printf(tls, __ccgo_ts+2910, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp + 4)), int32(PTHREAD_MUTEX_ERRORCHECK)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:131:2:
	v5 = pthread_mutexattr_destroy(tls, bp)
	r = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:131:2:
		t_printf(tls, __ccgo_ts+3011, libc.VaList(bp+16, libc.Xstrerror(tls, r)))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:134:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:135:1:
	var i int32
	var v1, v2 uintptr
	_, _, _ = i, v1, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:138:2:
	test_mutexattr(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:140:2:
	i = test_relock(tls, PTHREAD_MUTEX_NORMAL)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:141:2:
	if i != -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:142:3:
		t_printf(tls, __ccgo_ts+3089, libc.VaList(bp+8, libc.Xstrerror(tls, i)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:143:2:
	i = test_relock(tls, int32(PTHREAD_MUTEX_ERRORCHECK))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:144:2:
	if i != int32(EDEADLK) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:145:3:
		if i == -int32(1) {
			v1 = __ccgo_ts + 3179
		} else {
			v1 = libc.Xstrerror(tls, i)
		}
		t_printf(tls, __ccgo_ts+3188, libc.VaList(bp+8, v1))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:146:2:
	i = test_relock(tls, int32(PTHREAD_MUTEX_RECURSIVE))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:147:2:
	if i != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:148:3:
		if i == -int32(1) {
			v2 = __ccgo_ts + 3179
		} else {
			v2 = libc.Xstrerror(tls, i)
		}
		t_printf(tls, __ccgo_ts+3288, libc.VaList(bp+8, v2))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:150:2:
	i = test_unlock(tls, int32(PTHREAD_MUTEX_ERRORCHECK))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:151:2:
	if i != int32(EPERM) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:152:3:
		t_printf(tls, __ccgo_ts+3379, libc.VaList(bp+8, libc.Xstrerror(tls, i)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:153:2:
	i = test_unlock(tls, int32(PTHREAD_MUTEX_RECURSIVE))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:154:2:
	if i != int32(EPERM) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:155:3:
		t_printf(tls, __ccgo_ts+3477, libc.VaList(bp+8, libc.Xstrerror(tls, i)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:157:2:
	i = test_unlock_other(tls, int32(PTHREAD_MUTEX_ERRORCHECK))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:158:2:
	if i != int32(EPERM) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:159:3:
		t_printf(tls, __ccgo_ts+3574, libc.VaList(bp+8, libc.Xstrerror(tls, i)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:160:2:
	i = test_unlock_other(tls, int32(PTHREAD_MUTEX_RECURSIVE))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:161:2:
	if i != int32(EPERM) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:162:3:
		t_printf(tls, __ccgo_ts+3672, libc.VaList(bp+8, libc.Xstrerror(tls, i)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_mutex.c:164:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+3769, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+3779, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3871, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3876, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3883, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3901, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3909, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3914, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3957, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+4006) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+4014) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+4026) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+4038) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+4050) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+4059) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3870) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+4059) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+4065, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/pthread_mutex.c:17: pthread_mutex_lock(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:18: sem_post(a[1]) failed: %s\n\x00src/functional/pthread_mutex.c:20: sem_post(a[1]) failed: %s\n\x00src/functional/pthread_mutex.c:22: pthread_mutex_unlock(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:24: pthread_mutex_unlock(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:40: pthread_mutexattr_init(&ma) failed: %s\n\x00src/functional/pthread_mutex.c:41: pthread_mutexattr_settype(&ma, mtype) failed: %s\n\x00src/functional/pthread_mutex.c:42: pthread_mutex_init(a[0], &ma) failed: %s\n\x00src/functional/pthread_mutex.c:43: pthread_mutexattr_destroy(&ma) failed: %s\n\x00src/functional/pthread_mutex.c:44: sem_init(a[1], 0, 0) failed: %s\n\x00src/functional/pthread_mutex.c:45: pthread_create(&t, 0, relock, a) failed: %s\n\x00src/functional/pthread_mutex.c:46: sem_wait(a[1]) failed: %s\n\x00src/functional/pthread_mutex.c:47: clock_gettime(CLOCK_REALTIME, &ts) failed: %s\n\x00src/functional/pthread_mutex.c:56: sem_timedwait failed with unexpected error: %s\n\x00src/functional/pthread_mutex.c:60: pthread_join(t, &p) failed: %s\n\x00src/functional/pthread_mutex.c:61: pthread_mutex_destroy(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:62: sem_destroy(a[1]) failed: %s\n\x00src/functional/pthread_mutex.c:84: pthread_mutexattr_init(&ma) failed: %s\n\x00src/functional/pthread_mutex.c:85: pthread_mutexattr_settype(&ma, mtype) failed: %s\n\x00src/functional/pthread_mutex.c:86: pthread_mutex_init(a[0], &ma) failed: %s\n\x00src/functional/pthread_mutex.c:87: pthread_mutexattr_destroy(&ma) failed: %s\n\x00src/functional/pthread_mutex.c:88: pthread_create(&t, 0, unlock, a) failed: %s\n\x00src/functional/pthread_mutex.c:89: pthread_join(t, &p) failed: %s\n\x00src/functional/pthread_mutex.c:90: pthread_mutex_destroy(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:104: pthread_mutexattr_init(&ma) failed: %s\n\x00src/functional/pthread_mutex.c:105: pthread_mutexattr_settype(&ma, mtype) failed: %s\n\x00src/functional/pthread_mutex.c:106: pthread_mutex_init(a[0], &ma) failed: %s\n\x00src/functional/pthread_mutex.c:107: pthread_mutexattr_destroy(&ma) failed: %s\n\x00src/functional/pthread_mutex.c:108: pthread_mutex_lock(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:109: pthread_create(&t, 0, unlock, a) failed: %s\n\x00src/functional/pthread_mutex.c:110: pthread_join(t, &p) failed: %s\n\x00src/functional/pthread_mutex.c:111: pthread_mutex_unlock(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:112: pthread_mutex_destroy(a[0]) failed: %s\n\x00src/functional/pthread_mutex.c:123: pthread_mutexattr_init(&a) failed: %s\n\x00src/functional/pthread_mutex.c:124: pthread_mutexattr_gettype(&a, &i) failed: %s\n\x00src/functional/pthread_mutex.c:126: default mutex type is %d, wanted PTHREAD_MUTEX_DEFAULT (%d)\n\x00src/functional/pthread_mutex.c:127: pthread_mutexattr_settype(&a, PTHREAD_MUTEX_ERRORCHECK) failed: %s\n\x00src/functional/pthread_mutex.c:128: pthread_mutexattr_gettype(&a, &i) failed: %s\n\x00src/functional/pthread_mutex.c:130: setting error check mutex type failed failed: got %d, wanted %d\n\x00src/functional/pthread_mutex.c:131: pthread_mutexattr_destroy(&a) failed: %s\n\x00src/functional/pthread_mutex.c:142: PTHREAD_MUTEX_NORMAL relock did not deadlock, got %s\n\x00deadlock\x00src/functional/pthread_mutex.c:145: PTHREAD_MUTEX_ERRORCHECK relock did not return EDEADLK, got %s\n\x00src/functional/pthread_mutex.c:148: PTHREAD_MUTEX_RECURSIVE relock did not succed, got %s\n\x00src/functional/pthread_mutex.c:152: PTHREAD_MUTEX_ERRORCHECK unlock did not return EPERM, got %s\n\x00src/functional/pthread_mutex.c:155: PTHREAD_MUTEX_RECURSIVE unlock did not return EPERM, got %s\n\x00src/functional/pthread_mutex.c:159: PTHREAD_MUTEX_ERRORCHECK unlock did not return EPERM, got %s\n\x00src/functional/pthread_mutex.c:162: PTHREAD_MUTEX_RECURSIVE unlock did not return EPERM, got %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
