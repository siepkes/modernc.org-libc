// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/string_memset.exe.go src/functional/string_memset.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:6:9:
const N = 500
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:7:13:
var buf [500]int8

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:8:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:8:13:
var buf2 [500]int8

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:10:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:10:13:
var pmemset uintptr

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:12:13:
func aligned(tls *libc.TLS, p uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:13:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:14:2:
	return uintptr((uint32(p) + libc.Uint32FromInt32(63)) & uint32(-libc.Int32FromInt32(64)))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:17:13:
func test_align(tls *libc.TLS, align int32, len1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:18:1:
	var i int32
	var p, s, want uintptr
	var v2 int8
	_, _, _, _, _ = i, p, s, want, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:19:7:
	s = aligned(tls, uintptr(unsafe.Pointer(&buf))+uintptr(64)) + uintptr(align)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:20:7:
	want = aligned(tls, uintptr(unsafe.Pointer(&buf2))+uintptr(64)) + uintptr(align)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:24:2:
	if len1+int32(64) > int32(uintptr(unsafe.Pointer(&buf))+uintptr(N))-int32(s) || len1+int32(64) > int32(uintptr(unsafe.Pointer(&buf2))+uintptr(N))-int32(want) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:25:3:
		libc.Xabort(tls)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:26:2:
	i = 0
	for {
		if !(i < int32(N)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:27:3:
		v2 = libc.Int8FromUint8(' ')
		buf2[i] = v2
		buf[i] = v2
		goto _1
	_1:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:28:2:
	i = 0
	for {
		if !(i < len1) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:29:3:
		*(*int8)(unsafe.Pointer(want + uintptr(i))) = int8('#')
		goto _3
	_3:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:30:2:
	p = (*(*func(*libc.TLS, uintptr, int32, size_t) uintptr)(unsafe.Pointer(&struct{ uintptr }{pmemset})))(tls, s, int32('#'), uint32(len1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:31:2:
	if p != s {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:32:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, s, p))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:33:2:
	i = -int32(64)
	for {
		if !(i < len1+int32(64)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:34:3:
		if int32(*(*int8)(unsafe.Pointer(s + uintptr(i)))) != int32(*(*int8)(unsafe.Pointer(want + uintptr(i)))) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:35:4:
			t_printf(tls, __ccgo_ts+63, libc.VaList(bp+8, align, len1, i))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:36:4:
			t_printf(tls, __ccgo_ts+142, libc.VaList(bp+8, len1+int32(128), s-uintptr(64)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:37:4:
			t_printf(tls, __ccgo_ts+156, libc.VaList(bp+8, len1+int32(128), want-uintptr(64)))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:38:4:
			break
		}
		goto _4
	_4:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:42:13:
func test_value(tls *libc.TLS, c int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:43:1:
	var i int32
	_ = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:46:2:
	(*(*func(*libc.TLS, uintptr, int32, size_t) uintptr)(unsafe.Pointer(&struct{ uintptr }{pmemset})))(tls, uintptr(unsafe.Pointer(&buf)), c, uint32(10))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:47:2:
	i = 0
	for {
		if !(i < int32(10)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:48:3:
		if int32(uint8(buf[i])) != int32(uint8(c)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:49:4:
			t_printf(tls, __ccgo_ts+170, libc.VaList(bp+8, c, int32(buf[i])))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:50:4:
			break
		}
		goto _1
	_1:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:54:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:55:1:
	var i, j, k int32
	_, _, _ = i, j, k
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:58:2:
	pmemset = __ccgo_fp(libc.Xmemset)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:60:2:
	i = 0
	for {
		if !(i < int32(64)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:61:3:
		j = 0
		for {
			if !(j < libc.Int32FromInt32(N)-libc.Int32FromInt32(256)) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:62:4:
			test_align(tls, i, j)
			goto _2
		_2:
			j++
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:64:2:
	test_value(tls, int32('c'))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:65:2:
	test_value(tls, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:66:2:
	test_value(tls, -int32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:67:2:
	test_value(tls, -int32(5))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:68:2:
	test_value(tls, int32(0xab))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/string_memset.c:69:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+232, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+242, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+334, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+339, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+346, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+364, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+372, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+377, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+420, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+469) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+477) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+489) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+501) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+513) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+522) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+333) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+522) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+528, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
