// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/iconv_open.exe.go src/functional/iconv_open.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/iconv.h:14:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/iconv.h:14:14:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:6:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(160)
	defer tls.Free(160)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:7:1:
	var bad uintptr
	var cd iconv_t
	var r size_t
	var _ /* buf at bp+0 */ [100]int8
	var _ /* inbuf at bp+100 */ uintptr
	var _ /* inlen at bp+108 */ size_t
	var _ /* outbuf at bp+104 */ uintptr
	var _ /* outlen at bp+112 */ size_t
	_, _, _ = bad, cd, r
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:10:7:
	*(*uintptr)(unsafe.Pointer(bp + 100)) = __ccgo_ts
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:11:7:
	*(*uintptr)(unsafe.Pointer(bp + 104)) = bp
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:12:9:
	*(*size_t)(unsafe.Pointer(bp + 108)) = libc.Xstrlen(tls, *(*uintptr)(unsafe.Pointer(bp + 100)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:15:7:
	bad = __ccgo_ts + 5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:17:2:
	cd = libc.Xiconv_open(tls, bad, bad)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:18:2:
	if cd != uintptr(-libc.Int32FromInt32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:19:3:
		t_printf(tls, __ccgo_ts+17, libc.VaList(bp+128, bad, bad))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:20:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EINVAL) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:21:3:
		t_printf(tls, __ccgo_ts+84, libc.VaList(bp+128, bad, bad, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:23:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:24:2:
	cd = libc.Xiconv_open(tls, __ccgo_ts+172, __ccgo_ts+172)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:25:2:
	if cd == uintptr(-libc.Int32FromInt32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:26:3:
		t_printf(tls, __ccgo_ts+178, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:28:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:29:2:
	*(*size_t)(unsafe.Pointer(bp + 112)) = uint32(0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:30:2:
	r = libc.Xiconv(tls, cd, bp+100, bp+108, bp+104, bp+112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:31:2:
	if r != uint32(-libc.Int32FromInt32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:32:3:
		t_printf(tls, __ccgo_ts+240, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:33:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(E2BIG) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:34:3:
		t_printf(tls, __ccgo_ts+315, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:36:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:37:2:
	*(*size_t)(unsafe.Pointer(bp + 112)) = uint32(100)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:38:2:
	r = libc.Xiconv(tls, cd, bp+100, bp+108, bp+104, bp+112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:39:2:
	if r != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:40:3:
		t_printf(tls, __ccgo_ts+388, libc.VaList(bp+128, r))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:41:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:42:3:
		t_printf(tls, __ccgo_ts+483, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:44:2:
	r = uint32(libc.Xiconv_close(tls, cd))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:45:2:
	if r == uint32(-libc.Int32FromInt32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:46:3:
		t_printf(tls, __ccgo_ts+535, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/iconv_open.c:48:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+591, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+601, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+693, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+698, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+705, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+723, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+731, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+736, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+779, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+828) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+836) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+848) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+860) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+872) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+172) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+692) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+172) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+881, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "test\x00bad-codeset\x00src/functional/iconv_open.c:19: iconv_open(\"%s\",\"%s\") didn't fail\n\x00src/functional/iconv_open.c:21: iconv_open(\"%s\",\"%s\") did not fail with EINVAL, got %s\n\x00UTF-8\x00src/functional/iconv_open.c:26: iconv_open(\"\",\"\") failed: %s\n\x00src/functional/iconv_open.c:32: iconv() did not fail with 0 output length\n\x00src/functional/iconv_open.c:34: iconv() did not fail with E2BIG, got %s\n\x00src/functional/iconv_open.c:40: iconv() did not return 0 when converting utf8 to utf8, got %d\n\x00src/functional/iconv_open.c:42: iconv() failed: %s\n\x00src/functional/iconv_open.c:46: iconv_close failed: %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
