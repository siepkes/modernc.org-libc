// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/stat.exe.go src/functional/stat.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/stat.h:32:9:
const S_IFCHR = 8192

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/stat.h:31:9:
const S_IFDIR = 16384

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/stat.h:29:9:
const S_IFMT = 61440
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(176)
	defer tls.Free(176)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:13:1:
	var f, v9 uintptr
	var t time_t
	var v1, v10, v7 int32
	var _ /* st at bp+0 */ stat1
	_, _, _, _, _, _ = f, t, v1, v10, v7, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:18:2:
	if libc.Xstat(tls, __ccgo_ts, bp) == 0 {
		v1 = int32(1)
	} else {
		t_printf(tls, __ccgo_ts+2, libc.VaList(bp+152, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		v1 = libc.Int32FromInt32(0)
	}
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:19:3:
		if !((*(*stat1)(unsafe.Pointer(bp))).Fst_mode&uint32(S_IFMT) == uint32(S_IFDIR)) {
			t_printf(tls, __ccgo_ts+65, 0)
			_ = libc.Int32FromInt32(0)
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:20:3:
		if !((*(*stat1)(unsafe.Pointer(bp))).Fst_nlink > uint32(0)) {
			t_printf(tls, __ccgo_ts+121, libc.VaList(bp+152, uint64((*(*stat1)(unsafe.Pointer(bp))).Fst_nlink)))
			_ = libc.Int32FromInt32(0)
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:21:3:
		t = libc.Xtime(tls, uintptr(0))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:22:3:
		if !((*(*stat1)(unsafe.Pointer(bp))).Fst_ctim.Ftv_sec <= t) {
			t_printf(tls, __ccgo_ts+174, libc.VaList(bp+152, (*(*stat1)(unsafe.Pointer(bp))).Fst_ctim.Ftv_sec, t))
			_ = libc.Int32FromInt32(0)
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:23:3:
		if !((*(*stat1)(unsafe.Pointer(bp))).Fst_mtim.Ftv_sec <= t) {
			t_printf(tls, __ccgo_ts+234, libc.VaList(bp+152, (*(*stat1)(unsafe.Pointer(bp))).Fst_mtim.Ftv_sec, t))
			_ = libc.Int32FromInt32(0)
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:24:3:
		if !((*(*stat1)(unsafe.Pointer(bp))).Fst_atim.Ftv_sec <= t) {
			t_printf(tls, __ccgo_ts+294, libc.VaList(bp+152, (*(*stat1)(unsafe.Pointer(bp))).Fst_atim.Ftv_sec, t))
			_ = libc.Int32FromInt32(0)
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:27:2:
	if libc.Xstat(tls, __ccgo_ts+354, bp) == 0 {
		v7 = int32(1)
	} else {
		t_printf(tls, __ccgo_ts+364, libc.VaList(bp+152, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		v7 = libc.Int32FromInt32(0)
	}
	if v7 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:28:3:
		if !((*(*stat1)(unsafe.Pointer(bp))).Fst_mode&uint32(S_IFMT) == uint32(S_IFCHR)) {
			t_printf(tls, __ccgo_ts+435, 0)
			_ = libc.Int32FromInt32(0)
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:31:2:
	v9 = libc.Xtmpfile(tls)
	f = v9
	if v9 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:32:3:
		libc.Xfputs(tls, __ccgo_ts+491, f)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:33:3:
		libc.Xfflush(tls, f)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:34:3:
		if libc.Xfstat(tls, libc.Xfileno(tls, f), bp) == 0 {
			v10 = int32(1)
		} else {
			t_printf(tls, __ccgo_ts+497, libc.VaList(bp+152, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
			v10 = libc.Int32FromInt32(0)
		}
		if v10 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:35:4:
			if !((*(*stat1)(unsafe.Pointer(bp))).Fst_uid == libc.Xgeteuid(tls)) {
				t_printf(tls, __ccgo_ts+567, libc.VaList(bp+152, int32((*(*stat1)(unsafe.Pointer(bp))).Fst_uid), int32(libc.Xgeteuid(tls))))
				_ = libc.Int32FromInt32(0)
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:36:4:
			if !((*(*stat1)(unsafe.Pointer(bp))).Fst_gid == libc.Xgetegid(tls)) {
				t_printf(tls, __ccgo_ts+632, libc.VaList(bp+152, int32((*(*stat1)(unsafe.Pointer(bp))).Fst_uid), int32(libc.Xgeteuid(tls))))
				_ = libc.Int32FromInt32(0)
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:37:4:
			if !((*(*stat1)(unsafe.Pointer(bp))).Fst_size == int64(5)) {
				t_printf(tls, __ccgo_ts+697, libc.VaList(bp+152, (*(*stat1)(unsafe.Pointer(bp))).Fst_size))
				_ = libc.Int32FromInt32(0)
			}
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:39:3:
		libc.Xfclose(tls, f)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/stat.c:42:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+354, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+755, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+847, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+852, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+859, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+877, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+885, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+890, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+933, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+982) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+990) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1002) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1014) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1026) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1035) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+846) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1035) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1041, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = ".\x00src/functional/stat.c:18: stat(\".\",&st)==0 failed: errno = %s\n\x00src/functional/stat.c:19: S_ISDIR(st.st_mode) failed: \n\x00src/functional/stat.c:20: st.st_nlink>0 failed: %ju\n\x00src/functional/stat.c:22: st.st_ctime<=t failed: %jd > %jd\n\x00src/functional/stat.c:23: st.st_mtime<=t failed: %jd > %jd\n\x00src/functional/stat.c:24: st.st_atime<=t failed: %jd > %jd\n\x00/dev/null\x00src/functional/stat.c:27: stat(\"/dev/null\",&st)==0 failed: errno = %s\n\x00src/functional/stat.c:28: S_ISCHR(st.st_mode) failed: \n\x00hello\x00src/functional/stat.c:34: fstat(fileno(f),&st)==0 failed: errnp = %s\n\x00src/functional/stat.c:35: st.st_uid==geteuid() failed: %d vs %d\n\x00src/functional/stat.c:36: st.st_gid==getegid() failed: %d vs %d\n\x00src/functional/stat.c:37: st.st_size==5 failed: %jd vs 5\n\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
