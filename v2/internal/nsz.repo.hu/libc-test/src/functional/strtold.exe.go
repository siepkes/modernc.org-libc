// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/strtold.exe.go src/functional/strtold.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:9:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:12:3:
var t = [31]struct {
	Fs uintptr
	Ff float64
}{
	...
	1: {
		Fs: __ccgo_ts + 2,
		Ff: libc.Float64FromFloat64(12.345),
	},
	2: {
		Fs: __ccgo_ts + 9,
		Ff: libc.Float64FromFloat64(12.345),
	...
	3: {
		Fs: __ccgo_ts + 18,
		Ff: float64(libc.X__builtin_inff(nil)),
	},
	4: {
		Fs: __ccgo_ts + 29,
		Ff: libc.Float64FromInt32(0),
	},
	5: {
		Fs: __ccgo_ts + 40,
		Ff: libc.Float64FromInt32(0),
	...
	6: {
		Fs: __ccgo_ts + 126,
		Ff: libc.Float64FromFloat64(5e-324),
	},
	7: {
		Fs: __ccgo_ts + 212,
		Ff: libc.Float64FromFloat64(5e-324),
	...
	8: {
		Fs: __ccgo_ts + 298,
		Ff: libc.Float64FromFloat64(1e-323),
	},
	9: {
		Fs: __ccgo_ts + 384,
		Ff: libc.Float64FromFloat64(2.2250738585072014e-308),
	},
	10: {
		Fs: __ccgo_ts + 470,
		Ff: libc.Float64FromFloat64(2.225073858507202e-308),
	},
	11: {
		Fs: __ccgo_ts + 556,
		Ff: libc.Float64FromFloat64(1.7976931348623157e+308),
	},
	12: {
		Fs: __ccgo_ts + 897,
		Ff: float64(libc.X__builtin_inff(nil)),
	...
	13: {
		Fs: __ccgo_ts + 1207,
		Ff: libc.Float64FromFloat64(0.5961860348131807),
	},
	14: {
		Fs: __ccgo_ts + 1252,
		Ff: libc.Float64FromFloat64(0.18150131692180388),
	},
	15: {
		Fs: __ccgo_ts + 1297,
		Ff: libc.Float64FromFloat64(0.42070823575344535),
	},
	16: {
		Fs: __ccgo_ts + 1342,
		Ff: libc.Float64FromFloat64(0.6654686306516261),
	},
	17: {
		Fs: __ccgo_ts + 1387,
		Ff: libc.Float64FromFloat64(0.6101852922970868),
	},
	18: {
		Fs: __ccgo_ts + 1432,
		Ff: libc.Float64FromFloat64(0.7696695208236968),
	},
	19: {
		Fs: __ccgo_ts + 1477,
		Ff: libc.Float64FromFloat64(0.25050653222286823),
	},
	20: {
		Fs: __ccgo_ts + 1522,
		Ff: libc.Float64FromFloat64(0.2740037230228005),
	},
	21: {
		Fs: __ccgo_ts + 1567,
		Ff: libc.Float64FromFloat64(0.20723093500497428),
	},
	22: {
		Fs: __ccgo_ts + 1612,
		Ff: libc.Float64FromFloat64(7.900280238081605),
	},
	23: {
		Fs: __ccgo_ts + 1657,
		Ff: libc.Float64FromFloat64(98.22860653737297),
	},
	24: {
		Fs: __ccgo_ts + 1702,
		Ff: libc.Float64FromFloat64(746.894972319037),
	},
	25: {
		Fs: __ccgo_ts + 1747,
		Ff: libc.Float64FromFloat64(1630.2683202827284),
	},
	26: {
		Fs: __ccgo_ts + 1792,
		Ff: libc.Float64FromFloat64(46371.68629719171),
	},
	27: {
		Fs: __ccgo_ts + 1837,
		Ff: libc.Float64FromFloat64(653780.5944497711),
	},
	28: {
		Fs: __ccgo_ts + 1882,
		Ff: libc.Float64FromFloat64(234632.43565024371),
	},
	29: {
		Fs: __ccgo_ts + 1927,
		Ff: libc.Float64FromFloat64(9.709481716420048e+07),
	},
	30: {
		Fs: __ccgo_ts + 1972,
		Ff: libc.Float64FromFloat64(4.9969085220518744e+08),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:82:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:83:1:
	var i int32
	var x float64
	var _ /* p at bp+0 */ uintptr
	_, _ = i, x
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:88:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(372)/libc.Uint32FromInt64(12)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:89:3:
		x = libc.Xstrtold(tls, t[i].Fs, bp)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:90:3:
		if x != t[i].Ff {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:91:4:
			t_printf(tls, __ccgo_ts+2017, libc.VaList(bp+16, t[i].Fs, t[i].Ff, x))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtold.c:93:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+2078, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+2088, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2180, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2185, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2190, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2208, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2216, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2221, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2264, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2313) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2321) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2333) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2345) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2357) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2366) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2179) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2366) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2372, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "0\x0012.345\x001.2345e1\x001e+1000000\x001e-1000000\x00.2470328229206232720882843964341106861825299013071623822127928412503377536351043e-323\x00.2470328229206232720882843964341106861825299013071623822127928412503377536351044e-323\x00.7410984687618698162648531893023320585475897039214871466383785237510132609053131e-323\x00.7410984687618698162648531893023320585475897039214871466383785237510132609053132e-323\x00.2225073858507201630123055637955676152503612414573018013083228724049586647606759e-307\x00.2225073858507201630123055637955676152503612414573018013083228724049586647606760e-307\x00.999999999999999999999999999999\x00\x00.5961860348131807091861002266453941950428e00\x001.815013169218038729887460898733526957442e-1\x0042.07082357534453600681618685682257590772e-2\x00665.4686306516261456328973225579833470816e-3\x006101.852922970868621786690495485449831753e-4\x0076966.95208236968077849464348875471158549e-5\x00250506.5322228682496132604807222923702304e-6\x002740037.230228005325852424697698331177377e-7\x0020723093.50049742645941529268715428324490e-8\x000.7900280238081604956226011047460238748912e1\x000.9822860653737296848190558448760465863597e2\x000.7468949723190370809405570560160405324869e3\x000.1630268320282728475980459844271031751665e4\x000.4637168629719170695109918769645492022088e5\x000.6537805944497711554209461686415872067523e6\x000.2346324356502437045212230713960457676531e6\x000.9709481716420048341897258980454298205278e8\x000.4996908522051874110779982354932499499602e9\x00src/functional/strtold.c:91: strtold(\"%s\") want %La got %La\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
