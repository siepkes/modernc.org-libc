// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/utime.exe.go src/functional/utime.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:9:9:
const EBADF = 9

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:20:9:
const ENOTDIR = 20

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/stat.h:70:9:
const UTIME_NOW = 1073741823

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/stat.h:71:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/stat.h:4:1:
type stat1 = struct {
	Fst_dev             dev_t
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:14:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(448)
	defer tls.Free(448)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:15:1:
	var f, v4 uintptr
	var fd, v3, v31 int32
	var t time_t
	var _ /* st at bp+288 */ stat1
	_, _, _, _, _, _ = f, fd, t, v3, v31, v4
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:21:2:
	*(*[2]timespec)(unsafe.Pointer(bp)) = [2]timespec{
		0: {
			Ftv_nsec: int32(UTIME_OMIT),
		},
		1: {
			Ftv_nsec: int32(UTIME_OMIT),
		},
	}
	if !(libc.Xutimensat(tls, -int32(100), __ccgo_ts, bp, 0) == 0 || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(ENOTDIR)) {
		t_printf(tls, __ccgo_ts+18, libc.VaList(bp+440, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:23:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 32)) = [2]timespec{
		0: {
			Ftv_nsec: int32(UTIME_OMIT),
		},
		1: {
	...
	if !(libc.Xfutimens(tls, -int32(1), bp+32) == 0 || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EBADF)) {
		t_printf(tls, __ccgo_ts+191, libc.VaList(bp+440, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:26:2:
	v4 = libc.Xtmpfile(tls)
	f = v4
	if v4 != 0 {
		v3 = int32(1)
	} else {
		t_printf(tls, __ccgo_ts+331, 0)
		v3 = libc.Int32FromInt32(0)
	}
	if !(v3 != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:26:28:
		return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:27:2:
	fd = libc.Xfileno(tls, f)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:29:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 64)) = [2]timespec{}
	if !(libc.Xfutimens(tls, fd, bp+64) == 0) {
		t_printf(tls, __ccgo_ts+381, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:30:2:
	if !(libc.Xfstat(tls, fd, bp+288) == 0) {
		t_printf(tls, __ccgo_ts+461, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:31:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec == 0) {
		t_printf(tls, __ccgo_ts+518, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:32:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_nsec == 0) {
		t_printf(tls, __ccgo_ts+581, libc.VaList(bp+440, int64((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_nsec)))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:33:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec == 0) {
		t_printf(tls, __ccgo_ts+645, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:34:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_nsec == 0) {
		t_printf(tls, __ccgo_ts+708, libc.VaList(bp+440, int64((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_nsec)))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:36:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 96)) = [2]timespec{
		0: {
			Ftv_sec:  int64(1),
			Ftv_nsec: int32(UTIME_OMIT),
		},
	...
	if !(libc.Xfutimens(tls, fd, bp+96) == 0) {
		t_printf(tls, __ccgo_ts+772, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:37:2:
	if !(libc.Xfstat(tls, fd, bp+288) == 0) {
		t_printf(tls, __ccgo_ts+916, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:38:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec == 0) {
		t_printf(tls, __ccgo_ts+973, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:39:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_nsec == 0) {
		t_printf(tls, __ccgo_ts+1036, libc.VaList(bp+440, int64((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_nsec)))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:40:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec == 0) {
		t_printf(tls, __ccgo_ts+1100, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:41:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_nsec == 0) {
		t_printf(tls, __ccgo_ts+1163, libc.VaList(bp+440, int64((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_nsec)))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:43:2:
	t = libc.Xtime(tls, uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:45:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 128)) = [2]timespec{
		0: {
			Ftv_nsec: int32(UTIME_NOW),
		},
		1: {
			Ftv_nsec: int32(UTIME_OMIT),
		},
	}
	if !(libc.Xfutimens(tls, fd, bp+128) == 0) {
		t_printf(tls, __ccgo_ts+1227, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:46:2:
	if !(libc.Xfstat(tls, fd, bp+288) == 0) {
		t_printf(tls, __ccgo_ts+1350, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:47:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec >= t) {
		t_printf(tls, __ccgo_ts+1407, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:48:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec == 0) {
		t_printf(tls, __ccgo_ts+1470, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:49:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_nsec == 0) {
		t_printf(tls, __ccgo_ts+1533, libc.VaList(bp+440, int64((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_nsec)))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:51:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 160)) = [2]timespec{}
	if !(libc.Xfutimens(tls, fd, bp+160) == 0) {
		t_printf(tls, __ccgo_ts+1597, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:52:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 192)) = [2]timespec{
		0: {
			Ftv_nsec: int32(UTIME_OMIT),
		},
		1: {
	...
	if !(libc.Xfutimens(tls, fd, bp+192) == 0) {
		t_printf(tls, __ccgo_ts+1677, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:53:2:
	if !(libc.Xfstat(tls, fd, bp+288) == 0) {
		t_printf(tls, __ccgo_ts+1800, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:54:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec == 0) {
		t_printf(tls, __ccgo_ts+1857, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:55:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec >= t) {
		t_printf(tls, __ccgo_ts+1920, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:57:2:
	*(*[2]timespec)(unsafe.Pointer(bp + 224)) = [2]timespec{
		0: {
			Ftv_nsec: int32(UTIME_NOW),
		},
		1: {
	...
	if !(libc.Xfutimens(tls, fd, bp+224) == 0) {
		t_printf(tls, __ccgo_ts+1983, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:58:2:
	if !(libc.Xfstat(tls, fd, bp+288) == 0) {
		t_printf(tls, __ccgo_ts+2106, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:59:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec >= t) {
		t_printf(tls, __ccgo_ts+2163, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:60:2:
	if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec >= t) {
		t_printf(tls, __ccgo_ts+2226, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:62:2:
	if int32(1) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:63:3:
		*(*[2]timespec)(unsafe.Pointer(bp + 256)) = [2]timespec{
			0: {
				Ftv_sec: libc.Int64FromInt64(1) << libc.Int32FromInt32(32),
			},
			1: {
				Ftv_sec: libc.Int64FromInt64(1) << libc.Int32FromInt32(32),
			},
		}
		if libc.Xfutimens(tls, fd, bp+256) == 0 {
			v31 = int32(1)
		} else {
			t_printf(tls, __ccgo_ts+2289, libc.VaList(bp+440, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
			v31 = libc.Int32FromInt32(0)
		}
		if v31 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:64:4:
			if !(libc.Xfstat(tls, fd, bp+288) == 0) {
				t_printf(tls, __ccgo_ts+2407, 0)
				_ = libc.Int32FromInt32(0)
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:65:4:
			if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec == libc.Int64FromInt64(1)<<libc.Int32FromInt32(32)) {
				t_printf(tls, __ccgo_ts+2464, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_atim.Ftv_sec))
				_ = libc.Int32FromInt32(0)
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:66:4:
			if !((*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec == libc.Int64FromInt64(1)<<libc.Int32FromInt32(32)) {
				t_printf(tls, __ccgo_ts+2533, libc.VaList(bp+440, (*(*stat1)(unsafe.Pointer(bp + 288))).Fst_mtim.Ftv_sec))
				_ = libc.Int32FromInt32(0)
			}
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:70:2:
	libc.Xfclose(tls, f)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/utime.c:72:2:
	return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+2602, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+2612, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2704, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2709, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2716, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2734, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2742, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2747, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2790, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2839) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2847) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2859) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2871) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2883) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2892) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2703) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2892) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2898, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "/dev/null/invalid\x00src/functional/utime.c:21: utimensat(AT_FDCWD, \"/dev/null/invalid\", ((struct timespec[2]){{.tv_nsec=UTIME_OMIT},{.tv_nsec=UTIME_OMIT}}), 0)==0 || errno==ENOTDIR failed: %s\n\x00src/functional/utime.c:23: futimens(-1, ((struct timespec[2]){{.tv_nsec=UTIME_OMIT},{.tv_nsec=UTIME_OMIT}}))==0 || errno==EBADF failed: %s\n\x00src/functional/utime.c:26: f = tmpfile() failed: \x00src/functional/utime.c:29: futimens(fd, (struct timespec[2]){0}) == 0 failed: \n\x00src/functional/utime.c:30: fstat(fd, &st) == 0 failed: \n\x00src/functional/utime.c:31: st.st_atim.tv_sec == 0 failed: %jd\n\x00src/functional/utime.c:32: st.st_atim.tv_nsec == 0 failed: %jd\n\x00src/functional/utime.c:33: st.st_mtim.tv_sec == 0 failed: %jd\n\x00src/functional/utime.c:34: st.st_mtim.tv_nsec == 0 failed: %jd\n\x00src/functional/utime.c:36: futimens(fd, ((struct timespec[2]){{.tv_sec=1,.tv_nsec=UTIME_OMIT},{.tv_sec=1,.tv_nsec=UTIME_OMIT}})) == 0 failed: \n\x00src/functional/utime.c:37: fstat(fd, &st) == 0 failed: \n\x00src/functional/utime.c:38: st.st_atim.tv_sec == 0 failed: %jd\n\x00src/functional/utime.c:39: st.st_atim.tv_nsec == 0 failed: %jd\n\x00src/functional/utime.c:40: st.st_mtim.tv_sec == 0 failed: %jd\n\x00src/functional/utime.c:41: st.st_mtim.tv_nsec == 0 failed: %jd\n\x00src/functional/utime.c:45: futimens(fd, ((struct timespec[2]){{.tv_nsec=UTIME_NOW},{.tv_nsec=UTIME_OMIT}})) == 0 failed: \n\x00src/functional/utime.c:46: fstat(fd, &st) == 0 failed: \n\x00src/functional/utime.c:47: st.st_atim.tv_sec >= t failed: %jd\n\x00src/functional/utime.c:48: st.st_mtim.tv_sec == 0 failed: %jd\n\x00src/functional/utime.c:49: st.st_mtim.tv_nsec == 0 failed: %jd\n\x00src/functional/utime.c:51: futimens(fd, (struct timespec[2]){0}) == 0 failed: \n\x00src/functional/utime.c:52: futimens(fd, ((struct timespec[2]){{.tv_nsec=UTIME_OMIT},{.tv_nsec=UTIME_NOW}})) == 0 failed: \n\x00src/functional/utime.c:53: fstat(fd, &st) == 0 failed: \n\x00src/functional/utime.c:54: st.st_atim.tv_sec == 0 failed: %jd\n\x00src/functional/utime.c:55: st.st_mtim.tv_sec >= t failed: %jd\n\x00src/functional/utime.c:57: futimens(fd, ((struct timespec[2]){{.tv_nsec=UTIME_NOW},{.tv_nsec=UTIME_OMIT}})) == 0 failed: \n\x00src/functional/utime.c:58: fstat(fd, &st) == 0 failed: \n\x00src/functional/utime.c:59: st.st_atim.tv_sec >= t failed: %jd\n\x00src/functional/utime.c:60: st.st_mtim.tv_sec >= t failed: %jd\n\x00src/functional/utime.c:63: futimens(fd, ((struct timespec[2]){{.tv_sec=1LL<<32},{.tv_sec=1LL<<32}})) == 0 failed: %s\n\x00src/functional/utime.c:64: fstat(fd, &st) == 0 failed: \n\x00src/functional/utime.c:65: st.st_atim.tv_sec == 1LL<<32 failed: %jd\n\x00src/functional/utime.c:66: st.st_mtim.tv_sec == 1LL<<32 failed: %jd\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
