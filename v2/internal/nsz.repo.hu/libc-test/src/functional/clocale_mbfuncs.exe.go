// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/clocale_mbfuncs.exe.go src/functional/clocale_mbfuncs.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/limits.h:35:9:
const MB_LEN_MAX = 4

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/wctype.h:23:9:
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/wctype.h:20:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/wctype.h:20:19:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(3152)
	defer tls.Free(3152)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:12:1:
	var c, i, j, ni_errors, v6, v7, v9 int32
	var rv, v11, v12 size_t
	var st2 mbstate_t
	var v10, v8 bool
	var v2 wchar_t
	var _ /* map at bp+28 */ [257]wchar_t
	var _ /* s at bp+2084 */ [1024]int8
	var _ /* st at bp+16 */ mbstate_t
	var _ /* wc at bp+24 */ wchar_t
	var _ /* wtmp at bp+1056 */ [257]wchar_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _ = c, i, j, ni_errors, rv, st2, v10, v11, v12, v2, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:19:6:
	ni_errors = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:21:2:
	libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:23:2:
	if libc.X__ctype_get_mb_cur_max(tls) != uint32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:23:23:
		t_printf(tls, __ccgo_ts+2, libc.VaList(bp+3120, int32(libc.X__ctype_get_mb_cur_max(tls))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:25:2:
	i = 0
	for {
		if !(i < int32(256)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:26:3:
		*(*mbstate_t)(unsafe.Pointer(bp + 16)) = mbstate_t{}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:27:3:
		*(*int8)(unsafe.Pointer(bp)) = int8(i)
		if libc.Xmbrtowc(tls, bp+24, bp, uint32(1), bp+16) != libc.BoolUint32(!!(i != 0)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:28:4:
			t_printf(tls, __ccgo_ts+68, libc.VaList(bp+3120, i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:29:3:
		v2 = int32(libc.Xbtowc(tls, i))
		(*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i] = v2
		if uint32(v2) == uint32(0xffffffff) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:30:4:
			t_printf(tls, __ccgo_ts+153, libc.VaList(bp+3120, i))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:31:4:
			goto _1
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:33:3:
		j = 0
		for {
			if !(j < i) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:34:4:
			if (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[j] == (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i] {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:35:5:
				t_printf(tls, __ccgo_ts+236, libc.VaList(bp+3120, j, i, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])))
			}
			goto _3
		_3:
			j++
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:39:2:
	i = 0
	for {
		if !(i < int32(256)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:40:3:
		if uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i]) == uint32(0xffffffff) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:40:21:
			goto _4
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:41:3:
		if libc.Xwctob(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != i {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:42:4:
			t_printf(tls, __ccgo_ts+319, libc.VaList(bp+3120, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i]), i))
		}
		goto _4
	_4:
		i++
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:46:2:
	i = 0
	for {
		if !(i < int32(0x110000)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:47:3:
		if libc.Xwcschr(tls, bp+28+uintptr(1)*4, int32(i)) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:47:25:
			goto _5
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:48:3:
		v6 = libc.Xwctob(tls, uint32(i))
		c = v6
		if v8 = uint32(v6) != uint32(0xffffffff); v8 {
			v7 = ni_errors
			ni_errors++
		}
		if v8 && v7 < int32(50) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:49:4:
			t_printf(tls, __ccgo_ts+412, libc.VaList(bp+3120, i, c))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:50:3:
		*(*mbstate_t)(unsafe.Pointer(bp + 16)) = mbstate_t{}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:51:3:
		if v10 = libc.Xwcrtomb(tls, bp+2084, int32(i), bp+16) != uint32(-libc.Int32FromInt32(1)); v10 {
			v9 = ni_errors
			ni_errors++
		}
		if v10 && v9 < int32(50) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:52:4:
			t_printf(tls, __ccgo_ts+501, libc.VaList(bp+3120, i))
		}
		goto _5
	_5:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:54:2:
	if ni_errors > int32(50) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:55:3:
		t_printf(tls, __ccgo_ts+579, libc.VaList(bp+3120, ni_errors))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:57:2:
	(*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[int32(256)] = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:58:2:
	*(*mbstate_t)(unsafe.Pointer(bp + 16)) = mbstate_t{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:59:2:
	*(*uintptr)(unsafe.Pointer(bp + 4)) = bp + 28 + uintptr(1)*4
	v11 = libc.Xwcsrtombs(tls, bp+2084, bp+4, uint32(1024), bp+16)
	rv = v11
	if v11 != uint32(255) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:60:3:
		t_printf(tls, __ccgo_ts+662, libc.VaList(bp+3120, rv))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:61:2:
	*(*uintptr)(unsafe.Pointer(bp + 8)) = bp + 2084
	v12 = libc.Xmbsrtowcs(tls, bp+1056, bp+8, uint32(256), bp+16)
	rv = v12
	if v12 != uint32(255) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:62:3:
		t_printf(tls, __ccgo_ts+737, libc.VaList(bp+3120, rv))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:63:2:
	if libc.Xmemcmp(tls, bp+28+uintptr(1)*4, bp+1056, libc.Uint32FromInt32(256)*libc.Uint32FromInt64(4)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:64:3:
		t_printf(tls, __ccgo_ts+812, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:66:2:
	i = int32(128)
	for {
		if !(i < int32(256)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:67:3:
		if libc.Xiswalnum(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:67:25:
			t_printf(tls, __ccgo_ts+888, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:68:3:
		if libc.Xiswalpha(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:68:25:
			t_printf(tls, __ccgo_ts+965, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:69:3:
		if libc.Xiswblank(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:69:25:
			t_printf(tls, __ccgo_ts+1042, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:70:3:
		if libc.Xiswcntrl(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:70:25:
			t_printf(tls, __ccgo_ts+1119, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:71:3:
		if libc.BoolInt32(uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])-uint32('0') < uint32(10)) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:71:25:
			t_printf(tls, __ccgo_ts+1196, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:72:3:
		if libc.Xiswgraph(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:72:25:
			t_printf(tls, __ccgo_ts+1273, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:73:3:
		if libc.Xiswlower(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:73:25:
			t_printf(tls, __ccgo_ts+1350, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:74:3:
		if libc.Xiswprint(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:74:25:
			t_printf(tls, __ccgo_ts+1427, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:75:3:
		if libc.Xiswpunct(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:75:25:
			t_printf(tls, __ccgo_ts+1504, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:76:3:
		if libc.Xiswspace(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:76:25:
			t_printf(tls, __ccgo_ts+1581, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:77:3:
		if libc.Xiswupper(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:77:25:
			t_printf(tls, __ccgo_ts+1658, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:78:3:
		if libc.Xiswxdigit(tls, uint32((*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i])) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:78:26:
			t_printf(tls, __ccgo_ts+1735, libc.VaList(bp+3120, (*(*[257]wchar_t)(unsafe.Pointer(bp + 28)))[i], i))
		}
		goto _13
	_13:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clocale_mbfuncs.c:81:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1813, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1823, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1915, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1920, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1927, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1945, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1953, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1958, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2001, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2050) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2058) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2070) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2082) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2094) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2103) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1914) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2103) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2109, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "C\x00src/functional/clocale_mbfuncs.c:23: MB_CUR_MAX = %d, expected 1\n\x00src/functional/clocale_mbfuncs.c:28: mbrtowc failed to convert byte %.2x to wchar_t\n\x00src/functional/clocale_mbfuncs.c:30: btowc failed to convert byte %.2x to wchar_t\n\x00src/functional/clocale_mbfuncs.c:35: bytes %.2x and %.2x map to same wchar_t %.4x\n\x00src/functional/clocale_mbfuncs.c:42: wctob failed to convert wchar_t %.4x back to byte %.2x\n\x00src/functional/clocale_mbfuncs.c:49: wctob accepted non-image wchar_t %.4x as byte %.2x\n\x00src/functional/clocale_mbfuncs.c:52: wcrtomb accepted non-image wchar_t %.4x\n\x00src/functional/clocale_mbfuncs.c:55: additional %d non-image errors (not printed)\n\x00src/functional/clocale_mbfuncs.c:60: wcsrtombs returned %zd, expected 255\n\x00src/functional/clocale_mbfuncs.c:62: mbsrtowcs returned %zd, expected 255\n\x00src/functional/clocale_mbfuncs.c:64: wcsrtombs/mbsrtowcs round trip failed\n\x00src/functional/clocale_mbfuncs.c:67: iswalnum returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:68: iswalpha returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:69: iswblank returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:70: iswcntrl returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:71: iswdigit returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:72: iswgraph returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:73: iswlower returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:74: iswprint returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:75: iswpunct returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:76: iswspace returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:77: iswupper returned true for %.4x (%.2x)\n\x00src/functional/clocale_mbfuncs.c:78: iswxdigit returned true for %.4x (%.2x)\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
