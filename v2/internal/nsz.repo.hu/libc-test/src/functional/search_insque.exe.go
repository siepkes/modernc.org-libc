// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/search_insque.exe.go src/functional/search_insque.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:8:1:
type q = struct {
	Fn uintptr
	Fp uintptr
	Fi int32
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:14:17:
func new1(tls *libc.TLS, i int32) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:15:1:
	var q1 uintptr
	_ = q1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:16:11:
	q1 = libc.Xmalloc(tls, uint32(12))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:17:2:
	(*q)(unsafe.Pointer(q1)).Fi = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:18:2:
	return q1
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:21:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:22:1:
	var i, v2 int32
	var p, q1 uintptr
	_, _, _, _ = i, p, q1, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:23:11:
	q1 = new1(tls, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:27:2:
	libc.Xinsque(tls, q1, uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:28:2:
	i = int32(1)
	for {
		if !(i < int32(10)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:29:3:
		libc.Xinsque(tls, new1(tls, i), q1)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:30:3:
		q1 = (*q)(unsafe.Pointer(q1)).Fn
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:32:2:
	p = q1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:33:2:
	for q1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:34:3:
		i--
		v2 = i
		if (*q)(unsafe.Pointer(q1)).Fi != v2 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:35:4:
			t_printf(tls, __ccgo_ts, libc.VaList(bp+8, (*q)(unsafe.Pointer(q1)).Fi, i))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:36:3:
		q1 = (*q)(unsafe.Pointer(q1)).Fp
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:38:2:
	libc.Xremque(tls, (*q)(unsafe.Pointer(p)).Fp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:39:2:
	if (*q)(unsafe.Pointer((*q)(unsafe.Pointer(p)).Fp)).Fi != (*q)(unsafe.Pointer(p)).Fi-int32(2) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:40:3:
		t_printf(tls, __ccgo_ts+69, libc.VaList(bp+8, (*q)(unsafe.Pointer((*q)(unsafe.Pointer(p)).Fp)).Fi, (*q)(unsafe.Pointer(p)).Fi-int32(2)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:41:2:
	if (*q)(unsafe.Pointer((*q)(unsafe.Pointer((*q)(unsafe.Pointer(p)).Fp)).Fn)).Fi != (*q)(unsafe.Pointer(p)).Fi {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:42:3:
		t_printf(tls, __ccgo_ts+131, libc.VaList(bp+8, (*q)(unsafe.Pointer((*q)(unsafe.Pointer((*q)(unsafe.Pointer(p)).Fp)).Fn)).Fi, (*q)(unsafe.Pointer(p)).Fi))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/search_insque.c:43:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+430) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+438) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+450) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+462) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+474) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+483) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+294) != 0
