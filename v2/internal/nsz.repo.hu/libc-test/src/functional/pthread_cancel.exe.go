// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/pthread_cancel.exe.go src/functional/pthread_cancel.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/pthread.h:69:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:10:13:
func start_async(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:11:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:12:2:
	pthread_setcanceltype(tls, int32(PTHREAD_CANCEL_ASYNCHRONOUS), uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:13:2:
	libc.Xsem_post(tls, arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:14:2:
	for {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:14:10:
		goto _1
	_1:
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:15:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:18:13:
func cleanup1(tls *libc.TLS, arg uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:19:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:20:2:
	*(*int32)(unsafe.Pointer(arg)) = int32(1)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:23:13:
func cleanup2(tls *libc.TLS, arg uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:24:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:25:2:
	*(*int32)(unsafe.Pointer(arg)) += int32(2)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:28:13:
func cleanup3(tls *libc.TLS, arg uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:29:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:30:2:
	*(*int32)(unsafe.Pointer(arg)) += int32(3)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:33:13:
func cleanup4(tls *libc.TLS, arg uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:34:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:35:2:
	*(*int32)(unsafe.Pointer(arg)) += int32(4)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:38:13:
func start_single(tls *libc.TLS, arg uintptr) (r uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:39:1:
	var _ /* __cb at bp+0 */ __ptcb
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:40:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:40:2:
	pthread_cleanup_push(tls, bp, __ccgo_fp(cleanup1), arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:40:37:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:41:2:
	libc.Xsleep(tls, uint32(3))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:42:2:
	pthread_cleanup_pop(tls, bp, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:43:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:46:13:
func start_nested(tls *libc.TLS, arg uintptr) (r uintptr) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:47:1:
	var foo uintptr
	var _ /* __cb at bp+0 */ __ptcb
	var _ /* __cb at bp+12 */ __ptcb
	var _ /* __cb at bp+24 */ __ptcb
	var _ /* __cb at bp+36 */ __ptcb
	_ = foo
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:48:6:
	foo = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:49:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:49:2:
	pthread_cleanup_push(tls, bp, __ccgo_fp(cleanup1), foo)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:49:37:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:50:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:50:2:
	pthread_cleanup_push(tls, bp+12, __ccgo_fp(cleanup2), foo+uintptr(1)*4)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:50:39:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:51:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:51:2:
	pthread_cleanup_push(tls, bp+24, __ccgo_fp(cleanup3), foo+uintptr(2)*4)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:51:39:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:52:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:52:2:
	pthread_cleanup_push(tls, bp+36, __ccgo_fp(cleanup4), foo+uintptr(3)*4)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:52:39:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:53:2:
	libc.Xsleep(tls, uint32(3))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:54:2:
	pthread_cleanup_pop(tls, bp+36, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:55:2:
	pthread_cleanup_pop(tls, bp+24, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:56:2:
	pthread_cleanup_pop(tls, bp+12, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:57:2:
	pthread_cleanup_pop(tls, bp, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:58:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:61:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:62:1:
	var r, v1, v10, v12, v14, v18, v20, v22, v3, v5, v7 int32
	var v11, v13, v15, v16, v17, v19, v2, v21, v23, v24, v25, v26, v27, v28, v4, v6, v8, v9 bool
	var _ /* foo at bp+24 */ [4]int32
	var _ /* res at bp+20 */ uintptr
	var _ /* sem1 at bp+4 */ sem_t
	var _ /* td at bp+0 */ pthread_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = r, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v26, v27, v28, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:69:2:
	v1 = libc.Xsem_init(tls, bp+4, 0, uint32(0))
	r = v1
	if v2 = v1 == 0; !v2 {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+48, __ccgo_ts+72, libc.Xstrerror(tls, r)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	/* Asynchronous cancellation */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:72:2:
	v3 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start_async), bp+4)
	r = v3
	if v4 = v3 == 0; !v4 {
		t_printf(tls, __ccgo_ts+94, libc.VaList(bp+48, __ccgo_ts+171, libc.Xstrerror(tls, r)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:73:2:
	for libc.Xsem_wait(tls, bp+4) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:73:25:
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:74:2:
	v5 = pthread_cancel(tls, *(*pthread_t)(unsafe.Pointer(bp)))
	r = v5
	if v6 = v5 == 0; !v6 {
		t_printf(tls, __ccgo_ts+214, libc.VaList(bp+48, __ccgo_ts+277, libc.Xstrerror(tls, r)))
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:75:2:
	v7 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+20)
	r = v7
	if v8 = v7 == 0; !v8 {
		t_printf(tls, __ccgo_ts+296, libc.VaList(bp+48, __ccgo_ts+373, libc.Xstrerror(tls, r)))
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:76:2:
	if v9 = *(*uintptr)(unsafe.Pointer(bp + 20)) == uintptr(-libc.Int32FromInt32(1)); !v9 {
		t_printf(tls, __ccgo_ts+396, libc.VaList(bp+48, __ccgo_ts+473))
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	/* Cancellation cleanup handlers */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:79:2:
	(*(*[4]int32)(unsafe.Pointer(bp + 24)))[0] = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:80:2:
	v10 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start_single), bp+24)
	r = v10
	if v11 = v10 == 0; !v11 {
		t_printf(tls, __ccgo_ts+497, libc.VaList(bp+48, __ccgo_ts+574, libc.Xstrerror(tls, r)))
	}
	_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:81:2:
	v12 = pthread_cancel(tls, *(*pthread_t)(unsafe.Pointer(bp)))
	r = v12
	if v13 = v12 == 0; !v13 {
		t_printf(tls, __ccgo_ts+616, libc.VaList(bp+48, __ccgo_ts+277, libc.Xstrerror(tls, r)))
	}
	_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:82:2:
	v14 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+20)
	r = v14
	if v15 = v14 == 0; !v15 {
		t_printf(tls, __ccgo_ts+680, libc.VaList(bp+48, __ccgo_ts+373, libc.Xstrerror(tls, r)))
	}
	_ = v15 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:83:2:
	if v16 = *(*uintptr)(unsafe.Pointer(bp + 20)) == uintptr(-libc.Int32FromInt32(1)); !v16 {
		t_printf(tls, __ccgo_ts+757, libc.VaList(bp+48, __ccgo_ts+473))
	}
	_ = v16 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:84:2:
	if v17 = (*(*[4]int32)(unsafe.Pointer(bp + 24)))[0] == int32(1); !v17 {
		t_printf(tls, __ccgo_ts+834, libc.VaList(bp+48, __ccgo_ts+913))
	}
	_ = v17 || libc.Bool(libc.Int32FromInt32(0) != 0)
	/* Nested cleanup handlers */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:87:2:
	libc.Xmemset(tls, bp+24, 0, uint32(16))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:88:2:
	v18 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start_nested), bp+24)
	r = v18
	if v19 = v18 == 0; !v19 {
		t_printf(tls, __ccgo_ts+925, libc.VaList(bp+48, __ccgo_ts+1002, libc.Xstrerror(tls, r)))
	}
	_ = v19 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:89:2:
	v20 = pthread_cancel(tls, *(*pthread_t)(unsafe.Pointer(bp)))
	r = v20
	if v21 = v20 == 0; !v21 {
		t_printf(tls, __ccgo_ts+1044, libc.VaList(bp+48, __ccgo_ts+277, libc.Xstrerror(tls, r)))
	}
	_ = v21 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:90:2:
	v22 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+20)
	r = v22
	if v23 = v22 == 0; !v23 {
		t_printf(tls, __ccgo_ts+1108, libc.VaList(bp+48, __ccgo_ts+373, libc.Xstrerror(tls, r)))
	}
	_ = v23 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:91:2:
	if v24 = *(*uintptr)(unsafe.Pointer(bp + 20)) == uintptr(-libc.Int32FromInt32(1)); !v24 {
		t_printf(tls, __ccgo_ts+1185, libc.VaList(bp+48, __ccgo_ts+473))
	}
	_ = v24 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:92:2:
	if v25 = (*(*[4]int32)(unsafe.Pointer(bp + 24)))[0] == int32(1); !v25 {
		t_printf(tls, __ccgo_ts+1262, libc.VaList(bp+48, __ccgo_ts+913))
	}
	_ = v25 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:93:2:
	if v26 = (*(*[4]int32)(unsafe.Pointer(bp + 24)))[int32(1)] == int32(2); !v26 {
		t_printf(tls, __ccgo_ts+1341, libc.VaList(bp+48, __ccgo_ts+1420))
	}
	_ = v26 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:94:2:
	if v27 = (*(*[4]int32)(unsafe.Pointer(bp + 24)))[int32(2)] == int32(3); !v27 {
		t_printf(tls, __ccgo_ts+1432, libc.VaList(bp+48, __ccgo_ts+1511))
	}
	_ = v27 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:95:2:
	if v28 = (*(*[4]int32)(unsafe.Pointer(bp + 24)))[int32(3)] == int32(4); !v28 {
		t_printf(tls, __ccgo_ts+1523, libc.VaList(bp+48, __ccgo_ts+1602))
	}
	_ = v28 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_cancel.c:97:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1614, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1624, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1716, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1721, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1728, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1746, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1754, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1759, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1802, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1851) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1859) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1871) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1883) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1895) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1904) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1715) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1904) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1910, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/pthread_cancel.c:69: %s failed: %s (creating semaphore)\n\x00sem_init(&sem1, 0, 0)\x00src/functional/pthread_cancel.c:72: %s failed: %s (failed to create thread)\n\x00pthread_create(&td, 0, start_async, &sem1)\x00src/functional/pthread_cancel.c:74: %s failed: %s (canceling)\n\x00pthread_cancel(td)\x00src/functional/pthread_cancel.c:75: %s failed: %s (joining canceled thread)\n\x00pthread_join(td, &res)\x00src/functional/pthread_cancel.c:76: %s failed (canceled thread exit status)\n\x00res == PTHREAD_CANCELED\x00src/functional/pthread_cancel.c:80: %s failed: %s (failed to create thread)\n\x00pthread_create(&td, 0, start_single, foo)\x00src/functional/pthread_cancel.c:81: %s failed: %s (cancelling)\n\x00src/functional/pthread_cancel.c:82: %s failed: %s (joining canceled thread)\n\x00src/functional/pthread_cancel.c:83: %s failed (canceled thread exit status)\n\x00src/functional/pthread_cancel.c:84: %s failed (cleanup handler failed to run)\n\x00foo[0] == 1\x00src/functional/pthread_cancel.c:88: %s failed: %s (failed to create thread)\n\x00pthread_create(&td, 0, start_nested, foo)\x00src/functional/pthread_cancel.c:89: %s failed: %s (cancelling)\n\x00src/functional/pthread_cancel.c:90: %s failed: %s (joining canceled thread)\n\x00src/functional/pthread_cancel.c:91: %s failed (canceled thread exit status)\n\x00src/functional/pthread_cancel.c:92: %s failed (cleanup handler failed to run)\n\x00src/functional/pthread_cancel.c:93: %s failed (cleanup handler failed to run)\n\x00foo[1] == 2\x00src/functional/pthread_cancel.c:94: %s failed (cleanup handler failed to run)\n\x00foo[2] == 3\x00src/functional/pthread_cancel.c:95: %s failed (cleanup handler failed to run)\n\x00foo[3] == 4\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
