// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/strftime.exe.go src/functional/strftime.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/limits.h:18:9:
const CHAR_BIT = 8

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/limits.h:26:9:
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:7:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:7:13:
var buffer [100]int8

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:9:13:
func checkStrftime(tls *libc.TLS, format uintptr, tm uintptr, expected uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:10:25:
	var resultLength size_t
	_ = resultLength
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:11:9:
	resultLength = libc.Xstrftime(tls, uintptr(unsafe.Pointer(&buffer)), uint32(100), format, tm)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:13:2:
	if resultLength != uint32(0) && libc.Xstrcmp(tls, uintptr(unsafe.Pointer(&buffer)), expected) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:14:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, format, expected, uintptr(unsafe.Pointer(&buffer))))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:15:9:
		if resultLength == uint32(0) && libc.Xstrlen(tls, expected) != uint32(0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:16:3:
			t_printf(tls, __ccgo_ts+61, libc.VaList(bp+8, format, expected))
		}
	}
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:20:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:20:18:
var tm1 = tm{
	Ftm_sec:   int32(45),
	Ftm_min:   int32(23),
	Ftm_hour:  int32(13),
	Ftm_mday:  int32(3),
	Ftm_mon:   int32(0),
	Ftm_year:  libc.Int32FromInt32(2016) - libc.Int32FromInt32(1900),
	Ftm_wday:  int32(0),
	Ftm_yday:  int32(2),
	Ftm_isdst: int32(0),
}
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:32:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:32:18:
var tm2 = tm{
	Ftm_sec:   int32(53),
	Ftm_min:   int32(17),
	Ftm_hour:  int32(5),
	Ftm_mday:  int32(5),
	Ftm_mon:   int32(0),
	Ftm_year:  libc.Int32FromInt32(10009) - libc.Int32FromInt32(1900),
	Ftm_wday:  int32(1),
	Ftm_yday:  int32(4),
	Ftm_isdst: int32(0),
}
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:44:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:44:18:
var tm3 = tm{
	Ftm_sec:   int32(0),
	Ftm_min:   int32(0),
	Ftm_hour:  int32(12),
	Ftm_mday:  int32(23),
	Ftm_mon:   int32(1),
	Ftm_year:  libc.Int32FromInt32(0) - libc.Int32FromInt32(1900),
	Ftm_wday:  int32(3),
	Ftm_yday:  int32(53),
	Ftm_isdst: int32(0),
}
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:56:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:56:18:
var tm4 = tm{
	Ftm_sec:   int32(0),
	Ftm_min:   int32(0),
	Ftm_hour:  int32(0),
	Ftm_mday:  int32(1),
	Ftm_mon:   int32(0),
	Ftm_year:  -libc.Int32FromInt32(123) - libc.Int32FromInt32(1900),
	Ftm_wday:  int32(1),
	Ftm_yday:  int32(0),
	Ftm_isdst: int32(0),
}
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:68:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:68:18:
var tm5 = tm{
	Ftm_sec:   int32(0),
	Ftm_min:   int32(0),
	Ftm_hour:  int32(0),
	Ftm_mday:  int32(1),
	Ftm_mon:   int32(0),
	Ftm_year:  int32(INT_MAX),
	Ftm_wday:  int32(3),
	Ftm_yday:  int32(0),
	Ftm_isdst: int32(0),
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:80:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:80:12:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:81:2:
	libc.Xsetenv(tls, __ccgo_ts+125, __ccgo_ts+128, int32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:83:2:
	checkStrftime(tls, __ccgo_ts+133, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+136)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:84:2:
	checkStrftime(tls, __ccgo_ts+133, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+161)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:85:2:
	checkStrftime(tls, __ccgo_ts+133, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+188)
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:90:2:
	checkStrftime(tls, __ccgo_ts+213, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+216)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:91:2:
	checkStrftime(tls, __ccgo_ts+219, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+224)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:92:2:
	checkStrftime(tls, __ccgo_ts+228, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+233)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:93:2:
	checkStrftime(tls, __ccgo_ts+213, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+237)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:94:2:
	checkStrftime(tls, __ccgo_ts+213, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+241)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:95:2:
	checkStrftime(tls, __ccgo_ts+244, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+249)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:97:2:
	checkStrftime(tls, __ccgo_ts+251, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+254)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:98:2:
	checkStrftime(tls, __ccgo_ts+265, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+271)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:99:2:
	checkStrftime(tls, __ccgo_ts+284, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+254)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:100:2:
	checkStrftime(tls, __ccgo_ts+290, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+296)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:101:2:
	checkStrftime(tls, __ccgo_ts+251, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+308)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:102:2:
	checkStrftime(tls, __ccgo_ts+321, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+327)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:103:2:
	checkStrftime(tls, __ccgo_ts+251, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+339)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:104:2:
	checkStrftime(tls, __ccgo_ts+350, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+355)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:105:2:
	checkStrftime(tls, __ccgo_ts+363, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+355)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:106:2:
	checkStrftime(tls, __ccgo_ts+368, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+339)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:107:2:
	checkStrftime(tls, __ccgo_ts+251, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+374)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:108:2:
	checkStrftime(tls, __ccgo_ts+321, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+385)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:110:2:
	checkStrftime(tls, __ccgo_ts+397, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+400)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:111:2:
	checkStrftime(tls, __ccgo_ts+397, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+403)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:113:2:
	checkStrftime(tls, __ccgo_ts+406, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+409)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:114:2:
	checkStrftime(tls, __ccgo_ts+414, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+419)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:115:2:
	checkStrftime(tls, __ccgo_ts+425, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+430)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:117:2:
	checkStrftime(tls, __ccgo_ts+436, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+439)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:118:2:
	checkStrftime(tls, __ccgo_ts+436, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+451)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:119:2:
	checkStrftime(tls, __ccgo_ts+436, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+463)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:120:2:
	checkStrftime(tls, __ccgo_ts+436, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+475)
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:124:2:
	checkStrftime(tls, __ccgo_ts+487, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+490)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:125:2:
	if libc.Uint32FromInt64(8)*libc.Uint32FromInt32(CHAR_BIT) >= uint32(64) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:126:3:
		checkStrftime(tls, __ccgo_ts+487, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+501)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:129:2:
	checkStrftime(tls, __ccgo_ts+514, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+517)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:130:2:
	checkStrftime(tls, __ccgo_ts+514, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+526)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:131:2:
	checkStrftime(tls, __ccgo_ts+514, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+535)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:132:2:
	checkStrftime(tls, __ccgo_ts+514, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+544)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:134:2:
	checkStrftime(tls, __ccgo_ts+553, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+556)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:135:2:
	checkStrftime(tls, __ccgo_ts+553, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+556)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:136:2:
	checkStrftime(tls, __ccgo_ts+553, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+559)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:138:2:
	checkStrftime(tls, __ccgo_ts+562, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+565)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:139:2:
	checkStrftime(tls, __ccgo_ts+562, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+568)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:140:2:
	checkStrftime(tls, __ccgo_ts+562, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+559)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:142:2:
	checkStrftime(tls, __ccgo_ts+571, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+241)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:143:2:
	checkStrftime(tls, __ccgo_ts+571, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+556)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:144:2:
	checkStrftime(tls, __ccgo_ts+571, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+559)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:146:2:
	checkStrftime(tls, __ccgo_ts+574, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+577)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:147:2:
	checkStrftime(tls, __ccgo_ts+586, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+517)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:148:2:
	checkStrftime(tls, __ccgo_ts+589, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+592)
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:156:2:
	checkStrftime(tls, __ccgo_ts+595, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+598)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:157:2:
	checkStrftime(tls, __ccgo_ts+603, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+608)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:158:2:
	checkStrftime(tls, __ccgo_ts+614, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+598)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:159:2:
	checkStrftime(tls, __ccgo_ts+619, uintptr(unsafe.Pointer(&tm1)), __ccgo_ts+624)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:160:2:
	checkStrftime(tls, __ccgo_ts+595, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+630)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:161:2:
	checkStrftime(tls, __ccgo_ts+603, uintptr(unsafe.Pointer(&tm2)), __ccgo_ts+430)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:162:2:
	checkStrftime(tls, __ccgo_ts+595, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+637)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:163:2:
	checkStrftime(tls, __ccgo_ts+642, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+241)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:164:2:
	checkStrftime(tls, __ccgo_ts+619, uintptr(unsafe.Pointer(&tm3)), __ccgo_ts+647)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:165:2:
	checkStrftime(tls, __ccgo_ts+595, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+653)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:166:2:
	checkStrftime(tls, __ccgo_ts+614, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+653)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:167:2:
	checkStrftime(tls, __ccgo_ts+619, uintptr(unsafe.Pointer(&tm4)), __ccgo_ts+658)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:169:2:
	if true {
		// The standard does not specify any range for tm_year, so INT_MAX
		// should be valid.
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:172:3:
		checkStrftime(tls, __ccgo_ts+589, uintptr(unsafe.Pointer(&tm5)), __ccgo_ts+664)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:173:3:
		checkStrftime(tls, __ccgo_ts+595, uintptr(unsafe.Pointer(&tm5)), __ccgo_ts+667)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:174:3:
		checkStrftime(tls, __ccgo_ts+679, uintptr(unsafe.Pointer(&tm5)), __ccgo_ts+685)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:175:3:
		if libc.Uint32FromInt64(8)*libc.Uint32FromInt32(CHAR_BIT) >= uint32(64) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:176:4:
			checkStrftime(tls, __ccgo_ts+487, uintptr(unsafe.Pointer(&tm5)), __ccgo_ts+697)
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strftime.c:180:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+715, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+725, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+817, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+822, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+487, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+842, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+850, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+855, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+898, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+947) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+955) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+967) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+979) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+991) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1000) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+816) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1000) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1006, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/strftime.c:14: \"%s\": expected \"%s\", got \"%s\"\n\x00src/functional/strftime.c:16: \"%s\": expected \"%s\", got nothing\n\x00TZ\x00UTC0\x00%c\x00Sun Jan  3 13:23:45 2016\x00Mon Jan  5 05:17:53 +10009\x00Wed Feb 23 12:00:00 0000\x00%C\x0020\x00%03C\x00020\x00%+3C\x00+20\x00100\x0000\x00%01C\x000\x00%F\x002016-01-03\x00%012F\x00002016-01-03\x00%+10F\x00%+11F\x00+2016-01-03\x00+10009-01-05\x00%011F\x0010009-01-05\x000000-02-23\x00%01F\x000-02-23\x00%06F\x00%010F\x00-123-01-01\x00-0123-01-01\x00%g\x0015\x0009\x00%G\x002015\x00%+5G\x00+2015\x00%04G\x0010009\x00%r\x0001:23:45 PM\x0005:17:53 AM\x0012:00:00 PM\x0012:00:00 AM\x00%s\x001451827425\x00253686748673\x00%T\x0013:23:45\x0005:17:53\x0012:00:00\x0000:00:00\x00%U\x0001\x0008\x00%V\x0053\x0002\x00%W\x00%x\x0001/03/16\x00%X\x00%y\x0016\x00%Y\x002016\x00%05Y\x0002016\x00%+4Y\x00%+5Y\x00+2016\x00+10009\x000000\x00%02Y\x00+0000\x00-123\x00-0123\x0047\x00+2147485547\x00%011Y\x0002147485547\x0067768036160140800\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
