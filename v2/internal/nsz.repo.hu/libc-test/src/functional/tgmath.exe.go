// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/tgmath.exe.go src/functional/tgmath.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:4:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:5:1:
	var i int32
	_ = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:8:2:
	i = libc.Xlrint(tls, float64(libc.Float32FromFloat32(1.234567891e+08))) & int32(0x7fffffff)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:9:2:
	if i != int32(123456792) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:10:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, i))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:11:2:
	i = libc.Xlrint(tls, float64(1.234567891e+08)) & int32(0x7fffffff)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:12:2:
	if i != int32(123456789) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:13:3:
		t_printf(tls, __ccgo_ts+83, libc.VaList(bp+8, i))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:15:2:
	if float64(libc.Float32FromComplex128(libc.Complex128FromFloat64(libc.Xsqrt(tls, float64(libc.Float32FromFloat32(2)))))) != float64(1.4142135381698608) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:16:3:
		t_printf(tls, __ccgo_ts+165, libc.VaList(bp+8, float64(libc.Float32FromComplex128(libc.Complex128FromFloat64(libc.Xsqrt(tls, float64(libc.Float32FromFloat32(2))))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:17:2:
	if libc.Float64FromComplex128(libc.Complex128FromComplex64(libc.Xcsqrtf(tls, libc.Complex64FromFloat64(libc.Float64FromFloat64(2))))) != float64(1.4142135623730951) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:18:3:
		t_printf(tls, __ccgo_ts+231, libc.VaList(bp+8, libc.Float64FromComplex128(libc.Complex128FromComplex64(libc.Xcsqrtf(tls, libc.Complex64FromFloat64(libc.Float64FromFloat64(2)))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:19:2:
	if float64(libc.Int32FromComplex128(libc.Complex128FromFloat64(libc.Xsqrt(tls, float64(libc.Int32FromInt32(2)))))) != float64(1.4142135623730951) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:20:3:
		t_printf(tls, __ccgo_ts+303, libc.VaList(bp+8, libc.Float64FromComplex128(libc.Complex128FromComplex64(libc.Xcsqrtf(tls, libc.Complex64FromFloat64(libc.Float64FromFloat64(2)))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:22:2:
	if uint32(4) != uint32(8) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:23:3:
		t_printf(tls, __ccgo_ts+373, libc.VaList(bp+8, libc.Int32FromInt64(8), libc.Int32FromInt64(4)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:24:2:
	if uint32(8) != uint32(8) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:25:3:
		t_printf(tls, __ccgo_ts+442, libc.VaList(bp+8, libc.Int32FromInt64(8), libc.Int32FromInt64(8)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:26:2:
	if uint32(4) != uint32(4) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:27:3:
		t_printf(tls, __ccgo_ts+506, libc.VaList(bp+8, libc.Int32FromInt64(4), libc.Int32FromInt64(4)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:28:2:
	if uint32(8) != uint32(16) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:29:3:
		t_printf(tls, __ccgo_ts+572, libc.VaList(bp+8, libc.Int32FromInt64(16), libc.Int32FromInt64(8)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:31:2:
	if libc.Float64FromComplex128(libc.Complex128FromComplex64(libc.Xcpowf(tls, libc.Complex64FromFloat64(libc.Float64FromFloat64(2)), libc.Complex64FromFloat64(libc.Float64FromFloat64(0.5))))) != float64(1.4142135623730951) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:32:3:
		t_printf(tls, __ccgo_ts+640, libc.VaList(bp+8, libc.Float64FromComplex128(libc.Complex128FromComplex64(libc.Xcpowf(tls, libc.Complex64FromFloat64(libc.Float64FromFloat64(2)), libc.Complex64FromFloat64(libc.Float64FromFloat64(0.5)))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:33:2:
	if libc.Float64FromComplex128(libc.Complex128FromComplex128(libc.Xcpow(tls, libc.Complex128FromInt32(libc.Int32FromInt32(2)), libc.Complex128FromFloat64(libc.Float64FromFloat64(0.5))))) != float64(1.4142135623730951) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:34:3:
		t_printf(tls, __ccgo_ts+715, libc.VaList(bp+8, libc.Float64FromComplex128(libc.Complex128FromComplex128(libc.Xcpow(tls, libc.Complex128FromInt32(libc.Int32FromInt32(2)), libc.Complex128FromFloat64(libc.Float64FromFloat64(0.5)))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:35:2:
	if float64(libc.Float32FromComplex128(libc.Complex128FromFloat64(libc.Xpow(tls, float64(libc.Int32FromInt32(2)), float64(libc.Float32FromFloat32(0.5)))))) != float64(1.4142135623730951) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:36:3:
		t_printf(tls, __ccgo_ts+788, libc.VaList(bp+8, float64(libc.Float32FromComplex128(libc.Complex128FromFloat64(libc.Xpow(tls, float64(libc.Int32FromInt32(2)), float64(libc.Float32FromFloat32(0.5))))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tgmath.c:38:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+862, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+872, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+964, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+969, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+976, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+994, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1002, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1007, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1050, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1099) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1107) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1119) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1131) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1143) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1152) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+963) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1152) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1158, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/tgmath.c:10: lrint(123456789.1f)&0x7fffffff want 123456792 got %ld\n\x00src/functional/tgmath.c:13: lrint(123456789.1)&0x7fffffff want 123456789 got %ld\n\x00src/functional/tgmath.c:16: sqrt(2.0f) want 0x1.6a09e6p+0 got %a\n\x00src/functional/tgmath.c:18: sqrt(2.0) want 0x1.6a09e667f3bcdp+0 got %a\n\x00src/functional/tgmath.c:20: sqrt(2) want 0x1.6a09e667f3bcdp+0 got %a\n\x00src/functional/tgmath.c:23: sizeof pow(sqrt(8),0.5f) want %d got %d\n\x00src/functional/tgmath.c:25: sizeof pow(2.0,0.5) want %d got %d\n\x00src/functional/tgmath.c:27: sizeof pow(2.0f,0.5f) want %d got %d\n\x00src/functional/tgmath.c:29: sizeof pow(2.0,0.5+0*I) want %d got %d\n\x00src/functional/tgmath.c:32: pow(2.0,0.5) want 0x1.6a09e667f3bcdp+0 got %a\n\x00src/functional/tgmath.c:34: pow(2,0.5) want 0x1.6a09e667f3bcdp+0 got %a\n\x00src/functional/tgmath.c:36: pow(2,0.5f) want 0x1.6a09e667f3bcdp+0 got %a\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
