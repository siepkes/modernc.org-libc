// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/ipc_shm.exe.go src/functional/ipc_shm.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/shm.h:29:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/shm.h:3:1:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/shm.h:23:1:
type shminfo = struct {
	Fshmmax   uint32
	Fshmmin   uint32
	Fshmmni   uint32
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/shm.h:27:1:
type shm_info = struct {
	Fused_ids       int32
	Fshm_tot        uint32
	Fshm_rss        uint32
	Fshm_swp        uint32
	Fswap_attempts  uint32
	Fswap_successes uint32
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/shm.h:59:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/shm.h:59:23:
type shmatt_t = uint32
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:14:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:14:19:
var path = [2]int8{'.'}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:15:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:15:18:
var id = int32('h')

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:27:13:
func set(tls *libc.TLS) {
	bp := tls.Alloc(160)
	defer tls.Free(160)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:28:1:
	var k, v2 key_t
	var p, v5 uintptr
	var shmid, v3, v4 int32
	var t, v1 time_t
	var _ /* shmid_ds at bp+0 */ shmid_ds
	_, _, _, _, _, _, _, _, _ = k, p, shmid, t, v1, v2, v3, v4, v5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:35:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:35:2:
	v1 = libc.Xtime(tls, uintptr(0))
	t = v1
	if v1+int64(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:35:2:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+120, __ccgo_ts+44, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:36:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:36:2:
	v2 = libc.Xftok(tls, uintptr(unsafe.Pointer(&path)), id)
	k = v2
	if v2+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:36:2:
		t_printf(tls, __ccgo_ts+56, libc.VaList(bp+120, __ccgo_ts+100, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	/* make sure we get a clean shared memory id */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:39:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:39:2:
	v3 = libc.Xshmget(tls, k, uint32(100), libc.Int32FromInt32(IPC_CREAT)|libc.Int32FromInt32(0666))
	shmid = v3
	if v3+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:39:2:
		t_printf(tls, __ccgo_ts+119, libc.VaList(bp+120, __ccgo_ts+163, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:40:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:40:2:
	if libc.Xshmctl(tls, shmid, IPC_RMID, uintptr(0))+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:40:2:
		t_printf(tls, __ccgo_ts+202, libc.VaList(bp+120, __ccgo_ts+246, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:41:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:41:2:
	v4 = libc.Xshmget(tls, k, uint32(100), libc.Int32FromInt32(IPC_CREAT)|libc.Int32FromInt32(IPC_EXCL)|libc.Int32FromInt32(0666))
	shmid = v4
	if v4+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:41:2:
		t_printf(tls, __ccgo_ts+273, libc.VaList(bp+120, __ccgo_ts+317, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:43:2:
	if libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:44:3:
		libc.Xexit(tls, libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))))
	}
	/* check IPC_EXCL */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:47:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:48:2:
	if libc.Xshmget(tls, k, uint32(100), libc.Int32FromInt32(IPC_CREAT)|libc.Int32FromInt32(IPC_EXCL)|libc.Int32FromInt32(0666)) != -int32(1) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EEXIST) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:49:3:
		t_printf(tls, __ccgo_ts+365, libc.VaList(bp+120, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	/* check if shmget initilaized the msshmid_ds structure correctly */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:52:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:52:2:
	if libc.Xshmctl(tls, shmid, int32(IPC_STAT), bp)+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:52:2:
		t_printf(tls, __ccgo_ts+461, libc.VaList(bp+120, __ccgo_ts+505, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:53:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:53:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fcuid != libc.Xgeteuid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:53:2:
		t_printf(tls, __ccgo_ts+540, libc.VaList(bp+120, __ccgo_ts+603, __ccgo_ts+626, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fcuid, libc.Xgeteuid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:54:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:54:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fuid != libc.Xgeteuid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:54:2:
		t_printf(tls, __ccgo_ts+636, libc.VaList(bp+120, __ccgo_ts+699, __ccgo_ts+626, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fuid, libc.Xgeteuid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:55:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:55:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fcgid != libc.Xgetegid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:55:2:
		t_printf(tls, __ccgo_ts+721, libc.VaList(bp+120, __ccgo_ts+784, __ccgo_ts+807, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fcgid, libc.Xgetegid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:56:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:56:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fgid != libc.Xgetegid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:56:2:
		t_printf(tls, __ccgo_ts+817, libc.VaList(bp+120, __ccgo_ts+880, __ccgo_ts+807, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fgid, libc.Xgetegid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:57:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:57:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fmode&uint32(0x1ff) != uint32(libc.Int32FromInt32(0666)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:57:2:
		t_printf(tls, __ccgo_ts+902, libc.VaList(bp+120, __ccgo_ts+965, __ccgo_ts+996, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_perm.Fmode&uint32(0x1ff), int32(0666)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:58:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:58:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_segsz != uint32(libc.Int32FromInt32(100)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:58:2:
		t_printf(tls, __ccgo_ts+1001, libc.VaList(bp+120, __ccgo_ts+1064, __ccgo_ts+1083, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_segsz, int32(100)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:59:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:59:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_lpid != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:59:2:
		t_printf(tls, __ccgo_ts+1087, libc.VaList(bp+120, __ccgo_ts+1150, __ccgo_ts+1168, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_lpid, 0))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:60:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:60:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_cpid != libc.Xgetpid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:60:2:
		t_printf(tls, __ccgo_ts+1170, libc.VaList(bp+120, __ccgo_ts+1233, __ccgo_ts+1251, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_cpid, libc.Xgetpid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:61:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:61:2:
	if int32((*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_nattch) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:61:2:
		t_printf(tls, __ccgo_ts+1260, libc.VaList(bp+120, __ccgo_ts+1323, __ccgo_ts+1168, int32((*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_nattch), 0))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:62:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:62:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_atime != int64(libc.Int32FromInt32(0)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:62:2:
		t_printf(tls, __ccgo_ts+1348, libc.VaList(bp+120, __ccgo_ts+1413, __ccgo_ts+1168, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_atime, 0))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:63:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:63:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_dtime != int64(libc.Int32FromInt32(0)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:63:2:
		t_printf(tls, __ccgo_ts+1443, libc.VaList(bp+120, __ccgo_ts+1508, __ccgo_ts+1168, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_dtime, 0))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:64:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_ctime < t {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:65:3:
		t_printf(tls, __ccgo_ts+1538, libc.VaList(bp+120, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_ctime, t))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:66:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_ctime > t+int64(5) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:67:3:
		t_printf(tls, __ccgo_ts+1623, libc.VaList(bp+120, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_ctime, t+int64(5)))
	}
	/* test attach */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:70:2:
	v5 = libc.Xshmat(tls, shmid, uintptr(0), 0)
	p = v5
	if v5 == uintptr(0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:71:3:
		t_printf(tls, __ccgo_ts+1710, libc.VaList(bp+120, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:72:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:72:2:
	if libc.Xshmctl(tls, shmid, int32(IPC_STAT), bp)+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:72:2:
		t_printf(tls, __ccgo_ts+1757, libc.VaList(bp+120, __ccgo_ts+505, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:73:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:73:2:
	if int32((*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_nattch) != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:73:2:
		t_printf(tls, __ccgo_ts+1801, libc.VaList(bp+120, __ccgo_ts+1323, __ccgo_ts+1864, int32((*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_nattch), int32(1)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:74:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:74:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_lpid != libc.Xgetpid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:74:2:
		t_printf(tls, __ccgo_ts+1866, libc.VaList(bp+120, __ccgo_ts+1150, __ccgo_ts+1251, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_lpid, libc.Xgetpid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:75:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_atime < t {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:76:3:
		t_printf(tls, __ccgo_ts+1929, libc.VaList(bp+120, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_atime, t))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:77:2:
	if (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_atime > t+int64(5) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:78:3:
		t_printf(tls, __ccgo_ts+1990, libc.VaList(bp+120, (*(*shmid_ds)(unsafe.Pointer(bp))).Fshm_atime, t+int64(5)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:79:2:
	libc.Xstrcpy(tls, p, __ccgo_ts+2051)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:80:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:80:2:
	if libc.Xshmdt(tls, p)+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:80:2:
		t_printf(tls, __ccgo_ts+2061, libc.VaList(bp+120, __ccgo_ts+2105, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:83:13:
func get(tls *libc.TLS) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:84:1:
	var k, v1 key_t
	var p, v3 uintptr
	var shmid, v2 int32
	_, _, _, _, _, _ = k, p, shmid, v1, v2, v3
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:89:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:89:2:
	v1 = libc.Xftok(tls, uintptr(unsafe.Pointer(&path)), id)
	k = v1
	if v1+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:89:2:
		t_printf(tls, __ccgo_ts+2114, libc.VaList(bp+8, __ccgo_ts+100, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:90:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:90:2:
	v2 = libc.Xshmget(tls, k, uint32(0), 0)
	shmid = v2
	if v2+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:90:2:
		t_printf(tls, __ccgo_ts+2158, libc.VaList(bp+8, __ccgo_ts+2202, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:92:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:93:2:
	v3 = libc.Xshmat(tls, shmid, uintptr(0), int32(SHM_RDONLY))
	p = v3
	if v3 == uintptr(0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:94:3:
		t_printf(tls, __ccgo_ts+2226, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:96:2:
	if libc.Xstrcmp(tls, p, __ccgo_ts+2051) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:97:3:
		t_printf(tls, __ccgo_ts+2273, libc.VaList(bp+8, p))
	}
	/* cleanup */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:100:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:100:2:
	if libc.Xshmdt(tls, p)+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:100:2:
		t_printf(tls, __ccgo_ts+2360, libc.VaList(bp+8, __ccgo_ts+2105, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:101:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:101:2:
	if libc.Xshmctl(tls, shmid, IPC_RMID, uintptr(0))+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:101:2:
		t_printf(tls, __ccgo_ts+2405, libc.VaList(bp+8, __ccgo_ts+246, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:104:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:105:1:
	var p int32
	var _ /* status at bp+0 */ int32
	_ = p
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:109:2:
	set(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:110:2:
	p = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:111:2:
	if p == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:112:3:
		t_printf(tls, __ccgo_ts+2450, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:113:7:
		if p == 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:114:3:
			get(tls)
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:116:3:
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:116:3:
			if libc.Xwaitpid(tls, p, bp, 0)+int32(1) == 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:116:3:
				t_printf(tls, __ccgo_ts+2497, libc.VaList(bp+16, __ccgo_ts+2542, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:117:3:
			if !!(*(*int32)(unsafe.Pointer(bp))&libc.Int32FromInt32(0x7f) != 0) || *(*int32)(unsafe.Pointer(bp))&int32(0xff00)>>int32(8) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:118:4:
				t_printf(tls, __ccgo_ts+2565, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp))))
			}
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_shm.c:120:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+2618, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+2628, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2720, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2725, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2730, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2748, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2756, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2761, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2804, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2853) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2861) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2873) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2885) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2897) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2906) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2719) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2906) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2912, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/ipc_shm.c:35: %s failed: %s\n\x00t = time(0)\x00src/functional/ipc_shm.c:36: %s failed: %s\n\x00k = ftok(path, id)\x00src/functional/ipc_shm.c:39: %s failed: %s\n\x00shmid = shmget(k, 100, IPC_CREAT|0666)\x00src/functional/ipc_shm.c:40: %s failed: %s\n\x00shmctl(shmid, IPC_RMID, 0)\x00src/functional/ipc_shm.c:41: %s failed: %s\n\x00shmid = shmget(k, 100, IPC_CREAT|IPC_EXCL|0666)\x00src/functional/ipc_shm.c:49: shmget(IPC_CREAT|IPC_EXCL) should have failed with EEXIST, got %s\n\x00src/functional/ipc_shm.c:52: %s failed: %s\n\x00shmctl(shmid, IPC_STAT, &shmid_ds)\x00src/functional/ipc_shm.c:53: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_perm.cuid\x00geteuid()\x00src/functional/ipc_shm.c:54: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_perm.uid\x00src/functional/ipc_shm.c:55: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_perm.cgid\x00getegid()\x00src/functional/ipc_shm.c:56: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_perm.gid\x00src/functional/ipc_shm.c:57: %s == %s failed: got %o, want %o\n\x00shmid_ds.shm_perm.mode & 0x1ff\x000666\x00src/functional/ipc_shm.c:58: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_segsz\x00100\x00src/functional/ipc_shm.c:59: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_lpid\x000\x00src/functional/ipc_shm.c:60: %s == %s failed: got %d, want %d\n\x00shmid_ds.shm_cpid\x00getpid()\x00src/functional/ipc_shm.c:61: %s == %s failed: got %d, want %d\n\x00(int)shmid_ds.shm_nattch\x00src/functional/ipc_shm.c:62: %s == %s failed: got %lld, want %d\n\x00(long long)shmid_ds.shm_atime\x00src/functional/ipc_shm.c:63: %s == %s failed: got %lld, want %d\n\x00(long long)shmid_ds.shm_dtime\x00src/functional/ipc_shm.c:65: shmid_ds.shm_ctime >= t failed: got %lld, want >= %lld\n\x00src/functional/ipc_shm.c:67: shmid_ds.shm_ctime <= t+5 failed: got %lld, want <= %lld\n\x00src/functional/ipc_shm.c:71: shmat failed: %s\n\x00src/functional/ipc_shm.c:72: %s failed: %s\n\x00src/functional/ipc_shm.c:73: %s == %s failed: got %d, want %d\n\x001\x00src/functional/ipc_shm.c:74: %s == %s failed: got %d, want %d\n\x00src/functional/ipc_shm.c:76: shm_atime is %lld want >= %lld\n\x00src/functional/ipc_shm.c:78: shm_atime is %lld want <= %lld\n\x00test data\x00src/functional/ipc_shm.c:80: %s failed: %s\n\x00shmdt(p)\x00src/functional/ipc_shm.c:89: %s failed: %s\n\x00src/functional/ipc_shm.c:90: %s failed: %s\n\x00shmid = shmget(k, 0, 0)\x00src/functional/ipc_shm.c:94: shmat failed: %s\n\x00src/functional/ipc_shm.c:97: reading shared mem failed: got \"%.100s\" want \"test data\"\n\x00src/functional/ipc_shm.c:100: %s failed: %s\n\x00src/functional/ipc_shm.c:101: %s failed: %s\n\x00src/functional/ipc_shm.c:112: fork failed: %s\n\x00src/functional/ipc_shm.c:116: %s failed: %s\n\x00waitpid(p, &status, 0)\x00src/functional/ipc_shm.c:118: child exit status: %d\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
