// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/argv.exe.go src/functional/argv.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/limits.h:47:9:
const PATH_MAX = 4096
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:8:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(4112)
	defer tls.Free(4112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:9:1:
	var v1, v2, v3, v4, v5 bool
	var _ /* buf at bp+0 */ [4096]int8
	_, _, _, _, _ = v1, v2, v3, v4, v5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:11:2:
	if v1 = argc == int32(1); !v1 {
		t_printf(tls, __ccgo_ts, 0)
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:12:2:
	if v2 = *(*uintptr)(unsafe.Pointer(argv)) != uintptr(0); !v2 {
		t_printf(tls, __ccgo_ts+62, 0)
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:13:2:
	if v3 = *(*uintptr)(unsafe.Pointer(argv + 1*4)) == uintptr(0); !v3 {
		t_printf(tls, __ccgo_ts+137, 0)
	}
	_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:14:2:
	if v4 = int32(*(*int8)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(argv))))) != 0; !v4 {
		t_printf(tls, __ccgo_ts+208, 0)
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:15:2:
	if v5 = uint32(libc.Xsnprintf(tls, bp, uint32(4096), __ccgo_ts+287, libc.VaList(bp+4104, *(*uintptr)(unsafe.Pointer(argv))))) < uint32(4096); !v5 {
		t_printf(tls, __ccgo_ts+290, 0)
	}
	_ = v5 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/argv.c:16:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+407, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+417, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+509, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+514, libc.VaList(bp+8, v3, f & ^all)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+536, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+544, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+549, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+592, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+641) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+649) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+661) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+673) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+685) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+694) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+508) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+694) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+700, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/argv.c:11: argc == 1 failed: argc should be 1\n\x00src/functional/argv.c:12: argv[0] != 0 failed: argv[0] should not be NULL\n\x00src/functional/argv.c:13: argv[1] == 0 failed: argv[1] should be NULL\n\x00src/functional/argv.c:14: argv[0][0] != 0 failed: argv[0] should not be empty\n\x00%s\x00src/functional/argv.c:15: snprintf(buf, sizeof buf, \"%s\", argv[0]) < sizeof buf failed: argv[0] is not a valid path\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
