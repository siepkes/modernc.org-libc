// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/pthread_robust.exe.go src/functional/pthread_robust.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:132:9:
const ENOTRECOVERABLE = 131

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:131:9:
const EOWNERDEAD = 130

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/pthread.h:42:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/pthread.h:55:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:11:13:
func start_lock(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:12:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:13:2:
	pthread_mutex_lock(tls, arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:14:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:17:13:
func start_wait(tls *libc.TLS, arg uintptr) (r uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:18:1:
	var args uintptr
	_ = args
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:19:7:
	args = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:20:2:
	pthread_mutex_lock(tls, *(*uintptr)(unsafe.Pointer(args + 1*4)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:21:2:
	pthread_barrier_wait(tls, *(*uintptr)(unsafe.Pointer(args)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:22:2:
	*(*timespec)(unsafe.Pointer(bp)) = timespec{
		Ftv_nsec: int32(10000000),
	}
	libc.Xnanosleep(tls, bp, uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:23:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:26:6:
func f(tls *libc.TLS, pshared int32, pi int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:27:1:
	var r, v1, v11, v13, v15, v17, v19, v21, v23, v25, v27, v29, v3, v31, v33, v35, v37, v39, v41, v43, v45, v47, v49, v5, v51, v53, v55, v57, v59, v7, v9 int32
	var v10, v12, v14, v16, v18, v2, v20, v22, v24, v26, v28, v30, v32, v34, v36, v38, v4, v40, v42, v44, v46, v48, v50, v52, v54, v56, v58, v6, v60, v8 bool
	var _ /* barrier2 at bp+16 */ pthread_barrier_t
	var _ /* mtx at bp+40 */ pthread_mutex_t
	var _ /* mtx_a at bp+36 */ pthread_mutexattr_t
	var _ /* res at bp+12 */ uintptr
	var _ /* td at bp+8 */ pthread_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = r, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v3, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v4, v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v5, v50, v51, v52, v53, v54, v55, v56, v57, v58, v59, v6, v60, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:35:2:
	v1 = pthread_barrier_init(tls, bp+16, uintptr(0), uint32(2))
	r = v1
	if v2 = v1 == 0; !v2 {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+72, __ccgo_ts+92, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	/* Robust mutexes */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:38:2:
	v3 = pthread_mutexattr_init(tls, bp+36)
	r = v3
	if v4 = v3 == 0; !v4 {
		t_printf(tls, __ccgo_ts+130, libc.VaList(bp+72, __ccgo_ts+229, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:39:2:
	v5 = pthread_mutexattr_setrobust(tls, bp+36, int32(PTHREAD_MUTEX_ROBUST))
	r = v5
	if v6 = v5 == 0; !v6 {
		t_printf(tls, __ccgo_ts+260, libc.VaList(bp+72, __ccgo_ts+360, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:40:2:
	if pshared != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:41:3:
		v7 = pthread_mutexattr_setpshared(tls, bp+36, int32(PTHREAD_PROCESS_SHARED))
		r = v7
		if v8 = v7 == 0; !v8 {
			t_printf(tls, __ccgo_ts+418, libc.VaList(bp+72, __ccgo_ts+519, pshared, pi, libc.Xstrerror(tls, r)))
		}
		_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:42:2:
	if pi != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:43:3:
		v9 = pthread_mutexattr_setprotocol(tls, bp+36, int32(PTHREAD_PRIO_INHERIT))
		r = v9
		if v10 = v9 == 0; !v10 {
			t_printf(tls, __ccgo_ts+580, libc.VaList(bp+72, __ccgo_ts+676, pshared, pi, libc.Xstrerror(tls, r)))
		}
		_ = v10 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:44:2:
	v11 = pthread_mutex_init(tls, bp+40, bp+36)
	r = v11
	if v12 = v11 == 0; !v12 {
		t_printf(tls, __ccgo_ts+736, libc.VaList(bp+72, __ccgo_ts+837, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v12 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:45:2:
	v13 = pthread_mutex_lock(tls, bp+40)
	r = v13
	if v14 = v13 == 0; !v14 {
		t_printf(tls, __ccgo_ts+870, libc.VaList(bp+72, __ccgo_ts+966, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v14 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:46:2:
	v15 = pthread_mutex_unlock(tls, bp+40)
	r = v15
	if v16 = v15 == 0; !v16 {
		t_printf(tls, __ccgo_ts+991, libc.VaList(bp+72, __ccgo_ts+1089, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v16 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:47:2:
	v17 = pthread_create(tls, bp+8, uintptr(0), __ccgo_fp(start_lock), bp+40)
	r = v17
	if v18 = v17 == 0; !v18 {
		t_printf(tls, __ccgo_ts+1116, libc.VaList(bp+72, __ccgo_ts+1215, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v18 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:48:2:
	v19 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp + 8)), bp+12)
	r = v19
	if v20 = v19 == 0; !v20 {
		t_printf(tls, __ccgo_ts+1256, libc.VaList(bp+72, __ccgo_ts+1346, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v20 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:49:2:
	v21 = pthread_mutex_lock(tls, bp+40)
	r = v21
	if v22 = v21 == int32(EOWNERDEAD); !v22 {
		t_printf(tls, __ccgo_ts+1369, libc.VaList(bp+72, __ccgo_ts+966, pshared, pi, r, libc.Xstrerror(tls, r), int32(EOWNERDEAD), libc.Xstrerror(tls, int32(EOWNERDEAD))))
	}
	_ = v22 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:50:2:
	v23 = pthread_mutex_unlock(tls, bp+40)
	r = v23
	if v24 = v23 == 0; !v24 {
		t_printf(tls, __ccgo_ts+1496, libc.VaList(bp+72, __ccgo_ts+1089, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v24 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:51:2:
	v25 = pthread_mutex_lock(tls, bp+40)
	r = v25
	if v26 = v25 == int32(ENOTRECOVERABLE); !v26 {
		t_printf(tls, __ccgo_ts+1603, libc.VaList(bp+72, __ccgo_ts+966, pshared, pi, r, libc.Xstrerror(tls, r), int32(ENOTRECOVERABLE), libc.Xstrerror(tls, int32(ENOTRECOVERABLE))))
	}
	_ = v26 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:52:2:
	v27 = pthread_mutex_destroy(tls, bp+40)
	r = v27
	if v28 = v27 == 0; !v28 {
		t_printf(tls, __ccgo_ts+1733, libc.VaList(bp+72, __ccgo_ts+1839, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v28 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:54:2:
	v29 = pthread_mutex_init(tls, bp+40, bp+36)
	r = v29
	if v30 = v29 == 0; !v30 {
		t_printf(tls, __ccgo_ts+1867, libc.VaList(bp+72, __ccgo_ts+837, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v30 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:55:2:
	v31 = pthread_create(tls, bp+8, uintptr(0), __ccgo_fp(start_lock), bp+40)
	r = v31
	if v32 = v31 == 0; !v32 {
		t_printf(tls, __ccgo_ts+1968, libc.VaList(bp+72, __ccgo_ts+1215, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v32 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:56:2:
	v33 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp + 8)), bp+12)
	r = v33
	if v34 = v33 == 0; !v34 {
		t_printf(tls, __ccgo_ts+2067, libc.VaList(bp+72, __ccgo_ts+1346, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v34 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:57:2:
	v35 = pthread_mutex_lock(tls, bp+40)
	r = v35
	if v36 = v35 == int32(EOWNERDEAD); !v36 {
		t_printf(tls, __ccgo_ts+2157, libc.VaList(bp+72, __ccgo_ts+966, pshared, pi, r, libc.Xstrerror(tls, r), int32(EOWNERDEAD), libc.Xstrerror(tls, int32(EOWNERDEAD))))
	}
	_ = v36 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:58:2:
	v37 = pthread_mutex_consistent(tls, bp+40)
	r = v37
	if v38 = v37 == 0; !v38 {
		t_printf(tls, __ccgo_ts+2284, libc.VaList(bp+72, __ccgo_ts+2360, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v38 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:59:2:
	v39 = pthread_mutex_unlock(tls, bp+40)
	r = v39
	if v40 = v39 == 0; !v40 {
		t_printf(tls, __ccgo_ts+2391, libc.VaList(bp+72, __ccgo_ts+1089, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v40 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:60:2:
	v41 = pthread_mutex_lock(tls, bp+40)
	r = v41
	if v42 = v41 == 0; !v42 {
		t_printf(tls, __ccgo_ts+2498, libc.VaList(bp+72, __ccgo_ts+966, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v42 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:61:2:
	v43 = pthread_mutex_destroy(tls, bp+40)
	r = v43
	if v44 = v43 == 0; !v44 {
		t_printf(tls, __ccgo_ts+2606, libc.VaList(bp+72, __ccgo_ts+1839, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v44 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:63:2:
	v45 = pthread_mutex_init(tls, bp+40, bp+36)
	r = v45
	if v46 = v45 == 0; !v46 {
		t_printf(tls, __ccgo_ts+2698, libc.VaList(bp+72, __ccgo_ts+837, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v46 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:64:2:
	*(*[2]uintptr)(unsafe.Pointer(bp)) = [2]uintptr{
		0: bp + 16,
		1: bp + 40,
	}
	v47 = pthread_create(tls, bp+8, uintptr(0), __ccgo_fp(start_wait), bp)
	r = v47
	if v48 = v47 == 0; !v48 {
		t_printf(tls, __ccgo_ts+2774, libc.VaList(bp+72, __ccgo_ts+2850, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v48 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:65:2:
	r = pthread_barrier_wait(tls, bp+16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:66:2:
	if r != 0 && r != -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:67:3:
		t_printf(tls, __ccgo_ts+2916, libc.VaList(bp+72, r, libc.Xstrerror(tls, r), -int32(1)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:69:2:
	v49 = pthread_barrier_destroy(tls, bp+16)
	r = v49
	if v50 = v49 == 0; !v50 {
		t_printf(tls, __ccgo_ts+3017, libc.VaList(bp+72, __ccgo_ts+3093, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v50 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:70:2:
	v51 = pthread_mutex_lock(tls, bp+40)
	r = v51
	if v52 = v51 == int32(EOWNERDEAD); !v52 {
		t_printf(tls, __ccgo_ts+3128, libc.VaList(bp+72, __ccgo_ts+966, pshared, pi, r, libc.Xstrerror(tls, r), int32(EOWNERDEAD), libc.Xstrerror(tls, int32(EOWNERDEAD))))
	}
	_ = v52 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:71:2:
	v53 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp + 8)), bp+12)
	r = v53
	if v54 = v53 == 0; !v54 {
		t_printf(tls, __ccgo_ts+3226, libc.VaList(bp+72, __ccgo_ts+1346, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v54 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:72:2:
	v55 = pthread_mutex_consistent(tls, bp+40)
	r = v55
	if v56 = v55 == 0; !v56 {
		t_printf(tls, __ccgo_ts+3302, libc.VaList(bp+72, __ccgo_ts+2360, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v56 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:73:2:
	v57 = pthread_mutex_unlock(tls, bp+40)
	r = v57
	if v58 = v57 == 0; !v58 {
		t_printf(tls, __ccgo_ts+3378, libc.VaList(bp+72, __ccgo_ts+1089, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v58 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:74:2:
	v59 = pthread_mutex_destroy(tls, bp+40)
	r = v59
	if v60 = v59 == 0; !v60 {
		t_printf(tls, __ccgo_ts+3454, libc.VaList(bp+72, __ccgo_ts+1839, pshared, pi, libc.Xstrerror(tls, r)))
	}
	_ = v60 || libc.Bool(libc.Int32FromInt32(0) != 0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:77:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:78:1:
	var pi, pshared int32
	_, _ = pi, pshared
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:79:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:79:11:
	pshared = 0
	for {
		if !(pshared <= int32(1)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:80:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:80:12:
		pi = 0
		for {
			if !(pi <= int32(1)) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:81:4:
			f(tls, pshared, pi)
			goto _2
		_2:
			pi++
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_robust.c:82:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+3530, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+3540, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3632, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3637, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3644, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3662, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3670, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3675, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3718, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3767) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3775) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3787) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3799) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3811) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3820) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+3631) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+3820) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+3826, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/pthread_robust.c:35: %s failed: (pshared==%d, pi==%d) %s (creating barrier)\n\x00pthread_barrier_init(&barrier2, 0, 2)\x00src/functional/pthread_robust.c:38: %s failed: (pshared==%d, pi==%d) %s (initializing mutex attr)\n\x00pthread_mutexattr_init(&mtx_a)\x00src/functional/pthread_robust.c:39: %s failed: (pshared==%d, pi==%d) %s (setting robust attribute)\n\x00pthread_mutexattr_setrobust(&mtx_a, PTHREAD_MUTEX_ROBUST)\x00src/functional/pthread_robust.c:41: %s failed: (pshared==%d, pi==%d) %s (setting pshared attribute)\n\x00pthread_mutexattr_setpshared(&mtx_a, PTHREAD_PROCESS_SHARED)\x00src/functional/pthread_robust.c:43: %s failed: (pshared==%d, pi==%d) %s (setting PI attribute)\n\x00pthread_mutexattr_setprotocol(&mtx_a, PTHREAD_PRIO_INHERIT)\x00src/functional/pthread_robust.c:44: %s failed: (pshared==%d, pi==%d) %s (initializing robust mutex)\n\x00pthread_mutex_init(&mtx, &mtx_a)\x00src/functional/pthread_robust.c:45: %s failed: (pshared==%d, pi==%d) %s (locking robust mutex)\n\x00pthread_mutex_lock(&mtx)\x00src/functional/pthread_robust.c:46: %s failed: (pshared==%d, pi==%d) %s (unlocking robust mutex)\n\x00pthread_mutex_unlock(&mtx)\x00src/functional/pthread_robust.c:47: %s failed: (pshared==%d, pi==%d) %s (failed to create thread)\n\x00pthread_create(&td, 0, start_lock, &mtx)\x00src/functional/pthread_robust.c:48: %s failed: (pshared==%d, pi==%d) %s (joining thread)\n\x00pthread_join(td, &res)\x00src/functional/pthread_robust.c:49: %s failed: (pshared==%d, pi==%d) got %d \"%s\" want %d \"%s\" (locking orphaned robust mutex)\n\x00src/functional/pthread_robust.c:50: %s failed: (pshared==%d, pi==%d) %s (unlocking orphaned robust mutex)\n\x00src/functional/pthread_robust.c:51: %s failed: (pshared==%d, pi==%d) got %d \"%s\" want %d \"%s\" (re-locking orphaned robust mutex)\n\x00src/functional/pthread_robust.c:52: %s failed: (pshared==%d, pi==%d) %s (destroying unrecoverable mutex)\n\x00pthread_mutex_destroy(&mtx)\x00src/functional/pthread_robust.c:54: %s failed: (pshared==%d, pi==%d) %s (initializing robust mutex)\n\x00src/functional/pthread_robust.c:55: %s failed: (pshared==%d, pi==%d) %s (failed to create thread)\n\x00src/functional/pthread_robust.c:56: %s failed: (pshared==%d, pi==%d) %s (joining thread)\n\x00src/functional/pthread_robust.c:57: %s failed: (pshared==%d, pi==%d) got %d \"%s\" want %d \"%s\" (locking orphaned robust mutex)\n\x00src/functional/pthread_robust.c:58: %s failed: (pshared==%d, pi==%d) %s ()\n\x00pthread_mutex_consistent(&mtx)\x00src/functional/pthread_robust.c:59: %s failed: (pshared==%d, pi==%d) %s (unlocking orphaned robust mutex)\n\x00src/functional/pthread_robust.c:60: %s failed: (pshared==%d, pi==%d) %s (re-locking orphaned robust mutex)\n\x00src/functional/pthread_robust.c:61: %s failed: (pshared==%d, pi==%d) %s (destroying mutex)\n\x00src/functional/pthread_robust.c:63: %s failed: (pshared==%d, pi==%d) %s ()\n\x00src/functional/pthread_robust.c:64: %s failed: (pshared==%d, pi==%d) %s ()\n\x00pthread_create(&td, 0, start_wait, (void *[]){ &barrier2, &mtx })\x00src/functional/pthread_robust.c:67: pthread_barrier_wait failed: got %d \"%s\", wanted either 0 or %d\n\x00src/functional/pthread_robust.c:69: %s failed: (pshared==%d, pi==%d) %s ()\n\x00pthread_barrier_destroy(&barrier2)\x00src/functional/pthread_robust.c:70: %s failed: (pshared==%d, pi==%d) got %d \"%s\" want %d \"%s\" ()\n\x00src/functional/pthread_robust.c:71: %s failed: (pshared==%d, pi==%d) %s ()\n\x00src/functional/pthread_robust.c:72: %s failed: (pshared==%d, pi==%d) %s ()\n\x00src/functional/pthread_robust.c:73: %s failed: (pshared==%d, pi==%d) %s ()\n\x00src/functional/pthread_robust.c:74: %s failed: (pshared==%d, pi==%d) %s ()\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
