// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/swprintf.exe.go src/functional/swprintf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:22:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:26:3:
var int_tests = [22]struct {
	Ffmt    uintptr
	Fi      int32
	Fexpect uintptr
}{
	0: {
		Ffmt:    __ccgo_ts,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 20,
	},
	1: {
		Ffmt:    __ccgo_ts + 40,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 60,
	},
	2: {
		Ffmt:    __ccgo_ts + 76,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 92,
	},
	3: {
		Ffmt:    __ccgo_ts + 108,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 128,
	},
	4: {
		Ffmt:    __ccgo_ts + 144,
		Fi:      int32(12),
	...
	16: {
		Ffmt:    __ccgo_ts + 516,
		Fi:      int32(63),
		Fexpect: __ccgo_ts + 528,
	},
	17: {
		Ffmt:    __ccgo_ts + 540,
		Fi:      int32(63),
		Fexpect: __ccgo_ts + 556,
	},
	18: {
		Ffmt:    __ccgo_ts + 576,
		Fi:      int32(63),
		Fexpect: __ccgo_ts + 588,
	},
	19: {
		Ffmt:    __ccgo_ts + 600,
		Fi:      int32(15),
		Fexpect: __ccgo_ts + 612,
	},
	20: {
		Ffmt:    __ccgo_ts + 624,
		Fi:      int32(15),
		Fexpect: __ccgo_ts + 640,
	},
	21: {},
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:59:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:63:3:
var fp_tests = [20]struct {
	Ffmt    uintptr
	Ff      float64
	Fexpect uintptr
}{
	0: {
		Ffmt:    __ccgo_ts + 656,
		Ff:      float64(0),
		Fexpect: __ccgo_ts + 668,
	},
	1: {
		Ffmt:    __ccgo_ts + 720,
		Ff:      float64(0),
		Fexpect: __ccgo_ts + 732,
	},
	2: {
		Ffmt:    __ccgo_ts + 768,
		Ff:      float64(0),
	...
	3: {
		Ffmt:    __ccgo_ts + 780,
		Ff:      float64(0),
		Fexpect: __ccgo_ts + 796,
	},
	4: {
		Ffmt:    __ccgo_ts + 720,
		Ff:      float64(1.1),
		Fexpect: __ccgo_ts + 828,
	},
	5: {
		Ffmt:    __ccgo_ts + 720,
		Ff:      float64(1.2),
		Fexpect: __ccgo_ts + 864,
	},
	6: {
		Ffmt:    __ccgo_ts + 720,
		Ff:      float64(1.3),
		Fexpect: __ccgo_ts + 900,
	},
	7: {
		Ffmt:    __ccgo_ts + 720,
		Ff:      float64(1.4),
		Fexpect: __ccgo_ts + 936,
	},
	8: {
		Ffmt:    __ccgo_ts + 720,
		Ff:      float64(1.5),
		Fexpect: __ccgo_ts + 972,
	},
	9: {
		Ffmt:    __ccgo_ts + 1008,
		Ff:      float64(1.23456789012345),
		Fexpect: __ccgo_ts + 1032,
	},
	10: {
		Ffmt:    __ccgo_ts + 768,
		Ff:      float64(0.0001),
		Fexpect: __ccgo_ts + 1100,
	},
	11: {
		Ffmt:    __ccgo_ts + 768,
		Ff:      float64(1e-05),
		Fexpect: __ccgo_ts + 1128,
	},
	12: {
		Ffmt:    __ccgo_ts + 768,
		Ff:      libc.Float64FromInt32(123456),
		Fexpect: __ccgo_ts + 1152,
	},
	13: {
		Ffmt:    __ccgo_ts + 768,
		Ff:      libc.Float64FromInt32(1234567),
		Fexpect: __ccgo_ts + 1180,
	},
	14: {
		Ffmt:    __ccgo_ts + 1228,
		Ff:      libc.Float64FromInt32(1234567),
		Fexpect: __ccgo_ts + 1248,
	},
	15: {
		Ffmt:    __ccgo_ts + 1228,
		Ff:      libc.Float64FromInt32(12345678),
		Fexpect: __ccgo_ts + 1280,
	},
	16: {
		Ffmt:    __ccgo_ts + 1332,
		Ff:      float64(3.141592653589793),
		Fexpect: __ccgo_ts + 1356,
	},
	17: {
		Ffmt:    __ccgo_ts + 1428,
		Ff:      float64(3.141592653589793),
		Fexpect: __ccgo_ts + 1452,
	},
	18: {
		Ffmt:    __ccgo_ts + 1536,
		Ff:      float64(3.402823669209385e+38),
		Fexpect: __ccgo_ts + 1556,
	},
	19: {},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:99:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(2048)
	defer tls.Free(2048)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:100:1:
	var i, j, v1, v11, v13, v15, v17, v19, v21, v24, v3, v5, v7, v9 int32
	var v10, v12, v14, v16, v18, v2, v20, v22, v23, v25, v4, v6, v8 bool
	var _ /* b at bp+0 */ [500]wchar_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = i, j, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:104:2:
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1716) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1728) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1740) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1749) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1761) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1769) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1775) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:113:2:
	v1 = libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1769)
	i = v1
	if v2 = v1 == 0; !v2 {
		t_printf(tls, __ccgo_ts+1776, libc.VaList(bp+2008, __ccgo_ts+1854, i, 0))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:115:2:
	v3 = libc.BoolInt32(libc.Xswprintf(tls, uintptr(0), uint32(0), __ccgo_ts+1892, libc.VaList(bp+2008, int32(123456))) < libc.Int32FromInt32(0))
	i = v3
	if v4 = v3 == int32(1); !v4 {
		t_printf(tls, __ccgo_ts+1904, libc.VaList(bp+2008, __ccgo_ts+1957, i, int32(1)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:117:2:
	v5 = libc.Xswprintf(tls, bp, uint32(2), __ccgo_ts+1989, libc.VaList(bp+2008, int32(0xc0)))
	i = v5
	if v6 = v5 == int32(1); !v6 {
		t_printf(tls, __ccgo_ts+2005, libc.VaList(bp+2008, __ccgo_ts+2058, i, int32(1)))
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:118:2:
	v7 = (*(*[500]wchar_t)(unsafe.Pointer(bp)))[0]
	i = v7
	if v8 = v7 == int32(0xc0); !v8 {
		t_printf(tls, __ccgo_ts+2087, libc.VaList(bp+2008, __ccgo_ts+2156, i, int32(0xc0)))
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:119:2:
	v9 = libc.Xswprintf(tls, bp, uint32(2), __ccgo_ts+1989, libc.VaList(bp+2008, int32(0x20ac)))
	i = v9
	if v10 = v9 == int32(1); !v10 {
		t_printf(tls, __ccgo_ts+2161, libc.VaList(bp+2008, __ccgo_ts+2214, i, int32(1)))
	}
	_ = v10 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:120:2:
	v11 = (*(*[500]wchar_t)(unsafe.Pointer(bp)))[0]
	i = v11
	if v12 = v11 == int32(0x20ac); !v12 {
		t_printf(tls, __ccgo_ts+2245, libc.VaList(bp+2008, __ccgo_ts+2156, i, int32(0x20ac)))
	}
	_ = v12 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:121:2:
	v13 = libc.Xswprintf(tls, bp, uint32(3), __ccgo_ts+2314, libc.VaList(bp+2008, __ccgo_ts+2326))
	i = v13
	if v14 = v13 == int32(2); !v14 {
		t_printf(tls, __ccgo_ts+2330, libc.VaList(bp+2008, __ccgo_ts+2383, i, int32(2)))
	}
	_ = v14 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:122:2:
	v15 = (*(*[500]wchar_t)(unsafe.Pointer(bp)))[0]
	i = v15
	if v16 = v15 == int32(0xc0); !v16 {
		t_printf(tls, __ccgo_ts+2418, libc.VaList(bp+2008, __ccgo_ts+2156, i, int32(0xc0)))
	}
	_ = v16 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:123:2:
	v17 = libc.Xswprintf(tls, bp, uint32(2), __ccgo_ts+2487, libc.VaList(bp+2008, __ccgo_ts+2326))
	i = v17
	if v18 = v17 == int32(1); !v18 {
		t_printf(tls, __ccgo_ts+2507, libc.VaList(bp+2008, __ccgo_ts+2560, i, int32(1)))
	}
	_ = v18 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:124:2:
	v19 = (*(*[500]wchar_t)(unsafe.Pointer(bp)))[0]
	i = v19
	if v20 = v19 == int32(0xc0); !v20 {
		t_printf(tls, __ccgo_ts+2597, libc.VaList(bp+2008, __ccgo_ts+2156, i, int32(0xc0)))
	}
	_ = v20 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:126:2:
	libc.Xwcscpy(tls, bp, __ccgo_ts+2666)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:127:2:
	v21 = libc.BoolInt32(libc.Xswprintf(tls, bp, uint32(4), __ccgo_ts+1892, libc.VaList(bp+2008, int32(123456))) < libc.Int32FromInt32(0))
	i = v21
	if v22 = v21 == int32(1); !v22 {
		t_printf(tls, __ccgo_ts+2702, libc.VaList(bp+2008, __ccgo_ts+2755, i, int32(1)))
	}
	_ = v22 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:128:2:
	if v23 = !(libc.Xwcscmp(tls, bp, __ccgo_ts+2787) != 0); !v23 {
		t_printf(tls, __ccgo_ts+2803, libc.VaList(bp+2008, bp, __ccgo_ts+2787, __ccgo_ts+2855))
	}
	_ = v23 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:129:2:
	v24 = (*(*[500]wchar_t)(unsafe.Pointer(bp)))[int32(5)]
	i = v24
	if v25 = v24 == int32('x'); !v25 {
		t_printf(tls, __ccgo_ts+2872, libc.VaList(bp+2008, __ccgo_ts+2931, i, int32('x')))
	}
	_ = v25 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:131:2:
	j = 0
	for {
		if !(int_tests[j].Ffmt != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:132:3:
		i = libc.Xswprintf(tls, bp, uint32(2000), int_tests[j].Ffmt, libc.VaList(bp+2008, int_tests[j].Fi))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:133:3:
		if uint32(i) != libc.Xwcslen(tls, int_tests[j].Fexpect) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:134:4:
			t_printf(tls, __ccgo_ts+2936, libc.VaList(bp+2008, int_tests[j].Ffmt, int_tests[j].Fi, i, libc.Xwcslen(tls, int_tests[j].Fexpect)))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:137:3:
		if libc.Xwcscmp(tls, bp, int_tests[j].Fexpect) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:138:4:
			t_printf(tls, __ccgo_ts+3023, libc.VaList(bp+2008, bp, int_tests[j].Fexpect))
		}
		goto _26
	_26:
		j++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:141:2:
	j = 0
	for {
		if !(fp_tests[j].Ffmt != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:142:3:
		i = libc.Xswprintf(tls, bp, uint32(2000), fp_tests[j].Ffmt, libc.VaList(bp+2008, fp_tests[j].Ff))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:143:3:
		if uint32(i) != libc.Xwcslen(tls, fp_tests[j].Fexpect) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:144:4:
			t_printf(tls, __ccgo_ts+3101, libc.VaList(bp+2008, fp_tests[j].Ffmt, fp_tests[j].Ff, i, libc.Xwcslen(tls, fp_tests[j].Fexpect)))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:147:3:
		if libc.Xwcscmp(tls, bp, fp_tests[j].Fexpect) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:148:4:
			t_printf(tls, __ccgo_ts+3188, libc.VaList(bp+2008, bp, fp_tests[j].Fexpect))
		}
		goto _27
	_27:
		j++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/swprintf.c:150:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+3273, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+3283, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3374, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3379, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+3386, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3404, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+3412, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3417, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+3460, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1761) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1749) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1716) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1728) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1740) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1769) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1775) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1769) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+3509, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "%\x00\x00\x000\x00\x00\x004\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x000\x00\x00\x000\x00\x00\x001\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x003\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x000\x00\x00\x001\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x003\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x001\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00-\x00\x00\x003\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x001\x00\x00\x002\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00+\x00\x00\x003\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00+\x00\x00\x001\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00+\x00\x00\x00-\x00\x00\x005\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00+\x00\x00\x001\x00\x00\x002\x00\x00\x00 \x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00+\x00\x00\x00-\x00\x00\x00 \x00\x00\x005\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00-\x00\x00\x00 \x00\x00\x005\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x001\x00\x00\x002\x00\x00\x00 \x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00 \x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x000\x00\x00\x00-\x00\x00\x005\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x001\x00\x00\x002\x00\x00\x00 \x00\x00\x00 \x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00-\x00\x00\x000\x00\x00\x005\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x000\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x000\x00\x00\x00o\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00#\x00\x00\x00.\x00\x00\x000\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00#\x00\x00\x00.\x00\x00\x000\x00\x00\x00o\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00#\x00\x00\x00.\x00\x00\x000\x00\x00\x00x\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00x\x00\x00\x00\x00\x00\x00\x003\x00\x00\x00f\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00#\x00\x00\x00x\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00x\x00\x00\x003\x00\x00\x00f\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00X\x00\x00\x00\x00\x00\x00\x003\x00\x00\x00F\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00o\x00\x00\x00\x00\x00\x00\x001\x00\x00\x007\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00#\x00\x00\x00o\x00\x00\x00\x00\x00\x00\x000\x00\x00\x001\x00\x00\x007\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00e\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00.\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00e\x00\x00\x00+\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00f\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00.\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00g\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00#\x00\x00\x00g\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00.\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x001\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x002\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x003\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x004\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x005\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x001\x00\x00\x005\x00\x00\x00g\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x002\x00\x00\x003\x00\x00\x004\x00\x00\x005\x00\x00\x006\x00\x00\x007\x00\x00\x008\x00\x00\x009\x00\x00\x000\x00\x00\x001\x00\x00\x002\x00\x00\x003\x00\x00\x004\x00\x00\x005\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00.\x00\x00\x000\x00\x00\x000\x00\x00\x000\x00\x00\x001\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00e\x00\x00\x00-\x00\x00\x000\x00\x00\x005\x00\x00\x00\x00\x00\x00\x001\x00\x00\x002\x00\x00\x003\x00\x00\x004\x00\x00\x005\x00\x00\x006\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x002\x00\x00\x003\x00\x00\x004\x00\x00\x005\x00\x00\x007\x00\x00\x00e\x00\x00\x00+\x00\x00\x000\x00\x00\x006\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x007\x00\x00\x00g\x00\x00\x00\x00\x00\x00\x001\x00\x00\x002\x00\x00\x003\x00\x00\x004\x00\x00\x005\x00\x00\x006\x00\x00\x007\x00\x00\x00\x00\x00\x00\x001\x00\x00\x00.\x00\x00\x002\x00\x00\x003\x00\x00\x004\x00\x00\x005\x00\x00\x006\x00\x00\x008\x00\x00\x00e\x00\x00\x00+\x00\x00\x000\x00\x00\x007\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x001\x00\x00\x005\x00\x00\x00f\x00\x00\x00\x00\x00\x00\x003\x00\x00\x00.\x00\x00\x001\x00\x00\x004\x00\x00\x001\x00\x00\x005\x00\x00\x009\x00\x00\x002\x00\x00\x006\x00\x00\x005\x00\x00\x003\x00\x00\x005\x00\x00\x008\x00\x00\x009\x00\x00\x007\x00\x00\x009\x00\x00\x003\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x001\x00\x00\x008\x00\x00\x00f\x00\x00\x00\x00\x00\x00\x003\x00\x00\x00.\x00\x00\x001\x00\x00\x004\x00\x00\x001\x00\x00\x005\x00\x00\x009\x00\x00\x002\x00\x00\x006\x00\x00\x005\x00\x00\x003\x00\x00\x005\x00\x00\x008\x00\x00\x009\x00\x00\x007\x00\x00\x009\x00\x00\x003\x00\x00\x001\x00\x00\x001\x00\x00\x006\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00.\x00\x00\x000\x00\x00\x00f\x00\x00\x00\x00\x00\x00\x003\x00\x00\x004\x00\x00\x000\x00\x00\x002\x00\x00\x008\x00\x00\x002\x00\x00\x003\x00\x00\x006\x00\x00\x006\x00\x00\x009\x00\x00\x002\x00\x00\x000\x00\x00\x009\x00\x00\x003\x00\x00\x008\x00\x00\x004\x00\x00\x006\x00\x00\x003\x00\x00\x004\x00\x00\x006\x00\x00\x003\x00\x00\x003\x00\x00\x007\x00\x00\x004\x00\x00\x006\x00\x00\x000\x00\x00\x007\x00\x00\x004\x00\x00\x003\x00\x00\x001\x00\x00\x007\x00\x00\x006\x00\x00\x008\x00\x00\x002\x00\x00\x001\x00\x00\x001\x00\x00\x004\x00\x00\x005\x00\x00\x006\x00\x00\x00\x00\x00\x00\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00POSIX.UTF-8\x00C.UTF-8\x00UTF-8\x00\x00src/functional/swprintf.c:113: %s failed (no UTF-8 locale; tests might fail)\n\x00strcmp(nl_langinfo(CODESET), \"UTF-8\")\x00%\x00\x00\x00d\x00\x00\x00\x00\x00\x00\x00src/functional/swprintf.c:115: %s failed (%d != %d)\n\x00swprintf(0, 0, L\"%d\", 123456)<0\x00%\x00\x00\x00l\x00\x00\x00c\x00\x00\x00\x00\x00\x00\x00src/functional/swprintf.c:117: %s failed (%d != %d)\n\x00swprintf(b, 2, L\"%lc\", 0xc0)\x00src/functional/swprintf.c:118: %s failed (wrong character %x != %x)\n\x00b[0]\x00src/functional/swprintf.c:119: %s failed (%d != %d)\n\x00swprintf(b, 2, L\"%lc\", 0x20ac)\x00src/functional/swprintf.c:120: %s failed (wrong character %x != %x)\n\x00%\x00\x00\x00s\x00\x00\x00\x00\x00\x00\x00À!\x00src/functional/swprintf.c:121: %s failed (%d != %d)\n\x00swprintf(b, 3, L\"%s\", \"\\xc3\\x80!\")\x00src/functional/swprintf.c:122: %s failed (wrong character %x != %x)\n\x00%\x00\x00\x00.\x00\x00\x001\x00\x00\x00s\x00\x00\x00\x00\x00\x00\x00src/functional/swprintf.c:123: %s failed (%d != %d)\n\x00swprintf(b, 2, L\"%.1s\", \"\\xc3\\x80!\")\x00src/functional/swprintf.c:124: %s failed (wrong character %x != %x)\n\x00x\x00\x00\x00x\x00\x00\x00x\x00\x00\x00x\x00\x00\x00x\x00\x00\x00x\x00\x00\x00x\x00\x00\x00x\x00\x00\x00\x00\x00\x00\x00src/functional/swprintf.c:127: %s failed (%d != %d)\n\x00swprintf(b, 4, L\"%d\", 123456)<0\x001\x00\x00\x002\x00\x00\x003\x00\x00\x00\x00\x00\x00\x00src/functional/swprintf.c:128: [%ls] != [%ls] (%s)\n\x00incorrect output\x00src/functional/swprintf.c:129: %s failed (buffer overrun)\n\x00b[5]\x00src/functional/swprintf.c:134: swprintf(b, sizeof b, \"%ls\", %d) returned %d wanted %d\n\x00src/functional/swprintf.c:138: bad integer conversion: got \"%ls\", want \"%ls\"\n\x00src/functional/swprintf.c:144: swprintf(b, sizeof b, \"%ls\", %f) returned %d wanted %d\n\x00src/functional/swprintf.c:148: bad floating-point conversion: got \"%ls\", want \"%ls\"\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
