// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/pthread_tsd.exe.go src/functional/pthread_tsd.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:9:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:9:22:
var k1 pthread_key_t

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:9:26:
var k2 pthread_key_t

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:11:13:
func dtor(tls *libc.TLS, p uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:12:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:13:2:
	*(*int32)(unsafe.Pointer(p)) = int32(1)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:16:13:
func start(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:17:1:
	var p uintptr
	_ = p
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:18:6:
	p = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:19:2:
	if pthread_setspecific(tls, k1, p) != 0 || pthread_setspecific(tls, k2, p+uintptr(1)*4) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:20:3:
		return arg
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:21:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:24:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:25:1:
	var r, v1, v10, v12, v19, v21, v23, v25, v3, v5, v6, v8 int32
	var v11, v13, v14, v15, v16, v17, v18, v2, v20, v22, v24, v26, v4, v7, v9 bool
	var _ /* bar at bp+16 */ [2]int32
	var _ /* foo at bp+8 */ [2]int32
	var _ /* res at bp+4 */ uintptr
	var _ /* td at bp+0 */ pthread_t
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = r, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v2, v20, v21, v22, v23, v24, v25, v26, v3, v4, v5, v6, v7, v8, v9
	/* Test POSIX thread-specific data */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:32:2:
	v1 = pthread_key_create(tls, uintptr(unsafe.Pointer(&k1)), __ccgo_fp(dtor))
	r = v1
	if v2 = v1 == 0; !v2 {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+32, __ccgo_ts+71, libc.Xstrerror(tls, r)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:33:2:
	v3 = pthread_key_create(tls, uintptr(unsafe.Pointer(&k2)), __ccgo_fp(dtor))
	r = v3
	if v4 = v3 == 0; !v4 {
		t_printf(tls, __ccgo_ts+101, libc.VaList(bp+32, __ccgo_ts+172, libc.Xstrerror(tls, r)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:34:2:
	v5 = libc.Int32FromInt32(0)
	(*(*[2]int32)(unsafe.Pointer(bp + 8)))[int32(1)] = v5
	(*(*[2]int32)(unsafe.Pointer(bp + 8)))[0] = v5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:35:2:
	v6 = pthread_setspecific(tls, k1, bp+16)
	r = v6
	if v7 = v6 == 0; !v7 {
		t_printf(tls, __ccgo_ts+202, libc.VaList(bp+32, __ccgo_ts+270, libc.Xstrerror(tls, r)))
	}
	_ = v7 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:36:2:
	v8 = pthread_setspecific(tls, k2, bp+16+uintptr(1)*4)
	r = v8
	if v9 = v8 == 0; !v9 {
		t_printf(tls, __ccgo_ts+299, libc.VaList(bp+32, __ccgo_ts+367, libc.Xstrerror(tls, r)))
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:37:2:
	v10 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start), bp+8)
	r = v10
	if v11 = v10 == 0; !v11 {
		t_printf(tls, __ccgo_ts+398, libc.VaList(bp+32, __ccgo_ts+472, libc.Xstrerror(tls, r)))
	}
	_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:38:2:
	v12 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+4)
	r = v12
	if v13 = v12 == 0; !v13 {
		t_printf(tls, __ccgo_ts+507, libc.VaList(bp+32, __ccgo_ts+572, libc.Xstrerror(tls, r)))
	}
	_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:39:2:
	if v14 = *(*uintptr)(unsafe.Pointer(bp + 4)) == uintptr(0); !v14 {
		t_printf(tls, __ccgo_ts+595, libc.VaList(bp+32, __ccgo_ts+678))
	}
	_ = v14 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:40:2:
	if v15 = (*(*[2]int32)(unsafe.Pointer(bp + 8)))[0] == int32(1); !v15 {
		t_printf(tls, __ccgo_ts+687, libc.VaList(bp+32, __ccgo_ts+752))
	}
	_ = v15 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:41:2:
	if v16 = (*(*[2]int32)(unsafe.Pointer(bp + 8)))[int32(1)] == int32(1); !v16 {
		t_printf(tls, __ccgo_ts+764, libc.VaList(bp+32, __ccgo_ts+829))
	}
	_ = v16 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:42:2:
	if v17 = pthread_getspecific(tls, k1) == bp+16; !v17 {
		t_printf(tls, __ccgo_ts+841, libc.VaList(bp+32, __ccgo_ts+901))
	}
	_ = v17 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:43:2:
	if v18 = pthread_getspecific(tls, k2) == bp+16+uintptr(1)*4; !v18 {
		t_printf(tls, __ccgo_ts+932, libc.VaList(bp+32, __ccgo_ts+992))
	}
	_ = v18 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:44:2:
	v19 = pthread_setspecific(tls, k1, uintptr(0))
	r = v19
	if v20 = v19 == 0; !v20 {
		t_printf(tls, __ccgo_ts+1025, libc.VaList(bp+32, __ccgo_ts+1095, libc.Xstrerror(tls, r)))
	}
	_ = v20 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:45:2:
	v21 = pthread_setspecific(tls, k2, uintptr(0))
	r = v21
	if v22 = v21 == 0; !v22 {
		t_printf(tls, __ccgo_ts+1122, libc.VaList(bp+32, __ccgo_ts+1192, libc.Xstrerror(tls, r)))
	}
	_ = v22 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:46:2:
	v23 = pthread_key_delete(tls, k1)
	r = v23
	if v24 = v23 == 0; !v24 {
		t_printf(tls, __ccgo_ts+1219, libc.VaList(bp+32, __ccgo_ts+1291, libc.Xstrerror(tls, r)))
	}
	_ = v24 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:47:2:
	v25 = pthread_key_delete(tls, k2)
	r = v25
	if v26 = v25 == 0; !v26 {
		t_printf(tls, __ccgo_ts+1314, libc.VaList(bp+32, __ccgo_ts+1386, libc.Xstrerror(tls, r)))
	}
	_ = v26 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/pthread_tsd.c:48:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1409, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1419, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1511, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1516, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1523, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1541, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1549, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1554, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1597, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1646) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1654) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1666) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1678) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1690) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1699) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1510) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1699) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1705, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/pthread_tsd.c:32: %s failed: %s (failed to create key)\n\x00pthread_key_create(&k1, dtor)\x00src/functional/pthread_tsd.c:33: %s failed: %s (failed to create key)\n\x00pthread_key_create(&k2, dtor)\x00src/functional/pthread_tsd.c:35: %s failed: %s (failed to set tsd)\n\x00pthread_setspecific(k1, bar)\x00src/functional/pthread_tsd.c:36: %s failed: %s (failed to set tsd)\n\x00pthread_setspecific(k2, bar+1)\x00src/functional/pthread_tsd.c:37: %s failed: %s (failed to create thread)\n\x00pthread_create(&td, 0, start, foo)\x00src/functional/pthread_tsd.c:38: %s failed: %s (failed to join)\n\x00pthread_join(td, &res)\x00src/functional/pthread_tsd.c:39: %s failed (pthread_setspecific failed in thread)\n\x00res == 0\x00src/functional/pthread_tsd.c:40: %s failed (dtor failed to run)\n\x00foo[0] == 1\x00src/functional/pthread_tsd.c:41: %s failed (dtor failed to run)\n\x00foo[1] == 1\x00src/functional/pthread_tsd.c:42: %s failed (tsd corrupted)\n\x00pthread_getspecific(k1) == bar\x00src/functional/pthread_tsd.c:43: %s failed (tsd corrupted)\n\x00pthread_getspecific(k2) == bar+1\x00src/functional/pthread_tsd.c:44: %s failed: %s (failed to clear tsd)\n\x00pthread_setspecific(k1, 0)\x00src/functional/pthread_tsd.c:45: %s failed: %s (failed to clear tsd)\n\x00pthread_setspecific(k2, 0)\x00src/functional/pthread_tsd.c:46: %s failed: %s (failed to destroy key)\n\x00pthread_key_delete(k1)\x00src/functional/pthread_tsd.c:47: %s failed: %s (failed to destroy key)\n\x00pthread_key_delete(k2)\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
