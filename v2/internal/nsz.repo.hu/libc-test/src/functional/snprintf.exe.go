// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/snprintf.exe.go src/functional/snprintf.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:21:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:25:3:
var int_tests = [40]struct {
	Ffmt    uintptr
	Fi      int32
	Fexpect uintptr
}{
	...
	1: {
		Ffmt:    __ccgo_ts + 10,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 15,
	},
	2: {
		Ffmt:    __ccgo_ts + 19,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 23,
	},
	3: {
		Ffmt:    __ccgo_ts + 27,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 32,
	},
	4: {
		Ffmt:    __ccgo_ts + 36,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 41,
	},
	5: {
		Ffmt:    __ccgo_ts + 45,
		Fi:      int32(12),
		Fexpect: __ccgo_ts + 51,
	},
	6: {
		Ffmt:    __ccgo_ts + 57,
		Fi:      int32(12),
	...
	20: {
		Ffmt:    __ccgo_ts + 158,
		Fi:      int32(0),
		Fexpect: __ccgo_ts + 164,
	},
	21: {
		Ffmt:    __ccgo_ts + 166,
		Fi:      int32(0),
		Fexpect: __ccgo_ts + 172,
	},
	22: {
		Ffmt:    __ccgo_ts + 174,
		Fi:      int32(63),
		Fexpect: __ccgo_ts + 177,
	},
	23: {
		Ffmt:    __ccgo_ts + 180,
		Fi:      int32(63),
		Fexpect: __ccgo_ts + 184,
	},
	24: {
		Ffmt:    __ccgo_ts + 189,
		Fi:      int32(63),
		Fexpect: __ccgo_ts + 192,
	},
	25: {
		Ffmt:    __ccgo_ts + 195,
		Fi:      int32(15),
		Fexpect: __ccgo_ts + 198,
	},
	26: {
		Ffmt:    __ccgo_ts + 201,
		Fi:      int32(15),
		Fexpect: __ccgo_ts + 205,
	},
	27: {
		Ffmt:    __ccgo_ts + 201,
		Fi:      int32(0),
	...
	33: {
		Ffmt:    __ccgo_ts + 218,
		Fi:      int32(1),
		Fexpect: __ccgo_ts + 224,
	},
	34: {
		Ffmt:    __ccgo_ts + 229,
		Fi:      int32(1),
		Fexpect: __ccgo_ts + 237,
	},
	35: {
		Ffmt:    __ccgo_ts + 242,
		Fi:      int32(1),
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:80:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:84:3:
var fp_tests = [43]struct {
	Ffmt    uintptr
	Ff      float64
	Fexpect uintptr
}{
	0: {
		Ffmt:    __ccgo_ts + 274,
		Ff:      float64(0),
		Fexpect: __ccgo_ts + 277,
	},
	1: {
		Ffmt:    __ccgo_ts + 284,
		Ff:      float64(0),
		Fexpect: __ccgo_ts + 287,
	},
	2: {
		Ffmt:    __ccgo_ts + 300,
		Ff:      float64(0),
		Fexpect: __ccgo_ts + 303,
	},
	3: {
		Ffmt:    __ccgo_ts + 312,
		Ff:      float64(0),
	...
	10: {
		Ffmt:    __ccgo_ts + 300,
		Ff:      float64(1.1),
		Fexpect: __ccgo_ts + 348,
	},
	11: {
		Ffmt:    __ccgo_ts + 300,
		Ff:      float64(1.2),
		Fexpect: __ccgo_ts + 357,
	},
	12: {
		Ffmt:    __ccgo_ts + 300,
		Ff:      float64(1.3),
		Fexpect: __ccgo_ts + 366,
	},
	13: {
		Ffmt:    __ccgo_ts + 300,
		Ff:      float64(1.4),
		Fexpect: __ccgo_ts + 375,
	},
	14: {
		Ffmt:    __ccgo_ts + 300,
		Ff:      float64(1.5),
		Fexpect: __ccgo_ts + 384,
	},
	15: {
		Ffmt:    __ccgo_ts + 393,
		Ff:      float64(1.06125),
		Fexpect: __ccgo_ts + 398,
	},
	16: {
		Ffmt:    __ccgo_ts + 393,
		Ff:      float64(1.03125),
		Fexpect: __ccgo_ts + 405,
	},
	17: {
		Ffmt:    __ccgo_ts + 412,
		Ff:      float64(1.375),
		Fexpect: __ccgo_ts + 417,
	},
	18: {
		Ffmt:    __ccgo_ts + 422,
		Ff:      float64(1.375),
		Fexpect: __ccgo_ts + 427,
	},
	19: {
		Ffmt:    __ccgo_ts + 431,
		Ff:      float64(1.375),
	...
	20: {
		Ffmt:    __ccgo_ts + 437,
		Ff:      float64(1.1),
		Fexpect: __ccgo_ts + 443,
	},
	21: {
		Ffmt:    __ccgo_ts + 461,
		Ff:      float64(1.1),
		Fexpect: __ccgo_ts + 467,
	},
	22: {
		Ffmt:    __ccgo_ts + 486,
		Ff:      float64(1.1),
		Fexpect: __ccgo_ts + 492,
	},
	23: {
		Ffmt:    __ccgo_ts + 512,
		Ff:      float64(1.500001e+06),
		Fexpect: __ccgo_ts + 517,
	},
	24: {
		Ffmt:    __ccgo_ts + 512,
		Ff:      float64(1.505e+06),
		Fexpect: __ccgo_ts + 517,
	},
	25: {
		Ffmt:    __ccgo_ts + 512,
		Ff:      float64(1.5050000000009537e+06),
		Fexpect: __ccgo_ts + 526,
	},
	26: {
		Ffmt:    __ccgo_ts + 512,
		Ff:      float64(1.505001e+06),
		Fexpect: __ccgo_ts + 526,
	},
	27: {
		Ffmt:    __ccgo_ts + 512,
		Ff:      float64(1.506e+06),
		Fexpect: __ccgo_ts + 526,
	},
	28: {
		Ffmt:    __ccgo_ts + 535,
		Ff:      float64(1.23456789012345),
		Fexpect: __ccgo_ts + 541,
	},
	29: {
		Ffmt:    __ccgo_ts + 312,
		Ff:      float64(0.0001),
		Fexpect: __ccgo_ts + 558,
	},
	30: {
		Ffmt:    __ccgo_ts + 312,
		Ff:      float64(1e-05),
		Fexpect: __ccgo_ts + 565,
	},
	31: {
		Ffmt:    __ccgo_ts + 312,
		Ff:      libc.Float64FromInt32(123456),
		Fexpect: __ccgo_ts + 571,
	},
	32: {
		Ffmt:    __ccgo_ts + 312,
		Ff:      libc.Float64FromInt32(1234567),
		Fexpect: __ccgo_ts + 578,
	},
	33: {
		Ffmt:    __ccgo_ts + 590,
		Ff:      libc.Float64FromInt32(1234567),
		Fexpect: __ccgo_ts + 595,
	},
	34: {
		Ffmt:    __ccgo_ts + 590,
		Ff:      libc.Float64FromInt32(12345678),
		Fexpect: __ccgo_ts + 603,
	},
	35: {
		Ffmt:    __ccgo_ts + 616,
		Ff:      float64(0.1),
		Fexpect: __ccgo_ts + 621,
	},
	36: {
		Ffmt:    __ccgo_ts + 625,
		Ff:      float64(0.1),
	...
	39: {
		Ffmt:    __ccgo_ts + 437,
		Ff:      float64(3.141592653589793),
		Fexpect: __ccgo_ts + 642,
	},
	40: {
		Ffmt:    __ccgo_ts + 660,
		Ff:      float64(3.141592653589793),
		Fexpect: __ccgo_ts + 666,
	},
	41: {
		Ffmt:    __ccgo_ts + 687,
		Ff:      float64(3.402823669209385e+38),
		Fexpect: __ccgo_ts + 692,
	},
	42: {},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:143:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(2048)
	defer tls.Free(2048)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:144:1:
	var i, j, k, v1, v10, v12, v18, v21, v25, v3, v5, v7 int32
	var v11, v13, v19, v2, v22, v26, v4, v6, v8, v9 bool
	var p16, p17 uintptr
	var _ /* b at bp+0 */ [2000]int8
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = i, j, k, v1, v10, v11, v12, v13, v18, v19, v2, v21, v22, v25, v26, v3, v4, v5, v6, v7, v8, v9, p16, p17
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:148:2:
	v1 = libc.Xsnprintf(tls, uintptr(0), uint32(0), __ccgo_ts+732, libc.VaList(bp+2008, int32(123456)))
	i = v1
	if v2 = v1 == int32(6); !v2 {
		t_printf(tls, __ccgo_ts+735, libc.VaList(bp+2008, __ccgo_ts+804, i, int32(6)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:149:2:
	v3 = libc.Xsnprintf(tls, uintptr(0), uint32(0), __ccgo_ts+833, libc.VaList(bp+2008, __ccgo_ts+838))
	i = v3
	if v4 = v3 == int32(4); !v4 {
		t_printf(tls, __ccgo_ts+844, libc.VaList(bp+2008, __ccgo_ts+913, i, int32(4)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:150:2:
	v5 = libc.Xsnprintf(tls, bp, uint32(0), __ccgo_ts+945, libc.VaList(bp+2008, __ccgo_ts+950))
	i = v5
	if v6 = v5 == 0; !v6 {
		t_printf(tls, __ccgo_ts+958, libc.VaList(bp+2008, __ccgo_ts+1027, i, 0))
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:152:2:
	libc.Xstrcpy(tls, bp, __ccgo_ts+1061)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:153:2:
	v7 = libc.Xsnprintf(tls, bp, uint32(4), __ccgo_ts+732, libc.VaList(bp+2008, int32(123456)))
	i = v7
	if v8 = v7 == int32(6); !v8 {
		t_printf(tls, __ccgo_ts+1070, libc.VaList(bp+2008, __ccgo_ts+1139, i, int32(6)))
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:154:2:
	if v9 = !(libc.Xstrcmp(tls, bp, __ccgo_ts+1168) != 0); !v9 {
		t_printf(tls, __ccgo_ts+1172, libc.VaList(bp+2008, bp, __ccgo_ts+1168, __ccgo_ts+1222))
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:155:2:
	v10 = int32((*(*[2000]int8)(unsafe.Pointer(bp)))[int32(5)])
	i = v10
	if v11 = v10 == int32('x'); !v11 {
		t_printf(tls, __ccgo_ts+1239, libc.VaList(bp+2008, __ccgo_ts+1298, i, int32('x')))
	}
	_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
	/* Perform ascii arithmetic to test printing tiny doubles */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:158:2:
	v12 = libc.Xsnprintf(tls, bp, uint32(2000), __ccgo_ts+1303, libc.VaList(bp+2008, float64(4.450147717014403e-308)))
	i = v12
	if v13 = v12 == int32(1024); !v13 {
		t_printf(tls, __ccgo_ts+1311, libc.VaList(bp+2008, __ccgo_ts+1364, i, int32(1024)))
	}
	_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:159:2:
	(*(*[2000]int8)(unsafe.Pointer(bp)))[int32(1)] = int8('0')
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:160:2:
	i = 0
	for {
		if !(i < int32(1021)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:161:3:
		k = 0
		j = libc.Int32FromInt32(1023)
		for {
			if !(j > 0) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:162:4:
			if int32((*(*[2000]int8)(unsafe.Pointer(bp)))[j]) < int32('5') {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:162:18:
				p16 = bp + uintptr(j)
				*(*int8)(unsafe.Pointer(p16)) = int8(int32(*(*int8)(unsafe.Pointer(p16))) + (int32((*(*[2000]int8)(unsafe.Pointer(bp)))[j]) - libc.Int32FromUint8('0') + k))
				k = libc.Int32FromInt32(0)
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:163:9:
				p17 = bp + uintptr(j)
				*(*int8)(unsafe.Pointer(p17)) = int8(int32(*(*int8)(unsafe.Pointer(p17))) + (int32((*(*[2000]int8)(unsafe.Pointer(bp)))[j]) - libc.Int32FromUint8('0') - libc.Int32FromInt32(10) + k))
				k = libc.Int32FromInt32(1)
			}
			goto _15
		_15:
			j--
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:166:2:
	v18 = int32((*(*[2000]int8)(unsafe.Pointer(bp)))[int32(1)])
	i = v18
	if v19 = v18 == int32('1'); !v19 {
		t_printf(tls, __ccgo_ts+1408, libc.VaList(bp+2008, __ccgo_ts+1465, i, int32('1')))
	}
	_ = v19 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:167:2:
	j = int32(2)
	for {
		if !(int32((*(*[2000]int8)(unsafe.Pointer(bp)))[j]) == int32('0')) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:167:27:
		goto _20
	_20:
		j++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:168:2:
	v21 = j
	i = v21
	if v22 = v21 == int32(1024); !v22 {
		t_printf(tls, __ccgo_ts+1470, libc.VaList(bp+2008, __ccgo_ts+1523, i, int32(1024)))
	}
	_ = v22 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:177:2:
	j = 0
	for {
		if !(int_tests[j].Ffmt != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:178:3:
		i = libc.Xsnprintf(tls, bp, uint32(2000), int_tests[j].Ffmt, libc.VaList(bp+2008, int_tests[j].Fi))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:179:3:
		if uint32(i) != libc.Xstrlen(tls, int_tests[j].Fexpect) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:180:4:
			t_printf(tls, __ccgo_ts+1525, libc.VaList(bp+2008, int_tests[j].Ffmt, int_tests[j].Fi, i, libc.Xstrlen(tls, int_tests[j].Fexpect)))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:183:3:
		if libc.Xstrcmp(tls, bp, int_tests[j].Fexpect) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:184:4:
			t_printf(tls, __ccgo_ts+1611, libc.VaList(bp+2008, bp, int_tests[j].Fexpect))
		}
		goto _23
	_23:
		j++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:187:2:
	j = 0
	for {
		if !(fp_tests[j].Ffmt != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:188:3:
		i = libc.Xsnprintf(tls, bp, uint32(2000), fp_tests[j].Ffmt, libc.VaList(bp+2008, fp_tests[j].Ff))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:189:3:
		if uint32(i) != libc.Xstrlen(tls, fp_tests[j].Fexpect) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:190:4:
			t_printf(tls, __ccgo_ts+1687, libc.VaList(bp+2008, fp_tests[j].Ffmt, fp_tests[j].Ff, i, libc.Xstrlen(tls, fp_tests[j].Fexpect)))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:193:3:
		if libc.Xstrcmp(tls, bp, fp_tests[j].Fexpect) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:194:4:
			t_printf(tls, __ccgo_ts+1773, libc.VaList(bp+2008, bp, fp_tests[j].Fexpect))
		}
		goto _24
	_24:
		j++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:197:2:
	v25 = libc.Xsnprintf(tls, uintptr(0), uint32(0), __ccgo_ts+1856, libc.VaList(bp+2008, float64(1)))
	i = v25
	if v26 = v25 == int32(11); !v26 {
		t_printf(tls, __ccgo_ts+1861, libc.VaList(bp+2008, __ccgo_ts+1914, i, int32(11)))
	}
	_ = v26 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/snprintf.c:198:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1942, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1952, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2043, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2048, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2053, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2071, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2079, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2084, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2127, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2176) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2184) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2196) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2208) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2220) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2229) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+103) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2229) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2235, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "%04d\x000012\x00%.3d\x00012\x00%3d\x00 12\x00%-3d\x0012 \x00%+3d\x00+12\x00%+-5d\x00+12  \x00%+- 5d\x00%- 5d\x00 12  \x00% d\x00%0-5d\x0012   \x00%-05d\x00%.0d\x00\x00%.0o\x00%#.0d\x00%#.0o\x000\x00%#.0x\x00%2.0u\x00  \x00%02.0u\x00%2.0d\x00%02.0d\x00% .0d\x00 \x00%+.0d\x00+\x00%x\x003f\x00%#x\x000x3f\x00%X\x003F\x00%o\x0017\x00%#o\x00017\x00%#.1o\x0001\x00%#04o\x000001\x00%#04.0o\x00  01\x00%#04.1o\x00%04o\x00%04.0o\x00   1\x00%04.1o\x00%a\x000x0p+0\x00%e\x000.000000e+00\x00%f\x000.000000\x00%g\x00%#g\x000.00000\x00%la\x00%le\x00%lf\x00%lg\x00%#lg\x001.100000\x001.200000\x001.300000\x001.400000\x001.500000\x00%.4f\x001.0613\x001.0312\x00%.2f\x001.38\x00%.1f\x001.4\x00%.1lf\x00%.15f\x001.100000000000000\x00%.16f\x001.1000000000000001\x00%.17f\x001.10000000000000009\x00%.2e\x001.50e+06\x001.51e+06\x00%.15g\x001.23456789012345\x000.0001\x001e-05\x00123456\x001.23457e+06\x00%.7g\x001234567\x001.234568e+07\x00%.8g\x000.1\x00%.9g\x00%.10g\x00%.11g\x003.141592653589793\x00%.18f\x003.141592653589793116\x00%.0f\x00340282366920938463463374607431768211456\x00%d\x00src/functional/snprintf.c:148: %s failed (length returned %d != %d)\n\x00snprintf(0, 0, \"%d\", 123456)\x00%.4s\x00hello\x00src/functional/snprintf.c:149: %s failed (length returned %d != %d)\n\x00snprintf(0, 0, \"%.4s\", \"hello\")\x00%.0s\x00goodbye\x00src/functional/snprintf.c:150: %s failed (length returned %d != %d)\n\x00snprintf(b, 0, \"%.0s\", \"goodbye\")\x00xxxxxxxx\x00src/functional/snprintf.c:153: %s failed (length returned %d != %d)\n\x00snprintf(b, 4, \"%d\", 123456)\x00123\x00src/functional/snprintf.c:154: [%s] != [%s] (%s)\n\x00incorrect output\x00src/functional/snprintf.c:155: %s failed (buffer overrun)\n\x00b[5]\x00%.1022f\x00src/functional/snprintf.c:158: %s failed (%d != %d)\n\x00snprintf(b, sizeof b, \"%.1022f\", 0x1p-1021)\x00src/functional/snprintf.c:166: %s failed ('%c' != '%c')\n\x00b[1]\x00src/functional/snprintf.c:168: %s failed (%d != %d)\n\x00j\x00src/functional/snprintf.c:180: snprintf(b, sizeof b, \"%s\", %d) returned %d wanted %d\n\x00src/functional/snprintf.c:184: bad integer conversion: got \"%s\", want \"%s\"\n\x00src/functional/snprintf.c:190: snprintf(b, sizeof b, \"%s\", %f) returned %d wanted %d\n\x00src/functional/snprintf.c:194: bad floating-point conversion: got \"%s\", want \"%s\"\n\x00%.4a\x00src/functional/snprintf.c:197: %s failed (%d != %d)\n\x00snprintf(0, 0, \"%.4a\", 1.0)\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00%s%s\x00%s%d\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
