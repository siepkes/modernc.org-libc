// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/tls_align_dlopen.exe.go src/functional/tls_align_dlopen.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/dlfcn.h:10:9:
const RTLD_LAZY = 1
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:4:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:5:1:
	var h, t uintptr
	var i int32
	_, _, _ = h, i, t
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:15:2:
	h = libc.Xdlopen(tls, __ccgo_ts, int32(RTLD_LAZY))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:16:2:
	if !(h != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:17:3:
		t_printf(tls, __ccgo_ts+32, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:18:2:
	t = libc.Xdlsym(tls, h, __ccgo_ts+85)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:19:2:
	if !(t != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:20:3:
		t_printf(tls, __ccgo_ts+87, 0)
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:21:7:
		i = 0
		for {
			if !(i < int32(4)) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:22:3:
			if !((*(*struct {
				Fname  uintptr
				Fsize  uint32
				Falign uint32
				Faddr  uint32
			})(unsafe.Pointer(t + uintptr(i)*16))).Fname != 0) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:23:4:
				t_printf(tls, __ccgo_ts+139, libc.VaList(bp+8, i))
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:24:3:
			if (*(*struct {
				Fname  uintptr
				Fsize  uint32
				Falign uint32
				Faddr  uint32
			})(unsafe.Pointer(t + uintptr(i)*16))).Faddr&((*(*struct {
				Fname  uintptr
				Fsize  uint32
				Falign uint32
				Faddr  uint32
			})(unsafe.Pointer(t + uintptr(i)*16))).Falign-libc.Uint32FromInt32(1)) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:25:4:
				t_printf(tls, __ccgo_ts+204, libc.VaList(bp+8, (*(*struct {
					Fname  uintptr
					Fsize  uint32
					Falign uint32
					Faddr  uint32
				})(unsafe.Pointer(t + uintptr(i)*16))).Fname, (*(*struct {
					Fname  uintptr
					Fsize  uint32
					Falign uint32
					Faddr  uint32
				})(unsafe.Pointer(t + uintptr(i)*16))).Fsize, (*(*struct {
					Fname  uintptr
					Fsize  uint32
					Falign uint32
					Faddr  uint32
				})(unsafe.Pointer(t + uintptr(i)*16))).Falign, (*(*struct {
					Fname  uintptr
					Fsize  uint32
					Falign uint32
					Faddr  uint32
				})(unsafe.Pointer(t + uintptr(i)*16))).Faddr))
			}
			goto _1
		_1:
			i++
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_align_dlopen.c:28:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+295, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+305, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+397, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+402, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+409, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+427, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+435, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+440, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+483, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+532) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+540) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+552) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+564) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+576) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+585) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+396) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+585) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+591, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
