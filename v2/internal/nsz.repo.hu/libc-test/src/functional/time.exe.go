// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/time.exe.go src/functional/time.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:75:9:
const EOVERFLOW = 75

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/limits.h:32:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:13:5:
func tm_cmp(tls *libc.TLS, tm1 tm, tm2 tm) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:14:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:15:2:
	return libc.BoolInt32(tm1.Ftm_sec != tm2.Ftm_sec || tm1.Ftm_min != tm2.Ftm_min || tm1.Ftm_hour != tm2.Ftm_hour || tm1.Ftm_mday != tm2.Ftm_mday || tm1.Ftm_mon != tm2.Ftm_mon || tm1.Ftm_year != tm2.Ftm_year || tm1.Ftm_wday != tm2.Ftm_wday || tm1.Ftm_yday != tm2.Ftm_yday || tm1.Ftm_isdst != tm2.Ftm_isdst)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:26:6:
func tm_str(tls *libc.TLS, tm1 tm) (r uintptr) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:30:2:
	i = (i + int32(1)) % int32(4)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:31:2:
	libc.Xsnprintf(tls, uintptr(unsafe.Pointer(&b))+uintptr(i)*64, uint32(64), __ccgo_ts, libc.VaList(bp+8, tm1.Ftm_sec, tm1.Ftm_min, tm1.Ftm_hour, tm1.Ftm_mday, tm1.Ftm_mon, tm1.Ftm_year, tm1.Ftm_wday, tm1.Ftm_yday, tm1.Ftm_isdst))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:36:2:
	return uintptr(unsafe.Pointer(&b)) + uintptr(i)*64
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:27:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:28:13:
var i int32

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:29:14:
var b [4][64]int8

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:48:13:
func sec2tm(tls *libc.TLS, _t time_t, m uintptr) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	*(*time_t)(unsafe.Pointer(bp)) = _t
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:49:1:
	var r time_t
	var tm1 uintptr
	_, _ = r, tm1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:53:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:54:2:
	tm1 = libc.Xgmtime(tls, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:55:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:56:3:
		t_printf(tls, __ccgo_ts+75, libc.VaList(bp+16, m, *(*time_t)(unsafe.Pointer(bp)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:58:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:59:2:
	r = libc.Xmktime(tls, tm1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:60:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:61:3:
		t_printf(tls, __ccgo_ts+156, libc.VaList(bp+16, m, tm_str(tls, *(*tm)(unsafe.Pointer(tm1))), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:63:2:
	if *(*time_t)(unsafe.Pointer(bp)) != r {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:64:3:
		t_printf(tls, __ccgo_ts+227, libc.VaList(bp+16, m, *(*time_t)(unsafe.Pointer(bp)), r, tm_str(tls, *(*tm)(unsafe.Pointer(tm1)))))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:68:13:
func tm2sec(tls *libc.TLS, tm1 uintptr, big int32, m uintptr) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:69:1:
	var overflow int32
	var r uintptr
	var _ /* t at bp+0 */ time_t
	_, _ = overflow, r
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:72:6:
	overflow = libc.BoolInt32(big != 0 && libc.Bool(libc.Int64FromInt64(0x7fffffffffffffff) != int64(0x7fffffffffffffff)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:74:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:75:2:
	*(*time_t)(unsafe.Pointer(bp)) = libc.Xmktime(tls, tm1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:76:2:
	if overflow != 0 && *(*time_t)(unsafe.Pointer(bp)) != int64(-int32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:77:3:
		t_printf(tls, __ccgo_ts+321, libc.VaList(bp+16, m, tm_str(tls, *(*tm)(unsafe.Pointer(tm1))), int32(*(*time_t)(unsafe.Pointer(bp)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:79:2:
	if overflow != 0 && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EOVERFLOW) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:80:3:
		t_printf(tls, __ccgo_ts+392, libc.VaList(bp+16, m, tm_str(tls, *(*tm)(unsafe.Pointer(tm1))), libc.Xstrerror(tls, int32(EOVERFLOW)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:82:2:
	if !(overflow != 0) && *(*time_t)(unsafe.Pointer(bp)) == int64(-int32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:83:3:
		t_printf(tls, __ccgo_ts+468, libc.VaList(bp+16, m, tm_str(tls, *(*tm)(unsafe.Pointer(tm1)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:85:2:
	if !(overflow != 0) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:86:3:
		t_printf(tls, __ccgo_ts+543, libc.VaList(bp+16, m, tm_str(tls, *(*tm)(unsafe.Pointer(tm1))), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:88:2:
	r = libc.Xgmtime(tls, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:89:2:
	if !(overflow != 0) && tm_cmp(tls, *(*tm)(unsafe.Pointer(r)), *(*tm)(unsafe.Pointer(tm1))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:90:3:
		t_printf(tls, __ccgo_ts+613, libc.VaList(bp+16, m, tm_str(tls, *(*tm)(unsafe.Pointer(tm1))), tm_str(tls, *(*tm)(unsafe.Pointer(r)))))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:94:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(144)
	defer tls.Free(144)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:95:1:
	var t time_t
	_ = t
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:98:2:
	libc.Xputenv(tls, __ccgo_ts+688)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:99:2:
	libc.Xtzset(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:100:2:
	*(*tm)(unsafe.Pointer(bp)) = tm{
		Ftm_sec:   0,
		Ftm_min:   0,
		Ftm_hour:  0,
		Ftm_mday:  int32(1),
	...
	tm2sec(tls, bp, 0, __ccgo_ts+695)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:101:2:
	*(*tm)(unsafe.Pointer(bp + 44)) = tm{
		Ftm_sec:   int32(7),
		Ftm_min:   int32(14),
		Ftm_hour:  int32(3),
		Ftm_mday:  int32(19),
	...
	tm2sec(tls, bp+44, 0, __ccgo_ts+705)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:102:2:
	*(*tm)(unsafe.Pointer(bp + 88)) = tm{
		Ftm_sec:   int32(8),
		Ftm_min:   int32(14),
		Ftm_hour:  int32(3),
		Ftm_mday:  int32(19),
	...
	tm2sec(tls, bp+88, int32(1), __ccgo_ts+713)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:104:2:
	sec2tm(tls, 0, __ccgo_ts+718)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:105:2:
	t = int64(1)
	for {
		if !(t < int64(1000)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:106:3:
		sec2tm(tls, t*int64(100003), __ccgo_ts+724)
		goto _1
	_1:
		t++
	}
	/* FIXME: set a TZ var and check DST boundary conditions */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/time.c:109:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+734, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+744, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+836, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+841, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+848, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+866, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+874, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+879, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+922, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+971) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+979) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+991) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1003) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1015) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1024) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+835) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1024) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1030, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "s=%02d m=%02d h=%02d mday=%02d mon=%02d year=%04d wday=%d yday=%d isdst=%d\x00src/functional/time.c:56: %s: gmtime((time_t)%lld) should not set errno, got %s\n\x00src/functional/time.c:61: %s: mktime(%s) should not set errno, got %s\n\x00src/functional/time.c:64: %s: mktime(gmtime(%lld)) roundtrip failed: got %lld (gmtime is %s)\n\x00src/functional/time.c:77: %s: mktime(%s) expected -1, got (time_t)%ld\n\x00src/functional/time.c:80: %s: mktime(%s) expected EOVERFLOW (%s), got (%s)\n\x00src/functional/time.c:83: %s: mktime(%s) expected success, got (time_t)-1\n\x00src/functional/time.c:86: %s: mktime(%s) expected no error, got (%s)\n\x00src/functional/time.c:90: %s: gmtime(mktime(%s)) roundtrip failed: got %s\n\x00TZ=GMT\x00gmtime(0)\x002038-1s\x002038\x00EPOCH\x00EPOCH+eps\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
