// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/sem_open.exe.go src/functional/sem_open.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:2:9:
const O_EXCL = 128
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:15:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(160)
	defer tls.Free(160)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:16:1:
	var sem, sem2, v1, v7 uintptr
	var v10, v11, v12, v13, v14, v15, v16, v17, v18, v2, v3, v4, v5, v6, v8, v9 bool
	var _ /* buf at bp+0 */ [100]int8
	var _ /* ts at bp+100 */ timespec
	var _ /* val at bp+116 */ int32
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = sem, sem2, v1, v10, v11, v12, v13, v14, v15, v16, v17, v18, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:22:2:
	libc.Xclock_gettime(tls, CLOCK_REALTIME, bp+100)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:23:2:
	libc.Xsnprintf(tls, bp, uint32(100), __ccgo_ts, libc.VaList(bp+128, libc.Xgetpid(tls), (*(*timespec)(unsafe.Pointer(bp + 100))).Ftv_nsec))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:25:2:
	v1 = libc.Xsem_open(tls, bp, libc.Int32FromInt32(O_CREAT)|libc.Int32FromInt32(O_EXCL), libc.VaList(bp+128, int32(0700), int32(1)))
	sem = v1
	if v2 = v1 != libc.UintptrFromInt32(0); !v2 {
		t_printf(tls, __ccgo_ts+17, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:27:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:28:2:
	if v3 = libc.Xsem_open(tls, bp, libc.Int32FromInt32(O_CREAT)|libc.Int32FromInt32(O_EXCL), libc.VaList(bp+128, int32(0700), int32(1))) == libc.UintptrFromInt32(0); !v3 {
		t_printf(tls, __ccgo_ts+138, 0)
	}
	_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:30:2:
	if v4 = *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EEXIST); !v4 {
		t_printf(tls, __ccgo_ts+264, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))), *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))), int32(EEXIST)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:33:2:
	if v5 = libc.Xsem_getvalue(tls, sem, bp+116) == 0; !v5 {
		t_printf(tls, __ccgo_ts+377, 0)
	}
	_ = v5 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:34:2:
	if v6 = *(*int32)(unsafe.Pointer(bp + 116)) == int32(1); !v6 {
		t_printf(tls, __ccgo_ts+469, libc.VaList(bp+128, *(*int32)(unsafe.Pointer(bp + 116))))
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:36:2:
	v7 = libc.Xsem_open(tls, bp, 0, 0)
	sem2 = v7
	if v8 = v7 == sem; !v8 {
		t_printf(tls, __ccgo_ts+551, libc.VaList(bp+128, sem2, sem))
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:39:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:40:2:
	if v9 = libc.Xsem_wait(tls, sem) == 0; !v9 {
		t_printf(tls, __ccgo_ts+659, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:41:2:
	if v10 = libc.Xsem_getvalue(tls, sem2, bp+116) == 0; !v10 {
		t_printf(tls, __ccgo_ts+720, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v10 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:42:2:
	if v11 = *(*int32)(unsafe.Pointer(bp + 116)) == 0; !v11 {
		t_printf(tls, __ccgo_ts+792, libc.VaList(bp+128, *(*int32)(unsafe.Pointer(bp + 116))))
	}
	_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:44:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:45:2:
	if v12 = libc.Xsem_trywait(tls, sem) == -int32(1) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EAGAIN); !v12 {
		t_printf(tls, __ccgo_ts+883, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))), *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))), int32(EAGAIN)))
	}
	_ = v12 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:48:2:
	if v13 = libc.Xsem_post(tls, sem) == 0; !v13 {
		t_printf(tls, __ccgo_ts+1025, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:49:2:
	if v14 = libc.Xsem_getvalue(tls, sem2, bp+116) == 0; !v14 {
		t_printf(tls, __ccgo_ts+1086, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v14 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:50:2:
	if v15 = *(*int32)(unsafe.Pointer(bp + 116)) == int32(1); !v15 {
		t_printf(tls, __ccgo_ts+1158, libc.VaList(bp+128, *(*int32)(unsafe.Pointer(bp + 116))))
	}
	_ = v15 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:52:2:
	if v16 = libc.Xsem_close(tls, sem) == 0; !v16 {
		t_printf(tls, __ccgo_ts+1249, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v16 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:53:2:
	if v17 = libc.Xsem_close(tls, sem) == 0; !v17 {
		t_printf(tls, __ccgo_ts+1311, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v17 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:54:2:
	if v18 = libc.Xsem_unlink(tls, bp) == 0; !v18 {
		t_printf(tls, __ccgo_ts+1373, libc.VaList(bp+128, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v18 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/sem_open.c:55:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1436, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1446, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1538, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1543, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1550, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1568, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1576, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1581, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1624, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1673) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1681) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1693) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1705) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1717) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1726) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1537) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1726) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1732, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "/testsuite-%d-%d\x00src/functional/sem_open.c:25: (sem=sem_open(buf, O_CREAT|O_EXCL, 0700, 1)) != SEM_FAILED failed: could not open sem: %s\n\x00src/functional/sem_open.c:28: sem_open(buf, O_CREAT|O_EXCL, 0700, 1) == SEM_FAILED failed: reopening should fail with O_EXCL\n\x00src/functional/sem_open.c:30: errno == EEXIST failed: after reopen failure errno is \"%s\" (%d); want EEXIST (%d)\n\x00src/functional/sem_open.c:33: sem_getvalue(sem, &val) == 0 failed: failed to get sem value\n\x00src/functional/sem_open.c:34: val == 1 failed: wrong initial semaphore value: %d\n\x00src/functional/sem_open.c:36: (sem2=sem_open(buf, 0)) == sem failed: could not reopen sem: got %p, want %p\n\x00src/functional/sem_open.c:40: sem_wait(sem) == 0 failed: %s\n\x00src/functional/sem_open.c:41: sem_getvalue(sem2, &val) == 0 failed: %s\n\x00src/functional/sem_open.c:42: val == 0 failed: wrong semaphore value on second handle: %d\n\x00src/functional/sem_open.c:45: sem_trywait(sem) == -1 && errno == EAGAIN failed: trywait on locked sem: got errno \"%s\" (%d), want EAGAIN (%d)\n\x00src/functional/sem_open.c:48: sem_post(sem) == 0 failed: %s\n\x00src/functional/sem_open.c:49: sem_getvalue(sem2, &val) == 0 failed: %s\n\x00src/functional/sem_open.c:50: val == 1 failed: wrong semaphore value on second handle: %d\n\x00src/functional/sem_open.c:52: sem_close(sem) == 0 failed: %s\n\x00src/functional/sem_open.c:53: sem_close(sem) == 0 failed: %s\n\x00src/functional/sem_open.c:54: sem_unlink(buf) == 0 failed: %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
