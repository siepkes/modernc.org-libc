// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/tls_init.exe.go src/functional/tls_init.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:7:13:
func f(tls *libc.TLS, arg uintptr) (r uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:8:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:9:2:
	if tls_fix != int32(23) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:10:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, tls_fix))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:11:2:
	if tls_zero != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:12:3:
		t_printf(tls, __ccgo_ts+65, libc.VaList(bp+8, tls_zero))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:13:2:
	tls_fix++
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:14:2:
	tls_zero++
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:15:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:21:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:22:1:
	var i, j int32
	var _ /* t at bp+0 */ [5]pthread_t
	_, _ = i, j
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:26:2:
	if tls_fix != int32(23) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:27:3:
		t_printf(tls, __ccgo_ts+128, libc.VaList(bp+32, tls_fix))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:28:2:
	if tls_zero != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:29:3:
		t_printf(tls, __ccgo_ts+193, libc.VaList(bp+32, tls_zero))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:31:2:
	j = 0
	for {
		if !(j < int32(2)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:32:3:
		i = 0
		for {
			if !(uint32(i) < libc.Uint32FromInt64(20)/libc.Uint32FromInt64(4)) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:33:4:
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:33:4:
			if pthread_create(tls, bp+uintptr(i)*4, uintptr(0), __ccgo_fp(f), uintptr(0)) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:33:4:
				t_printf(tls, __ccgo_ts+256, libc.VaList(bp+32, __ccgo_ts+298))
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:34:4:
			tls_fix++
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:35:4:
			tls_zero++
			goto _2
		_2:
			i++
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:37:3:
		i = 0
		for {
			if !(uint32(i) < libc.Uint32FromInt64(20)/libc.Uint32FromInt64(4)) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:38:4:
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:38:4:
			if pthread_join(tls, (*(*[5]pthread_t)(unsafe.Pointer(bp)))[i], uintptr(0)) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:38:4:
				t_printf(tls, __ccgo_ts+327, libc.VaList(bp+32, __ccgo_ts+369))
			}
			goto _3
		_3:
			i++
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:41:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+391, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+401, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+493, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+498, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+505, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+523, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+531, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+536, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+579, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+628) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+636) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+648) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+660) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+672) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+681) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+492) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+681) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+687, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:4:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:4:14:
var tls_fix = int32(23)

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:5:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/tls_init.c:5:14:
var tls_zero int32

var __ccgo_ts = (*reflect.StringHeader)(unsafe.Pointer(&__ccgo_ts1)).Data

var __ccgo_ts1 = "src/functional/tls_init.c:10: fixed init failed: want 23 got %d\n\x00src/functional/tls_init.c:12: zero init failed: want 0 got %d\n\x00src/functional/tls_init.c:27: fixed init failed: want 23 got %d\n\x00src/functional/tls_init.c:29: zero init failed: want 0 got %d\n\x00src/functional/tls_init.c:33: %s failed.\n\x00pthread_create(t+i, 0, f, 0)\x00src/functional/tls_init.c:38: %s failed.\n\x00pthread_join(t[i], 0)\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
