// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/popen.exe.go src/functional/popen.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:19:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:19:21:
var got_sig sig_atomic_t

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:21:13:
func handler(tls *libc.TLS, sig int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:21:30:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:22:2:
	got_sig = int32(1)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:25:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:26:1:
	var f, v1, v7 uintptr
	var i, v10, v12, v5 int32
	var v11, v13, v2, v3, v4, v6, v8, v9 bool
	var _ /* cmd at bp+6 */ [64]int8
	var _ /* foo at bp+0 */ [6]int8
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = f, i, v1, v10, v11, v12, v13, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:32:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v1 = libc.Xpopen(tls, __ccgo_ts, __ccgo_ts+11)
	f = v1
	if v2 = v1 != 0; !v2 {
		t_printf(tls, __ccgo_ts+13, libc.VaList(bp+80, __ccgo_ts+64, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:33:2:
	if f != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:34:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		if v3 = libc.Xfgets(tls, bp, int32(6), f) != 0; !v3 {
			t_printf(tls, __ccgo_ts+93, libc.VaList(bp+80, __ccgo_ts+144, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
		}
		_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:35:3:
		if v4 = !(libc.Xstrcmp(tls, bp, __ccgo_ts+170) != 0); !v4 {
			t_printf(tls, __ccgo_ts+176, libc.VaList(bp+80, bp, __ccgo_ts+170, __ccgo_ts+222))
		}
		_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:36:3:
		v5 = libc.Xpclose(tls, f)
		i = v5
		if v6 = v5 == 0; !v6 {
			t_printf(tls, __ccgo_ts+254, libc.VaList(bp+80, __ccgo_ts+319, i, 0))
		}
		_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:39:2:
	libc.Xsignal(tls, int32(SIGUSR1), __ccgo_fp(handler))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:40:2:
	libc.Xsnprintf(tls, bp+6, uint32(64), __ccgo_ts+329, libc.VaList(bp+80, libc.Xgetpid(tls)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:41:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v7 = libc.Xpopen(tls, bp+6, __ccgo_ts+375)
	f = v7
	if v8 = v7 != 0; !v8 {
		t_printf(tls, __ccgo_ts+377, libc.VaList(bp+80, __ccgo_ts+428, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:42:2:
	if f != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:43:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		if v9 = libc.Xfputs(tls, __ccgo_ts+170, f) >= 0; !v9 {
			t_printf(tls, __ccgo_ts+448, libc.VaList(bp+80, __ccgo_ts+499, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls)))))
		}
		_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:44:3:
		v10 = libc.Xpclose(tls, f)
		i = v10
		if v11 = v10 == 0; !v11 {
			t_printf(tls, __ccgo_ts+522, libc.VaList(bp+80, __ccgo_ts+319, i, 0))
		}
		_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:45:3:
		v12 = got_sig
		i = v12
		if v13 = v12 == int32(1); !v13 {
			t_printf(tls, __ccgo_ts+587, libc.VaList(bp+80, __ccgo_ts+661, i, int32(1)))
		}
		_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:47:2:
	libc.Xsignal(tls, int32(SIGUSR1), libc.UintptrFromInt32(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/popen.c:48:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+669, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+679, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+771, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+776, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+783, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+801, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+809, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+814, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+857, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+906) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+914) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+926) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+938) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+950) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+959) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+770) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+959) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+965, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "echo hello\x00r\x00src/functional/popen.c:32: %s failed (errno = %d)\n\x00f = popen(\"echo hello\", \"r\")\x00src/functional/popen.c:34: %s failed (errno = %d)\n\x00fgets(foo, sizeof foo, f)\x00hello\x00src/functional/popen.c:35: [%s] != [%s] (%s)\n\x00child process did not say hello\x00src/functional/popen.c:36: %s failed (exit status %04x != %04x)\n\x00pclose(f)\x00read a ; test \"x$a\" = xhello && kill -USR1 %d\x00w\x00src/functional/popen.c:41: %s failed (errno = %d)\n\x00f = popen(cmd, \"w\")\x00src/functional/popen.c:43: %s failed (errno = %d)\n\x00fputs(\"hello\", f) >= 0\x00src/functional/popen.c:44: %s failed (exit status %04x != %04x)\n\x00src/functional/popen.c:45: %s failed (child process did not send signal)\n\x00got_sig\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
