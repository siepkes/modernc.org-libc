// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/random.exe.go src/functional/random.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//	/* error p ~ 1.6e-6 */
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:9:12:
func chkmissing(tls *libc.TLS, x uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:10:1:
	var d [8]int32
	var i int32
	_, _ = d, i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:11:6:
	d = [8]int32{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:13:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:14:3:
		d[*(*int32)(unsafe.Pointer(x + uintptr(i)*4))%int32(8)]++
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:15:2:
	i = 0
	for {
		if !(i < int32(8)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:16:3:
		if d[i] == 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:17:4:
			return int32(1)
		}
		goto _2
	_2:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:18:2:
	return 0
}
...
//	/* error p ~ 4e-6 */
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:22:12:
func chkrepeat(tls *libc.TLS, x uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:23:1:
	var i, j int32
	_, _ = i, j
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:25:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:26:3:
		j = 0
		for {
			if !(j < i) {
				break
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:27:4:
			if *(*int32)(unsafe.Pointer(x + uintptr(i)*4)) == *(*int32)(unsafe.Pointer(x + uintptr(j)*4)) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:28:5:
				return int32(1)
			}
			goto _2
		_2:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:29:2:
	return 0
}
...
//	/* error p ~ 1e-6 */
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:33:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:33:17:
var orx uint32

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:34:12:
func chkones(tls *libc.TLS, x uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:35:1:
	var i int32
	_ = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:37:2:
	orx = uint32(0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:38:2:
	i = 0
	for {
		if !(i < int32(20)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:39:3:
		orx = orx | uint32(*(*int32)(unsafe.Pointer(x + uintptr(i)*4)))
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:40:2:
	return libc.BoolInt32(orx != uint32(0x7fffffff))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:43:6:
func checkseed(tls *libc.TLS, seed uint32, x uintptr) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:44:1:
	var i int32
	_ = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:46:2:
	libc.Xsrandom(tls, seed)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:47:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:48:3:
		*(*int32)(unsafe.Pointer(x + uintptr(i)*4)) = libc.Xrandom(tls)
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:49:2:
	if chkmissing(tls, x) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:50:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, seed))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:51:2:
	if chkrepeat(tls, x) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:52:3:
		t_printf(tls, __ccgo_ts+71, libc.VaList(bp+8, seed))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:53:2:
	if chkones(tls, x) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:54:3:
		t_printf(tls, __ccgo_ts+128, libc.VaList(bp+8, seed, orx))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:57:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(560)
	defer tls.Free(560)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:58:1:
	var i, y, z, v3, v5, v7 int32
	var p, q uintptr
	var _ /* state at bp+400 */ [128]int8
	var _ /* x at bp+0 */ [100]int32
	_, _, _, _, _, _, _, _ = i, p, q, y, z, v3, v5, v7
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:66:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:67:3:
		(*(*[100]int32)(unsafe.Pointer(bp)))[i] = libc.Xrandom(tls)
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:68:2:
	p = libc.Xinitstate(tls, uint32(1), bp+400, uint32(128))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:69:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:70:3:
		v3 = libc.Xrandom(tls)
		y = v3
		if (*(*[100]int32)(unsafe.Pointer(bp)))[i] != v3 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:71:4:
			t_printf(tls, __ccgo_ts+190, libc.VaList(bp+536, i, (*(*[100]int32)(unsafe.Pointer(bp)))[i], y))
		}
		goto _2
	_2:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:72:2:
	i = 0
	for {
		if !(i < int32(10)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:73:3:
		z = libc.Xrandom(tls)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:74:3:
		q = libc.Xsetstate(tls, p)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:75:3:
		v5 = libc.Xrandom(tls)
		y = v5
		if z != v5 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:76:4:
			t_printf(tls, __ccgo_ts+278, libc.VaList(bp+536, i, z, y))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:77:3:
		p = libc.Xsetstate(tls, q)
		goto _4
	_4:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:79:2:
	libc.Xsrandom(tls, uint32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:80:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:81:3:
		v7 = libc.Xrandom(tls)
		y = v7
		if (*(*[100]int32)(unsafe.Pointer(bp)))[i] != v7 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:82:4:
			t_printf(tls, __ccgo_ts+350, libc.VaList(bp+536, i, (*(*[100]int32)(unsafe.Pointer(bp)))[i], y))
		}
		goto _6
	_6:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:83:2:
	checkseed(tls, uint32(0x7fffffff), bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:84:2:
	i = 0
	for {
		if !(i < int32(10)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:85:3:
		checkseed(tls, uint32(i), bp)
		goto _8
	_8:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/random.c:86:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+436, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+446, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+538, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+543, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+550, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+568, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+576, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+581, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+624, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+673) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+681) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+693) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+705) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+717) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+726) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+537) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+726) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+732, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
