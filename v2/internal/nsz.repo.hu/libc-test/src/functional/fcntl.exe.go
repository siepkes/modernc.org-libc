// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/fcntl.exe.go src/functional/fcntl.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:13:9:
const EACCES = 13
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:34:9:
const F_GETLK = 12

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/fcntl.h:54:9:
const F_RDLCK = 0

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:35:9:
const F_SETLK = 13

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/fcntl.h:55:9:
const F_WRLCK = 1

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/unistd.h:14:9:
const SEEK_SET = 0
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:13:1:
	var f, v2 uintptr
	var fd, v1 int32
	var pid pid_t
	var _ /* fl at bp+0 */ flock1
	var _ /* status at bp+24 */ int32
	_, _, _, _, _ = f, fd, pid, v1, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:14:15:
	*(*flock1)(unsafe.Pointer(bp)) = flock1{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:20:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v2 = libc.Xtmpfile(tls)
	f = v2
	if v2 != 0 {
		v1 = int32(1)
	} else {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+40, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		v1 = libc.Int32FromInt32(0)
	}
	if !(v1 != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:20:27:
		return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:21:2:
	fd = libc.Xfileno(tls, f)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:23:2:
	(*(*flock1)(unsafe.Pointer(bp))).Fl_type = int16(F_WRLCK)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:24:2:
	(*(*flock1)(unsafe.Pointer(bp))).Fl_whence = SEEK_SET
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:25:2:
	(*(*flock1)(unsafe.Pointer(bp))).Fl_start = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:26:2:
	(*(*flock1)(unsafe.Pointer(bp))).Fl_len = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:27:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	if !(libc.Xfcntl(tls, fd, int32(F_SETLK), libc.VaList(bp+40, bp)) == 0) {
		t_printf(tls, __ccgo_ts+59, libc.VaList(bp+40, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:29:2:
	pid = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:30:2:
	if !(pid != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:31:3:
		(*(*flock1)(unsafe.Pointer(bp))).Fl_type = F_RDLCK
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:32:3:
		libc.X_exit(tls, libc.BoolInt32(libc.Xfcntl(tls, fd, int32(F_SETLK), libc.VaList(bp+40, bp)) == 0 || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EAGAIN) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EACCES)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:35:2:
	for libc.Xwaitpid(tls, pid, bp+24, 0) < 0 && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EINTR) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:35:52:
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:36:2:
	if !(*(*int32)(unsafe.Pointer(bp + 24)) == 0) {
		t_printf(tls, __ccgo_ts+128, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:38:2:
	pid = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:39:2:
	if !(pid != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:40:3:
		(*(*flock1)(unsafe.Pointer(bp))).Fl_type = int16(F_WRLCK)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:41:3:
		libc.X_exit(tls, libc.BoolInt32(libc.Xfcntl(tls, fd, int32(F_GETLK), libc.VaList(bp+40, bp)) != 0 || (*(*flock1)(unsafe.Pointer(bp))).Fl_pid != libc.Xgetppid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:43:2:
	for libc.Xwaitpid(tls, pid, bp+24, 0) < 0 && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EINTR) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:43:52:
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:44:2:
	if !(*(*int32)(unsafe.Pointer(bp + 24)) == 0) {
		t_printf(tls, __ccgo_ts+194, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:46:2:
	libc.Xfclose(tls, f)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/fcntl.c:48:2:
	return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+283, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+293, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+385, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+390, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+397, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+415, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+423, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+428, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+471, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+520) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+528) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+540) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+552) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+564) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+573) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+384) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+573) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+579, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
