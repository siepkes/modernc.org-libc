// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/ipc_sem.exe.go src/functional/ipc_sem.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/sem.h:23:9:
const GETNCNT = 14

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/sem.h:20:9:
const GETPID = 11

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/sem.h:21:9:
const GETVAL = 12

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/sem.h:24:9:
const GETZCNT = 15
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/sem.h:1:1:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/sem.h:36:1:
type seminfo = struct {
	Fsemmap int32
	Fsemmni int32
	Fsemmns int32
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/sem.h:49:1:
type sembuf = struct {
	Fsem_num uint16
	Fsem_op  int16
	Fsem_flg int16
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:14:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:14:19:
var path = [2]int8{'.'}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:15:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:15:18:
var id = int32('s')

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:27:13:
func inc(tls *libc.TLS) {
	bp := tls.Alloc(144)
	defer tls.Free(144)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:28:1:
	var k, v2 key_t
	var semid, semncnt, sempid, semval, semzcnt, v3, v4, v5, v6, v7, v8 int32
	var t, v1 time_t
	var _ /* arg at bp+80 */ struct {
		Fbuf   [0]uintptr
		Farray [0]uintptr
		Fval   int32
	}
	var _ /* semid_ds at bp+0 */ semid_ds
	var _ /* sops at bp+84 */ sembuf
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = k, semid, semncnt, sempid, semval, semzcnt, t, v1, v2, v3, v4, v5, v6, v7, v8
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:40:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:40:2:
	v1 = libc.Xtime(tls, uintptr(0))
	t = v1
	if v1+int64(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:40:2:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+104, __ccgo_ts+44, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:41:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:41:2:
	v2 = libc.Xftok(tls, uintptr(unsafe.Pointer(&path)), id)
	k = v2
	if v2+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:41:2:
		t_printf(tls, __ccgo_ts+56, libc.VaList(bp+104, __ccgo_ts+100, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	/* make sure we get a clean semaphore id */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:44:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:44:2:
	v3 = libc.Xsemget(tls, k, int32(1), libc.Int32FromInt32(IPC_CREAT)|libc.Int32FromInt32(0666))
	semid = v3
	if v3+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:44:2:
		t_printf(tls, __ccgo_ts+119, libc.VaList(bp+104, __ccgo_ts+163, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:45:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:45:2:
	if libc.Xsemctl(tls, semid, 0, IPC_RMID, 0)+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:45:2:
		t_printf(tls, __ccgo_ts+200, libc.VaList(bp+104, __ccgo_ts+244, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:46:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:46:2:
	v4 = libc.Xsemget(tls, k, int32(1), libc.Int32FromInt32(IPC_CREAT)|libc.Int32FromInt32(IPC_EXCL)|libc.Int32FromInt32(0666))
	semid = v4
	if v4+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:46:2:
		t_printf(tls, __ccgo_ts+271, libc.VaList(bp+104, __ccgo_ts+315, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:48:2:
	if libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:49:3:
		libc.Xexit(tls, libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))))
	}
	/* check IPC_EXCL */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:52:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:53:2:
	if libc.Xsemget(tls, k, int32(1), libc.Int32FromInt32(IPC_CREAT)|libc.Int32FromInt32(IPC_EXCL)|libc.Int32FromInt32(0666)) != -int32(1) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EEXIST) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:54:3:
		t_printf(tls, __ccgo_ts+361, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	/* check if msgget initilaized the msqid_ds structure correctly */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:57:2:
	*(*uintptr)(unsafe.Pointer(bp + 80)) = bp
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:58:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:58:2:
	if libc.Xsemctl(tls, semid, 0, int32(IPC_STAT), libc.VaList(bp+104, *(*struct {
		Fbuf   [0]uintptr
		Farray [0]uintptr
		Fval   int32
	})(unsafe.Pointer(bp + 80))))+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:58:2:
		t_printf(tls, __ccgo_ts+457, libc.VaList(bp+104, __ccgo_ts+501, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:59:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:59:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fcuid != libc.Xgeteuid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:59:2:
		t_printf(tls, __ccgo_ts+533, libc.VaList(bp+104, __ccgo_ts+596, __ccgo_ts+619, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fcuid, libc.Xgeteuid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:60:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:60:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fuid != libc.Xgeteuid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:60:2:
		t_printf(tls, __ccgo_ts+629, libc.VaList(bp+104, __ccgo_ts+692, __ccgo_ts+619, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fuid, libc.Xgeteuid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:61:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:61:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fcgid != libc.Xgetegid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:61:2:
		t_printf(tls, __ccgo_ts+714, libc.VaList(bp+104, __ccgo_ts+777, __ccgo_ts+800, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fcgid, libc.Xgetegid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:62:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:62:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fgid != libc.Xgetegid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:62:2:
		t_printf(tls, __ccgo_ts+810, libc.VaList(bp+104, __ccgo_ts+873, __ccgo_ts+800, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fgid, libc.Xgetegid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:63:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:63:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fmode&uint32(0x1ff) != uint32(libc.Int32FromInt32(0666)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:63:2:
		t_printf(tls, __ccgo_ts+895, libc.VaList(bp+104, __ccgo_ts+958, __ccgo_ts+989, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_perm.Fmode&uint32(0x1ff), int32(0666)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:64:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:64:2:
	if int32((*(*semid_ds)(unsafe.Pointer(bp))).Fsem_nsems) != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:64:2:
		t_printf(tls, __ccgo_ts+994, libc.VaList(bp+104, __ccgo_ts+1057, __ccgo_ts+1076, int32((*(*semid_ds)(unsafe.Pointer(bp))).Fsem_nsems), int32(1)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:65:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:65:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_otime != int64(libc.Int32FromInt32(0)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:65:2:
		t_printf(tls, __ccgo_ts+1078, libc.VaList(bp+104, __ccgo_ts+1143, __ccgo_ts+1173, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_otime, 0))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:66:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_ctime < t {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:67:3:
		t_printf(tls, __ccgo_ts+1175, libc.VaList(bp+104, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_ctime, t))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:68:2:
	if (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_ctime > t+int64(5) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:69:3:
		t_printf(tls, __ccgo_ts+1260, libc.VaList(bp+104, (*(*semid_ds)(unsafe.Pointer(bp))).Fsem_ctime, t+int64(5)))
	}
	/* test sem_op > 0 */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:72:2:
	(*(*sembuf)(unsafe.Pointer(bp + 84))).Fsem_num = uint16(0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:73:2:
	(*(*sembuf)(unsafe.Pointer(bp + 84))).Fsem_op = int16(1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:74:2:
	(*(*sembuf)(unsafe.Pointer(bp + 84))).Fsem_flg = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:75:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:75:2:
	if libc.Xsemop(tls, semid, bp+84, uint32(1))+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:75:2:
		t_printf(tls, __ccgo_ts+1347, libc.VaList(bp+104, __ccgo_ts+1391, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:76:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:76:2:
	v5 = libc.Xsemctl(tls, semid, 0, int32(GETVAL), 0)
	semval = v5
	if v5+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:76:2:
		t_printf(tls, __ccgo_ts+1414, libc.VaList(bp+104, __ccgo_ts+1458, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:77:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:77:2:
	if semval != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:77:2:
		t_printf(tls, __ccgo_ts+1492, libc.VaList(bp+104, __ccgo_ts+1555, __ccgo_ts+1076, semval, int32(1)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:78:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:78:2:
	v6 = libc.Xsemctl(tls, semid, 0, int32(GETPID), 0)
	sempid = v6
	if v6+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:78:2:
		t_printf(tls, __ccgo_ts+1562, libc.VaList(bp+104, __ccgo_ts+1606, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:79:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:79:2:
	if sempid != libc.Xgetpid(tls) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:79:2:
		t_printf(tls, __ccgo_ts+1640, libc.VaList(bp+104, __ccgo_ts+1703, __ccgo_ts+1710, sempid, libc.Xgetpid(tls)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:80:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:80:2:
	v7 = libc.Xsemctl(tls, semid, 0, int32(GETNCNT), 0)
	semncnt = v7
	if v7+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:80:2:
		t_printf(tls, __ccgo_ts+1719, libc.VaList(bp+104, __ccgo_ts+1763, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:81:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:81:2:
	if semncnt != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:81:2:
		t_printf(tls, __ccgo_ts+1799, libc.VaList(bp+104, __ccgo_ts+1862, __ccgo_ts+1173, semncnt, 0))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:82:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:82:2:
	v8 = libc.Xsemctl(tls, semid, 0, int32(GETZCNT), 0)
	semzcnt = v8
	if v8+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:82:2:
		t_printf(tls, __ccgo_ts+1870, libc.VaList(bp+104, __ccgo_ts+1914, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:83:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:83:2:
	if semzcnt != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:83:2:
		t_printf(tls, __ccgo_ts+1950, libc.VaList(bp+104, __ccgo_ts+2013, __ccgo_ts+1173, semzcnt, 0))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:86:13:
func dec(tls *libc.TLS) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:87:1:
	var k, v1 key_t
	var semid, semval, v2, v3 int32
	var _ /* sops at bp+0 */ sembuf
	_, _, _, _, _, _ = k, semid, semval, v1, v2, v3
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:92:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:92:2:
	v1 = libc.Xftok(tls, uintptr(unsafe.Pointer(&path)), id)
	k = v1
	if v1+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:92:2:
		t_printf(tls, __ccgo_ts+2021, libc.VaList(bp+16, __ccgo_ts+100, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:93:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:93:2:
	v2 = libc.Xsemget(tls, k, 0, 0)
	semid = v2
	if v2+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:93:2:
		t_printf(tls, __ccgo_ts+2065, libc.VaList(bp+16, __ccgo_ts+2109, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	/* test sem_op < 0 */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:96:2:
	(*(*sembuf)(unsafe.Pointer(bp))).Fsem_num = uint16(0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:97:2:
	(*(*sembuf)(unsafe.Pointer(bp))).Fsem_op = int16(-int32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:98:2:
	(*(*sembuf)(unsafe.Pointer(bp))).Fsem_flg = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:99:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:99:2:
	if libc.Xsemop(tls, semid, bp, uint32(1))+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:99:2:
		t_printf(tls, __ccgo_ts+2133, libc.VaList(bp+16, __ccgo_ts+1391, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:100:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:100:2:
	v3 = libc.Xsemctl(tls, semid, 0, int32(GETVAL), 0)
	semval = v3
	if v3+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:100:2:
		t_printf(tls, __ccgo_ts+2177, libc.VaList(bp+16, __ccgo_ts+1458, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:101:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:101:2:
	if semval != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:101:2:
		t_printf(tls, __ccgo_ts+2222, libc.VaList(bp+16, __ccgo_ts+1555, __ccgo_ts+1173, semval, 0))
	}
	/* cleanup */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:104:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:104:2:
	if libc.Xsemctl(tls, semid, 0, IPC_RMID, 0)+int32(1) == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:104:2:
		t_printf(tls, __ccgo_ts+2286, libc.VaList(bp+16, __ccgo_ts+244, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:107:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:108:1:
	var p int32
	var _ /* status at bp+0 */ int32
	_ = p
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:112:2:
	inc(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:113:2:
	p = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:114:2:
	if p == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:115:3:
		t_printf(tls, __ccgo_ts+2331, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:116:7:
		if p == 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:117:3:
			dec(tls)
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:119:3:
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:119:3:
			if libc.Xwaitpid(tls, p, bp, 0)+int32(1) == 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:119:3:
				t_printf(tls, __ccgo_ts+2378, libc.VaList(bp+16, __ccgo_ts+2423, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
			}
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:120:3:
			if !!(*(*int32)(unsafe.Pointer(bp))&libc.Int32FromInt32(0x7f) != 0) || *(*int32)(unsafe.Pointer(bp))&int32(0xff00)>>int32(8) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:121:4:
				t_printf(tls, __ccgo_ts+2446, libc.VaList(bp+16, *(*int32)(unsafe.Pointer(bp))))
			}
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/ipc_sem.c:123:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+2499, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+2509, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2601, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2606, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2611, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2629, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2637, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2642, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2685, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2734) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2742) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2754) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2766) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2778) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2787) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2600) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2787) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2793, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/ipc_sem.c:40: %s failed: %s\n\x00t = time(0)\x00src/functional/ipc_sem.c:41: %s failed: %s\n\x00k = ftok(path, id)\x00src/functional/ipc_sem.c:44: %s failed: %s\n\x00semid = semget(k, 1, IPC_CREAT|0666)\x00src/functional/ipc_sem.c:45: %s failed: %s\n\x00semctl(semid, 0, IPC_RMID)\x00src/functional/ipc_sem.c:46: %s failed: %s\n\x00semid = semget(k, 1, IPC_CREAT|IPC_EXCL|0666)\x00src/functional/ipc_sem.c:54: semget(IPC_CREAT|IPC_EXCL) should have failed with EEXIST, got %s\n\x00src/functional/ipc_sem.c:58: %s failed: %s\n\x00semctl(semid, 0, IPC_STAT, arg)\x00src/functional/ipc_sem.c:59: %s == %s failed: got %d, want %d\n\x00semid_ds.sem_perm.cuid\x00geteuid()\x00src/functional/ipc_sem.c:60: %s == %s failed: got %d, want %d\n\x00semid_ds.sem_perm.uid\x00src/functional/ipc_sem.c:61: %s == %s failed: got %d, want %d\n\x00semid_ds.sem_perm.cgid\x00getegid()\x00src/functional/ipc_sem.c:62: %s == %s failed: got %d, want %d\n\x00semid_ds.sem_perm.gid\x00src/functional/ipc_sem.c:63: %s == %s failed: got %o, want %o\n\x00semid_ds.sem_perm.mode & 0x1ff\x000666\x00src/functional/ipc_sem.c:64: %s == %s failed: got %d, want %d\n\x00semid_ds.sem_nsems\x001\x00src/functional/ipc_sem.c:65: %s == %s failed: got %lld, want %d\n\x00(long long)semid_ds.sem_otime\x000\x00src/functional/ipc_sem.c:67: semid_ds.sem_ctime >= t failed: got %lld, want >= %lld\n\x00src/functional/ipc_sem.c:69: semid_ds.sem_ctime <= t+5 failed: got %lld, want <= %lld\n\x00src/functional/ipc_sem.c:75: %s failed: %s\n\x00semop(semid, &sops, 1)\x00src/functional/ipc_sem.c:76: %s failed: %s\n\x00semval = semctl(semid, 0, GETVAL)\x00src/functional/ipc_sem.c:77: %s == %s failed: got %d, want %d\n\x00semval\x00src/functional/ipc_sem.c:78: %s failed: %s\n\x00sempid = semctl(semid, 0, GETPID)\x00src/functional/ipc_sem.c:79: %s == %s failed: got %d, want %d\n\x00sempid\x00getpid()\x00src/functional/ipc_sem.c:80: %s failed: %s\n\x00semncnt = semctl(semid, 0, GETNCNT)\x00src/functional/ipc_sem.c:81: %s == %s failed: got %d, want %d\n\x00semncnt\x00src/functional/ipc_sem.c:82: %s failed: %s\n\x00semzcnt = semctl(semid, 0, GETZCNT)\x00src/functional/ipc_sem.c:83: %s == %s failed: got %d, want %d\n\x00semzcnt\x00src/functional/ipc_sem.c:92: %s failed: %s\n\x00src/functional/ipc_sem.c:93: %s failed: %s\n\x00semid = semget(k, 0, 0)\x00src/functional/ipc_sem.c:99: %s failed: %s\n\x00src/functional/ipc_sem.c:100: %s failed: %s\n\x00src/functional/ipc_sem.c:101: %s == %s failed: got %d, want %d\n\x00src/functional/ipc_sem.c:104: %s failed: %s\n\x00src/functional/ipc_sem.c:115: fork failed: %s\n\x00src/functional/ipc_sem.c:119: %s failed: %s\n\x00waitpid(p, &status, 0)\x00src/functional/ipc_sem.c:121: child exit status: %d\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
