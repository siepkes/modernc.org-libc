// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/strtod_simple.exe.go src/functional/strtod_simple.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:16:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(1040)
	defer tls.Free(1040)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:17:1:
	var d, d2, v2, v4, v6 float64
	var i int32
	var v3, v5, v7 bool
	var _ /* buf at bp+0 */ [1000]int8
	_, _, _, _, _, _, _, _, _ = d, d2, i, v2, v3, v4, v5, v6, v7
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:22:2:
	i = 0
	for {
		if !(i < int32(100)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:23:3:
		d = libc.Xsin(tls, float64(i))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:24:3:
		libc.Xsnprintf(tls, bp, uint32(1000), __ccgo_ts, libc.VaList(bp+1008, d))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:25:3:
		v2 = libc.Xstrtod(tls, bp, uintptr(0))
		d2 = v2
		if v3 = v2 == d; !v3 {
			t_printf(tls, __ccgo_ts+7, libc.VaList(bp+1008, __ccgo_ts+85, d2, d, d2-d))
		}
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:28:2:
	v4 = libc.Xstrtod(tls, __ccgo_ts+100, uintptr(0))
	d = v4
	if v5 = v4 == float64(16); !v5 {
		t_printf(tls, __ccgo_ts+106, libc.VaList(bp+1008, __ccgo_ts+173, d, float64(16), d-float64(16)))
	}
	_ = v5 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:29:2:
	v6 = libc.Xstrtod(tls, __ccgo_ts+192, uintptr(0))
	d = v6
	if v7 = v6 == float64(17); !v7 {
		t_printf(tls, __ccgo_ts+200, libc.VaList(bp+1008, __ccgo_ts+267, d, float64(17), d-float64(17)))
	}
	_ = v7 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod_simple.c:30:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+288, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+298, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+390, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+395, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+402, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+420, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+428, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+433, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+476, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+525) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+533) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+545) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+557) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+569) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+578) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+389) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+578) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+584, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
