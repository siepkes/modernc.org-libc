// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/strptime.exe.go src/functional/strptime.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//	 */
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:17:13:
func checkStrptime(tls *libc.TLS, s uintptr, format uintptr, expected uintptr) {
	bp := tls.Alloc(224)
	defer tls.Free(224)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:17:89:
	var ret uintptr
	var _ /* buf1 at bp+44 */ [64]int8
	var _ /* buf2 at bp+108 */ [64]int8
	var _ /* tm at bp+0 */ tm
	_ = ret
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:18:12:
	*(*tm)(unsafe.Pointer(bp)) = tm{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:21:2:
	ret = libc.Xstrptime(tls, s, format, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:22:2:
	if !(ret != 0) || int32(*(*int8)(unsafe.Pointer(ret))) != int32('\000') {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:23:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+184, format, s))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:24:9:
		if (*(*tm)(unsafe.Pointer(bp))).Ftm_sec != (*tm)(unsafe.Pointer(expected)).Ftm_sec || (*(*tm)(unsafe.Pointer(bp))).Ftm_min != (*tm)(unsafe.Pointer(expected)).Ftm_min || (*(*tm)(unsafe.Pointer(bp))).Ftm_hour != (*tm)(unsafe.Pointer(expected)).Ftm_hour || (*(*tm)(unsafe.Pointer(bp))).Ftm_mday != (*tm)(unsafe.Pointer(expected)).Ftm_mday || (*(*tm)(unsafe.Pointer(bp))).Ftm_mon != (*tm)(unsafe.Pointer(expected)).Ftm_mon || (*(*tm)(unsafe.Pointer(bp))).Ftm_year != (*tm)(unsafe.Pointer(expected)).Ftm_year {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:33:3:
			libc.Xstrftime(tls, bp+44, uint32(64), __ccgo_ts+58, expected)
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:34:3:
			libc.Xstrftime(tls, bp+108, uint32(64), __ccgo_ts+58, bp)
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:36:3:
			t_printf(tls, __ccgo_ts+72, libc.VaList(bp+184, format, s, bp+44, bp+108))
		}
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:40:13:
func checkStrptimeTz(tls *libc.TLS, s uintptr, h int32, m int32) {
	bp := tls.Alloc(80)
	defer tls.Free(80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:40:58:
	var expected int32
	var ret uintptr
	var _ /* tm at bp+0 */ tm
	_, _ = expected, ret
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:41:11:
	expected = h*int32(3600) + m*int32(60)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:42:12:
	*(*tm)(unsafe.Pointer(bp)) = tm{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:45:2:
	ret = libc.Xstrptime(tls, s, __ccgo_ts+141, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:46:2:
	if !(ret != 0) || int32(*(*int8)(unsafe.Pointer(ret))) != int32('\000') {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:47:3:
		t_printf(tls, __ccgo_ts+144, libc.VaList(bp+56, s))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:48:9:
		if (*(*tm)(unsafe.Pointer(bp))).Ftm_gmtoff != expected {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:49:3:
			t_printf(tls, __ccgo_ts+203, libc.VaList(bp+56, s, (*(*tm)(unsafe.Pointer(bp))).Ftm_gmtoff, expected))
		}
	}
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:53:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:53:18:
var tm1 = tm{
	Ftm_sec:  int32(8),
	Ftm_min:  int32(57),
	Ftm_hour: int32(20),
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:62:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:62:18:
var tm2 = tm{
	Ftm_sec:  int32(0),
	Ftm_min:  int32(0),
	Ftm_hour: int32(0),
	Ftm_mday: int32(25),
	Ftm_mon:  libc.Int32FromInt32(8) - libc.Int32FromInt32(1),
	Ftm_year: libc.Int32FromInt32(1991) - libc.Int32FromInt32(1900),
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:71:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:71:18:
var tm3 = tm{
	Ftm_sec:  int32(0),
	Ftm_min:  int32(0),
	Ftm_hour: int32(0),
	Ftm_mday: int32(21),
	Ftm_mon:  libc.Int32FromInt32(10) - libc.Int32FromInt32(1),
	Ftm_year: libc.Int32FromInt32(2015) - libc.Int32FromInt32(1900),
}

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:80:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:80:18:
var tm4 = tm{
	Ftm_sec:  int32(0),
	Ftm_min:  int32(0),
	Ftm_hour: int32(0),
	Ftm_mday: int32(10),
	Ftm_mon:  libc.Int32FromInt32(7) - libc.Int32FromInt32(1),
	Ftm_year: libc.Int32FromInt32(1856) - libc.Int32FromInt32(1900),
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:89:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:89:12:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:90:2:
	libc.Xsetenv(tls, __ccgo_ts+285, __ccgo_ts+288, int32(1))
	/* Time */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:93:2:
	checkStrptime(tls, __ccgo_ts+293, __ccgo_ts+302, uintptr(unsafe.Pointer(&tm1)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:94:2:
	checkStrptime(tls, __ccgo_ts+311, __ccgo_ts+319, uintptr(unsafe.Pointer(&tm1)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:95:2:
	checkStrptime(tls, __ccgo_ts+293, __ccgo_ts+325, uintptr(unsafe.Pointer(&tm1)))
	/* Format */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:98:2:
	checkStrptime(tls, __ccgo_ts+293, __ccgo_ts+328, uintptr(unsafe.Pointer(&tm1)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:99:2:
	checkStrptime(tls, __ccgo_ts+343, __ccgo_ts+353, uintptr(unsafe.Pointer(&tm1)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:100:2:
	checkStrptime(tls, __ccgo_ts+362, __ccgo_ts+371, uintptr(unsafe.Pointer(&tm1)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:101:2:
	checkStrptime(tls, __ccgo_ts+384, __ccgo_ts+406, uintptr(unsafe.Pointer(&tm1)))
	/* Date */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:104:2:
	checkStrptime(tls, __ccgo_ts+426, __ccgo_ts+437, uintptr(unsafe.Pointer(&tm2)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:105:2:
	checkStrptime(tls, __ccgo_ts+446, __ccgo_ts+455, uintptr(unsafe.Pointer(&tm2)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:106:2:
	checkStrptime(tls, __ccgo_ts+464, __ccgo_ts+473, uintptr(unsafe.Pointer(&tm2)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:107:2:
	checkStrptime(tls, __ccgo_ts+476, __ccgo_ts+455, uintptr(unsafe.Pointer(&tm3)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:108:2:
	checkStrptime(tls, __ccgo_ts+485, __ccgo_ts+501, uintptr(unsafe.Pointer(&tm4)))
	//ccgo: /* Glibc */
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strptime.c:117:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+519, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+529, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+621, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+626, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+633, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+651, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+659, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+664, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+707, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+756) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+764) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+776) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+788) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+800) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+809) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+620) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+809) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+815, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/strptime.c:23: \"%s\": failed to parse \"%s\"\n\x00%FT%H:%M:%S%Z\x00src/functional/strptime.c:36: \"%s\": for \"%s\" expected %s but got %s\n\x00%z\x00src/functional/strptime.c:47: \"%%z\": failed to parse \"%s\"\n\x00src/functional/strptime.c:49: \"%%z\": for \"%s\" expected tm_gmtoff %ld but got %ld\n\x00TZ\x00UTC0\x0020:57:08\x00%H:%M:%S\x0020:57:8\x00%R:%S\x00%T\x00%H : %M  :  %S\x0020 57  08\x00%H %M %S\x0020%57%08\x00%H %% %M%%%S\x00foo20bar57qux08      \x00foo %Hbar %M qux%S \x001991-08-25\x00%Y-%m-%d\x0025.08.91\x00%d.%m.%y\x0008/25/91\x00%D\x0021.10.15\x0010.7.56 in 18th\x00%d.%m.%y in %C th\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
