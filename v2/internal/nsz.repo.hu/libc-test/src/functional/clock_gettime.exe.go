// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/clock_gettime.exe.go src/functional/clock_gettime.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clock_gettime.c:9:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clock_gettime.c:10:1:
	var v1 bool
	var _ /* ts at bp+0 */ timespec
	_ = v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clock_gettime.c:12:2:
	if v1 = libc.Xclock_gettime(tls, CLOCK_REALTIME, bp) == 0 && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == 0; !v1 {
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/clock_gettime.c:13:2:
