// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/socket.exe.go src/functional/socket.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:116:9:
const EINPROGRESS = 115

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/fcntl.h:58:9:
const FD_CLOEXEC = 1

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/select.h:18:9:
const FD_SETSIZE = 1024

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:23:9:
const F_GETFD = 1

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:25:9:
const F_GETFL = 3

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/netinet/in.h:79:9:
const IPPROTO_TCP = 6

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/netinet/in.h:82:9:
const IPPROTO_UDP = 17

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/fcntl.h:6:9:
const O_NONBLOCK = 2048

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:103:9:
const PF_INET = 2

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:95:9:
const SOCK_CLOEXEC = 524288

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:85:9:
const SOCK_DGRAM = 2

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:96:9:
const SOCK_NONBLOCK = 2048

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:84:9:
const SOCK_STREAM = 1

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:296:9:
const SOL_SOCKET = 1

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:229:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/socket.h:68:1:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:14:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(176)
	defer tls.Free(176)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:15:1:
	var c, s, t, v12, v18, v2, v22, v7 int32
	var _ /* buf at bp+48 */ [100]int8
	var _ /* sa at bp+32 */ sockaddr_in
	_, _, _, _, _, _, _, _ = c, s, t, v12, v18, v2, v22, v7
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:16:21:
	*(*sockaddr_in)(unsafe.Pointer(bp + 32)) = sockaddr_in{
		Fsin_family: uint16(PF_INET),
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:20:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v2 = libc.Xsocket(tls, int32(PF_INET), int32(SOCK_DGRAM), int32(IPPROTO_UDP))
	s = v2
	if !(v2 >= 0) {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:21:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	if !(libc.Xbind(tls, s, bp+32, uint32(16)) == 0) {
		t_printf(tls, __ccgo_ts+72, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:22:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	*(*[1]socklen_t)(unsafe.Pointer(bp)) = [1]socklen_t{
		0: uint32(16),
	}
	if !(libc.Xgetsockname(tls, s, bp+32, bp) == 0) {
		t_printf(tls, __ccgo_ts+155, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:24:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	*(*timeval)(unsafe.Pointer(bp + 4)) = timeval{
		Ftv_usec: int64(1),
	}
	if !(libc.Xsetsockopt(tls, s, int32(SOL_SOCKET), int32(SO_RCVTIMEO), bp+4, uint32(16)) == 0) {
		t_printf(tls, __ccgo_ts+260, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:27:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v7 = libc.Xsocket(tls, int32(PF_INET), int32(SOCK_DGRAM), int32(IPPROTO_UDP))
	c = v7
	if !(v7 >= 0) {
		t_printf(tls, __ccgo_ts+387, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:28:2:
	(*(*sockaddr_in)(unsafe.Pointer(bp + 32))).Fsin_addr.Fs_addr = libc.Xhtonl(tls, uint32(0x7f000001))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:29:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	if !(libc.Xsendto(tls, c, __ccgo_ts+459, uint32(1), 0, bp+32, uint32(16)) == int32(1)) {
		t_printf(tls, __ccgo_ts+461, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:30:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	*(*[1]socklen_t)(unsafe.Pointer(bp + 20)) = [1]socklen_t{
		0: uint32(16),
	}
	if !(libc.Xrecvfrom(tls, s, bp+48, uint32(100), 0, bp+32, bp+20) == int32(1)) {
		t_printf(tls, __ccgo_ts+557, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:31:2:
	if !(int32((*(*[100]int8)(unsafe.Pointer(bp + 48)))[0]) == int32('x')) {
		t_printf(tls, __ccgo_ts+679, libc.VaList(bp+160, int32((*(*[100]int8)(unsafe.Pointer(bp + 48)))[0])))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:33:2:
	libc.Xclose(tls, c)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:34:2:
	libc.Xclose(tls, s)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:36:2:
	libc.Xmemset(tls, bp+32, 0, uint32(16))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:37:2:
	(*(*sockaddr_in)(unsafe.Pointer(bp + 32))).Fsin_family = uint16(PF_INET)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:38:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v12 = libc.Xsocket(tls, int32(PF_INET), libc.Int32FromInt32(SOCK_STREAM)|libc.Int32FromInt32(SOCK_CLOEXEC), int32(IPPROTO_TCP))
	s = v12
	if !(v12 >= 0) {
		t_printf(tls, __ccgo_ts+733, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:39:2:
	if !(libc.Xfcntl(tls, s, int32(F_GETFD), 0)&int32(FD_CLOEXEC) != 0) {
		t_printf(tls, __ccgo_ts+813, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:40:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	if !(libc.Xbind(tls, s, bp+32, uint32(16)) == 0) {
		t_printf(tls, __ccgo_ts+905, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:41:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	*(*[1]socklen_t)(unsafe.Pointer(bp + 24)) = [1]socklen_t{
		0: uint32(16),
	}
	if !(libc.Xgetsockname(tls, s, bp+32, bp+24) == 0) {
		t_printf(tls, __ccgo_ts+988, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:42:2:
	(*(*sockaddr_in)(unsafe.Pointer(bp + 32))).Fsin_addr.Fs_addr = libc.Xhtonl(tls, uint32(0x7f000001))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:44:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	if !(libc.Xlisten(tls, s, int32(1)) == 0) {
		t_printf(tls, __ccgo_ts+1093, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:46:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	v18 = libc.Xsocket(tls, int32(PF_INET), libc.Int32FromInt32(SOCK_STREAM)|libc.Int32FromInt32(SOCK_NONBLOCK), int32(IPPROTO_TCP))
	c = v18
	if !(v18 >= 0) {
		t_printf(tls, __ccgo_ts+1157, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:47:2:
	if !(libc.Xfcntl(tls, c, int32(F_GETFL), 0)&int32(O_NONBLOCK) != 0) {
		t_printf(tls, __ccgo_ts+1234, 0)
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:49:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	if !(libc.Xconnect(tls, c, bp+32, uint32(16)) == 0 || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EINPROGRESS)) {
		t_printf(tls, __ccgo_ts+1327, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:51:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	*(*socklen_t)(unsafe.Pointer(bp + 28)) = uint32(16)
	v22 = libc.Xaccept(tls, s, bp+32, bp+28)
	t = v22
	if !(v22 >= 0) {
		t_printf(tls, __ccgo_ts+1443, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		_ = libc.Int32FromInt32(0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:53:2:
	libc.Xclose(tls, t)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:54:2:
	libc.Xclose(tls, c)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:55:2:
	libc.Xclose(tls, s)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/socket.c:57:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1546, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1556, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1648, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1653, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1660, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1678, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1686, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1691, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1734, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1783) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1791) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1803) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1815) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1827) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1836) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1647) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1836) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1842, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/functional/socket.c:20: (s=socket(2, 2, 17))>=0 failed: errno = %s\n\x00src/functional/socket.c:21: bind(s, (void *)&sa, sizeof sa)==0 failed: errno = %s\n\x00src/functional/socket.c:22: getsockname(s, (void *)&sa, (socklen_t[]){sizeof sa})==0 failed: errno = %s\n\x00src/functional/socket.c:24: setsockopt(s, 1, 66, &(struct timeval){.tv_usec=1}, sizeof(struct timeval))==0 failed: errno = %s\n\x00src/functional/socket.c:27: (c=socket(2, 2, 17))>=0 failed: errno = %s\n\x00x\x00src/functional/socket.c:29: sendto(c, \"x\", 1, 0, (void *)&sa, sizeof sa)==1 failed: errno = %s\n\x00src/functional/socket.c:30: recvfrom(s, buf, sizeof buf, 0, (void *)&sa, (socklen_t[]){sizeof sa})==1 failed: errno = %s\n\x00src/functional/socket.c:31: buf[0]=='x' failed: '%c'\n\x00src/functional/socket.c:38: (s=socket(2, 1|02000000, 6))>=0 failed: errno = %s\n\x00src/functional/socket.c:39: fcntl(s, F_GETFD)&FD_CLOEXEC failed: SOCK_CLOEXEC did not work\n\x00src/functional/socket.c:40: bind(s, (void *)&sa, sizeof sa)==0 failed: errno = %s\n\x00src/functional/socket.c:41: getsockname(s, (void *)&sa, (socklen_t[]){sizeof sa})==0 failed: errno = %s\n\x00src/functional/socket.c:44: listen(s, 1)==0 failed: errno = %s\n\x00src/functional/socket.c:46: (c=socket(2, 1|04000, 6))>=0 failed: errno = %s\n\x00src/functional/socket.c:47: fcntl(c, F_GETFL)&O_NONBLOCK failed: SOCK_NONBLOCK did not work\n\x00src/functional/socket.c:49: connect(c, (void *)&sa, sizeof sa)==0 || (*__errno_location())==115 failed: errno = %s\n\x00src/functional/socket.c:51: (t=accept(s, (void *)&sa, &(socklen_t){sizeof sa}))>=0 failed: errno = %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
