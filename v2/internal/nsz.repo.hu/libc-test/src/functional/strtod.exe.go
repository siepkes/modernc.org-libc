// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/functional/strtod.exe.go src/functional/strtod.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:8:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:11:3:
var t = [31]struct {
	Fs uintptr
	Ff float64
}{
	...
	9: {
		Fs: __ccgo_ts + 382,
		Ff: float64(2.2250738585072014e-308),
	},
	10: {
		Fs: __ccgo_ts + 468,
		Ff: float64(2.225073858507202e-308),
	},
	11: {
		Fs: __ccgo_ts + 554,
		Ff: float64(1.7976931348623157e+308),
	},
	12: {
		Fs: __ccgo_ts + 895,
		Ff: float64(libc.X__builtin_inff(nil)),
	...
	13: {
		Fs: __ccgo_ts + 1205,
		Ff: float64(0.5961860348131807),
	},
	14: {
		Fs: __ccgo_ts + 1250,
		Ff: float64(0.18150131692180388),
	},
	15: {
		Fs: __ccgo_ts + 1295,
		Ff: float64(0.42070823575344535),
	},
	16: {
		Fs: __ccgo_ts + 1340,
		Ff: float64(0.6654686306516261),
	},
	17: {
		Fs: __ccgo_ts + 1385,
		Ff: float64(0.6101852922970868),
	},
	18: {
		Fs: __ccgo_ts + 1430,
		Ff: float64(0.7696695208236968),
	},
	19: {
		Fs: __ccgo_ts + 1475,
		Ff: float64(0.25050653222286823),
	},
	20: {
		Fs: __ccgo_ts + 1520,
		Ff: float64(0.2740037230228005),
	},
	21: {
		Fs: __ccgo_ts + 1565,
		Ff: float64(0.20723093500497428),
	},
	22: {
		Fs: __ccgo_ts + 1610,
		Ff: float64(7.900280238081605),
	},
	23: {
		Fs: __ccgo_ts + 1655,
		Ff: float64(98.22860653737297),
	},
	24: {
		Fs: __ccgo_ts + 1700,
		Ff: float64(746.894972319037),
	},
	25: {
		Fs: __ccgo_ts + 1745,
		Ff: float64(1630.2683202827284),
	},
	26: {
		Fs: __ccgo_ts + 1790,
		Ff: float64(46371.68629719171),
	},
	27: {
		Fs: __ccgo_ts + 1835,
		Ff: float64(653780.5944497711),
	},
	28: {
		Fs: __ccgo_ts + 1880,
		Ff: float64(234632.43565024371),
	},
	29: {
		Fs: __ccgo_ts + 1925,
		Ff: float64(9.709481716420048e+07),
	},
	30: {
		Fs: __ccgo_ts + 1970,
		Ff: float64(4.9969085220518744e+08),
	},
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:62:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:63:1:
	var i int32
	var x float64
	var _ /* p at bp+0 */ uintptr
	_, _ = i, x
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:68:2:
	i = 0
	for {
		if !(uint32(i) < libc.Uint32FromInt64(372)/libc.Uint32FromInt64(12)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:69:3:
		x = libc.Xstrtod(tls, t[i].Fs, bp)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:70:3:
		if x != t[i].Ff {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:71:4:
			t_printf(tls, __ccgo_ts+2015, libc.VaList(bp+16, t[i].Fs, t[i].Ff, x))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/functional/strtod.c:73:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+2072, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+2082, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2174, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2179, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+2184, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2202, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+2210, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2215, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+2258, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2307) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2315) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2327) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2339) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2351) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2360) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+2173) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+2360) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+2366, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
