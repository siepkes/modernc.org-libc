// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/sigaltstack.exe.go src/regression/sigaltstack.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:12:9:
const ENOMEM = 12

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/signal.h:5:9:
const MINSIGSTKSZ = 2048

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/signal.h:98:9:
const SA_ONSTACK = 134217728

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/signal.h:6:9:
const SIGSTKSZ = 8192

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/signal.h:116:9:
const SIGUSR1 = 10

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/signal.h:258:9:
const SS_ONSTACK = 1
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:15:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:15:13:
var stack [8192]int8

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:17:13:
func handler(tls *libc.TLS, sig int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:18:1:
	var v1 bool
	var _ /* i at bp+0 */ uintptr_t
	var _ /* ss at bp+4 */ stack_t
	_ = v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:22:2:
	*(*uintptr_t)(unsafe.Pointer(bp)) = uintptr_t(bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:23:2:
	if *(*uintptr_t)(unsafe.Pointer(bp)) < uintptr_t(uintptr(unsafe.Pointer(&stack))) || *(*uintptr_t)(unsafe.Pointer(bp)) >= uintptr_t(uintptr(unsafe.Pointer(&stack)))+uint32(SIGSTKSZ) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:24:3:
		t_printf(tls, __ccgo_ts, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:26:2:
	if v1 = libc.Xsigaltstack(tls, uintptr(0), bp+4) == 0; !v1 {
		t_printf(tls, __ccgo_ts+81, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:27:2:
	if (*(*stack_t)(unsafe.Pointer(bp + 4))).Fss_flags != int32(SS_ONSTACK) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:28:3:
		t_printf(tls, __ccgo_ts+146, 0)
	}
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:31:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(176)
	defer tls.Free(176)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:32:1:
	var v1, v2, v3, v4, v5 bool
	var _ /* sa at bp+12 */ sigaction1
	var _ /* ss at bp+0 */ stack_t
	_, _, _, _, _ = v1, v2, v3, v4, v5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:36:2:
	(*(*stack_t)(unsafe.Pointer(bp))).Fss_sp = uintptr(unsafe.Pointer(&stack))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:37:2:
	(*(*stack_t)(unsafe.Pointer(bp))).Fss_size = uint32(8192)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:38:2:
	(*(*stack_t)(unsafe.Pointer(bp))).Fss_flags = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:39:2:
	*(*uintptr)(unsafe.Pointer(bp + 12)) = __ccgo_fp(handler)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:40:2:
	(*(*sigaction1)(unsafe.Pointer(bp + 12))).Fsa_flags = int32(SA_ONSTACK)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:42:2:
	if v1 = libc.Xsigaltstack(tls, bp, uintptr(0)) == 0; !v1 {
		t_printf(tls, __ccgo_ts+229, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:43:2:
	if v2 = libc.Xsigfillset(tls, bp+12+4) == 0; !v2 {
		t_printf(tls, __ccgo_ts+294, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:44:2:
	if v3 = libc.Xsigaction(tls, int32(SIGUSR1), bp+12, uintptr(0)) == 0; !v3 {
		t_printf(tls, __ccgo_ts+363, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:45:2:
	if v4 = libc.Xraise(tls, int32(SIGUSR1)) == 0; !v4 {
		t_printf(tls, __ccgo_ts+435, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:47:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:48:2:
	(*(*stack_t)(unsafe.Pointer(bp))).Fss_size = uint32(libc.Int32FromInt32(MINSIGSTKSZ) - libc.Int32FromInt32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:49:2:
	if libc.Xsigaltstack(tls, bp, uintptr(0)) != -int32(1) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(ENOMEM) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:50:3:
		t_printf(tls, __ccgo_ts+495, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:52:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:53:2:
	(*(*stack_t)(unsafe.Pointer(bp))).Fss_flags = -int32(1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:54:2:
	(*(*stack_t)(unsafe.Pointer(bp))).Fss_size = uint32(MINSIGSTKSZ)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:55:2:
	if libc.Xsigaltstack(tls, bp, uintptr(0)) != -int32(1) || *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EINVAL) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:56:3:
		t_printf(tls, __ccgo_ts+610, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:58:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:59:2:
	if v5 = libc.Xsigaltstack(tls, uintptr(0), uintptr(0)) == 0; !v5 {
		t_printf(tls, __ccgo_ts+713, libc.VaList(bp+160, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v5 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sigaltstack.c:61:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+776, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+786, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+878, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+883, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+890, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+908, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+916, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+921, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+964, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1013) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1021) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1033) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1045) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1057) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1066) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+877) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1066) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1072, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/sigaltstack.c:24: signal handler was not invoked on the altstack\n\x00src/regression/sigaltstack.c:26: sigaltstack(0, &ss) failed: %s\n\x00src/regression/sigaltstack.c:28: ss_flags is not SS_ONSTACK in the signal handler\n\x00src/regression/sigaltstack.c:42: sigaltstack(&ss, 0) failed: %s\n\x00src/regression/sigaltstack.c:43: sigfillset(&sa.sa_mask) failed: %s\n\x00src/regression/sigaltstack.c:44: sigaction(SIGUSR1, &sa, 0) failed: %s\n\x00src/regression/sigaltstack.c:45: raise(SIGUSR1) failed: %s\n\x00src/regression/sigaltstack.c:50: sigaltstack with stack size < MINSIGSTKSZ should have failed with ENOMEM, got %s\n\x00src/regression/sigaltstack.c:56: sigaltstack with bad ss_flags should have failed with EINVAL, got %s\n\x00src/regression/sigaltstack.c:59: sigaltstack(0, 0) failed: %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
