// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/daemon-failure.exe.go src/regression/daemon-failure.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:19:1:
	var fdout, pid, r, v1 int32
	var _ /* c at bp+12 */ int8
	var _ /* fd at bp+0 */ [2]int32
	var _ /* s at bp+8 */ int32
	_, _, _, _ = fdout, pid, r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:23:2:
	r = libc.Xpipe(tls, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:24:2:
	if r == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:25:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:26:3:
		return int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:28:2:
	fdout = libc.Xdup(tls, int32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:29:2:
	if fdout == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:30:3:
		t_printf(tls, __ccgo_ts+53, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:31:3:
		return int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:33:2:
	r = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:34:2:
	if r == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:35:3:
		t_printf(tls, __ccgo_ts+108, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:36:3:
		return int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:39:2:
	if r == 0 {
		/* exhausting all fds makes open("/dev/null") fail in daemon */
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:41:3:
		t_fdfill(tls)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:42:3:
		pid = libc.Xgetpid(tls)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:43:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:44:3:
		r = libc.Xdaemon(tls, 0, 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:45:3:
		if libc.Xdup2(tls, fdout, int32(1)) == -int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:46:4:
			libc.Xwrite(tls, fdout, __ccgo_ts+161, uint32(7))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:47:4:
			t_printf(tls, __ccgo_ts+169, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:49:3:
		if r != -int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:50:4:
			t_printf(tls, __ccgo_ts+258, 0)
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:51:3:
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EMFILE) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:52:4:
			t_printf(tls, __ccgo_ts+321, libc.VaList(bp+24, int32(EMFILE), *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:53:3:
		if libc.Xgetpid(tls) != pid || libc.Xgetppid(tls) == int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:54:4:
			t_printf(tls, __ccgo_ts+413, libc.VaList(bp+24, libc.Xgetppid(tls), libc.Xgetpid(tls), pid))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:56:3:
		if libc.Xwrite(tls, (*(*[2]int32)(unsafe.Pointer(bp)))[int32(1)], __ccgo_ts+518+libc.BoolUintptr(!(libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))) != 0)), uint32(1)) != int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:57:4:
			t_printf(tls, __ccgo_ts+520, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:58:3:
		return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:60:2:
	libc.Xclose(tls, (*(*[2]int32)(unsafe.Pointer(bp)))[int32(1)])
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:61:2:
	if libc.Xwaitpid(tls, r, bp+8, 0) != r {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:62:3:
		t_printf(tls, __ccgo_ts+574, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:63:7:
		if !!(*(*int32)(unsafe.Pointer(bp + 8))&libc.Int32FromInt32(0x7f) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:64:3:
			if uint32(*(*int32)(unsafe.Pointer(bp + 8))&libc.Int32FromInt32(0xffff))-uint32(1) < uint32(0xff) {
				v1 = *(*int32)(unsafe.Pointer(bp + 8)) & int32(0x7f)
			} else {
				v1 = 0
			}
			t_printf(tls, __ccgo_ts+630, libc.VaList(bp+24, v1))
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:65:7:
			if *(*int32)(unsafe.Pointer(bp + 8))&int32(0xff00)>>int32(8) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:66:3:
				t_printf(tls, __ccgo_ts+703, libc.VaList(bp+24, *(*int32)(unsafe.Pointer(bp + 8))&int32(0xff00)>>int32(8)))
			}
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:67:2:
	r = libc.Xread(tls, (*(*[2]int32)(unsafe.Pointer(bp)))[0], bp+12, uint32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:68:2:
	if r == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:69:3:
		t_printf(tls, __ccgo_ts+761, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:70:7:
		if r == 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:71:3:
			t_printf(tls, __ccgo_ts+814, 0)
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:72:7:
			if int32(*(*int8)(unsafe.Pointer(bp + 12))) != 0 {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:73:3:
				t_printf(tls, __ccgo_ts+899, 0)
			}
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/daemon-failure.c:75:2:
	return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+949, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+959, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1051, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1056, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1063, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1081, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1089, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1094, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1137, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1186) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1194) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1206) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1218) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1230) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1239) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1050) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1239) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1245, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/daemon-failure.c:25: pipe failed: %s\n\x00src/regression/daemon-failure.c:30: dup(1) failed: %s\n\x00src/regression/daemon-failure.c:35: fork failed: %s\n\x00ERROR:\n\x00src/regression/daemon-failure.c:47: failed to dup pipe fd for communicating results: %s\n\x00src/regression/daemon-failure.c:50: daemon should have failed\n\x00src/regression/daemon-failure.c:52: daemon should have failed with %d [EMFILE] got %d [%s]\n\x00src/regression/daemon-failure.c:54: daemon forked despite failure: ppid is %d, pid is %d, old pid is %d\n\x001\x00src/regression/daemon-failure.c:57: write failed: %s\n\x00src/regression/daemon-failure.c:62: waitpid failed: %s\n\x00src/regression/daemon-failure.c:64: child exited abnormally (signal %d)\n\x00src/regression/daemon-failure.c:66: child exited with %d\n\x00src/regression/daemon-failure.c:69: read failed: %s\n\x00src/regression/daemon-failure.c:71: read failed: child did not send its exit status\n\x00src/regression/daemon-failure.c:73: child failed\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
