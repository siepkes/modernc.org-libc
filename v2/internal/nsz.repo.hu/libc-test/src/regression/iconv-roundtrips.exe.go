// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/iconv-roundtrips.exe.go src/regression/iconv-roundtrips.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:7:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(1600)
	defer tls.Free(1600)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:8:1:
	var andback, there iconv_t
	var i, r1, r2 int32
	var u8len size_t
	var _ /* all_codepoints at bp+28 */ [256]int8
	var _ /* buf at bp+1308 */ [256]int8
	var _ /* u8buf at bp+284 */ [1024]int8
	var _ /* u8rem at bp+1564 */ size_t
	_, _, _, _, _, _ = andback, i, r1, r2, there, u8len
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:25:2:
	i = 0
	for {
		if !(i < int32(256)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:26:3:
		(*(*[256]int8)(unsafe.Pointer(bp + 28)))[i] = int8(int32(255) - i)
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:28:2:
	i = 0
	for {
		if !(test_charsets[i] != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:29:11:
		there = libc.Xiconv_open(tls, __ccgo_ts+115, test_charsets[i])
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:30:3:
		if there == uintptr(-libc.Int32FromInt32(1)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:30:29:
			goto _2
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:31:11:
		andback = libc.Xiconv_open(tls, test_charsets[i], __ccgo_ts+115)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:32:3:
		if andback == uintptr(-libc.Int32FromInt32(1)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:33:4:
			libc.Xiconv_close(tls, there)
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:34:4:
			goto _2
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:38:10:
		*(*size_t)(unsafe.Pointer(bp + 1564)) = uint32(1024)
		*(*uintptr)(unsafe.Pointer(bp)) = bp + 28
		*(*size_t)(unsafe.Pointer(bp + 4)) = uint32(256)
		*(*uintptr)(unsafe.Pointer(bp + 8)) = bp + 284
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:39:7:
		r1 = int32(libc.Xiconv(tls, there, bp, bp+4, bp+8, bp+1564))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:42:10:
		u8len = uint32(1024) - *(*size_t)(unsafe.Pointer(bp + 1564))
		*(*uintptr)(unsafe.Pointer(bp + 12)) = bp + 284
		*(*size_t)(unsafe.Pointer(bp + 16)) = u8len
		*(*uintptr)(unsafe.Pointer(bp + 20)) = bp + 1308
		*(*size_t)(unsafe.Pointer(bp + 24)) = uint32(256)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:43:7:
		r2 = int32(libc.Xiconv(tls, andback, bp+12, bp+16, bp+20, bp+24))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:47:3:
		if r1 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:47:11:
			t_printf(tls, __ccgo_ts+121, libc.VaList(bp+1576, r1, test_charsets[i]))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:48:3:
		if r2 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:48:11:
			t_printf(tls, __ccgo_ts+186, libc.VaList(bp+1576, r2, test_charsets[i]))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:50:3:
		if libc.Xmemcmp(tls, bp+28, bp+1308, uint32(256)) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:51:4:
			t_printf(tls, __ccgo_ts+254, libc.VaList(bp+1576, test_charsets[i]))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:54:3:
		libc.Xiconv_close(tls, there)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:55:3:
		libc.Xiconv_close(tls, andback)
		goto _2
	_2:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:58:2:
	return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/iconv-roundtrips.c:9:14:
var test_charsets = [11]uintptr{
	0:  __ccgo_ts,
	1:  __ccgo_ts + 11,
	2:  __ccgo_ts + 22,
	3:  __ccgo_ts + 33,
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+328, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+338, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+430, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+435, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+442, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+460, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+468, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+473, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+516, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+565) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+573) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+585) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+597) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+609) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+115) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+429) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+115) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+618, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
