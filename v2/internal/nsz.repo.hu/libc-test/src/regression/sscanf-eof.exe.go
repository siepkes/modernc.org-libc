// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/sscanf-eof.exe.go src/regression/sscanf-eof.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:6:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:7:1:
	var fmt, s uintptr
	var r int32
	var _ /* c at bp+4 */ int8
	var _ /* f at bp+0 */ float32
	_, _, _ = fmt, r, s
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:8:13:
	s = __ccgo_ts
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:9:13:
	fmt = __ccgo_ts + 2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:10:8:
	*(*float32)(unsafe.Pointer(bp)) = libc.Float32FromFloat32(1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:11:7:
	*(*int8)(unsafe.Pointer(bp + 4)) = int8('x')
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:12:6:
	r = libc.Xsscanf(tls, s, fmt, libc.VaList(bp+16, bp, bp+4))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:13:2:
	if r != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:14:3:
		t_printf(tls, __ccgo_ts+7, libc.VaList(bp+16, s, fmt, r))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:15:2:
	if *(*float32)(unsafe.Pointer(bp)) != libc.Float32FromFloat32(0) || int32(*(*int8)(unsafe.Pointer(bp + 4))) != int32('x') {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:16:3:
		t_printf(tls, __ccgo_ts+84, libc.VaList(bp+16, s, fmt, float64(*(*float32)(unsafe.Pointer(bp))), int32(*(*int8)(unsafe.Pointer(bp + 4)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sscanf-eof.c:17:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+413) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+421) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+433) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+445) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+466) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+279) != 0
