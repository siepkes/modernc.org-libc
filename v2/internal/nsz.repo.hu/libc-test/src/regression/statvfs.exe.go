// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/statvfs.exe.go src/regression/statvfs.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/statvfs.h:14:1:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:9:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:10:1:
	var _ /* f at bp+0 */ statvfs1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:13:2:
	if libc.Xstatvfs(tls, __ccgo_ts, bp) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:14:3:
		t_printf(tls, __ccgo_ts+2, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:15:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bsize == uint32(0) || (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bsize > uint32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(28)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:16:3:
		t_printf(tls, __ccgo_ts+56, libc.VaList(bp+104, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bsize))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:17:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_blocks == uint64(0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:18:3:
		t_printf(tls, __ccgo_ts+111, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:19:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_blocks < (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bfree {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:20:3:
		t_printf(tls, __ccgo_ts+156, libc.VaList(bp+104, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bfree, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_blocks))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:22:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_blocks < (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bavail {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:23:3:
		t_printf(tls, __ccgo_ts+241, libc.VaList(bp+104, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_bavail, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_blocks))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:25:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_files == uint64(0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:26:3:
		t_printf(tls, __ccgo_ts+327, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:27:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_files < (*(*statvfs1)(unsafe.Pointer(bp))).Ff_ffree {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:28:3:
		t_printf(tls, __ccgo_ts+376, libc.VaList(bp+104, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_ffree, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_files))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:30:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_files < (*(*statvfs1)(unsafe.Pointer(bp))).Ff_favail {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:31:3:
		t_printf(tls, __ccgo_ts+469, libc.VaList(bp+104, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_favail, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_files))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:33:2:
	if (*(*statvfs1)(unsafe.Pointer(bp))).Ff_namemax > uint32(libc.Int32FromInt32(1)<<libc.Int32FromInt32(16)) || (*(*statvfs1)(unsafe.Pointer(bp))).Ff_namemax < uint32(8) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:34:3:
		t_printf(tls, __ccgo_ts+563, libc.VaList(bp+104, (*(*statvfs1)(unsafe.Pointer(bp))).Ff_namemax))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/statvfs.c:36:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+620, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+630, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+722, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+727, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+734, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+752, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+760, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+765, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+808, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+857) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+865) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+877) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+889) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+901) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+910) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+721) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+910) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+916, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "/\x00src/regression/statvfs.c:14: statvfs(\"/\") failed: %s\n\x00src/regression/statvfs.c:16: / has bogus f_bsize: %lu\n\x00src/regression/statvfs.c:18: / has 0 blocks\n\x00src/regression/statvfs.c:20: / has more free blocks (%llu) than total blocks (%llu)\n\x00src/regression/statvfs.c:23: / has more avail blocks (%llu) than total blocks (%llu)\n\x00src/regression/statvfs.c:26: / has 0 file nodes\n\x00src/regression/statvfs.c:28: / has more free file nodes (%llu) than total file nodes (%llu)\n\x00src/regression/statvfs.c:31: / has more avail file nodes (%llu) than total file nodes (%llu)\n\x00src/regression/statvfs.c:34: / has bogus f_namemax: %lu\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
