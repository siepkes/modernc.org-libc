// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/ftello-unflushed-append.exe.go src/regression/ftello-unflushed-append.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/fcntl.h:45:9:
const O_WRONLY = 1
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:18:1:
	var f, v3 uintptr
	var fd, v1, v2 int32
	var off, v4, v5 off_t
	var _ /* tmp at bp+0 */ [22]int8
	_, _, _, _, _, _, _, _ = f, fd, off, v1, v2, v3, v4, v5
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:19:7:
	*(*[22]int8)(unsafe.Pointer(bp)) = [22]int8{'/', 't', 'm', 'p', '/', 't', 'e', 's', 't', 's', 'u', 'i', 't', 'e', '-', 'X', 'X', 'X', 'X', 'X', 'X'}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:24:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:24:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	...
	if !(v1 > libc.Int32FromInt32(2)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:24:2:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+32, __ccgo_ts+68, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:25:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:25:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:25:2:
	if !(libc.Xwrite(tls, fd, __ccgo_ts+92, uint32(4)) == libc.Int32FromInt32(4)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:25:2:
		t_printf(tls, __ccgo_ts+97, libc.VaList(bp+32, __ccgo_ts+165, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:26:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:26:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:26:2:
	if !(libc.Xclose(tls, fd) == libc.Int32FromInt32(0)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:26:2:
		t_printf(tls, __ccgo_ts+191, libc.VaList(bp+32, __ccgo_ts+259, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:28:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:28:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:28:2:
	v2 = libc.Xopen(tls, bp, int32(O_WRONLY), 0)
	fd = v2
	if !(v2 > libc.Int32FromInt32(2)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:28:2:
		t_printf(tls, __ccgo_ts+274, libc.VaList(bp+32, __ccgo_ts+342, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:29:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:29:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:29:2:
	v3 = libc.Xfdopen(tls, fd, __ccgo_ts+373)
	f = v3
	if !(v3 != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:29:2:
		t_printf(tls, __ccgo_ts+375, libc.VaList(bp+32, __ccgo_ts+443, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:30:2:
	if f != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:31:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:31:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:31:3:
		if !(libc.Xfwrite(tls, __ccgo_ts+463, uint32(1), uint32(3), f) == libc.Uint32FromInt32(3)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:31:3:
			t_printf(tls, __ccgo_ts+467, libc.VaList(bp+32, __ccgo_ts+535, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:32:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:32:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:32:3:
		v4 = libc.Xftello(tls, f)
		off = v4
		if !(v4 != int64(-libc.Int32FromInt32(1))) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:32:3:
			t_printf(tls, __ccgo_ts+563, libc.VaList(bp+32, __ccgo_ts+631, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:33:3:
		if off != int64(7) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:34:4:
			t_printf(tls, __ccgo_ts+655, libc.VaList(bp+32, off))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:35:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:35:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:35:3:
		if !(libc.Xfflush(tls, f) == libc.Int32FromInt32(0)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:35:3:
			t_printf(tls, __ccgo_ts+749, libc.VaList(bp+32, __ccgo_ts+817, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:36:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:36:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:36:3:
		v5 = libc.Xftello(tls, f)
		off = v5
		if !(v5 != int64(-libc.Int32FromInt32(1))) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:36:3:
			t_printf(tls, __ccgo_ts+832, libc.VaList(bp+32, __ccgo_ts+631, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:37:3:
		if off != int64(7) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:38:4:
			t_printf(tls, __ccgo_ts+900, libc.VaList(bp+32, off))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:39:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:39:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:39:3:
		if !(libc.Xfclose(tls, f) == libc.Int32FromInt32(0)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:39:3:
			t_printf(tls, __ccgo_ts+993, libc.VaList(bp+32, __ccgo_ts+1061, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:41:2:
	if fd > int32(2) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:42:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:42:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:42:3:
		if !(libc.Xunlink(tls, bp) == libc.Int32FromInt32(0)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:42:3:
			t_printf(tls, __ccgo_ts+1076, libc.VaList(bp+32, __ccgo_ts+1144, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/ftello-unflushed-append.c:43:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1161, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1171, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1263, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1268, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1275, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1293, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1301, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1306, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1349, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1398) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1406) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1418) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1430) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1442) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1451) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1262) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1451) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1457, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/ftello-unflushed-append.c:24: %s failed (errno: %s)\n\x00(fd = mkstemp(tmp)) > 2\x00abcd\x00src/regression/ftello-unflushed-append.c:25: %s failed (errno: %s)\n\x00write(fd, \"abcd\", 4) == 4\x00src/regression/ftello-unflushed-append.c:26: %s failed (errno: %s)\n\x00close(fd) == 0\x00src/regression/ftello-unflushed-append.c:28: %s failed (errno: %s)\n\x00(fd = open(tmp, O_WRONLY)) > 2\x00a\x00src/regression/ftello-unflushed-append.c:29: %s failed (errno: %s)\n\x00f = fdopen(fd, \"a\")\x00efg\x00src/regression/ftello-unflushed-append.c:31: %s failed (errno: %s)\n\x00fwrite(\"efg\", 1, 3, f) == 3\x00src/regression/ftello-unflushed-append.c:32: %s failed (errno: %s)\n\x00(off = ftello(f)) != -1\x00src/regression/ftello-unflushed-append.c:34: ftello is broken before flush: got %lld, want 7\n\x00src/regression/ftello-unflushed-append.c:35: %s failed (errno: %s)\n\x00fflush(f) == 0\x00src/regression/ftello-unflushed-append.c:36: %s failed (errno: %s)\n\x00src/regression/ftello-unflushed-append.c:38: ftello is broken after flush: got %lld, want 7\n\x00src/regression/ftello-unflushed-append.c:39: %s failed (errno: %s)\n\x00fclose(f) == 0\x00src/regression/ftello-unflushed-append.c:42: %s failed (errno: %s)\n\x00unlink(tmp) == 0\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
