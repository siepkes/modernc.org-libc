// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -shared -o src/regression/tls_get_new-dtv_dso.so.go src/regression/tls_get_new-dtv_dso.lo.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:5:6:
func f(tls *libc.TLS) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:6:1:
	var i int32
	_ = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:8:2:
	i = 0
	for {
		if !(uint32(i) < uint32(123)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:9:3:
		v[i] = int8(i % int32(16))
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:10:2:
	return uintptr(unsafe.Pointer(&v))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:12:6:
func g(tls *libc.TLS) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:12:11:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:12:12:
	return uintptr(unsafe.Pointer(&x))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:13:6:
func h(tls *libc.TLS) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:13:11:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:13:12:
	return uintptr(unsafe.Pointer(&y))
}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+10, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+102, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+107, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+114, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+132, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+140, libc.VaList(bp+8, p))
	}
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/sys/resource.h:79:9:
const RLIMIT_STACK = 3

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/signal.h:123:9:
const SIGCHLD = 17

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/signal.h:115:9:
const SIGKILL = 9

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/signal.h:30:9:
const SIG_BLOCK = 0
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/signal.h:184:1:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:13:13:
func handler(tls *libc.TLS, s int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:14:1:
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:17:12:
func start(tls *libc.TLS, wrap uintptr, argv uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:18:1:
	var pid int32
	_ = pid
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:21:2:
	pid = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:22:2:
	if pid == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:23:3:
		t_setrlim(tls, int32(RLIMIT_STACK), libc.Int32FromInt32(100)*libc.Int32FromInt32(1024))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:24:3:
		if *(*int8)(unsafe.Pointer(wrap)) != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:25:4:
			argv -= 4
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:26:4:
			*(*uintptr)(unsafe.Pointer(argv)) = wrap
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:28:3:
		libc.Xexecv(tls, *(*uintptr)(unsafe.Pointer(argv)), argv)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:29:3:
		t_printf(tls, __ccgo_ts+145, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:30:3:
		libc.Xexit(tls, int32(1))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:32:2:
	return pid
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:35:13:
func usage(tls *libc.TLS, argv uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:36:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:37:2:
	t_printf(tls, __ccgo_ts+190, libc.VaList(bp+8, *(*uintptr)(unsafe.Pointer(argv))))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:38:2:
	libc.Xexit(tls, -int32(1))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:41:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(176)
	defer tls.Free(176)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:42:1:
	var opt, pid, timeout, timeoutsec, v1 int32
	var wrap uintptr
	var _ /* set at bp+20 */ sigset_t
	var _ /* status at bp+16 */ int32
	_, _, _, _, _, _ = opt, pid, timeout, timeoutsec, wrap, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:43:7:
	wrap = __ccgo_ts + 101
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:44:6:
	timeoutsec = int32(5)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:45:6:
	timeout = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:51:2:
	for {
		v1 = libc.Xgetopt(tls, argc, argv, __ccgo_ts+268)
		opt = v1
		if !(v1 != -int32(1)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:52:3:
		switch opt {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:53:3:
		case int32('w'):
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:54:4:
			wrap = libc.Xoptarg
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:55:4:
			break
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:56:3:
			fallthrough
		case int32('t'):
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:57:4:
			timeoutsec = libc.Xatoi(tls, libc.Xoptarg)
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:58:4:
			break
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:59:3:
			fallthrough
		default:
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:60:4:
			usage(tls, argv)
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:63:2:
	if libc.Xoptind >= argc {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:64:3:
		usage(tls, argv)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:65:2:
	argv += uintptr(libc.Xoptind) * 4
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:66:2:
	libc.Xsigemptyset(tls, bp+20)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:67:2:
	libc.Xsigaddset(tls, bp+20, int32(SIGCHLD))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:68:2:
	libc.Xsigprocmask(tls, SIG_BLOCK, bp+20, uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:69:2:
	libc.Xsignal(tls, int32(SIGCHLD), __ccgo_fp(handler))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:70:2:
	pid = start(tls, wrap, argv)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:71:2:
	if pid == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:72:3:
		t_printf(tls, __ccgo_ts+273, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:73:3:
		t_printf(tls, __ccgo_ts+318, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:74:3:
		return -int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:76:2:
	*(*timespec)(unsafe.Pointer(bp)) = timespec{
		Ftv_sec:  int64(timeoutsec),
		Ftv_nsec: 0,
	}
	if libc.Xsigtimedwait(tls, bp+20, uintptr(0), bp) == -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:77:3:
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) == int32(EAGAIN) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:78:4:
			timeout = int32(1)
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:80:4:
			t_printf(tls, __ccgo_ts+338, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:81:3:
		if libc.Xkill(tls, pid, int32(SIGKILL)) == -int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:82:4:
			t_printf(tls, __ccgo_ts+391, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:84:2:
	if libc.Xwaitpid(tls, pid, bp+16, 0) != pid {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:85:3:
		t_printf(tls, __ccgo_ts+436, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:86:3:
		t_printf(tls, __ccgo_ts+318, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:87:3:
		return -int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:89:2:
	if !(*(*int32)(unsafe.Pointer(bp + 16))&libc.Int32FromInt32(0x7f) != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:90:3:
		if *(*int32)(unsafe.Pointer(bp + 16))&int32(0xff00)>>int32(8) == 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:91:4:
			return libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status)))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:92:3:
		t_printf(tls, __ccgo_ts+484, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), *(*int32)(unsafe.Pointer(bp + 16))&int32(0xff00)>>int32(8)))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:93:9:
		if timeout != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:94:3:
			t_printf(tls, __ccgo_ts+505, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:95:9:
			if uint32(*(*int32)(unsafe.Pointer(bp + 16))&libc.Int32FromInt32(0xffff))-uint32(1) < uint32(0xff) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:96:3:
				t_printf(tls, __ccgo_ts+526, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv)), libc.Xstrsignal(tls, *(*int32)(unsafe.Pointer(bp + 16))&int32(0x7f))))
			} else {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:98:3:
				t_printf(tls, __ccgo_ts+547, libc.VaList(bp+160, *(*uintptr)(unsafe.Pointer(argv))))
			}
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/runtest.c:99:2:
	return int32(1)
}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+566, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+609, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+658) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+666) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+678) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+690) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+702) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+711) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+101) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+711) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+717, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:1:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:1:15:
var v [123]int8

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:2:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:2:14:
var x = int32(42)

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:3:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv_dso.c:3:22:
var y float64

var __ccgo_ts = (*reflect.StringHeader)(unsafe.Pointer(&__ccgo_ts1)).Data

var __ccgo_ts1 = "/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/runtest.c:29: %s exec failed: %s\n\x00src/common/runtest.c:37: usage: %s [-t timeoutsec] [-w wrapcmd] cmd [args..]\n\x00w:t:\x00src/common/runtest.c:72: %s fork failed: %s\n\x00FAIL %s [internal]\n\x00src/common/runtest.c:80: %s sigtimedwait failed: %s\n\x00src/common/runtest.c:82: %s kill failed: %s\n\x00src/common/runtest.c:85: %s waitpid failed: %s\n\x00FAIL %s [status %d]\n\x00FAIL %s [timed out]\n\x00FAIL %s [signal %s]\n\x00FAIL %s [unknown]\n\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
