// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/pthread-robust-detach.exe.go src/regression/pthread-robust-detach.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:13:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:13:26:
var barrier2 pthread_barrier_t

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:14:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:14:12:
var pshared int32

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:16:13:
func start_lock(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:17:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:18:2:
	pthread_mutex_lock(tls, arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:19:2:
	pthread_barrier_wait(tls, uintptr(unsafe.Pointer(&barrier2)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:20:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:23:13:
func f(tls *libc.TLS) {
	bp := tls.Alloc(96)
	defer tls.Free(96)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:24:1:
	var r, v1, v11, v13, v15, v3, v5, v7, v9 int32
	var v10, v12, v14, v16, v2, v4, v6, v8 bool
	var _ /* mtx at bp+8 */ pthread_mutex_t
	var _ /* mtx_a at bp+4 */ pthread_mutexattr_t
	var _ /* td at bp+0 */ pthread_t
	var _ /* ts at bp+32 */ timespec
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = r, v1, v10, v11, v12, v13, v14, v15, v16, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:31:2:
	v1 = pthread_barrier_init(tls, uintptr(unsafe.Pointer(&barrier2)), uintptr(0), uint32(2))
	r = v1
	if v2 = v1 == 0; !v2 {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:32:2:
	v3 = pthread_mutexattr_init(tls, bp+4)
	r = v3
	if v4 = v3 == 0; !v4 {
		t_printf(tls, __ccgo_ts+129, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:33:2:
	v5 = pthread_mutexattr_setrobust(tls, bp+4, int32(PTHREAD_MUTEX_ROBUST))
	r = v5
	if v6 = v5 == 0; !v6 {
		t_printf(tls, __ccgo_ts+251, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:34:2:
	if pshared != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:35:3:
		v7 = pthread_mutexattr_setpshared(tls, bp+4, int32(PTHREAD_PROCESS_SHARED))
		r = v7
		if v8 = v7 == 0; !v8 {
			t_printf(tls, __ccgo_ts+381, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
		}
		_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:36:2:
	v9 = pthread_mutex_init(tls, bp+8, bp+4)
	r = v9
	if v10 = v9 == 0; !v10 {
		t_printf(tls, __ccgo_ts+512, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
	}
	_ = v10 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:37:2:
	v11 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start_lock), bp+8)
	r = v11
	if v12 = v11 == 0; !v12 {
		t_printf(tls, __ccgo_ts+636, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
	}
	_ = v12 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:38:2:
	v13 = pthread_detach(tls, *(*pthread_t)(unsafe.Pointer(bp)))
	r = v13
	if v14 = v13 == 0; !v14 {
		t_printf(tls, __ccgo_ts+768, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), 0, libc.Xstrerror(tls, 0)))
	}
	_ = v14 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:39:2:
	pthread_barrier_wait(tls, uintptr(unsafe.Pointer(&barrier2)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:40:2:
	pthread_barrier_destroy(tls, uintptr(unsafe.Pointer(&barrier2)))
	// enough time to ensure that the detached thread is dead
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:43:2:
	libc.Xclock_gettime(tls, CLOCK_REALTIME, bp+32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:44:2:
	(*(*timespec)(unsafe.Pointer(bp + 32))).Ftv_nsec += libc.Int32FromInt32(100) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:45:2:
	if (*(*timespec)(unsafe.Pointer(bp + 32))).Ftv_nsec >= libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:46:3:
		(*(*timespec)(unsafe.Pointer(bp + 32))).Ftv_sec++
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:47:3:
		(*(*timespec)(unsafe.Pointer(bp + 32))).Ftv_nsec -= libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:50:2:
	v15 = pthread_mutex_timedlock(tls, bp+8, bp+32)
	r = v15
	if v16 = v15 == int32(EOWNERDEAD); !v16 {
		t_printf(tls, __ccgo_ts+878, libc.VaList(bp+56, pshared, r, libc.Xstrerror(tls, r), int32(EOWNERDEAD), libc.Xstrerror(tls, int32(EOWNERDEAD))))
	}
	_ = v16 || libc.Bool(libc.Int32FromInt32(0) != 0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:53:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:54:1:
	// test non-pshared and pshared robust mutexes as well
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:56:2:
	f(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:57:2:
	pshared = int32(1)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:58:2:
	f(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread-robust-detach.c:59:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1004, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1014, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1106, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1111, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1118, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1136, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1144, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1149, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1192, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1241) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1249) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1261) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1273) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1285) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1294) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1105) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1294) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1300, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/pthread-robust-detach.c:31: pthread_barrier_init(&barrier2, 0, 2) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:32: pthread_mutexattr_init(&mtx_a) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:33: pthread_mutexattr_setrobust(&mtx_a, 1) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:35: pthread_mutexattr_setpshared(&mtx_a, 1) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:36: pthread_mutex_init(&mtx, &mtx_a) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:37: pthread_create(&td, 0, start_lock, &mtx) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:38: pthread_detach(td) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00src/regression/pthread-robust-detach.c:50: pthread_mutex_timedlock(&mtx, &ts) failed: (pshared==%d) got %d \"%s\" want %d \"%s\"\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
