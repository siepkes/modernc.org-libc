// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/tls_get_new-dtv.exe.go src/regression/tls_get_new-dtv.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:6:9:
const N = 10

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/dlfcn.h:11:9:
const RTLD_NOW = 2
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/dlfcn.h:28:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/dlfcn.h:33:3:
type Dl_info = struct {
	Fdli_fname uintptr
	Fdli_fbase uintptr
	Fdli_sname uintptr
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:10:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:10:26:
var b pthread_barrier_t

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:11:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:11:13:
var mod uintptr

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:13:13:
func start(tls *libc.TLS, a uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:14:1:
	var f, v1 uintptr
	var v2 bool
	_, _, _ = f, v1, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:17:2:
	pthread_barrier_wait(tls, uintptr(unsafe.Pointer(&b)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:18:2:
	v1 = libc.Xdlsym(tls, mod, __ccgo_ts)
	f = v1
	if v2 = v1 != 0; !v2 {
		t_printf(tls, __ccgo_ts+2, 0)
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:19:2:
	(*(*func(*libc.TLS) uintptr)(unsafe.Pointer(&struct{ uintptr }{f})))(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:20:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:23:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:24:1:
	var i int32
	var v2, v4, v6 bool
	var v3 uintptr
	var _ /* td at bp+0 */ [10]pthread_t
	_, _, _, _, _ = i, v2, v3, v4, v6
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:28:2:
	pthread_barrier_init(tls, uintptr(unsafe.Pointer(&b)), uintptr(0), uint32(libc.Int32FromInt32(N)+libc.Int32FromInt32(1)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:29:2:
	i = 0
	for {
		if !(i < int32(N)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:30:3:
		if v2 = !(pthread_create(tls, bp+uintptr(i)*4, uintptr(0), __ccgo_fp(start), uintptr(0)) != 0); !v2 {
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:32:2:
	v3 = libc.Xdlopen(tls, __ccgo_ts+147, int32(RTLD_NOW))
	mod = v3
	if v4 = v3 != 0; !v4 {
		t_printf(tls, __ccgo_ts+170, 0)
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:33:2:
	pthread_barrier_wait(tls, uintptr(unsafe.Pointer(&b)))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:35:2:
	i = 0
	for {
		if !(i < int32(N)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:36:3:
		if v6 = !(pthread_join(tls, (*(*[10]pthread_t)(unsafe.Pointer(bp)))[i], uintptr(0)) != 0); !v6 {
			t_printf(tls, __ccgo_ts+264, 0)
		}
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/tls_get_new-dtv.c:37:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+333, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+343, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+435, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+440, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+447, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+465, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+473, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+478, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+521, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+570) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+578) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+590) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+602) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+614) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+623) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+434) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+623) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+629, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
