// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/pthread_rwlock-ebusy.exe.go src/regression/pthread_rwlock-ebusy.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/errno.h:16:9:
const EBUSY = 16
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:10:13:
func tryrdlock(tls *libc.TLS, arg uintptr) (r1 uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:11:1:
	var r int32
	_ = r
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:12:6:
	r = pthread_rwlock_tryrdlock(tls, arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:13:2:
	if r != int32(EBUSY) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:14:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:15:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:18:13:
func trywrlock(tls *libc.TLS, arg uintptr) (r1 uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:19:1:
	var r int32
	_ = r
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:20:6:
	r = pthread_rwlock_trywrlock(tls, arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:21:2:
	if r != int32(EBUSY) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:22:3:
		t_printf(tls, __ccgo_ts+95, libc.VaList(bp+8, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:23:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:26:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:27:1:
	var r, v1, v2, v3, v4, v5, v6, v7, v8 int32
	var _ /* p at bp+36 */ uintptr
	var _ /* rw at bp+4 */ pthread_rwlock_t
	var _ /* t at bp+0 */ pthread_t
	_, _, _, _, _, _, _, _, _ = r, v1, v2, v3, v4, v5, v6, v7, v8
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:29:19:
	*(*pthread_rwlock_t)(unsafe.Pointer(bp + 4)) = pthread_rwlock_t{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:29:19:
	*(*int32)(unsafe.Pointer(bp + 4)) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:33:2:
	v1 = pthread_rwlock_rdlock(tls, bp+4)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:33:2:
		t_printf(tls, __ccgo_ts+190, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:34:2:
	v2 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(trywrlock), bp+4)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:34:2:
		t_printf(tls, __ccgo_ts+271, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:35:2:
	v3 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+36)
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:35:2:
		t_printf(tls, __ccgo_ts+363, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:36:2:
	v4 = pthread_rwlock_unlock(tls, bp+4)
	r = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:36:2:
		t_printf(tls, __ccgo_ts+437, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:38:2:
	v5 = pthread_rwlock_wrlock(tls, bp+4)
	r = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:38:2:
		t_printf(tls, __ccgo_ts+518, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:39:2:
	v6 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(tryrdlock), bp+4)
	r = v6
	if v6 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:39:2:
		t_printf(tls, __ccgo_ts+599, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:40:2:
	v7 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+36)
	r = v7
	if v7 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:40:2:
		t_printf(tls, __ccgo_ts+691, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:41:2:
	v8 = pthread_rwlock_unlock(tls, bp+4)
	r = v8
	if v8 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:41:2:
		t_printf(tls, __ccgo_ts+765, libc.VaList(bp+48, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_rwlock-ebusy.c:43:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+846, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+856, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+948, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+953, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+960, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+978, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+986, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+991, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1034, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1083) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1091) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1103) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1115) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1127) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1136) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+947) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1136) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1142, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/pthread_rwlock-ebusy.c:14: tryrdlock for wrlocked lock returned %s, want EBUSY\n\x00src/regression/pthread_rwlock-ebusy.c:22: trywrlock for rdlocked lock returned %s, want EBUSY\n\x00src/regression/pthread_rwlock-ebusy.c:33: pthread_rwlock_rdlock(&rw) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:34: pthread_create(&t, 0, trywrlock, &rw) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:35: pthread_join(t, &p) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:36: pthread_rwlock_unlock(&rw) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:38: pthread_rwlock_wrlock(&rw) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:39: pthread_create(&t, 0, tryrdlock, &rw) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:40: pthread_join(t, &p) failed: %s\n\x00src/regression/pthread_rwlock-ebusy.c:41: pthread_rwlock_unlock(&rw) failed: %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
