// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/execle-env.exe.go src/regression/execle-env.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/execle-env.c:8:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/execle-env.c:9:1:
	var _ /* env at bp+0 */ [2]uintptr
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/execle-env.c:10:7:
	*(*[2]uintptr)(unsafe.Pointer(bp)) = [2]uintptr{
		0: __ccgo_ts,
		1: uintptr(0),
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/execle-env.c:12:2:
	libc.Xexecle(tls, __ccgo_ts+8, __ccgo_ts+16, libc.VaList(bp+16, __ccgo_ts+19, __ccgo_ts+22, libc.UintptrFromInt32(0), bp))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/execle-env.c:16:2:
	t_printf(tls, __ccgo_ts+109, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/execle-env.c:17:2:
	return int32(1)
}
