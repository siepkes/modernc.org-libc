// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/syscall-sign-extend.exe.go src/regression/syscall-sign-extend.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/bits/syscall.h:443:9:
const SYS_read = 3
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:13:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:14:1:
	var fd, r, v1, v3 int32
	var v2, v4 bool
	var _ /* buf at bp+0 */ [1]int8
	_, _, _, _, _, _ = fd, r, v1, v2, v3, v4
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:15:7:
	*(*[1]int8)(unsafe.Pointer(bp)) = [1]int8{
		0: int8(1),
	}
	// test syscall with pointer
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:20:2:
	v1 = libc.Xopen(tls, __ccgo_ts, O_RDONLY, 0)
	fd = v1
	if v2 = !(v1 >= libc.Int32FromInt32(0)); v2 {
		t_printf(tls, __ccgo_ts+10, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v2 && libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:21:2:
	v3 = libc.Xsyscall(tls, int32(SYS_read), libc.VaList(bp+16, fd, bp, int32(1)))
	r = v3
	if v4 = !(v3 == libc.Int32FromInt32(1)); v4 {
		t_printf(tls, __ccgo_ts+103, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v4 && libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:22:2:
	if int32((*(*[1]int8)(unsafe.Pointer(bp)))[0]) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:23:3:
		t_printf(tls, __ccgo_ts+197, libc.VaList(bp+16, int32((*(*[1]int8)(unsafe.Pointer(bp)))[0])))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/syscall-sign-extend.c:25:2:
