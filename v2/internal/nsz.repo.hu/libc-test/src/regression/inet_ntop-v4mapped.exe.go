// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/inet_ntop-v4mapped.exe.go src/regression/inet_ntop-v4mapped.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:7:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(144)
	defer tls.Free(144)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:8:1:
	var expect uintptr
	var _ /* addr at bp+100 */ [16]int8
	var _ /* buf at bp+0 */ [100]int8
	_ = expect
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:9:7:
	expect = __ccgo_ts
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:12:2:
	if libc.Xinet_pton(tls, int32(PF_INET6), expect, bp+100) == int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:13:3:
		if !(libc.Xinet_ntop(tls, int32(PF_INET6), bp+100, bp, uint32(100)) != 0) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:14:4:
			t_printf(tls, __ccgo_ts+19, 0)
		} else {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:15:8:
			if !(libc.Xstrchr(tls, bp, int32('.')) != 0) {
				// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:16:4:
				t_printf(tls, __ccgo_ts+77, libc.VaList(bp+128, bp, expect))
			}
		}
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:18:3:
		t_printf(tls, __ccgo_ts+154, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_ntop-v4mapped.c:20:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+449) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+469) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+481) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+493) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+502) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+313) != 0
