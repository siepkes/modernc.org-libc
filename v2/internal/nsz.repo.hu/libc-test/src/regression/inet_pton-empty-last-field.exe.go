// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/inet_pton-empty-last-field.exe.go src/regression/inet_pton-empty-last-field.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:9:13:
func txt(tls *libc.TLS, s uintptr, buf uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:10:1:
	var i int32
	_ = i
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:12:2:
	libc.Xsprintf(tls, s, __ccgo_ts, libc.VaList(bp+8, int32(*(*uint8)(unsafe.Pointer(buf)))<<int32(8)|int32(*(*uint8)(unsafe.Pointer(buf + 1)))))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:13:2:
	i = int32(1)
	for {
		if !(i < int32(8)) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:14:3:
		libc.Xsprintf(tls, s+uintptr(int32(5)*i), __ccgo_ts+5, libc.VaList(bp+8, int32(*(*uint8)(unsafe.Pointer(buf + uintptr(int32(2)*i))))<<int32(8)|int32(*(*uint8)(unsafe.Pointer(buf + uintptr(int32(2)*i+int32(1)))))))
		goto _1
	_1:
		i++
	}
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:17:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(176)
	defer tls.Free(176)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:18:1:
	var addr uintptr
	var _ /* buf at bp+100 */ [16]uint8
	var _ /* s at bp+0 */ [50]int8
	var _ /* sw at bp+50 */ [50]int8
	var _ /* want at bp+116 */ [16]uint8
	_ = addr
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:21:16:
	*(*[16]uint8)(unsafe.Pointer(bp + 116)) = [16]uint8{
		0:  uint8(0),
		1:  uint8(1),
		2:  uint8(0),
		3:  uint8(2),
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:24:2:
	addr = __ccgo_ts + 11
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:25:2:
	if libc.Xinet_pton(tls, int32(PF_INET6), addr, bp+100) != int32(1) || libc.Xmemcmp(tls, bp+100, bp+116, uint32(16)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:26:3:
		txt(tls, bp, bp+100)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:27:3:
		txt(tls, bp+50, bp+116)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:28:3:
		t_printf(tls, __ccgo_ts+27, libc.VaList(bp+144, addr, bp, bp+50))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:32:2:
	addr = __ccgo_ts + 113
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:33:2:
	if libc.Xinet_pton(tls, int32(PF_INET6), addr, bp+100) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:34:3:
		txt(tls, bp, bp+100)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:35:3:
		t_printf(tls, __ccgo_ts+163, libc.VaList(bp+144, addr, bp))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/inet_pton-empty-last-field.c:38:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+256, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+266, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+358, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+363, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+370, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+388, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+396, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+401, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+444, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+493) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+501) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+513) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+525) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+537) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+546) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+357) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+546) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+552, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
