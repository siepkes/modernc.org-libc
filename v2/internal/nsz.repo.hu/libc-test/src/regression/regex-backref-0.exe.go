// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/regex-backref-0.exe.go src/regression/regex-backref-0.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:6:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(272)
	defer tls.Free(272)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:7:1:
	var n int32
	var _ /* buf at bp+0 */ [200]int8
	var _ /* pat at bp+200 */ [4]int8
	var _ /* r at bp+204 */ regex_t
	_ = n
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:9:7:
	*(*[4]int8)(unsafe.Pointer(bp + 200)) = [4]int8{'a', '\\', '0'}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:13:2:
	n = libc.Xregcomp(tls, bp+204, bp+200, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:14:2:
	if n != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:15:3:
		libc.Xregerror(tls, n, bp+204, bp, uint32(200))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:16:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+248, bp+200, n, bp))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:18:2:
	n = libc.Xregexec(tls, bp+204, __ccgo_ts+76, uint32(0), uintptr(0), 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:19:2:
	if n != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:20:3:
		libc.Xregerror(tls, n, bp+204, bp, uint32(200))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:21:3:
		t_printf(tls, __ccgo_ts+79, libc.VaList(bp+248, bp+200, n, bp))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-backref-0.c:25:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+165, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+175, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
