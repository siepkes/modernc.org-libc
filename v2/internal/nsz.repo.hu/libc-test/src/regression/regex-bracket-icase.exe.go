// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/regex-bracket-icase.exe.go src/regression/regex-bracket-icase.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/regex.h:28:9:
const REG_ICASE = 2
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:8:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(192)
	defer tls.Free(192)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:9:1:
	var i, n int32
	var pat uintptr
	var t [9]struct {
		Fs uintptr
	...
	var _ /* re at bp+100 */ regex_t
	_, _, _, _ = i, n, pat, t
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:17:4:
	t = [9]struct {
		Fs uintptr
		Fn int32
	}{
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:29:2:
	pat = __ccgo_ts + 16
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:30:2:
	n = libc.Xregcomp(tls, bp+100, pat, int32(REG_ICASE))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:31:2:
	if n != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:32:3:
		libc.Xregerror(tls, n, bp+100, bp, uint32(100))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:33:3:
		t_printf(tls, __ccgo_ts+24, libc.VaList(bp+144, pat, n, bp))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:36:2:
	i = 0
	for {
		if !(t[i].Fs != 0) {
			break
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:37:3:
		n = libc.Xregexec(tls, bp+100, t[i].Fs, uint32(0), uintptr(0), 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:38:3:
		if n != t[i].Fn {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:39:4:
			libc.Xregerror(tls, n, bp+100, bp, uint32(100))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:40:4:
			t_printf(tls, __ccgo_ts+96, libc.VaList(bp+144, pat, t[i].Fs, n, bp, t[i].Fn))
		}
		goto _1
	_1:
		i++
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/regex-bracket-icase.c:45:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+423) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+431) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+443) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+455) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+467) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+476) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+287) != 0
