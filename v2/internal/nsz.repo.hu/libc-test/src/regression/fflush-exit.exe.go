// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/fflush-exit.exe.go src/regression/fflush-exit.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:18:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:19:1:
	var fd, pid, v1, v2 int32
	var _ /* c at bp+28 */ int8
	var _ /* status at bp+24 */ int32
	var _ /* tmp at bp+0 */ [22]int8
	_, _, _, _ = fd, pid, v1, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:20:7:
	*(*[22]int8)(unsafe.Pointer(bp)) = [22]int8{'/', 't', 'm', 'p', '/', 't', 'e', 's', 't', 's', 'u', 'i', 't', 'e', '-', 'X', 'X', 'X', 'X', 'X', 'X'}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:24:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:24:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:24:2:
	v1 = libc.Xmkstemp(tls, bp)
	fd = v1
	if !(v1 > libc.Int32FromInt32(2)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:24:2:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+40, __ccgo_ts+56, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:25:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:25:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:25:2:
	v2 = libc.Xfork(tls)
	...
	if !(v2 >= libc.Int32FromInt32(0)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:25:2:
		t_printf(tls, __ccgo_ts+80, libc.VaList(bp+40, __ccgo_ts+136, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:26:2:
	if pid == 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:27:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:27:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:27:3:
		if !(libc.Xclose(tls, int32(1)) == libc.Int32FromInt32(0)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:27:3:
			t_printf(tls, __ccgo_ts+156, libc.VaList(bp+40, __ccgo_ts+212, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:28:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:28:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:28:3:
		if !(libc.Xdup(tls, fd) == libc.Int32FromInt32(1)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:28:3:
			t_printf(tls, __ccgo_ts+226, libc.VaList(bp+40, __ccgo_ts+282, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:29:3:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:29:3:
		*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:29:3:
		if !(libc.Xfwrite(tls, __ccgo_ts+295, uint32(1), uint32(1), libc.Xstdout) == libc.Uint32FromInt32(1)) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:29:3:
			t_printf(tls, __ccgo_ts+297, libc.VaList(bp+40, __ccgo_ts+353, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:30:3:
		libc.Xexit(tls, libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:32:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:32:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:32:2:
	if !(libc.Xwaitpid(tls, pid, bp+24, 0) == pid) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:32:2:
		t_printf(tls, __ccgo_ts+384, libc.VaList(bp+40, __ccgo_ts+440, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:33:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:33:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:33:2:
	if !(!(*(*int32)(unsafe.Pointer(bp + 24))&libc.Int32FromInt32(0x7f) != 0) && *(*int32)(unsafe.Pointer(bp + 24))&int32(0xff00)>>int32(8) == 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:33:2:
		t_printf(tls, __ccgo_ts+472, libc.VaList(bp+40, __ccgo_ts+528, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:34:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:34:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:34:2:
	if !(libc.Xpread(tls, fd, bp+28, uint32(1), 0) == libc.Int32FromInt32(1)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:34:2:
		t_printf(tls, __ccgo_ts+574, libc.VaList(bp+40, __ccgo_ts+630, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:35:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:35:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:35:2:
	if !(int32(*(*int8)(unsafe.Pointer(bp + 28))) == libc.Int32FromUint8('x')) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:35:2:
		t_printf(tls, __ccgo_ts+655, libc.VaList(bp+40, __ccgo_ts+711, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:36:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:36:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:36:2:
	if !(libc.Xunlink(tls, bp) == libc.Int32FromInt32(0)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:36:2:
		t_printf(tls, __ccgo_ts+720, libc.VaList(bp+40, __ccgo_ts+776, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/fflush-exit.c:37:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+793, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+803, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+895, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+900, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+907, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+925, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+933, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+938, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+981, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1030) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1038) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1050) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1062) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1074) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1083) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+894) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1083) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1089, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/fflush-exit.c:24: %s failed (errno: %s)\n\x00(fd = mkstemp(tmp)) > 2\x00src/regression/fflush-exit.c:25: %s failed (errno: %s)\n\x00(pid = fork()) >= 0\x00src/regression/fflush-exit.c:27: %s failed (errno: %s)\n\x00close(1) == 0\x00src/regression/fflush-exit.c:28: %s failed (errno: %s)\n\x00dup(fd) == 1\x00x\x00src/regression/fflush-exit.c:29: %s failed (errno: %s)\n\x00fwrite(\"x\", 1, 1, stdout) == 1\x00src/regression/fflush-exit.c:32: %s failed (errno: %s)\n\x00waitpid(pid, &status, 0) == pid\x00src/regression/fflush-exit.c:33: %s failed (errno: %s)\n\x00WIFEXITED(status) && WEXITSTATUS(status) == 0\x00src/regression/fflush-exit.c:34: %s failed (errno: %s)\n\x00pread(fd, &c, 1, 0) == 1\x00src/regression/fflush-exit.c:35: %s failed (errno: %s)\n\x00c == 'x'\x00src/regression/fflush-exit.c:36: %s failed (errno: %s)\n\x00unlink(tmp) == 0\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
