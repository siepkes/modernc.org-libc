// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/pthread_condattr_setclock.exe.go src/regression/pthread_condattr_setclock.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/time.h:89:9:
const CLOCK_PROCESS_CPUTIME_ID = 2

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/time.h:87:9:
const CLOCK_REALTIME = 0

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/time.h:90:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:11:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(128)
	defer tls.Free(128)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:12:1:
	var p uintptr
	var r, v1, v2, v3, v4, v5, v6, v7, v8, v9 int32
	var _ /* a at bp+48 */ pthread_condattr_t
	var _ /* c at bp+0 */ pthread_cond_t
	var _ /* clk at bp+76 */ clockid_t
	var _ /* m at bp+52 */ pthread_mutex_t
	var _ /* ts at bp+80 */ timespec
	_, _, _, _, _, _, _, _, _, _, _ = p, r, v1, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:21:2:
	v1 = pthread_condattr_init(tls, bp+48)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:21:2:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:22:2:
	r = pthread_condattr_setclock(tls, bp+48, int32(CLOCK_PROCESS_CPUTIME_ID))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:23:2:
	if r != int32(EINVAL) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:24:3:
		t_printf(tls, __ccgo_ts+85, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:25:2:
	r = pthread_condattr_setclock(tls, bp+48, int32(CLOCK_THREAD_CPUTIME_ID))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:26:2:
	if r != int32(EINVAL) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:27:3:
		t_printf(tls, __ccgo_ts+216, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:28:2:
	v2 = pthread_condattr_getclock(tls, bp+48, bp+76)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:28:2:
		t_printf(tls, __ccgo_ts+346, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:29:2:
	if *(*clockid_t)(unsafe.Pointer(bp + 76)) != CLOCK_REALTIME {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:30:3:
		t_printf(tls, __ccgo_ts+441, libc.VaList(bp+104, *(*clockid_t)(unsafe.Pointer(bp + 76)), libc.Int32FromInt32(CLOCK_REALTIME)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:32:2:
	v3 = pthread_cond_init(tls, bp, bp+48)
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:32:2:
		t_printf(tls, __ccgo_ts+546, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:33:2:
	v4 = pthread_mutex_init(tls, bp+52, uintptr(0))
	r = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:33:2:
		t_printf(tls, __ccgo_ts+631, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:34:2:
	v5 = pthread_mutex_lock(tls, bp+52)
	r = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:34:2:
		t_printf(tls, __ccgo_ts+716, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:35:2:
	r = libc.Xclock_gettime(tls, CLOCK_REALTIME, bp+80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:36:2:
	if r != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:37:3:
		t_printf(tls, __ccgo_ts+798, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	/* wait 10ms */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:39:2:
	(*(*timespec)(unsafe.Pointer(bp + 80))).Ftv_nsec += libc.Int32FromInt32(10) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:40:2:
	if (*(*timespec)(unsafe.Pointer(bp + 80))).Ftv_nsec >= libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:41:3:
		(*(*timespec)(unsafe.Pointer(bp + 80))).Ftv_nsec -= libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:42:3:
		(*(*timespec)(unsafe.Pointer(bp + 80))).Ftv_sec += int64(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:44:2:
	r = pthread_cond_timedwait(tls, bp, bp+52, bp+80)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:45:2:
	if r != int32(ETIMEDOUT) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:46:3:
		t_printf(tls, __ccgo_ts+871, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:47:2:
	v6 = pthread_mutex_unlock(tls, bp+52)
	r = v6
	if v6 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:47:2:
		t_printf(tls, __ccgo_ts+971, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:49:2:
	v7 = pthread_mutex_destroy(tls, bp+52)
	r = v7
	if v7 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:49:2:
		t_printf(tls, __ccgo_ts+1055, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:50:2:
	v8 = pthread_cond_destroy(tls, bp)
	r = v8
	if v8 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:50:2:
		t_printf(tls, __ccgo_ts+1140, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:51:2:
	v9 = pthread_condattr_destroy(tls, bp+48)
	r = v9
	if v9 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:51:2:
		t_printf(tls, __ccgo_ts+1224, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_condattr_setclock.c:52:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1312, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1322, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1414, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1419, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1426, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1444, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1452, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1457, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1500, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1549) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1557) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1569) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1581) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1593) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1602) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1413) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1602) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1608, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/pthread_condattr_setclock.c:21: pthread_condattr_init(&a) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:24: pthread_condattr_setclock CLOCK_PROCESS_CPUTIME_ID should fail with EINVAL, got %s\n\x00src/regression/pthread_condattr_setclock.c:27: pthread_condattr_setclock CLOCK_THREAD_CPUTIME_ID should fail with EINVAL, got %s\n\x00src/regression/pthread_condattr_setclock.c:28: pthread_condattr_getclock(&a, &clk) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:30: condattr default clock is %d, wanted CLOCK_REALTIME (%d)\n\x00src/regression/pthread_condattr_setclock.c:32: pthread_cond_init(&c, &a) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:33: pthread_mutex_init(&m, 0) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:34: pthread_mutex_lock(&m) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:37: clock_gettime failed: %s\n\x00src/regression/pthread_condattr_setclock.c:46: pthread_cond_timedwait did not timeout, returned %s\n\x00src/regression/pthread_condattr_setclock.c:47: pthread_mutex_unlock(&m) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:49: pthread_mutex_destroy(&m) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:50: pthread_cond_destroy(&c) failed: %s\n\x00src/regression/pthread_condattr_setclock.c:51: pthread_condattr_destroy(&a) failed: %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
