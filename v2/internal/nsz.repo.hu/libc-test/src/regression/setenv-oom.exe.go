// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/setenv-oom.exe.go src/regression/setenv-oom.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:9:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(10016)
	defer tls.Free(10016)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:10:1:
	var _ /* buf at bp+0 */ [10000]int8
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:13:2:
	if t_memfill(tls) < 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:14:3:
		t_printf(tls, __ccgo_ts, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:16:2:
	libc.Xmemset(tls, bp, int32('x'), uint32(10000))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:17:2:
	(*(*[10000]int8)(unsafe.Pointer(bp)))[libc.Uint32FromInt64(10000)-libc.Uint32FromInt32(1)] = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:19:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:20:2:
	if libc.Xsetenv(tls, __ccgo_ts+48, bp, int32(1)) != -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:21:3:
		t_printf(tls, __ccgo_ts+56, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:22:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(ENOMEM) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:23:3:
		t_printf(tls, __ccgo_ts+111, libc.VaList(bp+10008, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/setenv-oom.c:25:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+405) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+413) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+425) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+437) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+449) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+458) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+269) != 0
