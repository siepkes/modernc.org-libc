// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/scanf-bytes-consumed.exe.go src/regression/scanf-bytes-consumed.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:6:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:7:1:
	var n int32
	var _ /* buf at bp+0 */ [3]int8
	var _ /* dest at bp+3 */ [3]int8
	var _ /* read_count at bp+8 */ int32
	_ = n
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:8:7:
	*(*[3]int8)(unsafe.Pointer(bp)) = [3]int8{
		0: int8('a'),
		1: int8('a'),
		2: 0,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:13:2:
	n = libc.Xsscanf(tls, bp, __ccgo_ts, libc.VaList(bp+24, bp+3, bp+8))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:14:2:
	if n != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:15:3:
		t_printf(tls, __ccgo_ts+5, libc.VaList(bp+24, n))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:16:2:
	if *(*int32)(unsafe.Pointer(bp + 8)) != int32(2) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:17:3:
		t_printf(tls, __ccgo_ts+93, libc.VaList(bp+24, *(*int32)(unsafe.Pointer(bp + 8))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/scanf-bytes-consumed.c:18:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+176, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+186, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+413) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+421) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+433) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+445) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+457) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+466) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+277) != 0
