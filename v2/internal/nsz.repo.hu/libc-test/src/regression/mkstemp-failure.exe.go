// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/mkstemp-failure.exe.go src/regression/mkstemp-failure.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:13:9:
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:15:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(64)
	defer tls.Free(64)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:16:1:
	var r int32
	var _ /* p at bp+0 */ [18]int8
	_ = r
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:17:7:
	*(*[18]int8)(unsafe.Pointer(bp)) = [18]int8{'/', 'd', 'e', 'v', '/', 'n', 'u', 'l', 'l', '/', 'f', 'o', 'o', 'X', 'X', 'X', 'X'}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:20:2:
	r = libc.Xmkstemp(tls, bp)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:21:2:
	if r != -int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:22:3:
		t_printf(tls, __ccgo_ts, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:23:2:
	if libc.Xmemcmp(tls, bp, __ccgo_ts+78, uint32(18)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:24:3:
		t_printf(tls, __ccgo_ts+96, libc.VaList(bp+32, bp))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:25:2:
	if r == -int32(1) && *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(EINVAL) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:26:3:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/mkstemp-failure.c:28:2:
