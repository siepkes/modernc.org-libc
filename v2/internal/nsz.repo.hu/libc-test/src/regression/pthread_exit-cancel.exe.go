// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/pthread_exit-cancel.exe.go src/regression/pthread_exit-cancel.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:9:13:
func cleanup(tls *libc.TLS, arg uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:10:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:11:2:
	*(*int32)(unsafe.Pointer(arg)) = int32(1)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:14:13:
func start(tls *libc.TLS, arg uintptr) (r uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:15:1:
	var _ /* __cb at bp+0 */ __ptcb
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:16:2:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:16:2:
	pthread_cleanup_push(tls, bp, __ccgo_fp(cleanup), arg)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:16:36:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:17:2:
	pthread_exit(tls, uintptr(0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:18:2:
	pthread_cleanup_pop(tls, bp, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:19:2:
	return arg
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:22:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:23:1:
	var r, v1, v2 int32
	var _ /* arg at bp+8 */ int32
	var _ /* status at bp+4 */ uintptr
	var _ /* td at bp+0 */ pthread_t
	_, _, _ = r, v1, v2
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:26:6:
	*(*int32)(unsafe.Pointer(bp + 8)) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:29:2:
	v1 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start), bp+8)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:29:2:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+24, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:30:2:
	v2 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+4)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:30:2:
		t_printf(tls, __ccgo_ts+89, libc.VaList(bp+24, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:31:2:
	if *(*uintptr)(unsafe.Pointer(bp + 4)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:32:3:
		t_printf(tls, __ccgo_ts+168, libc.VaList(bp+24, int32(*(*uintptr)(unsafe.Pointer(bp + 4)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:33:2:
	if *(*int32)(unsafe.Pointer(bp + 8)) != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:34:3:
		t_printf(tls, __ccgo_ts+251, 0)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-cancel.c:35:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+323, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+333, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+425, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+430, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+437, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+455, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+463, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+468, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+511, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+560) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+568) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+580) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+592) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+604) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+613) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+424) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+613) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+619, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
