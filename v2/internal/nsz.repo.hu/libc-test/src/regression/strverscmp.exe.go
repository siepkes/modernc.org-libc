// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/strverscmp.exe.go src/regression/strverscmp.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:8:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:9:1:
	var v1, v10, v11, v12, v13, v14, v15, v2, v3, v4, v5, v6, v7, v8, v9 bool
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = v1, v10, v11, v12, v13, v14, v15, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:10:2:
	if v1 = libc.Xstrverscmp(tls, __ccgo_ts, __ccgo_ts) == 0; !v1 {
		t_printf(tls, __ccgo_ts+1, 0)
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:11:2:
	if v2 = libc.Xstrverscmp(tls, __ccgo_ts+65, __ccgo_ts+65) == 0; !v2 {
		t_printf(tls, __ccgo_ts+67, 0)
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:12:2:
	if v3 = libc.Xstrverscmp(tls, __ccgo_ts+65, __ccgo_ts+133) < 0; !v3 {
		t_printf(tls, __ccgo_ts+135, 0)
	}
	_ = v3 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:13:2:
	if v4 = libc.Xstrverscmp(tls, __ccgo_ts+133, __ccgo_ts+65) > 0; !v4 {
		t_printf(tls, __ccgo_ts+200, 0)
	}
	_ = v4 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:14:2:
	if v5 = libc.Xstrverscmp(tls, __ccgo_ts+265, __ccgo_ts+269) < 0; !v5 {
		t_printf(tls, __ccgo_ts+272, 0)
	}
	_ = v5 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:15:2:
	if v6 = libc.Xstrverscmp(tls, __ccgo_ts+269, __ccgo_ts+265) > 0; !v6 {
		t_printf(tls, __ccgo_ts+340, 0)
	}
	_ = v6 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:16:2:
	if v7 = libc.Xstrverscmp(tls, __ccgo_ts+408, __ccgo_ts+65) > 0; !v7 {
		t_printf(tls, __ccgo_ts+411, 0)
	}
	_ = v7 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:17:2:
	if v8 = libc.Xstrverscmp(tls, __ccgo_ts+269, __ccgo_ts+477) < 0; !v8 {
		t_printf(tls, __ccgo_ts+480, 0)
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:18:2:
	if v9 = libc.Xstrverscmp(tls, __ccgo_ts+477, __ccgo_ts+547) < 0; !v9 {
		t_printf(tls, __ccgo_ts+551, 0)
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:19:2:
	if v10 = libc.Xstrverscmp(tls, __ccgo_ts+547, __ccgo_ts+619) < 0; !v10 {
		t_printf(tls, __ccgo_ts+622, 0)
	}
	_ = v10 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:20:2:
	if v11 = libc.Xstrverscmp(tls, __ccgo_ts+619, __ccgo_ts+690) < 0; !v11 {
		t_printf(tls, __ccgo_ts+692, 0)
	}
	_ = v11 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:21:2:
	if v12 = libc.Xstrverscmp(tls, __ccgo_ts+758, __ccgo_ts+760) < 0; !v12 {
		t_printf(tls, __ccgo_ts+763, 0)
	}
	_ = v12 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:22:2:
	if v13 = libc.Xstrverscmp(tls, __ccgo_ts+829, __ccgo_ts+690) > 0; !v13 {
		t_printf(tls, __ccgo_ts+832, 0)
	}
	_ = v13 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:23:2:
	if v14 = libc.Xstrverscmp(tls, __ccgo_ts+898, __ccgo_ts+911) < 0; !v14 {
		t_printf(tls, __ccgo_ts+924, 0)
	}
	_ = v14 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:24:2:
	if v15 = libc.Xstrverscmp(tls, __ccgo_ts+898, __ccgo_ts+1011) > 0; !v15 {
		t_printf(tls, __ccgo_ts+1025, 0)
	}
	_ = v15 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/strverscmp.c:25:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1113, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1123, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1214, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1219, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1224, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1242, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1250, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1255, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1298, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1347) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1355) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1367) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1379) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1391) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1400) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1400) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1406, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "\x00src/regression/strverscmp.c:10: strverscmp(\"\", \"\") == 0 failed\n\x00a\x00src/regression/strverscmp.c:11: strverscmp(\"a\", \"a\") == 0 failed\n\x00b\x00src/regression/strverscmp.c:12: strverscmp(\"a\", \"b\") < 0 failed\n\x00src/regression/strverscmp.c:13: strverscmp(\"b\", \"a\") > 0 failed\n\x00000\x0000\x00src/regression/strverscmp.c:14: strverscmp(\"000\", \"00\") < 0 failed\n\x00src/regression/strverscmp.c:15: strverscmp(\"00\", \"000\") > 0 failed\n\x00a0\x00src/regression/strverscmp.c:16: strverscmp(\"a0\", \"a\") > 0 failed\n\x0001\x00src/regression/strverscmp.c:17: strverscmp(\"00\", \"01\") < 0 failed\n\x00010\x00src/regression/strverscmp.c:18: strverscmp(\"01\", \"010\") < 0 failed\n\x0009\x00src/regression/strverscmp.c:19: strverscmp(\"010\", \"09\") < 0 failed\n\x000\x00src/regression/strverscmp.c:20: strverscmp(\"09\", \"0\") < 0 failed\n\x009\x0010\x00src/regression/strverscmp.c:21: strverscmp(\"9\", \"10\") < 0 failed\n\x000a\x00src/regression/strverscmp.c:22: strverscmp(\"0a\", \"0\") > 0 failed\n\x00foobar-1.1.2\x00foobar-1.1.3\x00src/regression/strverscmp.c:23: strverscmp(\"foobar-1.1.2\", \"foobar-1.1.3\") < 0 failed\n\x00foobar-1.01.3\x00src/regression/strverscmp.c:24: strverscmp(\"foobar-1.1.2\", \"foobar-1.01.3\") > 0 failed\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00%s%s\x00%s%d\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
