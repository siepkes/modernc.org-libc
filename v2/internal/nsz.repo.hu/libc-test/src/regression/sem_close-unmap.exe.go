// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/sem_close-unmap.exe.go src/regression/sem_close-unmap.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:7:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:8:1:
	var sem uintptr
	var _ /* buf at bp+0 */ [12]int8
	_ = sem
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:9:7:
	*(*[12]int8)(unsafe.Pointer(bp)) = [12]int8{'m', 'y', 's', 'e', 'm', 'X', 'X', 'X', 'X', 'X', 'X'}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:10:2:
	if !(libc.Xmktemp(tls, bp) != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:10:20:
		return int32(1)
	}
	// open twice
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:12:8:
	sem = libc.Xsem_open(tls, bp, libc.Int32FromInt32(O_CREAT)|libc.Int32FromInt32(O_EXCL), libc.VaList(bp+24, int32(0600), 0))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:13:2:
	libc.Xsem_open(tls, bp, 0, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:14:2:
	libc.Xsem_unlink(tls, bp)
	// close once
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:16:2:
	libc.Xsem_close(tls, sem)
	// semaphore should be still mapped
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/sem_close-unmap.c:18:2:
	libc.Xsem_post(tls, sem)
	return r
}
