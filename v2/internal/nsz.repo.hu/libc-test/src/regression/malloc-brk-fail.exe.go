// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/malloc-brk-fail.exe.go src/regression/malloc-brk-fail.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:12:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:13:1:
	var q uintptr
	var r int32
	var v1, v2 bool
	var _ /* n at bp+4 */ size_t
	var _ /* p at bp+0 */ uintptr
	_, _, _, _ = q, r, v1, v2
	// fill memory, largest mmaped area is [p,p+n)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:20:2:
	if t_vmfill(tls, bp, bp+4, int32(1)) < int32(1) || *(*size_t)(unsafe.Pointer(bp + 4)) < uint32(libc.Int32FromInt32(2)*libc.Int32FromInt32(65536)) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:21:3:
		t_printf(tls, __ccgo_ts, 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:22:3:
		return int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:24:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:25:2:
	if v1 = t_setrlim(tls, int32(RLIMIT_DATA), 0) == 0; !v1 {
		t_printf(tls, __ccgo_ts+52, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// malloc should fail here
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:28:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:29:2:
	q = libc.Xmalloc(tls, uint32(10000))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:30:2:
	if q != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:31:3:
		t_printf(tls, __ccgo_ts+127, 0)
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:32:7:
		if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(ENOMEM) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:33:3:
			t_printf(tls, __ccgo_ts+212, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		}
	}
	// make some space available for mmap
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:36:2:
	if v2 = libc.Xmunmap(tls, *(*uintptr)(unsafe.Pointer(bp))+uintptr(65536), uint32(65536)) == 0; !v2 {
		t_printf(tls, __ccgo_ts+290, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	_ = v2 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// malloc should succeed now
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:39:2:
	q = libc.Xmalloc(tls, uint32(10000))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:40:2:
	if !(q != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:41:3:
		t_printf(tls, __ccgo_ts+369, libc.VaList(bp+16, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/malloc-brk-fail.c:43:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+470, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+480, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+572, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+577, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+584, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+602, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+610, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+615, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+658, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+707) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+715) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+727) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+739) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+751) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+760) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+571) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+760) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+766, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/malloc-brk-fail.c:21: vmfill failed\n\x00src/regression/malloc-brk-fail.c:25: t_setrlim(RLIMIT_DATA, 0) failed: %s\n\x00src/regression/malloc-brk-fail.c:31: malloc(10000) succeeded after memory is filled\n\x00src/regression/malloc-brk-fail.c:33: malloc did not fail with ENOMEM, got %s\n\x00src/regression/malloc-brk-fail.c:36: munmap((char*)p+65536, 65536) failed: %s\n\x00src/regression/malloc-brk-fail.c:41: malloc(10000) failed (eventhough 64k is available to mmap): %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
