// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/pthread_once-deadlock.exe.go src/regression/pthread_once-deadlock.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/include/linux/386/pthread.h:61:9:
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:12:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:12:12:
var count int32

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:14:13:
func init1(tls *libc.TLS) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:15:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:16:2:
	count++
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:19:13:
func start(tls *libc.TLS, arg uintptr) (r1 uintptr) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:20:1:
	var a uintptr
	var r, v1 int32
	_, _, _ = a, r, v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:21:7:
	a = arg
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:23:2:
	...
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:24:2:
	v1 = pthread_once(tls, *(*uintptr)(unsafe.Pointer(a)), __ccgo_fp(init1))
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:24:2:
		t_printf(tls, __ccgo_ts+70, libc.VaList(bp+8, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:25:2:
	if libc.Xsem_post(tls, *(*uintptr)(unsafe.Pointer(a + 1*4))) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:25:2:
		t_printf(tls, __ccgo_ts+150, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:26:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:29:12:
func deadlocked(tls *libc.TLS, s uintptr) (r int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:30:1:
	var _ /* ts at bp+0 */ timespec
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:33:2:
	if libc.Xsem_wait(tls, s) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:33:2:
		t_printf(tls, __ccgo_ts+220, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:34:2:
	if libc.Xclock_gettime(tls, CLOCK_REALTIME, bp) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:34:2:
		t_printf(tls, __ccgo_ts+287, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:35:2:
	(*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec += libc.Int32FromInt32(100) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:36:2:
	if (*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec >= libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000)*libc.Int32FromInt32(1000) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:37:3:
		(*(*timespec)(unsafe.Pointer(bp))).Ftv_nsec -= libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000) * libc.Int32FromInt32(1000)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:38:3:
		(*(*timespec)(unsafe.Pointer(bp))).Ftv_sec += int64(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:40:2:
	*(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) = 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:41:2:
	if libc.Xsem_timedwait(tls, s, bp) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:41:2:
		t_printf(tls, __ccgo_ts+377, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:42:2:
	if *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))) != int32(ETIMEDOUT) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:43:3:
		return 0
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:44:2:
	t_printf(tls, __ccgo_ts+453, 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:45:2:
	return int32(1)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:48:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(112)
	defer tls.Free(112)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:49:1:
	var r, v1, v2, v3, v4, v5, v6 int32
	var _ /* a1 at bp+64 */ [2]uintptr
	var _ /* a2 at bp+72 */ [2]uintptr
	var _ /* a3 at bp+80 */ [2]uintptr
	var _ /* once at bp+12 */ pthread_once_t
	var _ /* p at bp+88 */ uintptr
	var _ /* s1 at bp+16 */ sem_t
	var _ /* s2 at bp+32 */ sem_t
	var _ /* s3 at bp+48 */ sem_t
	var _ /* t1 at bp+0 */ pthread_t
	var _ /* t2 at bp+4 */ pthread_t
	var _ /* t3 at bp+8 */ pthread_t
	_, _, _, _, _, _, _ = r, v1, v2, v3, v4, v5, v6
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:51:17:
	*(*pthread_once_t)(unsafe.Pointer(bp + 12)) = PTHREAD_ONCE_INIT
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:53:7:
	*(*[2]uintptr)(unsafe.Pointer(bp + 64)) = [2]uintptr{
		0: bp + 12,
		1: bp + 16,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:54:7:
	*(*[2]uintptr)(unsafe.Pointer(bp + 72)) = [2]uintptr{
		0: bp + 12,
		1: bp + 32,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:55:7:
	*(*[2]uintptr)(unsafe.Pointer(bp + 80)) = [2]uintptr{
		0: bp + 12,
		1: bp + 48,
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:59:2:
	if libc.Xsem_init(tls, bp+16, 0, uint32(0)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:59:2:
		t_printf(tls, __ccgo_ts+521, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:60:2:
	if libc.Xsem_init(tls, bp+32, 0, uint32(0)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:60:2:
		t_printf(tls, __ccgo_ts+594, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:61:2:
	if libc.Xsem_init(tls, bp+48, 0, uint32(0)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:61:2:
		t_printf(tls, __ccgo_ts+667, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:62:2:
	v1 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start), bp+64)
	r = v1
	if v1 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:62:2:
		t_printf(tls, __ccgo_ts+740, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:63:2:
	v2 = pthread_create(tls, bp+4, uintptr(0), __ccgo_fp(start), bp+72)
	r = v2
	if v2 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:63:2:
		t_printf(tls, __ccgo_ts+829, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:64:2:
	v3 = pthread_create(tls, bp+8, uintptr(0), __ccgo_fp(start), bp+80)
	r = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:64:2:
		t_printf(tls, __ccgo_ts+918, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:65:2:
	if !(deadlocked(tls, bp+16) != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:65:24:
		v4 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+88)
		r = v4
		if v4 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:65:24:
			t_printf(tls, __ccgo_ts+1007, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:66:2:
	if !(deadlocked(tls, bp+32) != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:66:24:
		v5 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp + 4)), bp+88)
		r = v5
		if v5 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:66:24:
			t_printf(tls, __ccgo_ts+1082, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:67:2:
	if !(deadlocked(tls, bp+48) != 0) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:67:24:
		v6 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp + 8)), bp+88)
		r = v6
		if v6 != 0 {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:67:24:
			t_printf(tls, __ccgo_ts+1157, libc.VaList(bp+104, libc.Xstrerror(tls, r)))
		}
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:68:2:
	if count != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:69:3:
		t_printf(tls, __ccgo_ts+1232, libc.VaList(bp+104, count))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:70:2:
	if libc.Xsem_destroy(tls, bp+16) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:70:2:
		t_printf(tls, __ccgo_ts+1323, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:71:2:
	if libc.Xsem_destroy(tls, bp+32) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:71:2:
		t_printf(tls, __ccgo_ts+1395, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:72:2:
	if libc.Xsem_destroy(tls, bp+48) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:72:2:
		t_printf(tls, __ccgo_ts+1467, libc.VaList(bp+104, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_once-deadlock.c:73:2:
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1539, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1549, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1641, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1646, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1653, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1671, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1679, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1684, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1727, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1776) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1784) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1796) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1808) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1820) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1829) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1640) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1829) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1835, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/pthread_once-deadlock.c:23: sem_post(a[1]) failed: %s\n\x00src/regression/pthread_once-deadlock.c:24: pthread_once(a[0], init) failed: %s\n\x00src/regression/pthread_once-deadlock.c:25: sem_post(a[1]) failed: %s\n\x00src/regression/pthread_once-deadlock.c:33: sem_wait(s) failed: %s\n\x00src/regression/pthread_once-deadlock.c:34: clock_gettime(CLOCK_REALTIME, &ts) failed: %s\n\x00src/regression/pthread_once-deadlock.c:41: sem_timedwait(s,&ts) failed: %s\n\x00src/regression/pthread_once-deadlock.c:44: pthread_once deadlocked\n\x00src/regression/pthread_once-deadlock.c:59: sem_init(&s1,0,0) failed: %s\n\x00src/regression/pthread_once-deadlock.c:60: sem_init(&s2,0,0) failed: %s\n\x00src/regression/pthread_once-deadlock.c:61: sem_init(&s3,0,0) failed: %s\n\x00src/regression/pthread_once-deadlock.c:62: pthread_create(&t1, 0, start, a1) failed: %s\n\x00src/regression/pthread_once-deadlock.c:63: pthread_create(&t2, 0, start, a2) failed: %s\n\x00src/regression/pthread_once-deadlock.c:64: pthread_create(&t3, 0, start, a3) failed: %s\n\x00src/regression/pthread_once-deadlock.c:65: pthread_join(t1,&p) failed: %s\n\x00src/regression/pthread_once-deadlock.c:66: pthread_join(t2,&p) failed: %s\n\x00src/regression/pthread_once-deadlock.c:67: pthread_join(t3,&p) failed: %s\n\x00src/regression/pthread_once-deadlock.c:69: pthread_once ran init %d times instead of once\n\x00src/regression/pthread_once-deadlock.c:70: sem_destroy(&s1) failed: %s\n\x00src/regression/pthread_once-deadlock.c:71: sem_destroy(&s2) failed: %s\n\x00src/regression/pthread_once-deadlock.c:72: sem_destroy(&s3) failed: %s\n\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
