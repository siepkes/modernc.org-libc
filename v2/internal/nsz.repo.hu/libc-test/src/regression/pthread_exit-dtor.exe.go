// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/pthread_exit-dtor.exe.go src/regression/pthread_exit-dtor.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:14:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:14:22:
var k pthread_key_t

//
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:15:1:

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:15:12:
var data int32

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:17:13:
func dtor(tls *libc.TLS, p uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:18:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:19:2:
	*(*int32)(unsafe.Pointer(p)) = int32(1)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:22:13:
func start(tls *libc.TLS, arg uintptr) (r uintptr) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:23:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:24:2:
	if pthread_setspecific(tls, k, arg) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:25:3:
		return arg
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:26:2:
	return uintptr(0)
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:29:13:
func cleanup(tls *libc.TLS) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:30:1:
	var v1 bool
	_ = v1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:31:2:
	if v1 = data == int32(1); !v1 {
		t_printf(tls, __ccgo_ts, libc.VaList(bp+8, __ccgo_ts+89))
	}
	_ = v1 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:32:2:
	libc.X_exit(tls, libc.AtomicLoadPInt32(uintptr(unsafe.Pointer(&t_status))))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:35:13:
func die(tls *libc.TLS) {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:36:1:
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:37:2:
	libc.X_exit(tls, int32(1))
}

// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:40:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	bp := tls.Alloc(48)
	defer tls.Free(48)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:41:1:
	var pid, v1, v2, v3, v4, v5, v6 int32
	var v10, v7, v8, v9 bool
	var _ /* arg at bp+8 */ int32
	var _ /* r at bp+4 */ int32
	var _ /* res at bp+12 */ uintptr
	var _ /* td at bp+0 */ pthread_t
	_, _, _, _, _, _, _, _, _, _, _ = pid, v1, v10, v2, v3, v4, v5, v6, v7, v8, v9
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:43:9:
	*(*int32)(unsafe.Pointer(bp + 8)) = 0
	// test if atexit handlers are run after pthread_exit
	// (early musl failed this test)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:48:2:
	pid = libc.Xfork(tls)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:49:2:
	switch pid {
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:50:2:
	case -int32(1):
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:51:3:
		t_printf(tls, __ccgo_ts+99, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:52:3:
		return int32(1)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:53:2:
		fallthrough
	case 0:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:54:3:
		libc.Xatexit(tls, __ccgo_fp(die))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:55:3:
		pthread_exit(tls, uintptr(0))
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:56:2:
		fallthrough
	default:
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:57:3:
		if libc.Xwaitpid(tls, pid, bp+4, 0) != pid {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:58:4:
			t_printf(tls, __ccgo_ts+155, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:59:4:
			return int32(1)
		}
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:61:3:
		if !!(*(*int32)(unsafe.Pointer(bp + 4))&libc.Int32FromInt32(0x7f) != 0) || *(*int32)(unsafe.Pointer(bp + 4))&int32(0xff00)>>int32(8) != int32(1) {
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:62:4:
			if !!(*(*int32)(unsafe.Pointer(bp + 4))&libc.Int32FromInt32(0x7f) != 0) && uint32(*(*int32)(unsafe.Pointer(bp + 4))&libc.Int32FromInt32(0xffff))-uint32(1) < uint32(0xff) {
				v1 = *(*int32)(unsafe.Pointer(bp + 4)) & int32(0x7f)
			} else {
				v1 = 0
			}
			if !(*(*int32)(unsafe.Pointer(bp + 4))&libc.Int32FromInt32(0x7f) != 0) {
				v2 = *(*int32)(unsafe.Pointer(bp + 4)) & int32(0xff00) >> int32(8)
			} else {
				v2 = 0
			}
			t_printf(tls, __ccgo_ts+214, libc.VaList(bp+24, libc.BoolInt32(!(*(*int32)(unsafe.Pointer(bp + 4))&libc.Int32FromInt32(0x7f) != 0)), v1, v2))
			// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:65:4:
			return int32(1)
		}
	}
	// dtor should set tsd (arg and data) from 0 to 1
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:70:2:
	if libc.Xatexit(tls, __ccgo_fp(cleanup)) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:71:3:
		t_printf(tls, __ccgo_ts+360, 0)
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:72:3:
		return int32(1)
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:74:2:
	v3 = pthread_key_create(tls, uintptr(unsafe.Pointer(&k)), __ccgo_fp(dtor))
	*(*int32)(unsafe.Pointer(bp + 4)) = v3
	if v3 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:74:2:
		t_printf(tls, __ccgo_ts+414, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(bp + 4)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:75:2:
	v4 = pthread_setspecific(tls, k, uintptr(unsafe.Pointer(&data)))
	*(*int32)(unsafe.Pointer(bp + 4)) = v4
	if v4 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:75:2:
		t_printf(tls, __ccgo_ts+494, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(bp + 4)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:76:2:
	v5 = pthread_create(tls, bp, uintptr(0), __ccgo_fp(start), bp+8)
	*(*int32)(unsafe.Pointer(bp + 4)) = v5
	if v5 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:76:2:
		t_printf(tls, __ccgo_ts+575, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(bp + 4)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:77:2:
	v6 = pthread_join(tls, *(*pthread_t)(unsafe.Pointer(bp)), bp+12)
	*(*int32)(unsafe.Pointer(bp + 4)) = v6
	if v6 != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:77:2:
		t_printf(tls, __ccgo_ts+662, libc.VaList(bp+24, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(bp + 4)))))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:78:2:
	if v7 = *(*uintptr)(unsafe.Pointer(bp + 12)) == uintptr(0); !v7 {
		t_printf(tls, __ccgo_ts+736, libc.VaList(bp+24, __ccgo_ts+825))
	}
	_ = v7 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:79:2:
	if v8 = *(*int32)(unsafe.Pointer(bp + 8)) == int32(1); !v8 {
		t_printf(tls, __ccgo_ts+834, libc.VaList(bp+24, __ccgo_ts+905))
	}
	_ = v8 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:80:2:
	if v9 = data == 0; !v9 {
		t_printf(tls, __ccgo_ts+914, libc.VaList(bp+24, __ccgo_ts+998))
	}
	_ = v9 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:81:2:
	if v10 = pthread_getspecific(tls, k) == uintptr(unsafe.Pointer(&data)); !v10 {
		t_printf(tls, __ccgo_ts+1008, libc.VaList(bp+24, __ccgo_ts+1092))
	}
	_ = v10 || libc.Bool(libc.Int32FromInt32(0) != 0)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/pthread_exit-dtor.c:82:2:
	pthread_exit(tls, uintptr(0))
	return r
}
...
func t_fdfill(tls *libc.TLS) {
	...
	if libc.Xdup(tls, fd) == -int32(1) {
		...
		fd = libc.Xopen(tls, __ccgo_ts+1124, O_RDONLY, 0)
	}
...
func t_memfill(tls *libc.TLS) (r1 int32) {
	...
	if t_vmfill(tls, uintptr(0), uintptr(0), 0) < 0 {
		...
		t_printf(tls, __ccgo_ts+1134, libc.VaList(bp+8, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func estr(tls *libc.TLS, f int32) (r uintptr) {
	...
	for {
		...
		if f&eflags[i].Fflag != 0 {
			...
			p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1226, libc.VaList(bp+8, v2, eflags[i].Fs)))
	...
	if all != f {
		...
		p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1231, libc.VaList(bp+8, v3, f & ^all)))
	...
	p += uintptr(libc.Xsprintf(tls, p, __ccgo_ts+1238, libc.VaList(bp+8, v4)))
...
func t_pathrel(tls *libc.TLS, buf uintptr, n size_t, argv0 uintptr, p uintptr) (r uintptr) {
	...
	if s != 0 {
		...
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1256, libc.VaList(bp+8, int32(s)-int32(argv0), argv0, p))
	} else {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/path.c:14:3:
		k = libc.Xsnprintf(tls, buf, n, __ccgo_ts+1264, libc.VaList(bp+8, p))
	}
...
func t_setrlim(tls *libc.TLS, r int32, lim int32) (r1 int32) {
	...
	if libc.Xgetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1269, libc.VaList(bp+24, r, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
	...
	if libc.Xsetrlimit(tls, r, bp) != 0 {
		...
		t_printf(tls, __ccgo_ts+1312, libc.VaList(bp+24, r, lim, libc.Xstrerror(tls, *(*int32)(unsafe.Pointer(libc.X__errno_location(tls))))))
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1361) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1369) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1381) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1393) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1405) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1414) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+1225) != 0
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:17:2:
	if libc.Xstrcmp(tls, libc.Xnl_langinfo(tls, int32(CODESET)), __ccgo_ts+1414) != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/common/utf8.c:18:3:
		return t_printf(tls, __ccgo_ts+1420, libc.VaList(bp+8, libc.Xnl_langinfo(tls, int32(CODESET))))
	}
...
var __ccgo_ts1 = "src/regression/pthread_exit-dtor.c:31: %s failed (dtor was not run for the last thread)\n\x00data == 1\x00src/regression/pthread_exit-dtor.c:51: fork failed: %s\n\x00src/regression/pthread_exit-dtor.c:58: waitpid failed: %s\n\x00src/regression/pthread_exit-dtor.c:62: atexit handler was not run after last thread exited (exited=%d, signal=%d, status=%d, want exit status=1)\n\x00src/regression/pthread_exit-dtor.c:71: atexit failed\n\x00src/regression/pthread_exit-dtor.c:74: pthread_key_create(&k, dtor) failed: %s\n\x00src/regression/pthread_exit-dtor.c:75: pthread_setspecific(k, &data) failed: %s\n\x00src/regression/pthread_exit-dtor.c:76: pthread_create(&td, 0, start, &arg) failed: %s\n\x00src/regression/pthread_exit-dtor.c:77: pthread_join(td, &res) failed: %s\n\x00src/regression/pthread_exit-dtor.c:78: %s failed (pthread_setspecific failed in thread)\n\x00res == 0\x00src/regression/pthread_exit-dtor.c:79: %s failed (dtor failed to run)\n\x00arg == 1\x00src/regression/pthread_exit-dtor.c:80: %s failed (tsd in main thread is corrupted)\n\x00data == 0\x00src/regression/pthread_exit-dtor.c:81: %s failed (tsd in main thread is corrupted)\n\x00pthread_getspecific(k) == &data\x00/dev/null\x00src/common/memfill.c:12: vmfill failed: %s\n\x00INEXACT\x00INVALID\x00DIVBYZERO\x00UNDERFLOW\x00OVERFLOW\x00|\x00\x00%s%s\x00%s%d\x000\x00%s\x00RN\x00RZ\x00RU\x00RD\x00R?\x00%.*s/%s\x00./%s\x00src/common/setrlim.c:11: getrlimit %d: %s\n\x00src/common/setrlim.c:21: setrlimit(%d, %ld): %s\n\x00C.UTF-8\x00POSIX.UTF-8\x00en_US.UTF-8\x00en_GB.UTF-8\x00en.UTF-8\x00UTF-8\x00src/common/utf8.c:18: cannot set UTF-8 locale for test (codeset=%s)\n\x00"
