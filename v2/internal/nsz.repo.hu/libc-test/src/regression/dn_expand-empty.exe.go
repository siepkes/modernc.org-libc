// Code generated for linux/386 by 'cc --prefix-field=F -absolute-paths -extended-errors -positions -o src/regression/dn_expand-empty.exe.go src/regression/dn_expand-empty.o.go src/common/libtest.a -lpthread -lm -lrt -lcrypt -ldl -lresolv -lutil -lpthread', DO NOT EDIT.
...
// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:7:5:
func main1(tls *libc.TLS, argc int32, argv uintptr) (r1 int32) {
	bp := tls.Alloc(32)
	defer tls.Free(32)
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:8:1:
	var r int32
	var _ /* name at bp+3 */ [3]int8
	var _ /* packet at bp+0 */ [1]uint8
	_ = r
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:9:16:
	*(*[1]uint8)(unsafe.Pointer(bp)) = [1]uint8{}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:10:7:
	*(*[3]int8)(unsafe.Pointer(bp + 3)) = [3]int8{'X', 'X'}
	/* empty name in packet */
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:14:2:
	r = libc.Xdn_expand(tls, bp, bp+uintptr(1), bp, bp+3, int32(1))
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:15:2:
	if r != int32(1) {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:16:3:
		t_printf(tls, __ccgo_ts, libc.VaList(bp+16, r))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:17:2:
	if (*(*[3]int8)(unsafe.Pointer(bp + 3)))[0] != 0 {
		// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:18:3:
		t_printf(tls, __ccgo_ts+83, libc.VaList(bp+16, bp+3))
	}
	// /home/jnml/src/modernc.org/builder/.exclude/modernc.org/libc/v2/internal/nsz.repo.hu/libc-test/src/regression/dn_expand-empty.c:20:2:
...
func t_setutf8(tls *libc.TLS) (r int32) {
	...
	_ = libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+414) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+422) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+434) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+446) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+458) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+467) != 0 || libc.Xsetlocale(tls, LC_CTYPE, __ccgo_ts+278) != 0
