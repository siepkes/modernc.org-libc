...
//go:build darwin || (freebsd && amd64) || (linux && arm) || (linux && arm64) || (linux && s390x) || (netbsd && amd64) || windows
// +build darwin freebsd,amd64 linux,arm linux,arm64 linux,s390x netbsd,amd64 windows
